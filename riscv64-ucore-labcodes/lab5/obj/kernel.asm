...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	516060ef          	jal	ra,ffffffffc0206560 <memset>
...
ffffffffc0200056:	53e58593          	addi	a1,a1,1342 # ffffffffc0206590 <etext+0x6>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	55650513          	addi	a0,a0,1366 # ffffffffc02065b0 <etext+0x26>
...
ffffffffc020007a:	439050ef          	jal	ra,ffffffffc0205cb2 <proc_init>
...
ffffffffc020008e:	5e3050ef          	jal	ra,ffffffffc0205e70 <cpu_idle>
...
ffffffffc02000ac:	51050513          	addi	a0,a0,1296 # ffffffffc02065b8 <etext+0x2e>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	7ef050ef          	jal	ra,ffffffffc0206162 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	7b9050ef          	jal	ra,ffffffffc0206162 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	3b650513          	addi	a0,a0,950 # ffffffffc02065c0 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc0200224:	3c050513          	addi	a0,a0,960 # ffffffffc02065e0 <etext+0x56>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	35e58593          	addi	a1,a1,862 # ffffffffc020658a <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	3cc50513          	addi	a0,a0,972 # ffffffffc0206600 <etext+0x76>
...
ffffffffc020024c:	3d850513          	addi	a0,a0,984 # ffffffffc0206620 <etext+0x96>
...
ffffffffc0200260:	3e450513          	addi	a0,a0,996 # ffffffffc0206640 <etext+0xb6>
...
ffffffffc020028e:	3d650513          	addi	a0,a0,982 # ffffffffc0206660 <etext+0xd6>
}
...
ffffffffc020029c:	3f860613          	addi	a2,a2,1016 # ffffffffc0206690 <etext+0x106>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	40450513          	addi	a0,a0,1028 # ffffffffc02066a8 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc02002b8:	40c60613          	addi	a2,a2,1036 # ffffffffc02066c0 <etext+0x136>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	42458593          	addi	a1,a1,1060 # ffffffffc02066e0 <etext+0x156>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	42450513          	addi	a0,a0,1060 # ffffffffc02066e8 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	42660613          	addi	a2,a2,1062 # ffffffffc02066f8 <etext+0x16e>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	44658593          	addi	a1,a1,1094 # ffffffffc0206720 <etext+0x196>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	40650513          	addi	a0,a0,1030 # ffffffffc02066e8 <etext+0x15e>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	44260613          	addi	a2,a2,1090 # ffffffffc0206730 <etext+0x1a6>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	45a58593          	addi	a1,a1,1114 # ffffffffc0206750 <etext+0x1c6>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	3ea50513          	addi	a0,a0,1002 # ffffffffc02066e8 <etext+0x15e>
...
ffffffffc020033c:	42850513          	addi	a0,a0,1064 # ffffffffc0206760 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	42e50513          	addi	a0,a0,1070 # ffffffffc0206788 <etext+0x1fe>
...
ffffffffc0200374:	488c0c13          	addi	s8,s8,1160 # ffffffffc02067f8 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200378:	00006917          	auipc	s2,0x6
ffffffffc020037c:	43890913          	addi	s2,s2,1080 # ffffffffc02067b0 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	43848493          	addi	s1,s1,1080 # ffffffffc02067b8 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	436b0b13          	addi	s6,s6,1078 # ffffffffc02067c0 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	34ea0a13          	addi	s4,s4,846 # ffffffffc02066e0 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003b8:	444d0d13          	addi	s10,s10,1092 # ffffffffc02067f8 <commands>
        argv[argc ++] = buf;
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	16a060ef          	jal	ra,ffffffffc020652c <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	156060ef          	jal	ra,ffffffffc020652c <strcmp>
...
ffffffffc0200414:	136060ef          	jal	ra,ffffffffc020654a <strchr>
...
ffffffffc0200452:	0f8060ef          	jal	ra,ffffffffc020654a <strchr>
...
ffffffffc0200470:	37450513          	addi	a0,a0,884 # ffffffffc02067e0 <etext+0x256>
...
ffffffffc02004ac:	39850513          	addi	a0,a0,920 # ffffffffc0206840 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02004c2:	33a50513          	addi	a0,a0,826 # ffffffffc02077f8 <default_pmm_manager+0x518>
...
ffffffffc02004f6:	36e50513          	addi	a0,a0,878 # ffffffffc0206860 <commands+0x68>
__warn(const char *file, int line, const char *fmt, ...) {
...
ffffffffc0200516:	2e650513          	addi	a0,a0,742 # ffffffffc02077f8 <default_pmm_manager+0x518>
...
ffffffffc0200550:	33450513          	addi	a0,a0,820 # ffffffffc0206880 <commands+0x88>
    ticks = 0;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	763050ef          	jal	ra,ffffffffc0206572 <memcpy>
    return 0;
}
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	73f050ef          	jal	ra,ffffffffc0206572 <memcpy>
    return 0;
}
...
ffffffffc0200674:	23050513          	addi	a0,a0,560 # ffffffffc02068a0 <commands+0xa8>
void print_regs(struct pushregs* gpr) {
...
ffffffffc0200684:	23850513          	addi	a0,a0,568 # ffffffffc02068b8 <commands+0xc0>
...
ffffffffc0200692:	24250513          	addi	a0,a0,578 # ffffffffc02068d0 <commands+0xd8>
...
ffffffffc02006a0:	24c50513          	addi	a0,a0,588 # ffffffffc02068e8 <commands+0xf0>
...
ffffffffc02006ae:	25650513          	addi	a0,a0,598 # ffffffffc0206900 <commands+0x108>
...
ffffffffc02006bc:	26050513          	addi	a0,a0,608 # ffffffffc0206918 <commands+0x120>
...
ffffffffc02006ca:	26a50513          	addi	a0,a0,618 # ffffffffc0206930 <commands+0x138>
...
ffffffffc02006d8:	27450513          	addi	a0,a0,628 # ffffffffc0206948 <commands+0x150>
...
ffffffffc02006e6:	27e50513          	addi	a0,a0,638 # ffffffffc0206960 <commands+0x168>
...
ffffffffc02006f4:	28850513          	addi	a0,a0,648 # ffffffffc0206978 <commands+0x180>
...
ffffffffc0200702:	29250513          	addi	a0,a0,658 # ffffffffc0206990 <commands+0x198>
...
ffffffffc0200710:	29c50513          	addi	a0,a0,668 # ffffffffc02069a8 <commands+0x1b0>
...
ffffffffc020071e:	2a650513          	addi	a0,a0,678 # ffffffffc02069c0 <commands+0x1c8>
...
ffffffffc020072c:	2b050513          	addi	a0,a0,688 # ffffffffc02069d8 <commands+0x1e0>
...
ffffffffc020073a:	2ba50513          	addi	a0,a0,698 # ffffffffc02069f0 <commands+0x1f8>
...
ffffffffc0200748:	2c450513          	addi	a0,a0,708 # ffffffffc0206a08 <commands+0x210>
...
ffffffffc0200756:	2ce50513          	addi	a0,a0,718 # ffffffffc0206a20 <commands+0x228>
...
ffffffffc0200764:	2d850513          	addi	a0,a0,728 # ffffffffc0206a38 <commands+0x240>
...
ffffffffc0200772:	2e250513          	addi	a0,a0,738 # ffffffffc0206a50 <commands+0x258>
...
ffffffffc0200780:	2ec50513          	addi	a0,a0,748 # ffffffffc0206a68 <commands+0x270>
...
ffffffffc020078e:	2f650513          	addi	a0,a0,758 # ffffffffc0206a80 <commands+0x288>
...
ffffffffc020079c:	30050513          	addi	a0,a0,768 # ffffffffc0206a98 <commands+0x2a0>
...
ffffffffc02007aa:	30a50513          	addi	a0,a0,778 # ffffffffc0206ab0 <commands+0x2b8>
...
ffffffffc02007b8:	31450513          	addi	a0,a0,788 # ffffffffc0206ac8 <commands+0x2d0>
...
ffffffffc02007c6:	31e50513          	addi	a0,a0,798 # ffffffffc0206ae0 <commands+0x2e8>
...
ffffffffc02007d4:	32850513          	addi	a0,a0,808 # ffffffffc0206af8 <commands+0x300>
...
ffffffffc02007e2:	33250513          	addi	a0,a0,818 # ffffffffc0206b10 <commands+0x318>
...
ffffffffc02007f0:	33c50513          	addi	a0,a0,828 # ffffffffc0206b28 <commands+0x330>
...
ffffffffc02007fe:	34650513          	addi	a0,a0,838 # ffffffffc0206b40 <commands+0x348>
...
ffffffffc020080c:	35050513          	addi	a0,a0,848 # ffffffffc0206b58 <commands+0x360>
...
ffffffffc020081a:	35a50513          	addi	a0,a0,858 # ffffffffc0206b70 <commands+0x378>
...
ffffffffc020082c:	36050513          	addi	a0,a0,864 # ffffffffc0206b88 <commands+0x390>
}
...
ffffffffc0200840:	36450513          	addi	a0,a0,868 # ffffffffc0206ba0 <commands+0x3a8>
print_trapframe(struct trapframe *tf) {
...
ffffffffc0200858:	36450513          	addi	a0,a0,868 # ffffffffc0206bb8 <commands+0x3c0>
...
ffffffffc0200868:	36c50513          	addi	a0,a0,876 # ffffffffc0206bd0 <commands+0x3d8>
...
ffffffffc0200878:	37450513          	addi	a0,a0,884 # ffffffffc0206be8 <commands+0x3f0>
...
ffffffffc020088c:	37050513          	addi	a0,a0,880 # ffffffffc0206bf8 <commands+0x400>
}
...
ffffffffc02008d4:	34050513          	addi	a0,a0,832 # ffffffffc0206c10 <commands+0x418>
...
ffffffffc0200940:	2f468693          	addi	a3,a3,756 # ffffffffc0206c30 <commands+0x438>
ffffffffc0200944:	00006617          	auipc	a2,0x6
ffffffffc0200948:	30460613          	addi	a2,a2,772 # ffffffffc0206c48 <commands+0x450>
ffffffffc020094c:	06b00593          	li	a1,107
ffffffffc0200950:	00006517          	auipc	a0,0x6
ffffffffc0200954:	31050513          	addi	a0,a0,784 # ffffffffc0206c60 <commands+0x468>
...
ffffffffc020098a:	28a50513          	addi	a0,a0,650 # ffffffffc0206c10 <commands+0x418>
ffffffffc020098e:	ff2ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
            panic("unhandled page fault.\n");
ffffffffc0200992:	00006617          	auipc	a2,0x6
ffffffffc0200996:	2e660613          	addi	a2,a2,742 # ffffffffc0206c78 <commands+0x480>
ffffffffc020099a:	07200593          	li	a1,114
ffffffffc020099e:	00006517          	auipc	a0,0x6
ffffffffc02009a2:	2c250513          	addi	a0,a0,706 # ffffffffc0206c60 <commands+0x468>
...
ffffffffc02009c2:	37270713          	addi	a4,a4,882 # ffffffffc0206d30 <commands+0x538>
...
ffffffffc02009d4:	32050513          	addi	a0,a0,800 # ffffffffc0206cf0 <commands+0x4f8>
ffffffffc02009d8:	fa8ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02009dc:	00006517          	auipc	a0,0x6
ffffffffc02009e0:	2f450513          	addi	a0,a0,756 # ffffffffc0206cd0 <commands+0x4d8>
ffffffffc02009e4:	f9cff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02009e8:	00006517          	auipc	a0,0x6
ffffffffc02009ec:	2a850513          	addi	a0,a0,680 # ffffffffc0206c90 <commands+0x498>
ffffffffc02009f0:	f90ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02009f4:	00006517          	auipc	a0,0x6
ffffffffc02009f8:	2bc50513          	addi	a0,a0,700 # ffffffffc0206cb0 <commands+0x4b8>
...
ffffffffc0200a38:	2dc50513          	addi	a0,a0,732 # ffffffffc0206d10 <commands+0x518>
...
ffffffffc0200a5a:	4a270713          	addi	a4,a4,1186 # ffffffffc0206ef8 <commands+0x700>
...
ffffffffc0200a6c:	3e850513          	addi	a0,a0,1000 # ffffffffc0206e50 <commands+0x658>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	5da0506f          	j	ffffffffc0206060 <syscall>
            cprintf("Environment call from H-mode\n");
ffffffffc0200a8a:	00006517          	auipc	a0,0x6
ffffffffc0200a8e:	3e650513          	addi	a0,a0,998 # ffffffffc0206e70 <commands+0x678>
}
...
ffffffffc0200aa2:	3f250513          	addi	a0,a0,1010 # ffffffffc0206e90 <commands+0x698>
ffffffffc0200aa6:	b7f5                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Instruction page fault\n");
ffffffffc0200aa8:	00006517          	auipc	a0,0x6
ffffffffc0200aac:	40850513          	addi	a0,a0,1032 # ffffffffc0206eb0 <commands+0x6b8>
ffffffffc0200ab0:	b7cd                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Load page fault\n");
ffffffffc0200ab2:	00006517          	auipc	a0,0x6
ffffffffc0200ab6:	41650513          	addi	a0,a0,1046 # ffffffffc0206ec8 <commands+0x6d0>
...
ffffffffc0200ad8:	40c50513          	addi	a0,a0,1036 # ffffffffc0206ee0 <commands+0x6e8>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	51a050ef          	jal	ra,ffffffffc0206060 <syscall>
...
ffffffffc0200b68:	26450513          	addi	a0,a0,612 # ffffffffc0206dc8 <commands+0x5d0>
ffffffffc0200b6c:	b71d                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc0200b6e:	00006517          	auipc	a0,0x6
ffffffffc0200b72:	27a50513          	addi	a0,a0,634 # ffffffffc0206de8 <commands+0x5f0>
...
ffffffffc0200b90:	27460613          	addi	a2,a2,628 # ffffffffc0206e00 <commands+0x608>
ffffffffc0200b94:	0cd00593          	li	a1,205
ffffffffc0200b98:	00006517          	auipc	a0,0x6
ffffffffc0200b9c:	0c850513          	addi	a0,a0,200 # ffffffffc0206c60 <commands+0x468>
ffffffffc0200ba0:	8dbff0ef          	jal	ra,ffffffffc020047a <__panic>
            cprintf("Store/AMO access fault\n");
ffffffffc0200ba4:	00006517          	auipc	a0,0x6
ffffffffc0200ba8:	29450513          	addi	a0,a0,660 # ffffffffc0206e38 <commands+0x640>
...
ffffffffc0200bc8:	23c60613          	addi	a2,a2,572 # ffffffffc0206e00 <commands+0x608>
ffffffffc0200bcc:	0d700593          	li	a1,215
ffffffffc0200bd0:	00006517          	auipc	a0,0x6
ffffffffc0200bd4:	09050513          	addi	a0,a0,144 # ffffffffc0206c60 <commands+0x468>
...
ffffffffc0200bec:	23860613          	addi	a2,a2,568 # ffffffffc0206e20 <commands+0x628>
ffffffffc0200bf0:	0d100593          	li	a1,209
ffffffffc0200bf4:	00006517          	auipc	a0,0x6
ffffffffc0200bf8:	06c50513          	addi	a0,a0,108 # ffffffffc0206c60 <commands+0x468>
...
ffffffffc0200c0c:	1f860613          	addi	a2,a2,504 # ffffffffc0206e00 <commands+0x608>
ffffffffc0200c10:	0f100593          	li	a1,241
ffffffffc0200c14:	00006517          	auipc	a0,0x6
ffffffffc0200c18:	04c50513          	addi	a0,a0,76 # ffffffffc0206c60 <commands+0x468>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	2d80506f          	j	ffffffffc0205f74 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	5f2040ef          	jal	ra,ffffffffc0205294 <do_exit>
            if (current->need_resched) {
...
ffffffffc0200ede:	d6e63603          	ld	a2,-658(a2) # ffffffffc0208c48 <nbase>
...
ffffffffc0201124:	e1868693          	addi	a3,a3,-488 # ffffffffc0206f38 <commands+0x740>
ffffffffc0201128:	00006617          	auipc	a2,0x6
ffffffffc020112c:	b2060613          	addi	a2,a2,-1248 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201130:	0f000593          	li	a1,240
ffffffffc0201134:	00006517          	auipc	a0,0x6
ffffffffc0201138:	e1450513          	addi	a0,a0,-492 # ffffffffc0206f48 <commands+0x750>
ffffffffc020113c:	b3eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0201140:	00006697          	auipc	a3,0x6
ffffffffc0201144:	ea068693          	addi	a3,a3,-352 # ffffffffc0206fe0 <commands+0x7e8>
ffffffffc0201148:	00006617          	auipc	a2,0x6
ffffffffc020114c:	b0060613          	addi	a2,a2,-1280 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201150:	0bd00593          	li	a1,189
ffffffffc0201154:	00006517          	auipc	a0,0x6
ffffffffc0201158:	df450513          	addi	a0,a0,-524 # ffffffffc0206f48 <commands+0x750>
ffffffffc020115c:	b1eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201160:	00006697          	auipc	a3,0x6
ffffffffc0201164:	ea868693          	addi	a3,a3,-344 # ffffffffc0207008 <commands+0x810>
ffffffffc0201168:	00006617          	auipc	a2,0x6
ffffffffc020116c:	ae060613          	addi	a2,a2,-1312 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201170:	0be00593          	li	a1,190
ffffffffc0201174:	00006517          	auipc	a0,0x6
ffffffffc0201178:	dd450513          	addi	a0,a0,-556 # ffffffffc0206f48 <commands+0x750>
ffffffffc020117c:	afeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201180:	00006697          	auipc	a3,0x6
ffffffffc0201184:	ec868693          	addi	a3,a3,-312 # ffffffffc0207048 <commands+0x850>
ffffffffc0201188:	00006617          	auipc	a2,0x6
ffffffffc020118c:	ac060613          	addi	a2,a2,-1344 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201190:	0c000593          	li	a1,192
ffffffffc0201194:	00006517          	auipc	a0,0x6
ffffffffc0201198:	db450513          	addi	a0,a0,-588 # ffffffffc0206f48 <commands+0x750>
ffffffffc020119c:	adeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(!list_empty(&free_list));
ffffffffc02011a0:	00006697          	auipc	a3,0x6
ffffffffc02011a4:	f3068693          	addi	a3,a3,-208 # ffffffffc02070d0 <commands+0x8d8>
ffffffffc02011a8:	00006617          	auipc	a2,0x6
ffffffffc02011ac:	aa060613          	addi	a2,a2,-1376 # ffffffffc0206c48 <commands+0x450>
ffffffffc02011b0:	0d900593          	li	a1,217
ffffffffc02011b4:	00006517          	auipc	a0,0x6
ffffffffc02011b8:	d9450513          	addi	a0,a0,-620 # ffffffffc0206f48 <commands+0x750>
ffffffffc02011bc:	abeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02011c0:	00006697          	auipc	a3,0x6
ffffffffc02011c4:	dc068693          	addi	a3,a3,-576 # ffffffffc0206f80 <commands+0x788>
ffffffffc02011c8:	00006617          	auipc	a2,0x6
ffffffffc02011cc:	a8060613          	addi	a2,a2,-1408 # ffffffffc0206c48 <commands+0x450>
ffffffffc02011d0:	0d200593          	li	a1,210
ffffffffc02011d4:	00006517          	auipc	a0,0x6
ffffffffc02011d8:	d7450513          	addi	a0,a0,-652 # ffffffffc0206f48 <commands+0x750>
ffffffffc02011dc:	a9eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 3);
ffffffffc02011e0:	00006697          	auipc	a3,0x6
ffffffffc02011e4:	ee068693          	addi	a3,a3,-288 # ffffffffc02070c0 <commands+0x8c8>
ffffffffc02011e8:	00006617          	auipc	a2,0x6
ffffffffc02011ec:	a6060613          	addi	a2,a2,-1440 # ffffffffc0206c48 <commands+0x450>
ffffffffc02011f0:	0d000593          	li	a1,208
ffffffffc02011f4:	00006517          	auipc	a0,0x6
ffffffffc02011f8:	d5450513          	addi	a0,a0,-684 # ffffffffc0206f48 <commands+0x750>
ffffffffc02011fc:	a7eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201200:	00006697          	auipc	a3,0x6
ffffffffc0201204:	ea868693          	addi	a3,a3,-344 # ffffffffc02070a8 <commands+0x8b0>
ffffffffc0201208:	00006617          	auipc	a2,0x6
ffffffffc020120c:	a4060613          	addi	a2,a2,-1472 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201210:	0cb00593          	li	a1,203
ffffffffc0201214:	00006517          	auipc	a0,0x6
ffffffffc0201218:	d3450513          	addi	a0,a0,-716 # ffffffffc0206f48 <commands+0x750>
ffffffffc020121c:	a5eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0201220:	00006697          	auipc	a3,0x6
ffffffffc0201224:	e6868693          	addi	a3,a3,-408 # ffffffffc0207088 <commands+0x890>
ffffffffc0201228:	00006617          	auipc	a2,0x6
ffffffffc020122c:	a2060613          	addi	a2,a2,-1504 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201230:	0c200593          	li	a1,194
ffffffffc0201234:	00006517          	auipc	a0,0x6
ffffffffc0201238:	d1450513          	addi	a0,a0,-748 # ffffffffc0206f48 <commands+0x750>
ffffffffc020123c:	a3eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 != NULL);
ffffffffc0201240:	00006697          	auipc	a3,0x6
ffffffffc0201244:	ed868693          	addi	a3,a3,-296 # ffffffffc0207118 <commands+0x920>
ffffffffc0201248:	00006617          	auipc	a2,0x6
ffffffffc020124c:	a0060613          	addi	a2,a2,-1536 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201250:	0f800593          	li	a1,248
ffffffffc0201254:	00006517          	auipc	a0,0x6
ffffffffc0201258:	cf450513          	addi	a0,a0,-780 # ffffffffc0206f48 <commands+0x750>
ffffffffc020125c:	a1eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 0);
ffffffffc0201260:	00006697          	auipc	a3,0x6
ffffffffc0201264:	ea868693          	addi	a3,a3,-344 # ffffffffc0207108 <commands+0x910>
ffffffffc0201268:	00006617          	auipc	a2,0x6
ffffffffc020126c:	9e060613          	addi	a2,a2,-1568 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201270:	0df00593          	li	a1,223
ffffffffc0201274:	00006517          	auipc	a0,0x6
ffffffffc0201278:	cd450513          	addi	a0,a0,-812 # ffffffffc0206f48 <commands+0x750>
ffffffffc020127c:	9feff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201280:	00006697          	auipc	a3,0x6
ffffffffc0201284:	e2868693          	addi	a3,a3,-472 # ffffffffc02070a8 <commands+0x8b0>
ffffffffc0201288:	00006617          	auipc	a2,0x6
ffffffffc020128c:	9c060613          	addi	a2,a2,-1600 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201290:	0dd00593          	li	a1,221
ffffffffc0201294:	00006517          	auipc	a0,0x6
ffffffffc0201298:	cb450513          	addi	a0,a0,-844 # ffffffffc0206f48 <commands+0x750>
ffffffffc020129c:	9deff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc02012a0:	00006697          	auipc	a3,0x6
ffffffffc02012a4:	e4868693          	addi	a3,a3,-440 # ffffffffc02070e8 <commands+0x8f0>
ffffffffc02012a8:	00006617          	auipc	a2,0x6
ffffffffc02012ac:	9a060613          	addi	a2,a2,-1632 # ffffffffc0206c48 <commands+0x450>
ffffffffc02012b0:	0dc00593          	li	a1,220
ffffffffc02012b4:	00006517          	auipc	a0,0x6
ffffffffc02012b8:	c9450513          	addi	a0,a0,-876 # ffffffffc0206f48 <commands+0x750>
ffffffffc02012bc:	9beff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02012c0:	00006697          	auipc	a3,0x6
ffffffffc02012c4:	cc068693          	addi	a3,a3,-832 # ffffffffc0206f80 <commands+0x788>
ffffffffc02012c8:	00006617          	auipc	a2,0x6
ffffffffc02012cc:	98060613          	addi	a2,a2,-1664 # ffffffffc0206c48 <commands+0x450>
ffffffffc02012d0:	0b900593          	li	a1,185
ffffffffc02012d4:	00006517          	auipc	a0,0x6
ffffffffc02012d8:	c7450513          	addi	a0,a0,-908 # ffffffffc0206f48 <commands+0x750>
ffffffffc02012dc:	99eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012e0:	00006697          	auipc	a3,0x6
ffffffffc02012e4:	dc868693          	addi	a3,a3,-568 # ffffffffc02070a8 <commands+0x8b0>
ffffffffc02012e8:	00006617          	auipc	a2,0x6
ffffffffc02012ec:	96060613          	addi	a2,a2,-1696 # ffffffffc0206c48 <commands+0x450>
ffffffffc02012f0:	0d600593          	li	a1,214
ffffffffc02012f4:	00006517          	auipc	a0,0x6
ffffffffc02012f8:	c5450513          	addi	a0,a0,-940 # ffffffffc0206f48 <commands+0x750>
ffffffffc02012fc:	97eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201300:	00006697          	auipc	a3,0x6
ffffffffc0201304:	cc068693          	addi	a3,a3,-832 # ffffffffc0206fc0 <commands+0x7c8>
ffffffffc0201308:	00006617          	auipc	a2,0x6
ffffffffc020130c:	94060613          	addi	a2,a2,-1728 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201310:	0d400593          	li	a1,212
ffffffffc0201314:	00006517          	auipc	a0,0x6
ffffffffc0201318:	c3450513          	addi	a0,a0,-972 # ffffffffc0206f48 <commands+0x750>
ffffffffc020131c:	95eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201320:	00006697          	auipc	a3,0x6
ffffffffc0201324:	c8068693          	addi	a3,a3,-896 # ffffffffc0206fa0 <commands+0x7a8>
ffffffffc0201328:	00006617          	auipc	a2,0x6
ffffffffc020132c:	92060613          	addi	a2,a2,-1760 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201330:	0d300593          	li	a1,211
ffffffffc0201334:	00006517          	auipc	a0,0x6
ffffffffc0201338:	c1450513          	addi	a0,a0,-1004 # ffffffffc0206f48 <commands+0x750>
ffffffffc020133c:	93eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201340:	00006697          	auipc	a3,0x6
ffffffffc0201344:	c8068693          	addi	a3,a3,-896 # ffffffffc0206fc0 <commands+0x7c8>
ffffffffc0201348:	00006617          	auipc	a2,0x6
ffffffffc020134c:	90060613          	addi	a2,a2,-1792 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201350:	0bb00593          	li	a1,187
ffffffffc0201354:	00006517          	auipc	a0,0x6
ffffffffc0201358:	bf450513          	addi	a0,a0,-1036 # ffffffffc0206f48 <commands+0x750>
ffffffffc020135c:	91eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(count == 0);
ffffffffc0201360:	00006697          	auipc	a3,0x6
ffffffffc0201364:	f0868693          	addi	a3,a3,-248 # ffffffffc0207268 <commands+0xa70>
ffffffffc0201368:	00006617          	auipc	a2,0x6
ffffffffc020136c:	8e060613          	addi	a2,a2,-1824 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201370:	12500593          	li	a1,293
ffffffffc0201374:	00006517          	auipc	a0,0x6
ffffffffc0201378:	bd450513          	addi	a0,a0,-1068 # ffffffffc0206f48 <commands+0x750>
ffffffffc020137c:	8feff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 0);
ffffffffc0201380:	00006697          	auipc	a3,0x6
ffffffffc0201384:	d8868693          	addi	a3,a3,-632 # ffffffffc0207108 <commands+0x910>
ffffffffc0201388:	00006617          	auipc	a2,0x6
ffffffffc020138c:	8c060613          	addi	a2,a2,-1856 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201390:	11a00593          	li	a1,282
ffffffffc0201394:	00006517          	auipc	a0,0x6
ffffffffc0201398:	bb450513          	addi	a0,a0,-1100 # ffffffffc0206f48 <commands+0x750>
ffffffffc020139c:	8deff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02013a0:	00006697          	auipc	a3,0x6
ffffffffc02013a4:	d0868693          	addi	a3,a3,-760 # ffffffffc02070a8 <commands+0x8b0>
ffffffffc02013a8:	00006617          	auipc	a2,0x6
ffffffffc02013ac:	8a060613          	addi	a2,a2,-1888 # ffffffffc0206c48 <commands+0x450>
ffffffffc02013b0:	11800593          	li	a1,280
ffffffffc02013b4:	00006517          	auipc	a0,0x6
ffffffffc02013b8:	b9450513          	addi	a0,a0,-1132 # ffffffffc0206f48 <commands+0x750>
ffffffffc02013bc:	8beff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc02013c0:	00006697          	auipc	a3,0x6
ffffffffc02013c4:	ca868693          	addi	a3,a3,-856 # ffffffffc0207068 <commands+0x870>
ffffffffc02013c8:	00006617          	auipc	a2,0x6
ffffffffc02013cc:	88060613          	addi	a2,a2,-1920 # ffffffffc0206c48 <commands+0x450>
ffffffffc02013d0:	0c100593          	li	a1,193
ffffffffc02013d4:	00006517          	auipc	a0,0x6
ffffffffc02013d8:	b7450513          	addi	a0,a0,-1164 # ffffffffc0206f48 <commands+0x750>
ffffffffc02013dc:	89eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02013e0:	00006697          	auipc	a3,0x6
ffffffffc02013e4:	e4868693          	addi	a3,a3,-440 # ffffffffc0207228 <commands+0xa30>
ffffffffc02013e8:	00006617          	auipc	a2,0x6
ffffffffc02013ec:	86060613          	addi	a2,a2,-1952 # ffffffffc0206c48 <commands+0x450>
ffffffffc02013f0:	11200593          	li	a1,274
ffffffffc02013f4:	00006517          	auipc	a0,0x6
ffffffffc02013f8:	b5450513          	addi	a0,a0,-1196 # ffffffffc0206f48 <commands+0x750>
ffffffffc02013fc:	87eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201400:	00006697          	auipc	a3,0x6
ffffffffc0201404:	e0868693          	addi	a3,a3,-504 # ffffffffc0207208 <commands+0xa10>
ffffffffc0201408:	00006617          	auipc	a2,0x6
ffffffffc020140c:	84060613          	addi	a2,a2,-1984 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201410:	11000593          	li	a1,272
ffffffffc0201414:	00006517          	auipc	a0,0x6
ffffffffc0201418:	b3450513          	addi	a0,a0,-1228 # ffffffffc0206f48 <commands+0x750>
ffffffffc020141c:	85eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201420:	00006697          	auipc	a3,0x6
ffffffffc0201424:	dc068693          	addi	a3,a3,-576 # ffffffffc02071e0 <commands+0x9e8>
ffffffffc0201428:	00006617          	auipc	a2,0x6
ffffffffc020142c:	82060613          	addi	a2,a2,-2016 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201430:	10e00593          	li	a1,270
ffffffffc0201434:	00006517          	auipc	a0,0x6
ffffffffc0201438:	b1450513          	addi	a0,a0,-1260 # ffffffffc0206f48 <commands+0x750>
ffffffffc020143c:	83eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201440:	00006697          	auipc	a3,0x6
ffffffffc0201444:	d7868693          	addi	a3,a3,-648 # ffffffffc02071b8 <commands+0x9c0>
ffffffffc0201448:	00006617          	auipc	a2,0x6
ffffffffc020144c:	80060613          	addi	a2,a2,-2048 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201450:	10d00593          	li	a1,269
ffffffffc0201454:	00006517          	auipc	a0,0x6
ffffffffc0201458:	af450513          	addi	a0,a0,-1292 # ffffffffc0206f48 <commands+0x750>
ffffffffc020145c:	81eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201460:	00006697          	auipc	a3,0x6
ffffffffc0201464:	d4868693          	addi	a3,a3,-696 # ffffffffc02071a8 <commands+0x9b0>
ffffffffc0201468:	00005617          	auipc	a2,0x5
ffffffffc020146c:	7e060613          	addi	a2,a2,2016 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201470:	10800593          	li	a1,264
ffffffffc0201474:	00006517          	auipc	a0,0x6
ffffffffc0201478:	ad450513          	addi	a0,a0,-1324 # ffffffffc0206f48 <commands+0x750>
ffffffffc020147c:	ffffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201480:	00006697          	auipc	a3,0x6
ffffffffc0201484:	c2868693          	addi	a3,a3,-984 # ffffffffc02070a8 <commands+0x8b0>
ffffffffc0201488:	00005617          	auipc	a2,0x5
ffffffffc020148c:	7c060613          	addi	a2,a2,1984 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201490:	10700593          	li	a1,263
ffffffffc0201494:	00006517          	auipc	a0,0x6
ffffffffc0201498:	ab450513          	addi	a0,a0,-1356 # ffffffffc0206f48 <commands+0x750>
ffffffffc020149c:	fdffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02014a0:	00006697          	auipc	a3,0x6
ffffffffc02014a4:	ce868693          	addi	a3,a3,-792 # ffffffffc0207188 <commands+0x990>
ffffffffc02014a8:	00005617          	auipc	a2,0x5
ffffffffc02014ac:	7a060613          	addi	a2,a2,1952 # ffffffffc0206c48 <commands+0x450>
ffffffffc02014b0:	10600593          	li	a1,262
ffffffffc02014b4:	00006517          	auipc	a0,0x6
ffffffffc02014b8:	a9450513          	addi	a0,a0,-1388 # ffffffffc0206f48 <commands+0x750>
ffffffffc02014bc:	fbffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc02014c0:	00006697          	auipc	a3,0x6
ffffffffc02014c4:	c9868693          	addi	a3,a3,-872 # ffffffffc0207158 <commands+0x960>
ffffffffc02014c8:	00005617          	auipc	a2,0x5
ffffffffc02014cc:	78060613          	addi	a2,a2,1920 # ffffffffc0206c48 <commands+0x450>
ffffffffc02014d0:	10500593          	li	a1,261
ffffffffc02014d4:	00006517          	auipc	a0,0x6
ffffffffc02014d8:	a7450513          	addi	a0,a0,-1420 # ffffffffc0206f48 <commands+0x750>
ffffffffc02014dc:	f9ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02014e0:	00006697          	auipc	a3,0x6
ffffffffc02014e4:	c6068693          	addi	a3,a3,-928 # ffffffffc0207140 <commands+0x948>
ffffffffc02014e8:	00005617          	auipc	a2,0x5
ffffffffc02014ec:	76060613          	addi	a2,a2,1888 # ffffffffc0206c48 <commands+0x450>
ffffffffc02014f0:	10400593          	li	a1,260
ffffffffc02014f4:	00006517          	auipc	a0,0x6
ffffffffc02014f8:	a5450513          	addi	a0,a0,-1452 # ffffffffc0206f48 <commands+0x750>
ffffffffc02014fc:	f7ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201500:	00006697          	auipc	a3,0x6
ffffffffc0201504:	ba868693          	addi	a3,a3,-1112 # ffffffffc02070a8 <commands+0x8b0>
ffffffffc0201508:	00005617          	auipc	a2,0x5
ffffffffc020150c:	74060613          	addi	a2,a2,1856 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201510:	0fe00593          	li	a1,254
ffffffffc0201514:	00006517          	auipc	a0,0x6
ffffffffc0201518:	a3450513          	addi	a0,a0,-1484 # ffffffffc0206f48 <commands+0x750>
ffffffffc020151c:	f5ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(!PageProperty(p0));
ffffffffc0201520:	00006697          	auipc	a3,0x6
ffffffffc0201524:	c0868693          	addi	a3,a3,-1016 # ffffffffc0207128 <commands+0x930>
ffffffffc0201528:	00005617          	auipc	a2,0x5
ffffffffc020152c:	72060613          	addi	a2,a2,1824 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201530:	0f900593          	li	a1,249
ffffffffc0201534:	00006517          	auipc	a0,0x6
ffffffffc0201538:	a1450513          	addi	a0,a0,-1516 # ffffffffc0206f48 <commands+0x750>
ffffffffc020153c:	f3ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201540:	00006697          	auipc	a3,0x6
ffffffffc0201544:	d0868693          	addi	a3,a3,-760 # ffffffffc0207248 <commands+0xa50>
ffffffffc0201548:	00005617          	auipc	a2,0x5
ffffffffc020154c:	70060613          	addi	a2,a2,1792 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201550:	11700593          	li	a1,279
ffffffffc0201554:	00006517          	auipc	a0,0x6
ffffffffc0201558:	9f450513          	addi	a0,a0,-1548 # ffffffffc0206f48 <commands+0x750>
ffffffffc020155c:	f1ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(total == 0);
ffffffffc0201560:	00006697          	auipc	a3,0x6
ffffffffc0201564:	d1868693          	addi	a3,a3,-744 # ffffffffc0207278 <commands+0xa80>
ffffffffc0201568:	00005617          	auipc	a2,0x5
ffffffffc020156c:	6e060613          	addi	a2,a2,1760 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201570:	12600593          	li	a1,294
ffffffffc0201574:	00006517          	auipc	a0,0x6
ffffffffc0201578:	9d450513          	addi	a0,a0,-1580 # ffffffffc0206f48 <commands+0x750>
ffffffffc020157c:	efffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(total == nr_free_pages());
ffffffffc0201580:	00006697          	auipc	a3,0x6
ffffffffc0201584:	9e068693          	addi	a3,a3,-1568 # ffffffffc0206f60 <commands+0x768>
ffffffffc0201588:	00005617          	auipc	a2,0x5
ffffffffc020158c:	6c060613          	addi	a2,a2,1728 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201590:	0f300593          	li	a1,243
ffffffffc0201594:	00006517          	auipc	a0,0x6
ffffffffc0201598:	9b450513          	addi	a0,a0,-1612 # ffffffffc0206f48 <commands+0x750>
ffffffffc020159c:	edffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02015a0:	00006697          	auipc	a3,0x6
ffffffffc02015a4:	a0068693          	addi	a3,a3,-1536 # ffffffffc0206fa0 <commands+0x7a8>
ffffffffc02015a8:	00005617          	auipc	a2,0x5
ffffffffc02015ac:	6a060613          	addi	a2,a2,1696 # ffffffffc0206c48 <commands+0x450>
ffffffffc02015b0:	0ba00593          	li	a1,186
ffffffffc02015b4:	00006517          	auipc	a0,0x6
ffffffffc02015b8:	99450513          	addi	a0,a0,-1644 # ffffffffc0206f48 <commands+0x750>
...
ffffffffc02016f0:	ba468693          	addi	a3,a3,-1116 # ffffffffc0207290 <commands+0xa98>
ffffffffc02016f4:	00005617          	auipc	a2,0x5
ffffffffc02016f8:	55460613          	addi	a2,a2,1364 # ffffffffc0206c48 <commands+0x450>
ffffffffc02016fc:	08300593          	li	a1,131
ffffffffc0201700:	00006517          	auipc	a0,0x6
ffffffffc0201704:	84850513          	addi	a0,a0,-1976 # ffffffffc0206f48 <commands+0x750>
ffffffffc0201708:	d73fe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc020170c:	00006697          	auipc	a3,0x6
ffffffffc0201710:	b7c68693          	addi	a3,a3,-1156 # ffffffffc0207288 <commands+0xa90>
ffffffffc0201714:	00005617          	auipc	a2,0x5
ffffffffc0201718:	53460613          	addi	a2,a2,1332 # ffffffffc0206c48 <commands+0x450>
ffffffffc020171c:	08000593          	li	a1,128
ffffffffc0201720:	00006517          	auipc	a0,0x6
ffffffffc0201724:	82850513          	addi	a0,a0,-2008 # ffffffffc0206f48 <commands+0x750>
...
ffffffffc02017c2:	aca68693          	addi	a3,a3,-1334 # ffffffffc0207288 <commands+0xa90>
ffffffffc02017c6:	00005617          	auipc	a2,0x5
ffffffffc02017ca:	48260613          	addi	a2,a2,1154 # ffffffffc0206c48 <commands+0x450>
ffffffffc02017ce:	06200593          	li	a1,98
ffffffffc02017d2:	00005517          	auipc	a0,0x5
ffffffffc02017d6:	77650513          	addi	a0,a0,1910 # ffffffffc0206f48 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc0201894:	a2868693          	addi	a3,a3,-1496 # ffffffffc02072b8 <commands+0xac0>
ffffffffc0201898:	00005617          	auipc	a2,0x5
ffffffffc020189c:	3b060613          	addi	a2,a2,944 # ffffffffc0206c48 <commands+0x450>
ffffffffc02018a0:	04900593          	li	a1,73
ffffffffc02018a4:	00005517          	auipc	a0,0x5
ffffffffc02018a8:	6a450513          	addi	a0,a0,1700 # ffffffffc0206f48 <commands+0x750>
ffffffffc02018ac:	bcffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc02018b0:	00006697          	auipc	a3,0x6
ffffffffc02018b4:	9d868693          	addi	a3,a3,-1576 # ffffffffc0207288 <commands+0xa90>
ffffffffc02018b8:	00005617          	auipc	a2,0x5
ffffffffc02018bc:	39060613          	addi	a2,a2,912 # ffffffffc0206c48 <commands+0x450>
ffffffffc02018c0:	04600593          	li	a1,70
ffffffffc02018c4:	00005517          	auipc	a0,0x5
ffffffffc02018c8:	68450513          	addi	a0,a0,1668 # ffffffffc0206f48 <commands+0x750>
...
ffffffffc02019a4:	2a86b683          	ld	a3,680(a3) # ffffffffc0208c48 <nbase>
...
ffffffffc02019d4:	94860613          	addi	a2,a2,-1720 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc02019d8:	06900593          	li	a1,105
ffffffffc02019dc:	00006517          	auipc	a0,0x6
ffffffffc02019e0:	96450513          	addi	a0,a0,-1692 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0201ac2:	89268693          	addi	a3,a3,-1902 # ffffffffc0207350 <default_pmm_manager+0x70>
ffffffffc0201ac6:	00005617          	auipc	a2,0x5
ffffffffc0201aca:	18260613          	addi	a2,a2,386 # ffffffffc0206c48 <commands+0x450>
ffffffffc0201ace:	06400593          	li	a1,100
ffffffffc0201ad2:	00006517          	auipc	a0,0x6
ffffffffc0201ad6:	89e50513          	addi	a0,a0,-1890 # ffffffffc0207370 <default_pmm_manager+0x90>
...
ffffffffc0201ae4:	8a850513          	addi	a0,a0,-1880 # ffffffffc0207388 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201af4:	8b050513          	addi	a0,a0,-1872 # ffffffffc02073a0 <default_pmm_manager+0xc0>
}
...
ffffffffc0201c1c:	03053503          	ld	a0,48(a0) # ffffffffc0208c48 <nbase>
...
ffffffffc0201c7a:	77260613          	addi	a2,a2,1906 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc0201c7e:	06200593          	li	a1,98
ffffffffc0201c82:	00005517          	auipc	a0,0x5
ffffffffc0201c86:	6be50513          	addi	a0,a0,1726 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0201c94:	73060613          	addi	a2,a2,1840 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0201c98:	06e00593          	li	a1,110
ffffffffc0201c9c:	00005517          	auipc	a0,0x5
ffffffffc0201ca0:	6a450513          	addi	a0,a0,1700 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0201cae:	73e60613          	addi	a2,a2,1854 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc0201cb2:	06200593          	li	a1,98
ffffffffc0201cb6:	00005517          	auipc	a0,0x5
ffffffffc0201cba:	68a50513          	addi	a0,a0,1674 # ffffffffc0207340 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201cca:	74260613          	addi	a2,a2,1858 # ffffffffc0207408 <default_pmm_manager+0x128>
ffffffffc0201cce:	07400593          	li	a1,116
ffffffffc0201cd2:	00005517          	auipc	a0,0x5
ffffffffc0201cd6:	66e50513          	addi	a0,a0,1646 # ffffffffc0207340 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201e72:	6ee040ef          	jal	ra,ffffffffc0206560 <memset>
    return page - pages + nbase;
...
ffffffffc0201f04:	65c040ef          	jal	ra,ffffffffc0206560 <memset>
    return page - pages + nbase;
...
ffffffffc0201f5e:	3be60613          	addi	a2,a2,958 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0201f62:	0e300593          	li	a1,227
ffffffffc0201f66:	00005517          	auipc	a0,0x5
ffffffffc0201f6a:	4ca50513          	addi	a0,a0,1226 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0201f6e:	d0cfe0ef          	jal	ra,ffffffffc020047a <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201f72:	00005617          	auipc	a2,0x5
ffffffffc0201f76:	3a660613          	addi	a2,a2,934 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0201f7a:	0ee00593          	li	a1,238
ffffffffc0201f7e:	00005517          	auipc	a0,0x5
ffffffffc0201f82:	4b250513          	addi	a0,a0,1202 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0201f90:	38c60613          	addi	a2,a2,908 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0201f94:	0eb00593          	li	a1,235
ffffffffc0201f98:	00005517          	auipc	a0,0x5
ffffffffc0201f9c:	49850513          	addi	a0,a0,1176 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0201faa:	37260613          	addi	a2,a2,882 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0201fae:	0df00593          	li	a1,223
ffffffffc0201fb2:	00005517          	auipc	a0,0x5
ffffffffc0201fb6:	47e50513          	addi	a0,a0,1150 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0202118:	32c68693          	addi	a3,a3,812 # ffffffffc0207440 <default_pmm_manager+0x160>
ffffffffc020211c:	00005617          	auipc	a2,0x5
ffffffffc0202120:	b2c60613          	addi	a2,a2,-1236 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202124:	10f00593          	li	a1,271
ffffffffc0202128:	00005517          	auipc	a0,0x5
ffffffffc020212c:	30850513          	addi	a0,a0,776 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202130:	b4afe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0202134:	00005697          	auipc	a3,0x5
ffffffffc0202138:	33c68693          	addi	a3,a3,828 # ffffffffc0207470 <default_pmm_manager+0x190>
ffffffffc020213c:	00005617          	auipc	a2,0x5
ffffffffc0202140:	b0c60613          	addi	a2,a2,-1268 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202144:	11000593          	li	a1,272
ffffffffc0202148:	00005517          	auipc	a0,0x5
ffffffffc020214c:	2e850513          	addi	a0,a0,744 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0202392:	0b268693          	addi	a3,a3,178 # ffffffffc0207440 <default_pmm_manager+0x160>
ffffffffc0202396:	00005617          	auipc	a2,0x5
ffffffffc020239a:	8b260613          	addi	a2,a2,-1870 # ffffffffc0206c48 <commands+0x450>
ffffffffc020239e:	12000593          	li	a1,288
ffffffffc02023a2:	00005517          	auipc	a0,0x5
ffffffffc02023a6:	08e50513          	addi	a0,a0,142 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc02023aa:	8d0fe0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02023ae:	00005617          	auipc	a2,0x5
ffffffffc02023b2:	f6a60613          	addi	a2,a2,-150 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc02023b6:	06900593          	li	a1,105
ffffffffc02023ba:	00005517          	auipc	a0,0x5
ffffffffc02023be:	f8650513          	addi	a0,a0,-122 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc02023ce:	0a668693          	addi	a3,a3,166 # ffffffffc0207470 <default_pmm_manager+0x190>
ffffffffc02023d2:	00005617          	auipc	a2,0x5
ffffffffc02023d6:	87660613          	addi	a2,a2,-1930 # ffffffffc0206c48 <commands+0x450>
ffffffffc02023da:	12100593          	li	a1,289
ffffffffc02023de:	00005517          	auipc	a0,0x5
ffffffffc02023e2:	05250513          	addi	a0,a0,82 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0202580:	d6478793          	addi	a5,a5,-668 # ffffffffc02072e0 <default_pmm_manager>
...
ffffffffc020258e:	efe50513          	addi	a0,a0,-258 # ffffffffc0207488 <default_pmm_manager+0x1a8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02025dc:	ec850513          	addi	a0,a0,-312 # ffffffffc02074a0 <default_pmm_manager+0x1c0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc02025fc:	ec050513          	addi	a0,a0,-320 # ffffffffc02074b8 <default_pmm_manager+0x1d8>
...
ffffffffc0202664:	e8050513          	addi	a0,a0,-384 # ffffffffc02074e0 <default_pmm_manager+0x200>
...
ffffffffc0202680:	e7c50513          	addi	a0,a0,-388 # ffffffffc02074f8 <default_pmm_manager+0x218>
...
ffffffffc0202920:	ec450513          	addi	a0,a0,-316 # ffffffffc02077e0 <default_pmm_manager+0x500>
...
ffffffffc02029d6:	f4658593          	addi	a1,a1,-186 # ffffffffc0207918 <default_pmm_manager+0x638>
ffffffffc02029da:	10000513          	li	a0,256
ffffffffc02029de:	33d030ef          	jal	ra,ffffffffc020651a <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	343030ef          	jal	ra,ffffffffc020652c <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	2c5030ef          	jal	ra,ffffffffc02064e4 <strlen>
...
ffffffffc0202ae4:	eb050513          	addi	a0,a0,-336 # ffffffffc0207990 <default_pmm_manager+0x6b0>
...
ffffffffc0202bfe:	c4668693          	addi	a3,a3,-954 # ffffffffc0207840 <default_pmm_manager+0x560>
ffffffffc0202c02:	00004617          	auipc	a2,0x4
ffffffffc0202c06:	04660613          	addi	a2,a2,70 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202c0a:	22900593          	li	a1,553
ffffffffc0202c0e:	00005517          	auipc	a0,0x5
ffffffffc0202c12:	82250513          	addi	a0,a0,-2014 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202c16:	865fd0ef          	jal	ra,ffffffffc020047a <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202c1a:	00005697          	auipc	a3,0x5
ffffffffc0202c1e:	be668693          	addi	a3,a3,-1050 # ffffffffc0207800 <default_pmm_manager+0x520>
ffffffffc0202c22:	00004617          	auipc	a2,0x4
ffffffffc0202c26:	02660613          	addi	a2,a2,38 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202c2a:	22800593          	li	a1,552
ffffffffc0202c2e:	00005517          	auipc	a0,0x5
ffffffffc0202c32:	80250513          	addi	a0,a0,-2046 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0202c40:	6dc60613          	addi	a2,a2,1756 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0202c44:	22800593          	li	a1,552
ffffffffc0202c48:	00004517          	auipc	a0,0x4
ffffffffc0202c4c:	7e850513          	addi	a0,a0,2024 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0202c5c:	76860613          	addi	a2,a2,1896 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0202c60:	07f00593          	li	a1,127
ffffffffc0202c64:	00004517          	auipc	a0,0x4
ffffffffc0202c68:	7cc50513          	addi	a0,a0,1996 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202c6c:	80ffd0ef          	jal	ra,ffffffffc020047a <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202c70:	00004617          	auipc	a2,0x4
ffffffffc0202c74:	75060613          	addi	a2,a2,1872 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0202c78:	0c100593          	li	a1,193
ffffffffc0202c7c:	00004517          	auipc	a0,0x4
ffffffffc0202c80:	7b450513          	addi	a0,a0,1972 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202c84:	ff6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc0202c88:	00005697          	auipc	a3,0x5
ffffffffc0202c8c:	8b068693          	addi	a3,a3,-1872 # ffffffffc0207538 <default_pmm_manager+0x258>
ffffffffc0202c90:	00004617          	auipc	a2,0x4
ffffffffc0202c94:	fb860613          	addi	a2,a2,-72 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202c98:	1ec00593          	li	a1,492
ffffffffc0202c9c:	00004517          	auipc	a0,0x4
ffffffffc0202ca0:	79450513          	addi	a0,a0,1940 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202ca4:	fd6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202ca8:	00005697          	auipc	a3,0x5
ffffffffc0202cac:	87068693          	addi	a3,a3,-1936 # ffffffffc0207518 <default_pmm_manager+0x238>
ffffffffc0202cb0:	00004617          	auipc	a2,0x4
ffffffffc0202cb4:	f9860613          	addi	a2,a2,-104 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202cb8:	1eb00593          	li	a1,491
ffffffffc0202cbc:	00004517          	auipc	a0,0x4
ffffffffc0202cc0:	77450513          	addi	a0,a0,1908 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0202cd0:	8fc68693          	addi	a3,a3,-1796 # ffffffffc02075c8 <default_pmm_manager+0x2e8>
ffffffffc0202cd4:	00004617          	auipc	a2,0x4
ffffffffc0202cd8:	f7460613          	addi	a2,a2,-140 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202cdc:	1f400593          	li	a1,500
ffffffffc0202ce0:	00004517          	auipc	a0,0x4
ffffffffc0202ce4:	75050513          	addi	a0,a0,1872 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202ce8:	f92fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202cec:	00005697          	auipc	a3,0x5
ffffffffc0202cf0:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0207598 <default_pmm_manager+0x2b8>
ffffffffc0202cf4:	00004617          	auipc	a2,0x4
ffffffffc0202cf8:	f5460613          	addi	a2,a2,-172 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202cfc:	1f100593          	li	a1,497
ffffffffc0202d00:	00004517          	auipc	a0,0x4
ffffffffc0202d04:	73050513          	addi	a0,a0,1840 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202d08:	f72fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202d0c:	00005697          	auipc	a3,0x5
ffffffffc0202d10:	86468693          	addi	a3,a3,-1948 # ffffffffc0207570 <default_pmm_manager+0x290>
ffffffffc0202d14:	00004617          	auipc	a2,0x4
ffffffffc0202d18:	f3460613          	addi	a2,a2,-204 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202d1c:	1ed00593          	li	a1,493
ffffffffc0202d20:	00004517          	auipc	a0,0x4
ffffffffc0202d24:	71050513          	addi	a0,a0,1808 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202d28:	f52fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202d2c:	00005697          	auipc	a3,0x5
ffffffffc0202d30:	92468693          	addi	a3,a3,-1756 # ffffffffc0207650 <default_pmm_manager+0x370>
ffffffffc0202d34:	00004617          	auipc	a2,0x4
ffffffffc0202d38:	f1460613          	addi	a2,a2,-236 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202d3c:	1fd00593          	li	a1,509
ffffffffc0202d40:	00004517          	auipc	a0,0x4
ffffffffc0202d44:	6f050513          	addi	a0,a0,1776 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202d48:	f32fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202d4c:	00005697          	auipc	a3,0x5
ffffffffc0202d50:	9a468693          	addi	a3,a3,-1628 # ffffffffc02076f0 <default_pmm_manager+0x410>
ffffffffc0202d54:	00004617          	auipc	a2,0x4
ffffffffc0202d58:	ef460613          	addi	a2,a2,-268 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202d5c:	20200593          	li	a1,514
ffffffffc0202d60:	00004517          	auipc	a0,0x4
ffffffffc0202d64:	6d050513          	addi	a0,a0,1744 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202d68:	f12fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202d6c:	00005697          	auipc	a3,0x5
ffffffffc0202d70:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0207628 <default_pmm_manager+0x348>
ffffffffc0202d74:	00004617          	auipc	a2,0x4
ffffffffc0202d78:	ed460613          	addi	a2,a2,-300 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202d7c:	1fa00593          	li	a1,506
ffffffffc0202d80:	00004517          	auipc	a0,0x4
ffffffffc0202d84:	6b050513          	addi	a0,a0,1712 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0202d92:	58a60613          	addi	a2,a2,1418 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0202d96:	1f900593          	li	a1,505
ffffffffc0202d9a:	00004517          	auipc	a0,0x4
ffffffffc0202d9e:	69650513          	addi	a0,a0,1686 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202da2:	ed8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202da6:	00005697          	auipc	a3,0x5
ffffffffc0202daa:	8e268693          	addi	a3,a3,-1822 # ffffffffc0207688 <default_pmm_manager+0x3a8>
ffffffffc0202dae:	00004617          	auipc	a2,0x4
ffffffffc0202db2:	e9a60613          	addi	a2,a2,-358 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202db6:	20700593          	li	a1,519
ffffffffc0202dba:	00004517          	auipc	a0,0x4
ffffffffc0202dbe:	67650513          	addi	a0,a0,1654 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202dc2:	eb8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202dc6:	00005697          	auipc	a3,0x5
ffffffffc0202dca:	98a68693          	addi	a3,a3,-1654 # ffffffffc0207750 <default_pmm_manager+0x470>
ffffffffc0202dce:	00004617          	auipc	a2,0x4
ffffffffc0202dd2:	e7a60613          	addi	a2,a2,-390 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202dd6:	20600593          	li	a1,518
ffffffffc0202dda:	00004517          	auipc	a0,0x4
ffffffffc0202dde:	65650513          	addi	a0,a0,1622 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202de2:	e98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202de6:	00005697          	auipc	a3,0x5
ffffffffc0202dea:	95268693          	addi	a3,a3,-1710 # ffffffffc0207738 <default_pmm_manager+0x458>
ffffffffc0202dee:	00004617          	auipc	a2,0x4
ffffffffc0202df2:	e5a60613          	addi	a2,a2,-422 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202df6:	20500593          	li	a1,517
ffffffffc0202dfa:	00004517          	auipc	a0,0x4
ffffffffc0202dfe:	63650513          	addi	a0,a0,1590 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202e02:	e78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202e06:	00005697          	auipc	a3,0x5
ffffffffc0202e0a:	90268693          	addi	a3,a3,-1790 # ffffffffc0207708 <default_pmm_manager+0x428>
ffffffffc0202e0e:	00004617          	auipc	a2,0x4
ffffffffc0202e12:	e3a60613          	addi	a2,a2,-454 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202e16:	20400593          	li	a1,516
ffffffffc0202e1a:	00004517          	auipc	a0,0x4
ffffffffc0202e1e:	61650513          	addi	a0,a0,1558 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202e22:	e58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202e26:	00005697          	auipc	a3,0x5
ffffffffc0202e2a:	a9a68693          	addi	a3,a3,-1382 # ffffffffc02078c0 <default_pmm_manager+0x5e0>
ffffffffc0202e2e:	00004617          	auipc	a2,0x4
ffffffffc0202e32:	e1a60613          	addi	a2,a2,-486 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202e36:	23300593          	li	a1,563
ffffffffc0202e3a:	00004517          	auipc	a0,0x4
ffffffffc0202e3e:	5f650513          	addi	a0,a0,1526 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202e42:	e38fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc0202e46:	00005697          	auipc	a3,0x5
ffffffffc0202e4a:	89268693          	addi	a3,a3,-1902 # ffffffffc02076d8 <default_pmm_manager+0x3f8>
ffffffffc0202e4e:	00004617          	auipc	a2,0x4
ffffffffc0202e52:	dfa60613          	addi	a2,a2,-518 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202e56:	20100593          	li	a1,513
ffffffffc0202e5a:	00004517          	auipc	a0,0x4
ffffffffc0202e5e:	5d650513          	addi	a0,a0,1494 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202e62:	e18fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202e66:	00005697          	auipc	a3,0x5
ffffffffc0202e6a:	86268693          	addi	a3,a3,-1950 # ffffffffc02076c8 <default_pmm_manager+0x3e8>
ffffffffc0202e6e:	00004617          	auipc	a2,0x4
ffffffffc0202e72:	dda60613          	addi	a2,a2,-550 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202e76:	20000593          	li	a1,512
ffffffffc0202e7a:	00004517          	auipc	a0,0x4
ffffffffc0202e7e:	5b650513          	addi	a0,a0,1462 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202e82:	df8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202e86:	00005697          	auipc	a3,0x5
ffffffffc0202e8a:	93a68693          	addi	a3,a3,-1734 # ffffffffc02077c0 <default_pmm_manager+0x4e0>
ffffffffc0202e8e:	00004617          	auipc	a2,0x4
ffffffffc0202e92:	dba60613          	addi	a2,a2,-582 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202e96:	24400593          	li	a1,580
ffffffffc0202e9a:	00004517          	auipc	a0,0x4
ffffffffc0202e9e:	59650513          	addi	a0,a0,1430 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202ea2:	dd8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202ea6:	00005697          	auipc	a3,0x5
ffffffffc0202eaa:	81268693          	addi	a3,a3,-2030 # ffffffffc02076b8 <default_pmm_manager+0x3d8>
ffffffffc0202eae:	00004617          	auipc	a2,0x4
ffffffffc0202eb2:	d9a60613          	addi	a2,a2,-614 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202eb6:	1ff00593          	li	a1,511
ffffffffc0202eba:	00004517          	auipc	a0,0x4
ffffffffc0202ebe:	57650513          	addi	a0,a0,1398 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202ec2:	db8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202ec6:	00004697          	auipc	a3,0x4
ffffffffc0202eca:	74a68693          	addi	a3,a3,1866 # ffffffffc0207610 <default_pmm_manager+0x330>
ffffffffc0202ece:	00004617          	auipc	a2,0x4
ffffffffc0202ed2:	d7a60613          	addi	a2,a2,-646 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202ed6:	20c00593          	li	a1,524
ffffffffc0202eda:	00004517          	auipc	a0,0x4
ffffffffc0202ede:	55650513          	addi	a0,a0,1366 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202ee2:	d98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202ee6:	00005697          	auipc	a3,0x5
ffffffffc0202eea:	88268693          	addi	a3,a3,-1918 # ffffffffc0207768 <default_pmm_manager+0x488>
ffffffffc0202eee:	00004617          	auipc	a2,0x4
ffffffffc0202ef2:	d5a60613          	addi	a2,a2,-678 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202ef6:	20900593          	li	a1,521
ffffffffc0202efa:	00004517          	auipc	a0,0x4
ffffffffc0202efe:	53650513          	addi	a0,a0,1334 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202f02:	d78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202f06:	00004697          	auipc	a3,0x4
ffffffffc0202f0a:	6f268693          	addi	a3,a3,1778 # ffffffffc02075f8 <default_pmm_manager+0x318>
ffffffffc0202f0e:	00004617          	auipc	a2,0x4
ffffffffc0202f12:	d3a60613          	addi	a2,a2,-710 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202f16:	20800593          	li	a1,520
ffffffffc0202f1a:	00004517          	auipc	a0,0x4
ffffffffc0202f1e:	51650513          	addi	a0,a0,1302 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202f22:	d58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202f26:	00004617          	auipc	a2,0x4
ffffffffc0202f2a:	3f260613          	addi	a2,a2,1010 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0202f2e:	06900593          	li	a1,105
ffffffffc0202f32:	00004517          	auipc	a0,0x4
ffffffffc0202f36:	40e50513          	addi	a0,a0,1038 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0202f3a:	d40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc0202f3e:	00005697          	auipc	a3,0x5
ffffffffc0202f42:	85a68693          	addi	a3,a3,-1958 # ffffffffc0207798 <default_pmm_manager+0x4b8>
ffffffffc0202f46:	00004617          	auipc	a2,0x4
ffffffffc0202f4a:	d0260613          	addi	a2,a2,-766 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202f4e:	21300593          	li	a1,531
ffffffffc0202f52:	00004517          	auipc	a0,0x4
ffffffffc0202f56:	4de50513          	addi	a0,a0,1246 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202f5a:	d20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f5e:	00004697          	auipc	a3,0x4
ffffffffc0202f62:	7f268693          	addi	a3,a3,2034 # ffffffffc0207750 <default_pmm_manager+0x470>
ffffffffc0202f66:	00004617          	auipc	a2,0x4
ffffffffc0202f6a:	ce260613          	addi	a2,a2,-798 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202f6e:	21100593          	li	a1,529
ffffffffc0202f72:	00004517          	auipc	a0,0x4
ffffffffc0202f76:	4be50513          	addi	a0,a0,1214 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202f7a:	d00fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202f7e:	00005697          	auipc	a3,0x5
ffffffffc0202f82:	80268693          	addi	a3,a3,-2046 # ffffffffc0207780 <default_pmm_manager+0x4a0>
ffffffffc0202f86:	00004617          	auipc	a2,0x4
ffffffffc0202f8a:	cc260613          	addi	a2,a2,-830 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202f8e:	21000593          	li	a1,528
ffffffffc0202f92:	00004517          	auipc	a0,0x4
ffffffffc0202f96:	49e50513          	addi	a0,a0,1182 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202f9a:	ce0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f9e:	00004697          	auipc	a3,0x4
ffffffffc0202fa2:	7b268693          	addi	a3,a3,1970 # ffffffffc0207750 <default_pmm_manager+0x470>
ffffffffc0202fa6:	00004617          	auipc	a2,0x4
ffffffffc0202faa:	ca260613          	addi	a2,a2,-862 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202fae:	20d00593          	li	a1,525
ffffffffc0202fb2:	00004517          	auipc	a0,0x4
ffffffffc0202fb6:	47e50513          	addi	a0,a0,1150 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202fba:	cc0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202fbe:	00005697          	auipc	a3,0x5
ffffffffc0202fc2:	8ea68693          	addi	a3,a3,-1814 # ffffffffc02078a8 <default_pmm_manager+0x5c8>
ffffffffc0202fc6:	00004617          	auipc	a2,0x4
ffffffffc0202fca:	c8260613          	addi	a2,a2,-894 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202fce:	23200593          	li	a1,562
ffffffffc0202fd2:	00004517          	auipc	a0,0x4
ffffffffc0202fd6:	45e50513          	addi	a0,a0,1118 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202fda:	ca0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202fde:	00005697          	auipc	a3,0x5
ffffffffc0202fe2:	89268693          	addi	a3,a3,-1902 # ffffffffc0207870 <default_pmm_manager+0x590>
ffffffffc0202fe6:	00004617          	auipc	a2,0x4
ffffffffc0202fea:	c6260613          	addi	a2,a2,-926 # ffffffffc0206c48 <commands+0x450>
ffffffffc0202fee:	23100593          	li	a1,561
ffffffffc0202ff2:	00004517          	auipc	a0,0x4
ffffffffc0202ff6:	43e50513          	addi	a0,a0,1086 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0202ffa:	c80fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202ffe:	00005697          	auipc	a3,0x5
ffffffffc0203002:	85a68693          	addi	a3,a3,-1958 # ffffffffc0207858 <default_pmm_manager+0x578>
ffffffffc0203006:	00004617          	auipc	a2,0x4
ffffffffc020300a:	c4260613          	addi	a2,a2,-958 # ffffffffc0206c48 <commands+0x450>
ffffffffc020300e:	22d00593          	li	a1,557
ffffffffc0203012:	00004517          	auipc	a0,0x4
ffffffffc0203016:	41e50513          	addi	a0,a0,1054 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc020301a:	c60fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020301e:	00004697          	auipc	a3,0x4
ffffffffc0203022:	7a268693          	addi	a3,a3,1954 # ffffffffc02077c0 <default_pmm_manager+0x4e0>
ffffffffc0203026:	00004617          	auipc	a2,0x4
ffffffffc020302a:	c2260613          	addi	a2,a2,-990 # ffffffffc0206c48 <commands+0x450>
ffffffffc020302e:	21b00593          	li	a1,539
ffffffffc0203032:	00004517          	auipc	a0,0x4
ffffffffc0203036:	3fe50513          	addi	a0,a0,1022 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc020303a:	c40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020303e:	00004697          	auipc	a3,0x4
ffffffffc0203042:	5ba68693          	addi	a3,a3,1466 # ffffffffc02075f8 <default_pmm_manager+0x318>
ffffffffc0203046:	00004617          	auipc	a2,0x4
ffffffffc020304a:	c0260613          	addi	a2,a2,-1022 # ffffffffc0206c48 <commands+0x450>
ffffffffc020304e:	1f500593          	li	a1,501
ffffffffc0203052:	00004517          	auipc	a0,0x4
ffffffffc0203056:	3de50513          	addi	a0,a0,990 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc020305a:	c20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc020305e:	00004617          	auipc	a2,0x4
ffffffffc0203062:	2ba60613          	addi	a2,a2,698 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0203066:	1f800593          	li	a1,504
ffffffffc020306a:	00004517          	auipc	a0,0x4
ffffffffc020306e:	3c650513          	addi	a0,a0,966 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0203072:	c08fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0203076:	00004697          	auipc	a3,0x4
ffffffffc020307a:	59a68693          	addi	a3,a3,1434 # ffffffffc0207610 <default_pmm_manager+0x330>
ffffffffc020307e:	00004617          	auipc	a2,0x4
ffffffffc0203082:	bca60613          	addi	a2,a2,-1078 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203086:	1f600593          	li	a1,502
ffffffffc020308a:	00004517          	auipc	a0,0x4
ffffffffc020308e:	3a650513          	addi	a0,a0,934 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc0203092:	be8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0203096:	00004697          	auipc	a3,0x4
ffffffffc020309a:	5f268693          	addi	a3,a3,1522 # ffffffffc0207688 <default_pmm_manager+0x3a8>
ffffffffc020309e:	00004617          	auipc	a2,0x4
ffffffffc02030a2:	baa60613          	addi	a2,a2,-1110 # ffffffffc0206c48 <commands+0x450>
ffffffffc02030a6:	1fe00593          	li	a1,510
ffffffffc02030aa:	00004517          	auipc	a0,0x4
ffffffffc02030ae:	38650513          	addi	a0,a0,902 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc02030b2:	bc8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02030b6:	00005697          	auipc	a3,0x5
ffffffffc02030ba:	8b268693          	addi	a3,a3,-1870 # ffffffffc0207968 <default_pmm_manager+0x688>
ffffffffc02030be:	00004617          	auipc	a2,0x4
ffffffffc02030c2:	b8a60613          	addi	a2,a2,-1142 # ffffffffc0206c48 <commands+0x450>
ffffffffc02030c6:	23b00593          	li	a1,571
ffffffffc02030ca:	00004517          	auipc	a0,0x4
ffffffffc02030ce:	36650513          	addi	a0,a0,870 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc02030d2:	ba8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02030d6:	00005697          	auipc	a3,0x5
ffffffffc02030da:	85a68693          	addi	a3,a3,-1958 # ffffffffc0207930 <default_pmm_manager+0x650>
ffffffffc02030de:	00004617          	auipc	a2,0x4
ffffffffc02030e2:	b6a60613          	addi	a2,a2,-1174 # ffffffffc0206c48 <commands+0x450>
ffffffffc02030e6:	23800593          	li	a1,568
ffffffffc02030ea:	00004517          	auipc	a0,0x4
ffffffffc02030ee:	34650513          	addi	a0,a0,838 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc02030f2:	b88fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 2);
ffffffffc02030f6:	00005697          	auipc	a3,0x5
ffffffffc02030fa:	80a68693          	addi	a3,a3,-2038 # ffffffffc0207900 <default_pmm_manager+0x620>
ffffffffc02030fe:	00004617          	auipc	a2,0x4
ffffffffc0203102:	b4a60613          	addi	a2,a2,-1206 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203106:	23400593          	li	a1,564
ffffffffc020310a:	00004517          	auipc	a0,0x4
ffffffffc020310e:	32650513          	addi	a0,a0,806 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0203232:	340030ef          	jal	ra,ffffffffc0206572 <memcpy>
...
ffffffffc0203248:	78c68693          	addi	a3,a3,1932 # ffffffffc02079d0 <default_pmm_manager+0x6f0>
ffffffffc020324c:	00004617          	auipc	a2,0x4
ffffffffc0203250:	9fc60613          	addi	a2,a2,-1540 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203254:	18d00593          	li	a1,397
ffffffffc0203258:	00004517          	auipc	a0,0x4
ffffffffc020325c:	1d850513          	addi	a0,a0,472 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc0203282:	09a60613          	addi	a2,a2,154 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0203286:	06900593          	li	a1,105
ffffffffc020328a:	00004517          	auipc	a0,0x4
ffffffffc020328e:	0b650513          	addi	a0,a0,182 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0203292:	9e8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(page != NULL);
ffffffffc0203296:	00004697          	auipc	a3,0x4
ffffffffc020329a:	71a68693          	addi	a3,a3,1818 # ffffffffc02079b0 <default_pmm_manager+0x6d0>
ffffffffc020329e:	00004617          	auipc	a2,0x4
ffffffffc02032a2:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0206c48 <commands+0x450>
ffffffffc02032a6:	17200593          	li	a1,370
ffffffffc02032aa:	00004517          	auipc	a0,0x4
ffffffffc02032ae:	18650513          	addi	a0,a0,390 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc02032b2:	9c8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc02032b6:	00004697          	auipc	a3,0x4
ffffffffc02032ba:	1ba68693          	addi	a3,a3,442 # ffffffffc0207470 <default_pmm_manager+0x190>
ffffffffc02032be:	00004617          	auipc	a2,0x4
ffffffffc02032c2:	98a60613          	addi	a2,a2,-1654 # ffffffffc0206c48 <commands+0x450>
ffffffffc02032c6:	15e00593          	li	a1,350
ffffffffc02032ca:	00004517          	auipc	a0,0x4
ffffffffc02032ce:	16650513          	addi	a0,a0,358 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc02032d2:	9a8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(npage != NULL);
ffffffffc02032d6:	00004697          	auipc	a3,0x4
ffffffffc02032da:	6ea68693          	addi	a3,a3,1770 # ffffffffc02079c0 <default_pmm_manager+0x6e0>
ffffffffc02032de:	00004617          	auipc	a2,0x4
ffffffffc02032e2:	96a60613          	addi	a2,a2,-1686 # ffffffffc0206c48 <commands+0x450>
ffffffffc02032e6:	17300593          	li	a1,371
ffffffffc02032ea:	00004517          	auipc	a0,0x4
ffffffffc02032ee:	14650513          	addi	a0,a0,326 # ffffffffc0207430 <default_pmm_manager+0x150>
ffffffffc02032f2:	988fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02032f6:	00004617          	auipc	a2,0x4
ffffffffc02032fa:	0f260613          	addi	a2,a2,242 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc02032fe:	06200593          	li	a1,98
ffffffffc0203302:	00004517          	auipc	a0,0x4
ffffffffc0203306:	03e50513          	addi	a0,a0,62 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc020330a:	970fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc020330e:	00004617          	auipc	a2,0x4
ffffffffc0203312:	0fa60613          	addi	a2,a2,250 # ffffffffc0207408 <default_pmm_manager+0x128>
ffffffffc0203316:	07400593          	li	a1,116
ffffffffc020331a:	00004517          	auipc	a0,0x4
ffffffffc020331e:	02650513          	addi	a0,a0,38 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0203322:	958fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc0203326:	00004697          	auipc	a3,0x4
ffffffffc020332a:	11a68693          	addi	a3,a3,282 # ffffffffc0207440 <default_pmm_manager+0x160>
ffffffffc020332e:	00004617          	auipc	a2,0x4
ffffffffc0203332:	91a60613          	addi	a2,a2,-1766 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203336:	15d00593          	li	a1,349
ffffffffc020333a:	00004517          	auipc	a0,0x4
ffffffffc020333e:	0f650513          	addi	a0,a0,246 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc02033ea:	5fa68693          	addi	a3,a3,1530 # ffffffffc02079e0 <default_pmm_manager+0x700>
ffffffffc02033ee:	00004617          	auipc	a2,0x4
ffffffffc02033f2:	85a60613          	addi	a2,a2,-1958 # ffffffffc0206c48 <commands+0x450>
ffffffffc02033f6:	1cc00593          	li	a1,460
ffffffffc02033fa:	00004517          	auipc	a0,0x4
ffffffffc02033fe:	03650513          	addi	a0,a0,54 # ffffffffc0207430 <default_pmm_manager+0x150>
...
ffffffffc020340c:	fe060613          	addi	a2,a2,-32 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc0203410:	06200593          	li	a1,98
ffffffffc0203414:	00004517          	auipc	a0,0x4
ffffffffc0203418:	f2c50513          	addi	a0,a0,-212 # ffffffffc0207340 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc020349c:	59050513          	addi	a0,a0,1424 # ffffffffc0207a28 <default_pmm_manager+0x748>
    return listelm->next;
...
ffffffffc02034ee:	55650513          	addi	a0,a0,1366 # ffffffffc0207a40 <default_pmm_manager+0x760>
...
ffffffffc0203542:	57250513          	addi	a0,a0,1394 # ffffffffc0207ab0 <default_pmm_manager+0x7d0>
...
ffffffffc020355e:	5a650513          	addi	a0,a0,1446 # ffffffffc0207b00 <default_pmm_manager+0x820>
...
ffffffffc02035d2:	5ba50513          	addi	a0,a0,1466 # ffffffffc0207b88 <default_pmm_manager+0x8a8>
...
ffffffffc02036ea:	56260613          	addi	a2,a2,1378 # ffffffffc0208c48 <nbase>
...
ffffffffc0203716:	51e50513          	addi	a0,a0,1310 # ffffffffc0207c30 <default_pmm_manager+0x950>
...
ffffffffc02037f6:	48e50513          	addi	a0,a0,1166 # ffffffffc0207c80 <default_pmm_manager+0x9a0>
...
ffffffffc0203808:	73468693          	addi	a3,a3,1844 # ffffffffc0206f38 <commands+0x740>
ffffffffc020380c:	00003617          	auipc	a2,0x3
ffffffffc0203810:	43c60613          	addi	a2,a2,1084 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203814:	0bc00593          	li	a1,188
ffffffffc0203818:	00004517          	auipc	a0,0x4
ffffffffc020381c:	20050513          	addi	a0,a0,512 # ffffffffc0207a18 <default_pmm_manager+0x738>
...
ffffffffc020382c:	bc060613          	addi	a2,a2,-1088 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc0203830:	06200593          	li	a1,98
ffffffffc0203834:	00004517          	auipc	a0,0x4
ffffffffc0203838:	b0c50513          	addi	a0,a0,-1268 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc020383c:	c3ffc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0203840:	00004697          	auipc	a3,0x4
ffffffffc0203844:	3c868693          	addi	a3,a3,968 # ffffffffc0207c08 <default_pmm_manager+0x928>
ffffffffc0203848:	00003617          	auipc	a2,0x3
ffffffffc020384c:	40060613          	addi	a2,a2,1024 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203850:	0fc00593          	li	a1,252
ffffffffc0203854:	00004517          	auipc	a0,0x4
ffffffffc0203858:	1c450513          	addi	a0,a0,452 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc020385c:	c1ffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0203860:	00004697          	auipc	a3,0x4
ffffffffc0203864:	2c868693          	addi	a3,a3,712 # ffffffffc0207b28 <default_pmm_manager+0x848>
ffffffffc0203868:	00003617          	auipc	a2,0x3
ffffffffc020386c:	3e060613          	addi	a2,a2,992 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203870:	0dc00593          	li	a1,220
ffffffffc0203874:	00004517          	auipc	a0,0x4
ffffffffc0203878:	1a450513          	addi	a0,a0,420 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc020387c:	bfffc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203880:	00004617          	auipc	a2,0x4
ffffffffc0203884:	17860613          	addi	a2,a2,376 # ffffffffc02079f8 <default_pmm_manager+0x718>
ffffffffc0203888:	02800593          	li	a1,40
ffffffffc020388c:	00004517          	auipc	a0,0x4
ffffffffc0203890:	18c50513          	addi	a0,a0,396 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203894:	be7fc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0203898:	00004697          	auipc	a3,0x4
ffffffffc020389c:	35868693          	addi	a3,a3,856 # ffffffffc0207bf0 <default_pmm_manager+0x910>
ffffffffc02038a0:	00003617          	auipc	a2,0x3
ffffffffc02038a4:	3a860613          	addi	a2,a2,936 # ffffffffc0206c48 <commands+0x450>
ffffffffc02038a8:	0fb00593          	li	a1,251
ffffffffc02038ac:	00004517          	auipc	a0,0x4
ffffffffc02038b0:	16c50513          	addi	a0,a0,364 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc02038b4:	bc7fc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02038b8:	00004617          	auipc	a2,0x4
ffffffffc02038bc:	b5060613          	addi	a2,a2,-1200 # ffffffffc0207408 <default_pmm_manager+0x128>
ffffffffc02038c0:	07400593          	li	a1,116
ffffffffc02038c4:	00004517          	auipc	a0,0x4
ffffffffc02038c8:	a7c50513          	addi	a0,a0,-1412 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc02038cc:	baffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc02038d0:	00004697          	auipc	a3,0x4
ffffffffc02038d4:	27068693          	addi	a3,a3,624 # ffffffffc0207b40 <default_pmm_manager+0x860>
ffffffffc02038d8:	00003617          	auipc	a2,0x3
ffffffffc02038dc:	37060613          	addi	a2,a2,880 # ffffffffc0206c48 <commands+0x450>
ffffffffc02038e0:	0dd00593          	li	a1,221
ffffffffc02038e4:	00004517          	auipc	a0,0x4
ffffffffc02038e8:	13450513          	addi	a0,a0,308 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc02038ec:	b8ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(check_mm_struct == NULL);
ffffffffc02038f0:	00004697          	auipc	a3,0x4
ffffffffc02038f4:	18868693          	addi	a3,a3,392 # ffffffffc0207a78 <default_pmm_manager+0x798>
ffffffffc02038f8:	00003617          	auipc	a2,0x3
ffffffffc02038fc:	35060613          	addi	a2,a2,848 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203900:	0c700593          	li	a1,199
ffffffffc0203904:	00004517          	auipc	a0,0x4
ffffffffc0203908:	11450513          	addi	a0,a0,276 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc020390c:	b6ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total == nr_free_pages());
ffffffffc0203910:	00003697          	auipc	a3,0x3
ffffffffc0203914:	65068693          	addi	a3,a3,1616 # ffffffffc0206f60 <commands+0x768>
ffffffffc0203918:	00003617          	auipc	a2,0x3
ffffffffc020391c:	33060613          	addi	a2,a2,816 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203920:	0bf00593          	li	a1,191
ffffffffc0203924:	00004517          	auipc	a0,0x4
ffffffffc0203928:	0f450513          	addi	a0,a0,244 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc020392c:	b4ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert( nr_free == 0);         
ffffffffc0203930:	00003697          	auipc	a3,0x3
ffffffffc0203934:	7d868693          	addi	a3,a3,2008 # ffffffffc0207108 <commands+0x910>
ffffffffc0203938:	00003617          	auipc	a2,0x3
ffffffffc020393c:	31060613          	addi	a2,a2,784 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203940:	0f300593          	li	a1,243
ffffffffc0203944:	00004517          	auipc	a0,0x4
ffffffffc0203948:	0d450513          	addi	a0,a0,212 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc020394c:	b2ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203950:	00004697          	auipc	a3,0x4
ffffffffc0203954:	14068693          	addi	a3,a3,320 # ffffffffc0207a90 <default_pmm_manager+0x7b0>
ffffffffc0203958:	00003617          	auipc	a2,0x3
ffffffffc020395c:	2f060613          	addi	a2,a2,752 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203960:	0cc00593          	li	a1,204
ffffffffc0203964:	00004517          	auipc	a0,0x4
ffffffffc0203968:	0b450513          	addi	a0,a0,180 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc020396c:	b0ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(mm != NULL);
ffffffffc0203970:	00004697          	auipc	a3,0x4
ffffffffc0203974:	0f868693          	addi	a3,a3,248 # ffffffffc0207a68 <default_pmm_manager+0x788>
ffffffffc0203978:	00003617          	auipc	a2,0x3
ffffffffc020397c:	2d060613          	addi	a2,a2,720 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203980:	0c400593          	li	a1,196
ffffffffc0203984:	00004517          	auipc	a0,0x4
ffffffffc0203988:	09450513          	addi	a0,a0,148 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc020398c:	aeffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total==0);
ffffffffc0203990:	00004697          	auipc	a3,0x4
ffffffffc0203994:	2e068693          	addi	a3,a3,736 # ffffffffc0207c70 <default_pmm_manager+0x990>
ffffffffc0203998:	00003617          	auipc	a2,0x3
ffffffffc020399c:	2b060613          	addi	a2,a2,688 # ffffffffc0206c48 <commands+0x450>
ffffffffc02039a0:	11e00593          	li	a1,286
ffffffffc02039a4:	00004517          	auipc	a0,0x4
ffffffffc02039a8:	07450513          	addi	a0,a0,116 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc02039ac:	acffc0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02039b0:	00004617          	auipc	a2,0x4
ffffffffc02039b4:	96860613          	addi	a2,a2,-1688 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc02039b8:	06900593          	li	a1,105
ffffffffc02039bc:	00004517          	auipc	a0,0x4
ffffffffc02039c0:	98450513          	addi	a0,a0,-1660 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc02039c4:	ab7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(count==0);
ffffffffc02039c8:	00004697          	auipc	a3,0x4
ffffffffc02039cc:	29868693          	addi	a3,a3,664 # ffffffffc0207c60 <default_pmm_manager+0x980>
ffffffffc02039d0:	00003617          	auipc	a2,0x3
ffffffffc02039d4:	27860613          	addi	a2,a2,632 # ffffffffc0206c48 <commands+0x450>
ffffffffc02039d8:	11d00593          	li	a1,285
ffffffffc02039dc:	00004517          	auipc	a0,0x4
ffffffffc02039e0:	03c50513          	addi	a0,a0,60 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc02039e4:	a97fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc02039e8:	00004697          	auipc	a3,0x4
ffffffffc02039ec:	1c868693          	addi	a3,a3,456 # ffffffffc0207bb0 <default_pmm_manager+0x8d0>
ffffffffc02039f0:	00003617          	auipc	a2,0x3
ffffffffc02039f4:	25860613          	addi	a2,a2,600 # ffffffffc0206c48 <commands+0x450>
ffffffffc02039f8:	09500593          	li	a1,149
ffffffffc02039fc:	00004517          	auipc	a0,0x4
ffffffffc0203a00:	01c50513          	addi	a0,a0,28 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203a04:	a77fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203a08:	00004697          	auipc	a3,0x4
ffffffffc0203a0c:	15868693          	addi	a3,a3,344 # ffffffffc0207b60 <default_pmm_manager+0x880>
ffffffffc0203a10:	00003617          	auipc	a2,0x3
ffffffffc0203a14:	23860613          	addi	a2,a2,568 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203a18:	0ea00593          	li	a1,234
ffffffffc0203a1c:	00004517          	auipc	a0,0x4
ffffffffc0203a20:	ffc50513          	addi	a0,a0,-4 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203a24:	a57fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0203a28:	00004697          	auipc	a3,0x4
ffffffffc0203a2c:	0c068693          	addi	a3,a3,192 # ffffffffc0207ae8 <default_pmm_manager+0x808>
ffffffffc0203a30:	00003617          	auipc	a2,0x3
ffffffffc0203a34:	21860613          	addi	a2,a2,536 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203a38:	0d700593          	li	a1,215
ffffffffc0203a3c:	00004517          	auipc	a0,0x4
ffffffffc0203a40:	fdc50513          	addi	a0,a0,-36 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203a44:	a37fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(ret==0);
ffffffffc0203a48:	00004697          	auipc	a3,0x4
ffffffffc0203a4c:	21068693          	addi	a3,a3,528 # ffffffffc0207c58 <default_pmm_manager+0x978>
ffffffffc0203a50:	00003617          	auipc	a2,0x3
ffffffffc0203a54:	1f860613          	addi	a2,a2,504 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203a58:	10200593          	li	a1,258
ffffffffc0203a5c:	00004517          	auipc	a0,0x4
ffffffffc0203a60:	fbc50513          	addi	a0,a0,-68 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203a64:	a17fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(vma != NULL);
ffffffffc0203a68:	00004697          	auipc	a3,0x4
ffffffffc0203a6c:	03868693          	addi	a3,a3,56 # ffffffffc0207aa0 <default_pmm_manager+0x7c0>
ffffffffc0203a70:	00003617          	auipc	a2,0x3
ffffffffc0203a74:	1d860613          	addi	a2,a2,472 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203a78:	0cf00593          	li	a1,207
ffffffffc0203a7c:	00004517          	auipc	a0,0x4
ffffffffc0203a80:	f9c50513          	addi	a0,a0,-100 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203a84:	9f7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203a88:	00004697          	auipc	a3,0x4
ffffffffc0203a8c:	15868693          	addi	a3,a3,344 # ffffffffc0207be0 <default_pmm_manager+0x900>
ffffffffc0203a90:	00003617          	auipc	a2,0x3
ffffffffc0203a94:	1b860613          	addi	a2,a2,440 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203a98:	09f00593          	li	a1,159
ffffffffc0203a9c:	00004517          	auipc	a0,0x4
ffffffffc0203aa0:	f7c50513          	addi	a0,a0,-132 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203aa4:	9d7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203aa8:	00004697          	auipc	a3,0x4
ffffffffc0203aac:	13868693          	addi	a3,a3,312 # ffffffffc0207be0 <default_pmm_manager+0x900>
ffffffffc0203ab0:	00003617          	auipc	a2,0x3
ffffffffc0203ab4:	19860613          	addi	a2,a2,408 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203ab8:	0a100593          	li	a1,161
ffffffffc0203abc:	00004517          	auipc	a0,0x4
ffffffffc0203ac0:	f5c50513          	addi	a0,a0,-164 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203ac4:	9b7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ac8:	00004697          	auipc	a3,0x4
ffffffffc0203acc:	0f868693          	addi	a3,a3,248 # ffffffffc0207bc0 <default_pmm_manager+0x8e0>
ffffffffc0203ad0:	00003617          	auipc	a2,0x3
ffffffffc0203ad4:	17860613          	addi	a2,a2,376 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203ad8:	09700593          	li	a1,151
ffffffffc0203adc:	00004517          	auipc	a0,0x4
ffffffffc0203ae0:	f3c50513          	addi	a0,a0,-196 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203ae4:	997fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ae8:	00004697          	auipc	a3,0x4
ffffffffc0203aec:	0d868693          	addi	a3,a3,216 # ffffffffc0207bc0 <default_pmm_manager+0x8e0>
ffffffffc0203af0:	00003617          	auipc	a2,0x3
ffffffffc0203af4:	15860613          	addi	a2,a2,344 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203af8:	09900593          	li	a1,153
ffffffffc0203afc:	00004517          	auipc	a0,0x4
ffffffffc0203b00:	f1c50513          	addi	a0,a0,-228 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203b04:	977fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b08:	00004697          	auipc	a3,0x4
ffffffffc0203b0c:	0c868693          	addi	a3,a3,200 # ffffffffc0207bd0 <default_pmm_manager+0x8f0>
ffffffffc0203b10:	00003617          	auipc	a2,0x3
ffffffffc0203b14:	13860613          	addi	a2,a2,312 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203b18:	09b00593          	li	a1,155
ffffffffc0203b1c:	00004517          	auipc	a0,0x4
ffffffffc0203b20:	efc50513          	addi	a0,a0,-260 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203b24:	957fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b28:	00004697          	auipc	a3,0x4
ffffffffc0203b2c:	0a868693          	addi	a3,a3,168 # ffffffffc0207bd0 <default_pmm_manager+0x8f0>
ffffffffc0203b30:	00003617          	auipc	a2,0x3
ffffffffc0203b34:	11860613          	addi	a2,a2,280 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203b38:	09d00593          	li	a1,157
ffffffffc0203b3c:	00004517          	auipc	a0,0x4
ffffffffc0203b40:	edc50513          	addi	a0,a0,-292 # ffffffffc0207a18 <default_pmm_manager+0x738>
ffffffffc0203b44:	937fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc0203b48:	00004697          	auipc	a3,0x4
ffffffffc0203b4c:	06868693          	addi	a3,a3,104 # ffffffffc0207bb0 <default_pmm_manager+0x8d0>
ffffffffc0203b50:	00003617          	auipc	a2,0x3
ffffffffc0203b54:	0f860613          	addi	a2,a2,248 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203b58:	09300593          	li	a1,147
ffffffffc0203b5c:	00004517          	auipc	a0,0x4
ffffffffc0203b60:	ebc50513          	addi	a0,a0,-324 # ffffffffc0207a18 <default_pmm_manager+0x738>
...
ffffffffc0203bac:	158b0b13          	addi	s6,s6,344 # ffffffffc0207d00 <default_pmm_manager+0xa20>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203bb0:	00004b97          	auipc	s7,0x4
ffffffffc0203bb4:	138b8b93          	addi	s7,s7,312 # ffffffffc0207ce8 <default_pmm_manager+0xa08>
...
ffffffffc0203c66:	03e50513          	addi	a0,a0,62 # ffffffffc0207ca0 <default_pmm_manager+0x9c0>
...
ffffffffc0203c78:	05c68693          	addi	a3,a3,92 # ffffffffc0207cd0 <default_pmm_manager+0x9f0>
ffffffffc0203c7c:	00003617          	auipc	a2,0x3
ffffffffc0203c80:	fcc60613          	addi	a2,a2,-52 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203c84:	06800593          	li	a1,104
ffffffffc0203c88:	00004517          	auipc	a0,0x4
ffffffffc0203c8c:	d9050513          	addi	a0,a0,-624 # ffffffffc0207a18 <default_pmm_manager+0x738>
...
ffffffffc0203cd0:	08450513          	addi	a0,a0,132 # ffffffffc0207d50 <default_pmm_manager+0xa70>
...
ffffffffc0203cf2:	05268693          	addi	a3,a3,82 # ffffffffc0207d40 <default_pmm_manager+0xa60>
ffffffffc0203cf6:	00003617          	auipc	a2,0x3
ffffffffc0203cfa:	f5260613          	addi	a2,a2,-174 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203cfe:	07e00593          	li	a1,126
ffffffffc0203d02:	00004517          	auipc	a0,0x4
ffffffffc0203d06:	d1650513          	addi	a0,a0,-746 # ffffffffc0207a18 <default_pmm_manager+0x738>
...
ffffffffc0203d36:	05e50513          	addi	a0,a0,94 # ffffffffc0207d90 <default_pmm_manager+0xab0>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc0203d6c:	06850513          	addi	a0,a0,104 # ffffffffc0207dd0 <default_pmm_manager+0xaf0>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203d90:	06c50513          	addi	a0,a0,108 # ffffffffc0207df8 <default_pmm_manager+0xb18>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc0203dae:	07650513          	addi	a0,a0,118 # ffffffffc0207e20 <default_pmm_manager+0xb40>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203dca:	08250513          	addi	a0,a0,130 # ffffffffc0207e48 <default_pmm_manager+0xb68>
...
ffffffffc0203de8:	03c50513          	addi	a0,a0,60 # ffffffffc0207e20 <default_pmm_manager+0xb40>
...
ffffffffc0203e00:	fd450513          	addi	a0,a0,-44 # ffffffffc0207dd0 <default_pmm_manager+0xaf0>
...
ffffffffc0203e1a:	00a50513          	addi	a0,a0,10 # ffffffffc0207e20 <default_pmm_manager+0xb40>
...
ffffffffc0203e34:	f6050513          	addi	a0,a0,-160 # ffffffffc0207d90 <default_pmm_manager+0xab0>
...
ffffffffc0203e4e:	fae50513          	addi	a0,a0,-82 # ffffffffc0207df8 <default_pmm_manager+0xb18>
...
ffffffffc0203e68:	fe450513          	addi	a0,a0,-28 # ffffffffc0207e48 <default_pmm_manager+0xb68>
...
ffffffffc0203e86:	f4e50513          	addi	a0,a0,-178 # ffffffffc0207dd0 <default_pmm_manager+0xaf0>
...
ffffffffc0203ec4:	d2068693          	addi	a3,a3,-736 # ffffffffc0207be0 <default_pmm_manager+0x900>
ffffffffc0203ec8:	00003617          	auipc	a2,0x3
ffffffffc0203ecc:	d8060613          	addi	a2,a2,-640 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203ed0:	05100593          	li	a1,81
ffffffffc0203ed4:	00004517          	auipc	a0,0x4
ffffffffc0203ed8:	ee450513          	addi	a0,a0,-284 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203edc:	d9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==11);
ffffffffc0203ee0:	00004697          	auipc	a3,0x4
ffffffffc0203ee4:	01868693          	addi	a3,a3,24 # ffffffffc0207ef8 <default_pmm_manager+0xc18>
ffffffffc0203ee8:	00003617          	auipc	a2,0x3
ffffffffc0203eec:	d6060613          	addi	a2,a2,-672 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203ef0:	07300593          	li	a1,115
ffffffffc0203ef4:	00004517          	auipc	a0,0x4
ffffffffc0203ef8:	ec450513          	addi	a0,a0,-316 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203efc:	d7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203f00:	00004697          	auipc	a3,0x4
ffffffffc0203f04:	fd068693          	addi	a3,a3,-48 # ffffffffc0207ed0 <default_pmm_manager+0xbf0>
ffffffffc0203f08:	00003617          	auipc	a2,0x3
ffffffffc0203f0c:	d4060613          	addi	a2,a2,-704 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203f10:	07100593          	li	a1,113
ffffffffc0203f14:	00004517          	auipc	a0,0x4
ffffffffc0203f18:	ea450513          	addi	a0,a0,-348 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203f1c:	d5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==10);
ffffffffc0203f20:	00004697          	auipc	a3,0x4
ffffffffc0203f24:	fa068693          	addi	a3,a3,-96 # ffffffffc0207ec0 <default_pmm_manager+0xbe0>
ffffffffc0203f28:	00003617          	auipc	a2,0x3
ffffffffc0203f2c:	d2060613          	addi	a2,a2,-736 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203f30:	06f00593          	li	a1,111
ffffffffc0203f34:	00004517          	auipc	a0,0x4
ffffffffc0203f38:	e8450513          	addi	a0,a0,-380 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203f3c:	d3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==9);
ffffffffc0203f40:	00004697          	auipc	a3,0x4
ffffffffc0203f44:	f7068693          	addi	a3,a3,-144 # ffffffffc0207eb0 <default_pmm_manager+0xbd0>
ffffffffc0203f48:	00003617          	auipc	a2,0x3
ffffffffc0203f4c:	d0060613          	addi	a2,a2,-768 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203f50:	06c00593          	li	a1,108
ffffffffc0203f54:	00004517          	auipc	a0,0x4
ffffffffc0203f58:	e6450513          	addi	a0,a0,-412 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203f5c:	d1efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==8);
ffffffffc0203f60:	00004697          	auipc	a3,0x4
ffffffffc0203f64:	f4068693          	addi	a3,a3,-192 # ffffffffc0207ea0 <default_pmm_manager+0xbc0>
ffffffffc0203f68:	00003617          	auipc	a2,0x3
ffffffffc0203f6c:	ce060613          	addi	a2,a2,-800 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203f70:	06900593          	li	a1,105
ffffffffc0203f74:	00004517          	auipc	a0,0x4
ffffffffc0203f78:	e4450513          	addi	a0,a0,-444 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203f7c:	cfefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==7);
ffffffffc0203f80:	00004697          	auipc	a3,0x4
ffffffffc0203f84:	f1068693          	addi	a3,a3,-240 # ffffffffc0207e90 <default_pmm_manager+0xbb0>
ffffffffc0203f88:	00003617          	auipc	a2,0x3
ffffffffc0203f8c:	cc060613          	addi	a2,a2,-832 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203f90:	06600593          	li	a1,102
ffffffffc0203f94:	00004517          	auipc	a0,0x4
ffffffffc0203f98:	e2450513          	addi	a0,a0,-476 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203f9c:	cdefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==6);
ffffffffc0203fa0:	00004697          	auipc	a3,0x4
ffffffffc0203fa4:	ee068693          	addi	a3,a3,-288 # ffffffffc0207e80 <default_pmm_manager+0xba0>
ffffffffc0203fa8:	00003617          	auipc	a2,0x3
ffffffffc0203fac:	ca060613          	addi	a2,a2,-864 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203fb0:	06300593          	li	a1,99
ffffffffc0203fb4:	00004517          	auipc	a0,0x4
ffffffffc0203fb8:	e0450513          	addi	a0,a0,-508 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203fbc:	cbefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fc0:	00004697          	auipc	a3,0x4
ffffffffc0203fc4:	eb068693          	addi	a3,a3,-336 # ffffffffc0207e70 <default_pmm_manager+0xb90>
ffffffffc0203fc8:	00003617          	auipc	a2,0x3
ffffffffc0203fcc:	c8060613          	addi	a2,a2,-896 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203fd0:	06000593          	li	a1,96
ffffffffc0203fd4:	00004517          	auipc	a0,0x4
ffffffffc0203fd8:	de450513          	addi	a0,a0,-540 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203fdc:	c9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fe0:	00004697          	auipc	a3,0x4
ffffffffc0203fe4:	e9068693          	addi	a3,a3,-368 # ffffffffc0207e70 <default_pmm_manager+0xb90>
ffffffffc0203fe8:	00003617          	auipc	a2,0x3
ffffffffc0203fec:	c6060613          	addi	a2,a2,-928 # ffffffffc0206c48 <commands+0x450>
ffffffffc0203ff0:	05d00593          	li	a1,93
ffffffffc0203ff4:	00004517          	auipc	a0,0x4
ffffffffc0203ff8:	dc450513          	addi	a0,a0,-572 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc0203ffc:	c7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204000:	00004697          	auipc	a3,0x4
ffffffffc0204004:	be068693          	addi	a3,a3,-1056 # ffffffffc0207be0 <default_pmm_manager+0x900>
ffffffffc0204008:	00003617          	auipc	a2,0x3
ffffffffc020400c:	c4060613          	addi	a2,a2,-960 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204010:	05a00593          	li	a1,90
ffffffffc0204014:	00004517          	auipc	a0,0x4
ffffffffc0204018:	da450513          	addi	a0,a0,-604 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc020401c:	c5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204020:	00004697          	auipc	a3,0x4
ffffffffc0204024:	bc068693          	addi	a3,a3,-1088 # ffffffffc0207be0 <default_pmm_manager+0x900>
ffffffffc0204028:	00003617          	auipc	a2,0x3
ffffffffc020402c:	c2060613          	addi	a2,a2,-992 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204030:	05700593          	li	a1,87
ffffffffc0204034:	00004517          	auipc	a0,0x4
ffffffffc0204038:	d8450513          	addi	a0,a0,-636 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc020403c:	c3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204040:	00004697          	auipc	a3,0x4
ffffffffc0204044:	ba068693          	addi	a3,a3,-1120 # ffffffffc0207be0 <default_pmm_manager+0x900>
ffffffffc0204048:	00003617          	auipc	a2,0x3
ffffffffc020404c:	c0060613          	addi	a2,a2,-1024 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204050:	05400593          	li	a1,84
ffffffffc0204054:	00004517          	auipc	a0,0x4
ffffffffc0204058:	d6450513          	addi	a0,a0,-668 # ffffffffc0207db8 <default_pmm_manager+0xad8>
...
ffffffffc0204086:	e8668693          	addi	a3,a3,-378 # ffffffffc0207f08 <default_pmm_manager+0xc28>
ffffffffc020408a:	00003617          	auipc	a2,0x3
ffffffffc020408e:	bbe60613          	addi	a2,a2,-1090 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204092:	04100593          	li	a1,65
ffffffffc0204096:	00004517          	auipc	a0,0x4
ffffffffc020409a:	d2250513          	addi	a0,a0,-734 # ffffffffc0207db8 <default_pmm_manager+0xad8>
ffffffffc020409e:	bdcfc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(in_tick==0);
ffffffffc02040a2:	00004697          	auipc	a3,0x4
ffffffffc02040a6:	e7668693          	addi	a3,a3,-394 # ffffffffc0207f18 <default_pmm_manager+0xc38>
ffffffffc02040aa:	00003617          	auipc	a2,0x3
ffffffffc02040ae:	b9e60613          	addi	a2,a2,-1122 # ffffffffc0206c48 <commands+0x450>
ffffffffc02040b2:	04200593          	li	a1,66
ffffffffc02040b6:	00004517          	auipc	a0,0x4
ffffffffc02040ba:	d0250513          	addi	a0,a0,-766 # ffffffffc0207db8 <default_pmm_manager+0xad8>
...
ffffffffc02040de:	e4e68693          	addi	a3,a3,-434 # ffffffffc0207f28 <default_pmm_manager+0xc48>
ffffffffc02040e2:	00003617          	auipc	a2,0x3
ffffffffc02040e6:	b6660613          	addi	a2,a2,-1178 # ffffffffc0206c48 <commands+0x450>
ffffffffc02040ea:	03200593          	li	a1,50
ffffffffc02040ee:	00004517          	auipc	a0,0x4
ffffffffc02040f2:	cca50513          	addi	a0,a0,-822 # ffffffffc0207db8 <default_pmm_manager+0xad8>
{
...
ffffffffc0204102:	e6268693          	addi	a3,a3,-414 # ffffffffc0207f60 <default_pmm_manager+0xc80>
ffffffffc0204106:	00003617          	auipc	a2,0x3
ffffffffc020410a:	b4260613          	addi	a2,a2,-1214 # ffffffffc0206c48 <commands+0x450>
ffffffffc020410e:	06d00593          	li	a1,109
ffffffffc0204112:	00004517          	auipc	a0,0x4
ffffffffc0204116:	e6e50513          	addi	a0,a0,-402 # ffffffffc0207f80 <default_pmm_manager+0xca0>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc020424a:	d4a68693          	addi	a3,a3,-694 # ffffffffc0207f90 <default_pmm_manager+0xcb0>
ffffffffc020424e:	00003617          	auipc	a2,0x3
ffffffffc0204252:	9fa60613          	addi	a2,a2,-1542 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204256:	07400593          	li	a1,116
ffffffffc020425a:	00004517          	auipc	a0,0x4
ffffffffc020425e:	d2650513          	addi	a0,a0,-730 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204262:	a18fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0204266:	00004697          	auipc	a3,0x4
ffffffffc020426a:	d6a68693          	addi	a3,a3,-662 # ffffffffc0207fd0 <default_pmm_manager+0xcf0>
ffffffffc020426e:	00003617          	auipc	a2,0x3
ffffffffc0204272:	9da60613          	addi	a2,a2,-1574 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204276:	06c00593          	li	a1,108
ffffffffc020427a:	00004517          	auipc	a0,0x4
ffffffffc020427e:	d0650513          	addi	a0,a0,-762 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204282:	9f8fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0204286:	00004697          	auipc	a3,0x4
ffffffffc020428a:	d2a68693          	addi	a3,a3,-726 # ffffffffc0207fb0 <default_pmm_manager+0xcd0>
ffffffffc020428e:	00003617          	auipc	a2,0x3
ffffffffc0204292:	9ba60613          	addi	a2,a2,-1606 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204296:	06b00593          	li	a1,107
ffffffffc020429a:	00004517          	auipc	a0,0x4
ffffffffc020429e:	ce650513          	addi	a0,a0,-794 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc02042dc:	d1868693          	addi	a3,a3,-744 # ffffffffc0207ff0 <default_pmm_manager+0xd10>
ffffffffc02042e0:	00003617          	auipc	a2,0x3
ffffffffc02042e4:	96860613          	addi	a2,a2,-1688 # ffffffffc0206c48 <commands+0x450>
ffffffffc02042e8:	09400593          	li	a1,148
ffffffffc02042ec:	00004517          	auipc	a0,0x4
ffffffffc02042f0:	c9450513          	addi	a0,a0,-876 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc020438c:	6e068693          	addi	a3,a3,1760 # ffffffffc0207a68 <default_pmm_manager+0x788>
ffffffffc0204390:	00003617          	auipc	a2,0x3
ffffffffc0204394:	8b860613          	addi	a2,a2,-1864 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204398:	0a700593          	li	a1,167
ffffffffc020439c:	00004517          	auipc	a0,0x4
ffffffffc02043a0:	be450513          	addi	a0,a0,-1052 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc0204426:	be668693          	addi	a3,a3,-1050 # ffffffffc0208008 <default_pmm_manager+0xd28>
ffffffffc020442a:	00003617          	auipc	a2,0x3
ffffffffc020442e:	81e60613          	addi	a2,a2,-2018 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204432:	0c000593          	li	a1,192
ffffffffc0204436:	00004517          	auipc	a0,0x4
ffffffffc020443a:	b4a50513          	addi	a0,a0,-1206 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc020449c:	b9068693          	addi	a3,a3,-1136 # ffffffffc0208028 <default_pmm_manager+0xd48>
ffffffffc02044a0:	00002617          	auipc	a2,0x2
ffffffffc02044a4:	7a860613          	addi	a2,a2,1960 # ffffffffc0206c48 <commands+0x450>
ffffffffc02044a8:	0d600593          	li	a1,214
ffffffffc02044ac:	00004517          	auipc	a0,0x4
ffffffffc02044b0:	ad450513          	addi	a0,a0,-1324 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc02044fc:	5a868693          	addi	a3,a3,1448 # ffffffffc0207aa0 <default_pmm_manager+0x7c0>
ffffffffc0204500:	00002617          	auipc	a2,0x2
ffffffffc0204504:	74860613          	addi	a2,a2,1864 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204508:	11300593          	li	a1,275
ffffffffc020450c:	00004517          	auipc	a0,0x4
ffffffffc0204510:	a7450513          	addi	a0,a0,-1420 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc020454a:	55a68693          	addi	a3,a3,1370 # ffffffffc0207aa0 <default_pmm_manager+0x7c0>
ffffffffc020454e:	00002617          	auipc	a2,0x2
ffffffffc0204552:	6fa60613          	addi	a2,a2,1786 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204556:	11900593          	li	a1,281
ffffffffc020455a:	00004517          	auipc	a0,0x4
ffffffffc020455e:	a2650513          	addi	a0,a0,-1498 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc020461e:	b2e50513          	addi	a0,a0,-1234 # ffffffffc0208148 <default_pmm_manager+0xe68>
ffffffffc0204622:	b5ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0204626:	00004697          	auipc	a3,0x4
ffffffffc020462a:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0208170 <default_pmm_manager+0xe90>
ffffffffc020462e:	00002617          	auipc	a2,0x2
ffffffffc0204632:	61a60613          	addi	a2,a2,1562 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204636:	13b00593          	li	a1,315
ffffffffc020463a:	00004517          	auipc	a0,0x4
ffffffffc020463e:	94650513          	addi	a0,a0,-1722 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc0204656:	b3650513          	addi	a0,a0,-1226 # ffffffffc0208188 <default_pmm_manager+0xea8>
...
ffffffffc0204706:	546a3a03          	ld	s4,1350(s4) # ffffffffc0208c48 <nbase>
...
ffffffffc02047a4:	a7850513          	addi	a0,a0,-1416 # ffffffffc0208218 <default_pmm_manager+0xf38>
...
ffffffffc02047be:	a7e50513          	addi	a0,a0,-1410 # ffffffffc0208238 <default_pmm_manager+0xf58>
}
...
ffffffffc02047cc:	89868693          	addi	a3,a3,-1896 # ffffffffc0208060 <default_pmm_manager+0xd80>
ffffffffc02047d0:	00002617          	auipc	a2,0x2
ffffffffc02047d4:	47860613          	addi	a2,a2,1144 # ffffffffc0206c48 <commands+0x450>
ffffffffc02047d8:	12200593          	li	a1,290
ffffffffc02047dc:	00003517          	auipc	a0,0x3
ffffffffc02047e0:	7a450513          	addi	a0,a0,1956 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc02047e4:	c97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02047e8:	00004697          	auipc	a3,0x4
ffffffffc02047ec:	90068693          	addi	a3,a3,-1792 # ffffffffc02080e8 <default_pmm_manager+0xe08>
ffffffffc02047f0:	00002617          	auipc	a2,0x2
ffffffffc02047f4:	45860613          	addi	a2,a2,1112 # ffffffffc0206c48 <commands+0x450>
ffffffffc02047f8:	13200593          	li	a1,306
ffffffffc02047fc:	00003517          	auipc	a0,0x3
ffffffffc0204800:	78450513          	addi	a0,a0,1924 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204804:	c77fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0204808:	00004697          	auipc	a3,0x4
ffffffffc020480c:	91068693          	addi	a3,a3,-1776 # ffffffffc0208118 <default_pmm_manager+0xe38>
ffffffffc0204810:	00002617          	auipc	a2,0x2
ffffffffc0204814:	43860613          	addi	a2,a2,1080 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204818:	13300593          	li	a1,307
ffffffffc020481c:	00003517          	auipc	a0,0x3
ffffffffc0204820:	76450513          	addi	a0,a0,1892 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204824:	c57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(vma != NULL);
ffffffffc0204828:	00003697          	auipc	a3,0x3
ffffffffc020482c:	27868693          	addi	a3,a3,632 # ffffffffc0207aa0 <default_pmm_manager+0x7c0>
ffffffffc0204830:	00002617          	auipc	a2,0x2
ffffffffc0204834:	41860613          	addi	a2,a2,1048 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204838:	15200593          	li	a1,338
ffffffffc020483c:	00003517          	auipc	a0,0x3
ffffffffc0204840:	74450513          	addi	a0,a0,1860 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204844:	c37fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0204848:	00004697          	auipc	a3,0x4
ffffffffc020484c:	80068693          	addi	a3,a3,-2048 # ffffffffc0208048 <default_pmm_manager+0xd68>
ffffffffc0204850:	00002617          	auipc	a2,0x2
ffffffffc0204854:	3f860613          	addi	a2,a2,1016 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204858:	12000593          	li	a1,288
ffffffffc020485c:	00003517          	auipc	a0,0x3
ffffffffc0204860:	72450513          	addi	a0,a0,1828 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204864:	c17fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma3 == NULL);
ffffffffc0204868:	00004697          	auipc	a3,0x4
ffffffffc020486c:	85068693          	addi	a3,a3,-1968 # ffffffffc02080b8 <default_pmm_manager+0xdd8>
ffffffffc0204870:	00002617          	auipc	a2,0x2
ffffffffc0204874:	3d860613          	addi	a2,a2,984 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204878:	12c00593          	li	a1,300
ffffffffc020487c:	00003517          	auipc	a0,0x3
ffffffffc0204880:	70450513          	addi	a0,a0,1796 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204884:	bf7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2 != NULL);
ffffffffc0204888:	00004697          	auipc	a3,0x4
ffffffffc020488c:	82068693          	addi	a3,a3,-2016 # ffffffffc02080a8 <default_pmm_manager+0xdc8>
ffffffffc0204890:	00002617          	auipc	a2,0x2
ffffffffc0204894:	3b860613          	addi	a2,a2,952 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204898:	12a00593          	li	a1,298
ffffffffc020489c:	00003517          	auipc	a0,0x3
ffffffffc02048a0:	6e450513          	addi	a0,a0,1764 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc02048a4:	bd7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1 != NULL);
ffffffffc02048a8:	00003697          	auipc	a3,0x3
ffffffffc02048ac:	7f068693          	addi	a3,a3,2032 # ffffffffc0208098 <default_pmm_manager+0xdb8>
ffffffffc02048b0:	00002617          	auipc	a2,0x2
ffffffffc02048b4:	39860613          	addi	a2,a2,920 # ffffffffc0206c48 <commands+0x450>
ffffffffc02048b8:	12800593          	li	a1,296
ffffffffc02048bc:	00003517          	auipc	a0,0x3
ffffffffc02048c0:	6c450513          	addi	a0,a0,1732 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc02048c4:	bb7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma5 == NULL);
ffffffffc02048c8:	00004697          	auipc	a3,0x4
ffffffffc02048cc:	81068693          	addi	a3,a3,-2032 # ffffffffc02080d8 <default_pmm_manager+0xdf8>
ffffffffc02048d0:	00002617          	auipc	a2,0x2
ffffffffc02048d4:	37860613          	addi	a2,a2,888 # ffffffffc0206c48 <commands+0x450>
ffffffffc02048d8:	13000593          	li	a1,304
ffffffffc02048dc:	00003517          	auipc	a0,0x3
ffffffffc02048e0:	6a450513          	addi	a0,a0,1700 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc02048e4:	b97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma4 == NULL);
ffffffffc02048e8:	00003697          	auipc	a3,0x3
ffffffffc02048ec:	7e068693          	addi	a3,a3,2016 # ffffffffc02080c8 <default_pmm_manager+0xde8>
ffffffffc02048f0:	00002617          	auipc	a2,0x2
ffffffffc02048f4:	35860613          	addi	a2,a2,856 # ffffffffc0206c48 <commands+0x450>
ffffffffc02048f8:	12e00593          	li	a1,302
ffffffffc02048fc:	00003517          	auipc	a0,0x3
ffffffffc0204900:	68450513          	addi	a0,a0,1668 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204904:	b77fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0204908:	00004697          	auipc	a3,0x4
ffffffffc020490c:	8a068693          	addi	a3,a3,-1888 # ffffffffc02081a8 <default_pmm_manager+0xec8>
ffffffffc0204910:	00002617          	auipc	a2,0x2
ffffffffc0204914:	33860613          	addi	a2,a2,824 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204918:	14b00593          	li	a1,331
ffffffffc020491c:	00003517          	auipc	a0,0x3
ffffffffc0204920:	66450513          	addi	a0,a0,1636 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204924:	b57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(mm != NULL);
ffffffffc0204928:	00003697          	auipc	a3,0x3
ffffffffc020492c:	14068693          	addi	a3,a3,320 # ffffffffc0207a68 <default_pmm_manager+0x788>
ffffffffc0204930:	00002617          	auipc	a2,0x2
ffffffffc0204934:	31860613          	addi	a2,a2,792 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204938:	10c00593          	li	a1,268
ffffffffc020493c:	00003517          	auipc	a0,0x3
ffffffffc0204940:	64450513          	addi	a0,a0,1604 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204944:	b37fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0204948:	00004697          	auipc	a3,0x4
ffffffffc020494c:	8a868693          	addi	a3,a3,-1880 # ffffffffc02081f0 <default_pmm_manager+0xf10>
ffffffffc0204950:	00002617          	auipc	a2,0x2
ffffffffc0204954:	2f860613          	addi	a2,a2,760 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204958:	17000593          	li	a1,368
ffffffffc020495c:	00003517          	auipc	a0,0x3
ffffffffc0204960:	62450513          	addi	a0,a0,1572 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc0204964:	b17fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0204968:	00003617          	auipc	a2,0x3
ffffffffc020496c:	9b060613          	addi	a2,a2,-1616 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0204970:	06900593          	li	a1,105
ffffffffc0204974:	00003517          	auipc	a0,0x3
ffffffffc0204978:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc020497c:	afffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir[0] == 0);
ffffffffc0204980:	00003697          	auipc	a3,0x3
ffffffffc0204984:	11068693          	addi	a3,a3,272 # ffffffffc0207a90 <default_pmm_manager+0x7b0>
ffffffffc0204988:	00002617          	auipc	a2,0x2
ffffffffc020498c:	2c060613          	addi	a2,a2,704 # ffffffffc0206c48 <commands+0x450>
ffffffffc0204990:	14f00593          	li	a1,335
ffffffffc0204994:	00003517          	auipc	a0,0x3
ffffffffc0204998:	5ec50513          	addi	a0,a0,1516 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc020499c:	adffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc02049a0:	00004697          	auipc	a3,0x4
ffffffffc02049a4:	82068693          	addi	a3,a3,-2016 # ffffffffc02081c0 <default_pmm_manager+0xee0>
ffffffffc02049a8:	00002617          	auipc	a2,0x2
ffffffffc02049ac:	2a060613          	addi	a2,a2,672 # ffffffffc0206c48 <commands+0x450>
ffffffffc02049b0:	15700593          	li	a1,343
ffffffffc02049b4:	00003517          	auipc	a0,0x3
ffffffffc02049b8:	5cc50513          	addi	a0,a0,1484 # ffffffffc0207f80 <default_pmm_manager+0xca0>
ffffffffc02049bc:	abffb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02049c0:	00003617          	auipc	a2,0x3
ffffffffc02049c4:	a2860613          	addi	a2,a2,-1496 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc02049c8:	06200593          	li	a1,98
ffffffffc02049cc:	00003517          	auipc	a0,0x3
ffffffffc02049d0:	97450513          	addi	a0,a0,-1676 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc02049d4:	aa7fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(sum == 0);
ffffffffc02049d8:	00004697          	auipc	a3,0x4
ffffffffc02049dc:	80868693          	addi	a3,a3,-2040 # ffffffffc02081e0 <default_pmm_manager+0xf00>
ffffffffc02049e0:	00002617          	auipc	a2,0x2
ffffffffc02049e4:	26860613          	addi	a2,a2,616 # ffffffffc0206c48 <commands+0x450>
ffffffffc02049e8:	16300593          	li	a1,355
ffffffffc02049ec:	00003517          	auipc	a0,0x3
ffffffffc02049f0:	59450513          	addi	a0,a0,1428 # ffffffffc0207f80 <default_pmm_manager+0xca0>
...
ffffffffc0204a9a:	80a50513          	addi	a0,a0,-2038 # ffffffffc02082a0 <default_pmm_manager+0xfc0>
...
ffffffffc0204aac:	7a850513          	addi	a0,a0,1960 # ffffffffc0208250 <default_pmm_manager+0xf70>
...
ffffffffc0204abc:	81050513          	addi	a0,a0,-2032 # ffffffffc02082c8 <default_pmm_manager+0xfe8>
...
ffffffffc0204acc:	7b850513          	addi	a0,a0,1976 # ffffffffc0208280 <default_pmm_manager+0xfa0>
...
ffffffffc0204b92:	76260613          	addi	a2,a2,1890 # ffffffffc02082f0 <default_pmm_manager+0x1010>
ffffffffc0204b96:	45b5                	li	a1,13
ffffffffc0204b98:	00003517          	auipc	a0,0x3
ffffffffc0204b9c:	77850513          	addi	a0,a0,1912 # ffffffffc0208310 <default_pmm_manager+0x1030>
...
ffffffffc0204bcc:	08073703          	ld	a4,128(a4) # ffffffffc0208c48 <nbase>
...
ffffffffc0204c06:	72660613          	addi	a2,a2,1830 # ffffffffc0208328 <default_pmm_manager+0x1048>
ffffffffc0204c0a:	45d1                	li	a1,20
ffffffffc0204c0c:	00003517          	auipc	a0,0x3
ffffffffc0204c10:	70450513          	addi	a0,a0,1796 # ffffffffc0208310 <default_pmm_manager+0x1030>
...
ffffffffc0204c22:	6fa60613          	addi	a2,a2,1786 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0204c26:	00002517          	auipc	a0,0x2
ffffffffc0204c2a:	71a50513          	addi	a0,a0,1818 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0204c5a:	ff273703          	ld	a4,-14(a4) # ffffffffc0208c48 <nbase>
...
ffffffffc0204c94:	69860613          	addi	a2,a2,1688 # ffffffffc0208328 <default_pmm_manager+0x1048>
ffffffffc0204c98:	45e5                	li	a1,25
ffffffffc0204c9a:	00003517          	auipc	a0,0x3
ffffffffc0204c9e:	67650513          	addi	a0,a0,1654 # ffffffffc0208310 <default_pmm_manager+0x1030>
...
ffffffffc0204cb0:	66c60613          	addi	a2,a2,1644 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0204cb4:	00002517          	auipc	a0,0x2
ffffffffc0204cb8:	68c50513          	addi	a0,a0,1676 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0204cc2:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cc4:	5d0000ef          	jal	ra,ffffffffc0205294 <do_exit>
...
ffffffffc0204ccc:	ea87b783          	ld	a5,-344(a5) # ffffffffc02b2b70 <current>
...
ffffffffc0204cda:	e9a7b783          	ld	a5,-358(a5) # ffffffffc02b2b70 <current>
ffffffffc0204cde:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204ce0:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204ce2:	00003617          	auipc	a2,0x3
ffffffffc0204ce6:	66660613          	addi	a2,a2,1638 # ffffffffc0208348 <default_pmm_manager+0x1068>
ffffffffc0204cea:	00003517          	auipc	a0,0x3
ffffffffc0204cee:	66e50513          	addi	a0,a0,1646 # ffffffffc0208358 <default_pmm_manager+0x1078>
user_main(void *arg) {
...
ffffffffc0204cfc:	ca878793          	addi	a5,a5,-856 # a9a0 <_binary_obj___user_forktest_out_size>
ffffffffc0204d00:	e43e                	sd	a5,8(sp)
ffffffffc0204d02:	00003517          	auipc	a0,0x3
ffffffffc0204d06:	64650513          	addi	a0,a0,1606 # ffffffffc0208348 <default_pmm_manager+0x1068>
ffffffffc0204d0a:	00046797          	auipc	a5,0x46
ffffffffc0204d0e:	b3678793          	addi	a5,a5,-1226 # ffffffffc024a840 <_binary_obj___user_forktest_out_start>
ffffffffc0204d12:	f03e                	sd	a5,32(sp)
ffffffffc0204d14:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204d16:	e802                	sd	zero,16(sp)
ffffffffc0204d18:	7cc010ef          	jal	ra,ffffffffc02064e4 <strlen>
...
ffffffffc0204d34:	65050513          	addi	a0,a0,1616 # ffffffffc0208380 <default_pmm_manager+0x10a0>
...
ffffffffc0204d40:	65460613          	addi	a2,a2,1620 # ffffffffc0208390 <default_pmm_manager+0x10b0>
ffffffffc0204d44:	34f00593          	li	a1,847
ffffffffc0204d48:	00003517          	auipc	a0,0x3
ffffffffc0204d4c:	66850513          	addi	a0,a0,1640 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
...
ffffffffc0204d8c:	da853503          	ld	a0,-600(a0) # ffffffffc02b2b30 <pages>
...
ffffffffc0204d9e:	62660613          	addi	a2,a2,1574 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0204da2:	06e00593          	li	a1,110
ffffffffc0204da6:	00002517          	auipc	a0,0x2
ffffffffc0204daa:	59a50513          	addi	a0,a0,1434 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0204dae:	eccfb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204db2:	00002617          	auipc	a2,0x2
ffffffffc0204db6:	63660613          	addi	a2,a2,1590 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc0204dba:	06200593          	li	a1,98
ffffffffc0204dbe:	00002517          	auipc	a0,0x2
ffffffffc0204dc2:	58250513          	addi	a0,a0,1410 # ffffffffc0207340 <default_pmm_manager+0x60>
...
ffffffffc0204dcc:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204dce:	000ae917          	auipc	s2,0xae
ffffffffc0204dd2:	da290913          	addi	s2,s2,-606 # ffffffffc02b2b70 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204dd6:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204dd8:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0204ddc:	f406                	sd	ra,40(sp)
ffffffffc0204dde:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204de0:	02a48863          	beq	s1,a0,ffffffffc0204e10 <proc_run+0x46>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204de4:	100027f3          	csrr	a5,sstatus
ffffffffc0204de8:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204dea:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204dec:	ef9d                	bnez	a5,ffffffffc0204e2a <proc_run+0x60>
...
ffffffffc0204dee:	755c                	ld	a5,168(a0)
ffffffffc0204df0:	577d                	li	a4,-1
ffffffffc0204df2:	177e                	slli	a4,a4,0x3f
ffffffffc0204df4:	83b1                	srli	a5,a5,0xc
            current = proc; //当前进程设为待调度的进程
ffffffffc0204df6:	00a93023          	sd	a0,0(s2)
ffffffffc0204dfa:	8fd9                	or	a5,a5,a4
ffffffffc0204dfc:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context));//switch_to进行上下文切换
ffffffffc0204e00:	03050593          	addi	a1,a0,48
ffffffffc0204e04:	03048513          	addi	a0,s1,48
ffffffffc0204e08:	082010ef          	jal	ra,ffffffffc0205e8a <switch_to>
    if (flag) {
ffffffffc0204e0c:	00099863          	bnez	s3,ffffffffc0204e1c <proc_run+0x52>
}
ffffffffc0204e10:	70a2                	ld	ra,40(sp)
ffffffffc0204e12:	7482                	ld	s1,32(sp)
ffffffffc0204e14:	6962                	ld	s2,24(sp)
ffffffffc0204e16:	69c2                	ld	s3,16(sp)
ffffffffc0204e18:	6145                	addi	sp,sp,48
ffffffffc0204e1a:	8082                	ret
ffffffffc0204e1c:	70a2                	ld	ra,40(sp)
ffffffffc0204e1e:	7482                	ld	s1,32(sp)
ffffffffc0204e20:	6962                	ld	s2,24(sp)
ffffffffc0204e22:	69c2                	ld	s3,16(sp)
ffffffffc0204e24:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204e26:	81bfb06f          	j	ffffffffc0200640 <intr_enable>
ffffffffc0204e2a:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204e2c:	81bfb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0204e30:	6522                	ld	a0,8(sp)
ffffffffc0204e32:	4985                	li	s3,1
ffffffffc0204e34:	bf6d                	j	ffffffffc0204dee <proc_run+0x24>

ffffffffc0204e36 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204e36:	7159                	addi	sp,sp,-112
ffffffffc0204e38:	eca6                	sd	s1,88(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204e3a:	000ae497          	auipc	s1,0xae
ffffffffc0204e3e:	d4e48493          	addi	s1,s1,-690 # ffffffffc02b2b88 <nr_process>
ffffffffc0204e42:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204e44:	f486                	sd	ra,104(sp)
ffffffffc0204e46:	f0a2                	sd	s0,96(sp)
ffffffffc0204e48:	e8ca                	sd	s2,80(sp)
ffffffffc0204e4a:	e4ce                	sd	s3,72(sp)
ffffffffc0204e4c:	e0d2                	sd	s4,64(sp)
ffffffffc0204e4e:	fc56                	sd	s5,56(sp)
ffffffffc0204e50:	f85a                	sd	s6,48(sp)
ffffffffc0204e52:	f45e                	sd	s7,40(sp)
ffffffffc0204e54:	f062                	sd	s8,32(sp)
ffffffffc0204e56:	ec66                	sd	s9,24(sp)
ffffffffc0204e58:	e86a                	sd	s10,16(sp)
ffffffffc0204e5a:	e46e                	sd	s11,8(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204e5c:	6785                	lui	a5,0x1
ffffffffc0204e5e:	36f75163          	bge	a4,a5,ffffffffc02051c0 <do_fork+0x38a>
ffffffffc0204e62:	8a2a                	mv	s4,a0
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204e64:	10800513          	li	a0,264
ffffffffc0204e68:	892e                	mv	s2,a1
ffffffffc0204e6a:	8432                	mv	s0,a2
ffffffffc0204e6c:	c97fc0ef          	jal	ra,ffffffffc0201b02 <kmalloc>
ffffffffc0204e70:	89aa                	mv	s3,a0
    if (proc != NULL) {
ffffffffc0204e72:	2e050663          	beqz	a0,ffffffffc020515e <do_fork+0x328>
        memset(proc, 0, sizeof(struct proc_struct));//初始化proc_struct结构体
ffffffffc0204e76:	10800613          	li	a2,264
ffffffffc0204e7a:	4581                	li	a1,0
ffffffffc0204e7c:	6e4010ef          	jal	ra,ffffffffc0206560 <memset>
        proc->state = PROC_UNINIT;
ffffffffc0204e80:	5c7d                	li	s8,-1
ffffffffc0204e82:	020c1793          	slli	a5,s8,0x20
ffffffffc0204e86:	00f9b023          	sd	a5,0(s3)
    proc->parent = current; // 设置父进程为当前进程
ffffffffc0204e8a:	000aeb17          	auipc	s6,0xae
ffffffffc0204e8e:	ce6b0b13          	addi	s6,s6,-794 # ffffffffc02b2b70 <current>
ffffffffc0204e92:	000b3783          	ld	a5,0(s6)
        proc->cr3 = boot_cr3;//进程的页目录表
ffffffffc0204e96:	000ae717          	auipc	a4,0xae
ffffffffc0204e9a:	c8273703          	ld	a4,-894(a4) # ffffffffc02b2b18 <boot_cr3>
ffffffffc0204e9e:	0ae9b423          	sd	a4,168(s3)
    proc->parent = current; // 设置父进程为当前进程
ffffffffc0204ea2:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204ea6:	4509                	li	a0,2
ffffffffc0204ea8:	e39fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204eac:	2c050863          	beqz	a0,ffffffffc020517c <do_fork+0x346>
    return page - pages + nbase;
ffffffffc0204eb0:	000aed97          	auipc	s11,0xae
ffffffffc0204eb4:	c80d8d93          	addi	s11,s11,-896 # ffffffffc02b2b30 <pages>
ffffffffc0204eb8:	000db683          	ld	a3,0(s11)
    return KADDR(page2pa(page));
ffffffffc0204ebc:	000aed17          	auipc	s10,0xae
ffffffffc0204ec0:	c6cd0d13          	addi	s10,s10,-916 # ffffffffc02b2b28 <npage>
    return page - pages + nbase;
ffffffffc0204ec4:	00004c97          	auipc	s9,0x4
ffffffffc0204ec8:	d84cbc83          	ld	s9,-636(s9) # ffffffffc0208c48 <nbase>
ffffffffc0204ecc:	40d506b3          	sub	a3,a0,a3
ffffffffc0204ed0:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204ed2:	000d3783          	ld	a5,0(s10)
    return page - pages + nbase;
ffffffffc0204ed6:	96e6                	add	a3,a3,s9
    return KADDR(page2pa(page));
ffffffffc0204ed8:	00cc5c13          	srli	s8,s8,0xc
ffffffffc0204edc:	0186f733          	and	a4,a3,s8
    return page2ppn(page) << PGSHIFT;
ffffffffc0204ee0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204ee2:	30f77063          	bgeu	a4,a5,ffffffffc02051e2 <do_fork+0x3ac>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204ee6:	000b3703          	ld	a4,0(s6)
ffffffffc0204eea:	000aea97          	auipc	s5,0xae
ffffffffc0204eee:	c56a8a93          	addi	s5,s5,-938 # ffffffffc02b2b40 <va_pa_offset>
ffffffffc0204ef2:	000ab783          	ld	a5,0(s5)
ffffffffc0204ef6:	02873b83          	ld	s7,40(a4)
ffffffffc0204efa:	96be                	add	a3,a3,a5
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204efc:	00d9b823          	sd	a3,16(s3)
    if (oldmm == NULL) {
ffffffffc0204f00:	020b8a63          	beqz	s7,ffffffffc0204f34 <do_fork+0xfe>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f04:	100a7a13          	andi	s4,s4,256
ffffffffc0204f08:	1c0a0363          	beqz	s4,ffffffffc02050ce <do_fork+0x298>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f0c:	030ba703          	lw	a4,48(s7)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f10:	018bb783          	ld	a5,24(s7)
ffffffffc0204f14:	c02006b7          	lui	a3,0xc0200
ffffffffc0204f18:	2705                	addiw	a4,a4,1
ffffffffc0204f1a:	02eba823          	sw	a4,48(s7)
    proc->mm = mm;
ffffffffc0204f1e:	0379b423          	sd	s7,40(s3)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f22:	2cd7ec63          	bltu	a5,a3,ffffffffc02051fa <do_fork+0x3c4>
ffffffffc0204f26:	000ab703          	ld	a4,0(s5)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f2a:	0109b683          	ld	a3,16(s3)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f2e:	8f99                	sub	a5,a5,a4
ffffffffc0204f30:	0af9b423          	sd	a5,168(s3)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f34:	6789                	lui	a5,0x2
ffffffffc0204f36:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7d00>
ffffffffc0204f3a:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204f3c:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f3e:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc0204f42:	87b6                	mv	a5,a3
ffffffffc0204f44:	12040893          	addi	a7,s0,288
ffffffffc0204f48:	00063803          	ld	a6,0(a2)
ffffffffc0204f4c:	6608                	ld	a0,8(a2)
ffffffffc0204f4e:	6a0c                	ld	a1,16(a2)
ffffffffc0204f50:	6e18                	ld	a4,24(a2)
ffffffffc0204f52:	0107b023          	sd	a6,0(a5)
ffffffffc0204f56:	e788                	sd	a0,8(a5)
ffffffffc0204f58:	eb8c                	sd	a1,16(a5)
ffffffffc0204f5a:	ef98                	sd	a4,24(a5)
ffffffffc0204f5c:	02060613          	addi	a2,a2,32
ffffffffc0204f60:	02078793          	addi	a5,a5,32
ffffffffc0204f64:	ff1612e3          	bne	a2,a7,ffffffffc0204f48 <do_fork+0x112>
    proc->tf->gpr.a0 = 0;
ffffffffc0204f68:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204f6c:	12090c63          	beqz	s2,ffffffffc02050a4 <do_fork+0x26e>
ffffffffc0204f70:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204f74:	00000797          	auipc	a5,0x0
ffffffffc0204f78:	d5478793          	addi	a5,a5,-684 # ffffffffc0204cc8 <forkret>
ffffffffc0204f7c:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204f80:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204f84:	100027f3          	csrr	a5,sstatus
ffffffffc0204f88:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204f8a:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204f8c:	12079d63          	bnez	a5,ffffffffc02050c6 <do_fork+0x290>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204f90:	000a2817          	auipc	a6,0xa2
ffffffffc0204f94:	69880813          	addi	a6,a6,1688 # ffffffffc02a7628 <last_pid.1>
ffffffffc0204f98:	00082783          	lw	a5,0(a6)
ffffffffc0204f9c:	6709                	lui	a4,0x2
ffffffffc0204f9e:	0017851b          	addiw	a0,a5,1
ffffffffc0204fa2:	00a82023          	sw	a0,0(a6)
ffffffffc0204fa6:	08e55863          	bge	a0,a4,ffffffffc0205036 <do_fork+0x200>
    if (last_pid >= next_safe) {
ffffffffc0204faa:	000a2317          	auipc	t1,0xa2
ffffffffc0204fae:	68230313          	addi	t1,t1,1666 # ffffffffc02a762c <next_safe.0>
ffffffffc0204fb2:	00032783          	lw	a5,0(t1)
ffffffffc0204fb6:	000ae417          	auipc	s0,0xae
ffffffffc0204fba:	b3240413          	addi	s0,s0,-1230 # ffffffffc02b2ae8 <proc_list>
ffffffffc0204fbe:	08f55463          	bge	a0,a5,ffffffffc0205046 <do_fork+0x210>
    proc->pid = get_pid();  // 为子进程分配pid
ffffffffc0204fc2:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204fc6:	45a9                	li	a1,10
ffffffffc0204fc8:	2501                	sext.w	a0,a0
ffffffffc0204fca:	116010ef          	jal	ra,ffffffffc02060e0 <hash32>
ffffffffc0204fce:	02051793          	slli	a5,a0,0x20
ffffffffc0204fd2:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204fd6:	000aa797          	auipc	a5,0xaa
ffffffffc0204fda:	b1278793          	addi	a5,a5,-1262 # ffffffffc02aeae8 <hash_list>
ffffffffc0204fde:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204fe0:	6510                	ld	a2,8(a0)
ffffffffc0204fe2:	0d898793          	addi	a5,s3,216
ffffffffc0204fe6:	6414                	ld	a3,8(s0)
    nr_process++;
ffffffffc0204fe8:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc0204fea:	e21c                	sd	a5,0(a2)
ffffffffc0204fec:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204fee:	0ec9b023          	sd	a2,224(s3)
    list_add(&proc_list, &(proc->list_link));   // 将子进程添加到proc_list中
ffffffffc0204ff2:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc0204ff6:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc0204ffa:	e29c                	sd	a5,0(a3)
    nr_process++;
ffffffffc0204ffc:	2705                	addiw	a4,a4,1
ffffffffc0204ffe:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc0205000:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc0205004:	0c89b423          	sd	s0,200(s3)
ffffffffc0205008:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc020500a:	14091c63          	bnez	s2,ffffffffc0205162 <do_fork+0x32c>
    wakeup_proc(proc);  // 唤醒子进程
ffffffffc020500e:	854e                	mv	a0,s3
ffffffffc0205010:	6e5000ef          	jal	ra,ffffffffc0205ef4 <wakeup_proc>
    ret = proc->pid;    // 设置返回值为子进程的pid
ffffffffc0205014:	0049a503          	lw	a0,4(s3)
}
ffffffffc0205018:	70a6                	ld	ra,104(sp)
ffffffffc020501a:	7406                	ld	s0,96(sp)
ffffffffc020501c:	64e6                	ld	s1,88(sp)
ffffffffc020501e:	6946                	ld	s2,80(sp)
ffffffffc0205020:	69a6                	ld	s3,72(sp)
ffffffffc0205022:	6a06                	ld	s4,64(sp)
ffffffffc0205024:	7ae2                	ld	s5,56(sp)
ffffffffc0205026:	7b42                	ld	s6,48(sp)
ffffffffc0205028:	7ba2                	ld	s7,40(sp)
ffffffffc020502a:	7c02                	ld	s8,32(sp)
ffffffffc020502c:	6ce2                	ld	s9,24(sp)
ffffffffc020502e:	6d42                	ld	s10,16(sp)
ffffffffc0205030:	6da2                	ld	s11,8(sp)
ffffffffc0205032:	6165                	addi	sp,sp,112
ffffffffc0205034:	8082                	ret
        last_pid = 1;
ffffffffc0205036:	4785                	li	a5,1
ffffffffc0205038:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc020503c:	4505                	li	a0,1
ffffffffc020503e:	000a2317          	auipc	t1,0xa2
ffffffffc0205042:	5ee30313          	addi	t1,t1,1518 # ffffffffc02a762c <next_safe.0>
    return listelm->next;
ffffffffc0205046:	000ae417          	auipc	s0,0xae
ffffffffc020504a:	aa240413          	addi	s0,s0,-1374 # ffffffffc02b2ae8 <proc_list>
ffffffffc020504e:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc0205052:	6789                	lui	a5,0x2
ffffffffc0205054:	00f32023          	sw	a5,0(t1)
ffffffffc0205058:	86aa                	mv	a3,a0
ffffffffc020505a:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc020505c:	6e89                	lui	t4,0x2
ffffffffc020505e:	108e0a63          	beq	t3,s0,ffffffffc0205172 <do_fork+0x33c>
ffffffffc0205062:	88ae                	mv	a7,a1
ffffffffc0205064:	87f2                	mv	a5,t3
ffffffffc0205066:	6609                	lui	a2,0x2
ffffffffc0205068:	a811                	j	ffffffffc020507c <do_fork+0x246>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc020506a:	00e6d663          	bge	a3,a4,ffffffffc0205076 <do_fork+0x240>
ffffffffc020506e:	00c75463          	bge	a4,a2,ffffffffc0205076 <do_fork+0x240>
ffffffffc0205072:	863a                	mv	a2,a4
ffffffffc0205074:	4885                	li	a7,1
ffffffffc0205076:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205078:	00878d63          	beq	a5,s0,ffffffffc0205092 <do_fork+0x25c>
            if (proc->pid == last_pid) {
ffffffffc020507c:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7ca4>
ffffffffc0205080:	fed715e3          	bne	a4,a3,ffffffffc020506a <do_fork+0x234>
                if (++ last_pid >= next_safe) {
ffffffffc0205084:	2685                	addiw	a3,a3,1
ffffffffc0205086:	0ec6d163          	bge	a3,a2,ffffffffc0205168 <do_fork+0x332>
ffffffffc020508a:	679c                	ld	a5,8(a5)
ffffffffc020508c:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020508e:	fe8797e3          	bne	a5,s0,ffffffffc020507c <do_fork+0x246>
ffffffffc0205092:	c581                	beqz	a1,ffffffffc020509a <do_fork+0x264>
ffffffffc0205094:	00d82023          	sw	a3,0(a6)
ffffffffc0205098:	8536                	mv	a0,a3
ffffffffc020509a:	f20884e3          	beqz	a7,ffffffffc0204fc2 <do_fork+0x18c>
ffffffffc020509e:	00c32023          	sw	a2,0(t1)
ffffffffc02050a2:	b705                	j	ffffffffc0204fc2 <do_fork+0x18c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02050a4:	8936                	mv	s2,a3
ffffffffc02050a6:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02050aa:	00000797          	auipc	a5,0x0
ffffffffc02050ae:	c1e78793          	addi	a5,a5,-994 # ffffffffc0204cc8 <forkret>
ffffffffc02050b2:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02050b6:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02050ba:	100027f3          	csrr	a5,sstatus
ffffffffc02050be:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02050c0:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02050c2:	ec0787e3          	beqz	a5,ffffffffc0204f90 <do_fork+0x15a>
        intr_disable();
ffffffffc02050c6:	d80fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02050ca:	4905                	li	s2,1
ffffffffc02050cc:	b5d1                	j	ffffffffc0204f90 <do_fork+0x15a>
    if ((mm = mm_create()) == NULL) {
ffffffffc02050ce:	852ff0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc02050d2:	8b2a                	mv	s6,a0
ffffffffc02050d4:	c151                	beqz	a0,ffffffffc0205158 <do_fork+0x322>
    if ((page = alloc_page()) == NULL) {
ffffffffc02050d6:	4505                	li	a0,1
ffffffffc02050d8:	c09fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc02050dc:	c93d                	beqz	a0,ffffffffc0205152 <do_fork+0x31c>
    return page - pages + nbase;
ffffffffc02050de:	000db683          	ld	a3,0(s11)
    return KADDR(page2pa(page));
ffffffffc02050e2:	000d3783          	ld	a5,0(s10)
    return page - pages + nbase;
ffffffffc02050e6:	40d506b3          	sub	a3,a0,a3
ffffffffc02050ea:	8699                	srai	a3,a3,0x6
ffffffffc02050ec:	96e6                	add	a3,a3,s9
    return KADDR(page2pa(page));
ffffffffc02050ee:	0186fc33          	and	s8,a3,s8
    return page2ppn(page) << PGSHIFT;
ffffffffc02050f2:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02050f4:	0efc7763          	bgeu	s8,a5,ffffffffc02051e2 <do_fork+0x3ac>
ffffffffc02050f8:	000aba03          	ld	s4,0(s5)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc02050fc:	6605                	lui	a2,0x1
ffffffffc02050fe:	000ae597          	auipc	a1,0xae
ffffffffc0205102:	a225b583          	ld	a1,-1502(a1) # ffffffffc02b2b20 <boot_pgdir>
ffffffffc0205106:	9a36                	add	s4,s4,a3
ffffffffc0205108:	8552                	mv	a0,s4
ffffffffc020510a:	468010ef          	jal	ra,ffffffffc0206572 <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc020510e:	038b8c13          	addi	s8,s7,56
    mm->pgdir = pgdir;
ffffffffc0205112:	014b3c23          	sd	s4,24(s6)
...
ffffffffc0205118:	40fc37af          	amoor.d	a5,a5,(s8)
...
lock(lock_t *lock) {
    while (!try_lock(lock)) {
ffffffffc020511c:	8b85                	andi	a5,a5,1
ffffffffc020511e:	4a05                	li	s4,1
ffffffffc0205120:	c799                	beqz	a5,ffffffffc020512e <do_fork+0x2f8>
        schedule();
ffffffffc0205122:	653000ef          	jal	ra,ffffffffc0205f74 <schedule>
ffffffffc0205126:	414c37af          	amoor.d	a5,s4,(s8)
    while (!try_lock(lock)) {
ffffffffc020512a:	8b85                	andi	a5,a5,1
ffffffffc020512c:	fbfd                	bnez	a5,ffffffffc0205122 <do_fork+0x2ec>
        ret = dup_mmap(mm, oldmm);
ffffffffc020512e:	85de                	mv	a1,s7
ffffffffc0205130:	855a                	mv	a0,s6
ffffffffc0205132:	a76ff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc0205136:	57f9                	li	a5,-2
ffffffffc0205138:	60fc37af          	amoand.d	a5,a5,(s8)
...
ffffffffc020513e:	c7d1                	beqz	a5,ffffffffc02051ca <do_fork+0x394>
good_mm:
ffffffffc0205140:	8bda                	mv	s7,s6
    if (ret != 0) {
ffffffffc0205142:	dc0505e3          	beqz	a0,ffffffffc0204f0c <do_fork+0xd6>
    exit_mmap(mm);
ffffffffc0205146:	855a                	mv	a0,s6
ffffffffc0205148:	afaff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc020514c:	855a                	mv	a0,s6
ffffffffc020514e:	c07ff0ef          	jal	ra,ffffffffc0204d54 <put_pgdir>
    mm_destroy(mm);
ffffffffc0205152:	855a                	mv	a0,s6
ffffffffc0205154:	952ff0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    kfree(proc);
ffffffffc0205158:	854e                	mv	a0,s3
ffffffffc020515a:	a59fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    ret = -E_NO_MEM;
ffffffffc020515e:	5571                	li	a0,-4
    return ret;
ffffffffc0205160:	bd65                	j	ffffffffc0205018 <do_fork+0x1e2>
        intr_enable();
ffffffffc0205162:	cdefb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205166:	b565                	j	ffffffffc020500e <do_fork+0x1d8>
                    if (last_pid >= MAX_PID) {
ffffffffc0205168:	01d6c363          	blt	a3,t4,ffffffffc020516e <do_fork+0x338>
                        last_pid = 1;
ffffffffc020516c:	4685                	li	a3,1
                    goto repeat;
ffffffffc020516e:	4585                	li	a1,1
ffffffffc0205170:	b5fd                	j	ffffffffc020505e <do_fork+0x228>
ffffffffc0205172:	c9a9                	beqz	a1,ffffffffc02051c4 <do_fork+0x38e>
ffffffffc0205174:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0205178:	8536                	mv	a0,a3
ffffffffc020517a:	b5a1                	j	ffffffffc0204fc2 <do_fork+0x18c>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc020517c:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc0205180:	c02007b7          	lui	a5,0xc0200
ffffffffc0205184:	0af6e463          	bltu	a3,a5,ffffffffc020522c <do_fork+0x3f6>
ffffffffc0205188:	000ae797          	auipc	a5,0xae
ffffffffc020518c:	9b87b783          	ld	a5,-1608(a5) # ffffffffc02b2b40 <va_pa_offset>
ffffffffc0205190:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0205194:	83b1                	srli	a5,a5,0xc
ffffffffc0205196:	000ae717          	auipc	a4,0xae
ffffffffc020519a:	99273703          	ld	a4,-1646(a4) # ffffffffc02b2b28 <npage>
ffffffffc020519e:	06e7fb63          	bgeu	a5,a4,ffffffffc0205214 <do_fork+0x3de>
    return &pages[PPN(pa) - nbase];
ffffffffc02051a2:	00004717          	auipc	a4,0x4
ffffffffc02051a6:	aa673703          	ld	a4,-1370(a4) # ffffffffc0208c48 <nbase>
ffffffffc02051aa:	8f99                	sub	a5,a5,a4
ffffffffc02051ac:	079a                	slli	a5,a5,0x6
ffffffffc02051ae:	000ae517          	auipc	a0,0xae
ffffffffc02051b2:	98253503          	ld	a0,-1662(a0) # ffffffffc02b2b30 <pages>
ffffffffc02051b6:	4589                	li	a1,2
ffffffffc02051b8:	953e                	add	a0,a0,a5
ffffffffc02051ba:	bb9fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
}
ffffffffc02051be:	bf69                	j	ffffffffc0205158 <do_fork+0x322>
    int ret = -E_NO_FREE_PROC;
ffffffffc02051c0:	556d                	li	a0,-5
ffffffffc02051c2:	bd99                	j	ffffffffc0205018 <do_fork+0x1e2>
    return last_pid;
ffffffffc02051c4:	00082503          	lw	a0,0(a6)
ffffffffc02051c8:	bbed                	j	ffffffffc0204fc2 <do_fork+0x18c>
        panic("Unlock failed.\n");
ffffffffc02051ca:	00003617          	auipc	a2,0x3
ffffffffc02051ce:	1fe60613          	addi	a2,a2,510 # ffffffffc02083c8 <default_pmm_manager+0x10e8>
ffffffffc02051d2:	03100593          	li	a1,49
ffffffffc02051d6:	00003517          	auipc	a0,0x3
ffffffffc02051da:	20250513          	addi	a0,a0,514 # ffffffffc02083d8 <default_pmm_manager+0x10f8>
ffffffffc02051de:	a9cfb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02051e2:	00002617          	auipc	a2,0x2
ffffffffc02051e6:	13660613          	addi	a2,a2,310 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc02051ea:	06900593          	li	a1,105
ffffffffc02051ee:	00002517          	auipc	a0,0x2
ffffffffc02051f2:	15250513          	addi	a0,a0,338 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc02051f6:	a84fb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc02051fa:	86be                	mv	a3,a5
ffffffffc02051fc:	00002617          	auipc	a2,0x2
ffffffffc0205200:	1c460613          	addi	a2,a2,452 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0205204:	15c00593          	li	a1,348
ffffffffc0205208:	00003517          	auipc	a0,0x3
ffffffffc020520c:	1a850513          	addi	a0,a0,424 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205210:	a6afb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205214:	00002617          	auipc	a2,0x2
ffffffffc0205218:	1d460613          	addi	a2,a2,468 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc020521c:	06200593          	li	a1,98
ffffffffc0205220:	00002517          	auipc	a0,0x2
ffffffffc0205224:	12050513          	addi	a0,a0,288 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0205228:	a52fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc020522c:	00002617          	auipc	a2,0x2
ffffffffc0205230:	19460613          	addi	a2,a2,404 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0205234:	06e00593          	li	a1,110
ffffffffc0205238:	00002517          	auipc	a0,0x2
ffffffffc020523c:	10850513          	addi	a0,a0,264 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0205240:	a3afb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205244 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0205244:	7129                	addi	sp,sp,-320
ffffffffc0205246:	fa22                	sd	s0,304(sp)
ffffffffc0205248:	f626                	sd	s1,296(sp)
ffffffffc020524a:	f24a                	sd	s2,288(sp)
ffffffffc020524c:	84ae                	mv	s1,a1
ffffffffc020524e:	892a                	mv	s2,a0
ffffffffc0205250:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0205252:	4581                	li	a1,0
ffffffffc0205254:	12000613          	li	a2,288
ffffffffc0205258:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020525a:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020525c:	304010ef          	jal	ra,ffffffffc0206560 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc0205260:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc0205262:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0205264:	100027f3          	csrr	a5,sstatus
ffffffffc0205268:	edd7f793          	andi	a5,a5,-291
ffffffffc020526c:	1207e793          	ori	a5,a5,288
ffffffffc0205270:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205272:	860a                	mv	a2,sp
ffffffffc0205274:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0205278:	00000797          	auipc	a5,0x0
ffffffffc020527c:	a4878793          	addi	a5,a5,-1464 # ffffffffc0204cc0 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205280:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0205282:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205284:	bb3ff0ef          	jal	ra,ffffffffc0204e36 <do_fork>
}
ffffffffc0205288:	70f2                	ld	ra,312(sp)
ffffffffc020528a:	7452                	ld	s0,304(sp)
ffffffffc020528c:	74b2                	ld	s1,296(sp)
ffffffffc020528e:	7912                	ld	s2,288(sp)
ffffffffc0205290:	6131                	addi	sp,sp,320
ffffffffc0205292:	8082                	ret

ffffffffc0205294 <do_exit>:
do_exit(int error_code) {
ffffffffc0205294:	7179                	addi	sp,sp,-48
ffffffffc0205296:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc0205298:	000ae417          	auipc	s0,0xae
ffffffffc020529c:	8d840413          	addi	s0,s0,-1832 # ffffffffc02b2b70 <current>
ffffffffc02052a0:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc02052a2:	f406                	sd	ra,40(sp)
ffffffffc02052a4:	ec26                	sd	s1,24(sp)
ffffffffc02052a6:	e84a                	sd	s2,16(sp)
ffffffffc02052a8:	e44e                	sd	s3,8(sp)
ffffffffc02052aa:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc02052ac:	000ae717          	auipc	a4,0xae
ffffffffc02052b0:	8cc73703          	ld	a4,-1844(a4) # ffffffffc02b2b78 <idleproc>
ffffffffc02052b4:	0ce78c63          	beq	a5,a4,ffffffffc020538c <do_exit+0xf8>
    if (current == initproc) {
ffffffffc02052b8:	000ae497          	auipc	s1,0xae
ffffffffc02052bc:	8c848493          	addi	s1,s1,-1848 # ffffffffc02b2b80 <initproc>
ffffffffc02052c0:	6098                	ld	a4,0(s1)
ffffffffc02052c2:	0ee78b63          	beq	a5,a4,ffffffffc02053b8 <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc02052c6:	0287b983          	ld	s3,40(a5)
ffffffffc02052ca:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc02052cc:	02098663          	beqz	s3,ffffffffc02052f8 <do_exit+0x64>
ffffffffc02052d0:	000ae797          	auipc	a5,0xae
ffffffffc02052d4:	8487b783          	ld	a5,-1976(a5) # ffffffffc02b2b18 <boot_cr3>
ffffffffc02052d8:	577d                	li	a4,-1
ffffffffc02052da:	177e                	slli	a4,a4,0x3f
ffffffffc02052dc:	83b1                	srli	a5,a5,0xc
ffffffffc02052de:	8fd9                	or	a5,a5,a4
ffffffffc02052e0:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc02052e4:	0309a783          	lw	a5,48(s3)
ffffffffc02052e8:	fff7871b          	addiw	a4,a5,-1
ffffffffc02052ec:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc02052f0:	cb55                	beqz	a4,ffffffffc02053a4 <do_exit+0x110>
        current->mm = NULL;
ffffffffc02052f2:	601c                	ld	a5,0(s0)
ffffffffc02052f4:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc02052f8:	601c                	ld	a5,0(s0)
ffffffffc02052fa:	470d                	li	a4,3
ffffffffc02052fc:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc02052fe:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205302:	100027f3          	csrr	a5,sstatus
ffffffffc0205306:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205308:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020530a:	e3f9                	bnez	a5,ffffffffc02053d0 <do_exit+0x13c>
        proc = current->parent;
ffffffffc020530c:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc020530e:	800007b7          	lui	a5,0x80000
ffffffffc0205312:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc0205314:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205316:	0ec52703          	lw	a4,236(a0)
ffffffffc020531a:	0af70f63          	beq	a4,a5,ffffffffc02053d8 <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc020531e:	6018                	ld	a4,0(s0)
ffffffffc0205320:	7b7c                	ld	a5,240(a4)
ffffffffc0205322:	c3a1                	beqz	a5,ffffffffc0205362 <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205324:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205328:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020532a:	0985                	addi	s3,s3,1
ffffffffc020532c:	a021                	j	ffffffffc0205334 <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc020532e:	6018                	ld	a4,0(s0)
ffffffffc0205330:	7b7c                	ld	a5,240(a4)
ffffffffc0205332:	cb85                	beqz	a5,ffffffffc0205362 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc0205334:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fa8>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205338:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc020533a:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020533c:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc020533e:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205342:	10e7b023          	sd	a4,256(a5)
ffffffffc0205346:	c311                	beqz	a4,ffffffffc020534a <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc0205348:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020534a:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc020534c:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc020534e:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205350:	fd271fe3          	bne	a4,s2,ffffffffc020532e <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205354:	0ec52783          	lw	a5,236(a0)
ffffffffc0205358:	fd379be3          	bne	a5,s3,ffffffffc020532e <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc020535c:	399000ef          	jal	ra,ffffffffc0205ef4 <wakeup_proc>
ffffffffc0205360:	b7f9                	j	ffffffffc020532e <do_exit+0x9a>
    if (flag) {
ffffffffc0205362:	020a1263          	bnez	s4,ffffffffc0205386 <do_exit+0xf2>
    schedule();
ffffffffc0205366:	40f000ef          	jal	ra,ffffffffc0205f74 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc020536a:	601c                	ld	a5,0(s0)
ffffffffc020536c:	00003617          	auipc	a2,0x3
ffffffffc0205370:	0a460613          	addi	a2,a2,164 # ffffffffc0208410 <default_pmm_manager+0x1130>
ffffffffc0205374:	20200593          	li	a1,514
ffffffffc0205378:	43d4                	lw	a3,4(a5)
ffffffffc020537a:	00003517          	auipc	a0,0x3
ffffffffc020537e:	03650513          	addi	a0,a0,54 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205382:	8f8fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc0205386:	abafb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc020538a:	bff1                	j	ffffffffc0205366 <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc020538c:	00003617          	auipc	a2,0x3
ffffffffc0205390:	06460613          	addi	a2,a2,100 # ffffffffc02083f0 <default_pmm_manager+0x1110>
ffffffffc0205394:	1d600593          	li	a1,470
ffffffffc0205398:	00003517          	auipc	a0,0x3
ffffffffc020539c:	01850513          	addi	a0,a0,24 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc02053a0:	8dafb0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc02053a4:	854e                	mv	a0,s3
ffffffffc02053a6:	89cff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc02053aa:	854e                	mv	a0,s3
ffffffffc02053ac:	9a9ff0ef          	jal	ra,ffffffffc0204d54 <put_pgdir>
            mm_destroy(mm);
ffffffffc02053b0:	854e                	mv	a0,s3
ffffffffc02053b2:	ef5fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc02053b6:	bf35                	j	ffffffffc02052f2 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc02053b8:	00003617          	auipc	a2,0x3
ffffffffc02053bc:	04860613          	addi	a2,a2,72 # ffffffffc0208400 <default_pmm_manager+0x1120>
ffffffffc02053c0:	1d900593          	li	a1,473
ffffffffc02053c4:	00003517          	auipc	a0,0x3
ffffffffc02053c8:	fec50513          	addi	a0,a0,-20 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc02053cc:	8aefb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_disable();
ffffffffc02053d0:	a76fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02053d4:	4a05                	li	s4,1
ffffffffc02053d6:	bf1d                	j	ffffffffc020530c <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc02053d8:	31d000ef          	jal	ra,ffffffffc0205ef4 <wakeup_proc>
ffffffffc02053dc:	b789                	j	ffffffffc020531e <do_exit+0x8a>

ffffffffc02053de <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc02053de:	715d                	addi	sp,sp,-80
ffffffffc02053e0:	f84a                	sd	s2,48(sp)
ffffffffc02053e2:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc02053e4:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc02053e8:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc02053ea:	fc26                	sd	s1,56(sp)
ffffffffc02053ec:	f052                	sd	s4,32(sp)
ffffffffc02053ee:	ec56                	sd	s5,24(sp)
ffffffffc02053f0:	e85a                	sd	s6,16(sp)
ffffffffc02053f2:	e45e                	sd	s7,8(sp)
ffffffffc02053f4:	e486                	sd	ra,72(sp)
ffffffffc02053f6:	e0a2                	sd	s0,64(sp)
ffffffffc02053f8:	84aa                	mv	s1,a0
ffffffffc02053fa:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc02053fc:	000adb97          	auipc	s7,0xad
ffffffffc0205400:	774b8b93          	addi	s7,s7,1908 # ffffffffc02b2b70 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205404:	00050b1b          	sext.w	s6,a0
ffffffffc0205408:	fff50a9b          	addiw	s5,a0,-1
ffffffffc020540c:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc020540e:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc0205410:	ccbd                	beqz	s1,ffffffffc020548e <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205412:	0359e863          	bltu	s3,s5,ffffffffc0205442 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205416:	45a9                	li	a1,10
ffffffffc0205418:	855a                	mv	a0,s6
ffffffffc020541a:	4c7000ef          	jal	ra,ffffffffc02060e0 <hash32>
ffffffffc020541e:	02051793          	slli	a5,a0,0x20
ffffffffc0205422:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205426:	000a9797          	auipc	a5,0xa9
ffffffffc020542a:	6c278793          	addi	a5,a5,1730 # ffffffffc02aeae8 <hash_list>
ffffffffc020542e:	953e                	add	a0,a0,a5
ffffffffc0205430:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205432:	a029                	j	ffffffffc020543c <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc0205434:	f2c42783          	lw	a5,-212(s0)
ffffffffc0205438:	02978163          	beq	a5,s1,ffffffffc020545a <do_wait.part.0+0x7c>
ffffffffc020543c:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc020543e:	fe851be3          	bne	a0,s0,ffffffffc0205434 <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc0205442:	5579                	li	a0,-2
}
ffffffffc0205444:	60a6                	ld	ra,72(sp)
ffffffffc0205446:	6406                	ld	s0,64(sp)
ffffffffc0205448:	74e2                	ld	s1,56(sp)
ffffffffc020544a:	7942                	ld	s2,48(sp)
ffffffffc020544c:	79a2                	ld	s3,40(sp)
ffffffffc020544e:	7a02                	ld	s4,32(sp)
ffffffffc0205450:	6ae2                	ld	s5,24(sp)
ffffffffc0205452:	6b42                	ld	s6,16(sp)
ffffffffc0205454:	6ba2                	ld	s7,8(sp)
ffffffffc0205456:	6161                	addi	sp,sp,80
ffffffffc0205458:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc020545a:	000bb683          	ld	a3,0(s7)
ffffffffc020545e:	f4843783          	ld	a5,-184(s0)
ffffffffc0205462:	fed790e3          	bne	a5,a3,ffffffffc0205442 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205466:	f2842703          	lw	a4,-216(s0)
ffffffffc020546a:	478d                	li	a5,3
ffffffffc020546c:	0ef70b63          	beq	a4,a5,ffffffffc0205562 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc0205470:	4785                	li	a5,1
ffffffffc0205472:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc0205474:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc0205478:	2fd000ef          	jal	ra,ffffffffc0205f74 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc020547c:	000bb783          	ld	a5,0(s7)
ffffffffc0205480:	0b07a783          	lw	a5,176(a5)
ffffffffc0205484:	8b85                	andi	a5,a5,1
ffffffffc0205486:	d7c9                	beqz	a5,ffffffffc0205410 <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc0205488:	555d                	li	a0,-9
ffffffffc020548a:	e0bff0ef          	jal	ra,ffffffffc0205294 <do_exit>
        proc = current->cptr;
ffffffffc020548e:	000bb683          	ld	a3,0(s7)
ffffffffc0205492:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc0205494:	d45d                	beqz	s0,ffffffffc0205442 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205496:	470d                	li	a4,3
ffffffffc0205498:	a021                	j	ffffffffc02054a0 <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc020549a:	10043403          	ld	s0,256(s0)
ffffffffc020549e:	d869                	beqz	s0,ffffffffc0205470 <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054a0:	401c                	lw	a5,0(s0)
ffffffffc02054a2:	fee79ce3          	bne	a5,a4,ffffffffc020549a <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc02054a6:	000ad797          	auipc	a5,0xad
ffffffffc02054aa:	6d27b783          	ld	a5,1746(a5) # ffffffffc02b2b78 <idleproc>
ffffffffc02054ae:	0c878963          	beq	a5,s0,ffffffffc0205580 <do_wait.part.0+0x1a2>
ffffffffc02054b2:	000ad797          	auipc	a5,0xad
ffffffffc02054b6:	6ce7b783          	ld	a5,1742(a5) # ffffffffc02b2b80 <initproc>
ffffffffc02054ba:	0cf40363          	beq	s0,a5,ffffffffc0205580 <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc02054be:	000a0663          	beqz	s4,ffffffffc02054ca <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc02054c2:	0e842783          	lw	a5,232(s0)
ffffffffc02054c6:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8be0>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02054ca:	100027f3          	csrr	a5,sstatus
ffffffffc02054ce:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02054d0:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02054d2:	e7c1                	bnez	a5,ffffffffc020555a <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc02054d4:	6c70                	ld	a2,216(s0)
ffffffffc02054d6:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc02054d8:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc02054dc:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc02054de:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc02054e0:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc02054e2:	6470                	ld	a2,200(s0)
ffffffffc02054e4:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc02054e6:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc02054e8:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc02054ea:	c319                	beqz	a4,ffffffffc02054f0 <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc02054ec:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc02054ee:	7c7c                	ld	a5,248(s0)
ffffffffc02054f0:	c3b5                	beqz	a5,ffffffffc0205554 <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc02054f2:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc02054f6:	000ad717          	auipc	a4,0xad
ffffffffc02054fa:	69270713          	addi	a4,a4,1682 # ffffffffc02b2b88 <nr_process>
ffffffffc02054fe:	431c                	lw	a5,0(a4)
ffffffffc0205500:	37fd                	addiw	a5,a5,-1
ffffffffc0205502:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc0205504:	e5a9                	bnez	a1,ffffffffc020554e <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205506:	6814                	ld	a3,16(s0)
ffffffffc0205508:	c02007b7          	lui	a5,0xc0200
ffffffffc020550c:	04f6ee63          	bltu	a3,a5,ffffffffc0205568 <do_wait.part.0+0x18a>
ffffffffc0205510:	000ad797          	auipc	a5,0xad
ffffffffc0205514:	6307b783          	ld	a5,1584(a5) # ffffffffc02b2b40 <va_pa_offset>
ffffffffc0205518:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc020551a:	82b1                	srli	a3,a3,0xc
ffffffffc020551c:	000ad797          	auipc	a5,0xad
ffffffffc0205520:	60c7b783          	ld	a5,1548(a5) # ffffffffc02b2b28 <npage>
ffffffffc0205524:	06f6fa63          	bgeu	a3,a5,ffffffffc0205598 <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc0205528:	00003517          	auipc	a0,0x3
ffffffffc020552c:	72053503          	ld	a0,1824(a0) # ffffffffc0208c48 <nbase>
ffffffffc0205530:	8e89                	sub	a3,a3,a0
ffffffffc0205532:	069a                	slli	a3,a3,0x6
ffffffffc0205534:	000ad517          	auipc	a0,0xad
ffffffffc0205538:	5fc53503          	ld	a0,1532(a0) # ffffffffc02b2b30 <pages>
ffffffffc020553c:	9536                	add	a0,a0,a3
ffffffffc020553e:	4589                	li	a1,2
ffffffffc0205540:	833fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc0205544:	8522                	mv	a0,s0
ffffffffc0205546:	e6cfc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc020554a:	4501                	li	a0,0
ffffffffc020554c:	bde5                	j	ffffffffc0205444 <do_wait.part.0+0x66>
        intr_enable();
ffffffffc020554e:	8f2fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205552:	bf55                	j	ffffffffc0205506 <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc0205554:	701c                	ld	a5,32(s0)
ffffffffc0205556:	fbf8                	sd	a4,240(a5)
ffffffffc0205558:	bf79                	j	ffffffffc02054f6 <do_wait.part.0+0x118>
        intr_disable();
ffffffffc020555a:	8ecfb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc020555e:	4585                	li	a1,1
ffffffffc0205560:	bf95                	j	ffffffffc02054d4 <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205562:	f2840413          	addi	s0,s0,-216
ffffffffc0205566:	b781                	j	ffffffffc02054a6 <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc0205568:	00002617          	auipc	a2,0x2
ffffffffc020556c:	e5860613          	addi	a2,a2,-424 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0205570:	06e00593          	li	a1,110
ffffffffc0205574:	00002517          	auipc	a0,0x2
ffffffffc0205578:	dcc50513          	addi	a0,a0,-564 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc020557c:	efffa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc0205580:	00003617          	auipc	a2,0x3
ffffffffc0205584:	eb060613          	addi	a2,a2,-336 # ffffffffc0208430 <default_pmm_manager+0x1150>
ffffffffc0205588:	2fd00593          	li	a1,765
ffffffffc020558c:	00003517          	auipc	a0,0x3
ffffffffc0205590:	e2450513          	addi	a0,a0,-476 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205594:	ee7fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205598:	00002617          	auipc	a2,0x2
ffffffffc020559c:	e5060613          	addi	a2,a2,-432 # ffffffffc02073e8 <default_pmm_manager+0x108>
ffffffffc02055a0:	06200593          	li	a1,98
ffffffffc02055a4:	00002517          	auipc	a0,0x2
ffffffffc02055a8:	d9c50513          	addi	a0,a0,-612 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc02055ac:	ecffa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02055b0 <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc02055b0:	1141                	addi	sp,sp,-16
ffffffffc02055b2:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02055b4:	ffefc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc02055b8:	d46fc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc02055bc:	4601                	li	a2,0
ffffffffc02055be:	4581                	li	a1,0
ffffffffc02055c0:	fffff517          	auipc	a0,0xfffff
ffffffffc02055c4:	71650513          	addi	a0,a0,1814 # ffffffffc0204cd6 <user_main>
ffffffffc02055c8:	c7dff0ef          	jal	ra,ffffffffc0205244 <kernel_thread>
    if (pid <= 0) {
ffffffffc02055cc:	00a04563          	bgtz	a0,ffffffffc02055d6 <init_main+0x26>
ffffffffc02055d0:	a071                	j	ffffffffc020565c <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc02055d2:	1a3000ef          	jal	ra,ffffffffc0205f74 <schedule>
    if (code_store != NULL) {
ffffffffc02055d6:	4581                	li	a1,0
ffffffffc02055d8:	4501                	li	a0,0
ffffffffc02055da:	e05ff0ef          	jal	ra,ffffffffc02053de <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
ffffffffc02055de:	d975                	beqz	a0,ffffffffc02055d2 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc02055e0:	00003517          	auipc	a0,0x3
ffffffffc02055e4:	e9050513          	addi	a0,a0,-368 # ffffffffc0208470 <default_pmm_manager+0x1190>
ffffffffc02055e8:	b99fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc02055ec:	000ad797          	auipc	a5,0xad
ffffffffc02055f0:	5947b783          	ld	a5,1428(a5) # ffffffffc02b2b80 <initproc>
ffffffffc02055f4:	7bf8                	ld	a4,240(a5)
ffffffffc02055f6:	e339                	bnez	a4,ffffffffc020563c <init_main+0x8c>
ffffffffc02055f8:	7ff8                	ld	a4,248(a5)
ffffffffc02055fa:	e329                	bnez	a4,ffffffffc020563c <init_main+0x8c>
ffffffffc02055fc:	1007b703          	ld	a4,256(a5)
ffffffffc0205600:	ef15                	bnez	a4,ffffffffc020563c <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0205602:	000ad697          	auipc	a3,0xad
ffffffffc0205606:	5866a683          	lw	a3,1414(a3) # ffffffffc02b2b88 <nr_process>
ffffffffc020560a:	4709                	li	a4,2
ffffffffc020560c:	0ae69463          	bne	a3,a4,ffffffffc02056b4 <init_main+0x104>
    return listelm->next;
ffffffffc0205610:	000ad697          	auipc	a3,0xad
ffffffffc0205614:	4d868693          	addi	a3,a3,1240 # ffffffffc02b2ae8 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0205618:	6698                	ld	a4,8(a3)
ffffffffc020561a:	0c878793          	addi	a5,a5,200
ffffffffc020561e:	06f71b63          	bne	a4,a5,ffffffffc0205694 <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205622:	629c                	ld	a5,0(a3)
ffffffffc0205624:	04f71863          	bne	a4,a5,ffffffffc0205674 <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc0205628:	00003517          	auipc	a0,0x3
ffffffffc020562c:	f3050513          	addi	a0,a0,-208 # ffffffffc0208558 <default_pmm_manager+0x1278>
ffffffffc0205630:	b51fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc0205634:	60a2                	ld	ra,8(sp)
ffffffffc0205636:	4501                	li	a0,0
ffffffffc0205638:	0141                	addi	sp,sp,16
ffffffffc020563a:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020563c:	00003697          	auipc	a3,0x3
ffffffffc0205640:	e5c68693          	addi	a3,a3,-420 # ffffffffc0208498 <default_pmm_manager+0x11b8>
ffffffffc0205644:	00001617          	auipc	a2,0x1
ffffffffc0205648:	60460613          	addi	a2,a2,1540 # ffffffffc0206c48 <commands+0x450>
ffffffffc020564c:	36200593          	li	a1,866
ffffffffc0205650:	00003517          	auipc	a0,0x3
ffffffffc0205654:	d6050513          	addi	a0,a0,-672 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205658:	e23fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc020565c:	00003617          	auipc	a2,0x3
ffffffffc0205660:	df460613          	addi	a2,a2,-524 # ffffffffc0208450 <default_pmm_manager+0x1170>
ffffffffc0205664:	35a00593          	li	a1,858
ffffffffc0205668:	00003517          	auipc	a0,0x3
ffffffffc020566c:	d4850513          	addi	a0,a0,-696 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205670:	e0bfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205674:	00003697          	auipc	a3,0x3
ffffffffc0205678:	eb468693          	addi	a3,a3,-332 # ffffffffc0208528 <default_pmm_manager+0x1248>
ffffffffc020567c:	00001617          	auipc	a2,0x1
ffffffffc0205680:	5cc60613          	addi	a2,a2,1484 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205684:	36500593          	li	a1,869
ffffffffc0205688:	00003517          	auipc	a0,0x3
ffffffffc020568c:	d2850513          	addi	a0,a0,-728 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205690:	debfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0205694:	00003697          	auipc	a3,0x3
ffffffffc0205698:	e6468693          	addi	a3,a3,-412 # ffffffffc02084f8 <default_pmm_manager+0x1218>
ffffffffc020569c:	00001617          	auipc	a2,0x1
ffffffffc02056a0:	5ac60613          	addi	a2,a2,1452 # ffffffffc0206c48 <commands+0x450>
ffffffffc02056a4:	36400593          	li	a1,868
ffffffffc02056a8:	00003517          	auipc	a0,0x3
ffffffffc02056ac:	d0850513          	addi	a0,a0,-760 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc02056b0:	dcbfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc02056b4:	00003697          	auipc	a3,0x3
ffffffffc02056b8:	e3468693          	addi	a3,a3,-460 # ffffffffc02084e8 <default_pmm_manager+0x1208>
ffffffffc02056bc:	00001617          	auipc	a2,0x1
ffffffffc02056c0:	58c60613          	addi	a2,a2,1420 # ffffffffc0206c48 <commands+0x450>
ffffffffc02056c4:	36300593          	li	a1,867
ffffffffc02056c8:	00003517          	auipc	a0,0x3
ffffffffc02056cc:	ce850513          	addi	a0,a0,-792 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc02056d0:	dabfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02056d4 <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02056d4:	7171                	addi	sp,sp,-176
ffffffffc02056d6:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc02056d8:	000add97          	auipc	s11,0xad
ffffffffc02056dc:	498d8d93          	addi	s11,s11,1176 # ffffffffc02b2b70 <current>
ffffffffc02056e0:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02056e4:	e54e                	sd	s3,136(sp)
ffffffffc02056e6:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc02056e8:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02056ec:	e94a                	sd	s2,144(sp)
ffffffffc02056ee:	f4de                	sd	s7,104(sp)
ffffffffc02056f0:	892a                	mv	s2,a0
ffffffffc02056f2:	8bb2                	mv	s7,a2
ffffffffc02056f4:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc02056f6:	862e                	mv	a2,a1
ffffffffc02056f8:	4681                	li	a3,0
ffffffffc02056fa:	85aa                	mv	a1,a0
ffffffffc02056fc:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc02056fe:	f506                	sd	ra,168(sp)
ffffffffc0205700:	f122                	sd	s0,160(sp)
ffffffffc0205702:	e152                	sd	s4,128(sp)
ffffffffc0205704:	fcd6                	sd	s5,120(sp)
ffffffffc0205706:	f8da                	sd	s6,112(sp)
ffffffffc0205708:	f0e2                	sd	s8,96(sp)
ffffffffc020570a:	ece6                	sd	s9,88(sp)
ffffffffc020570c:	e8ea                	sd	s10,80(sp)
ffffffffc020570e:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205710:	bc8ff0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc0205714:	40050a63          	beqz	a0,ffffffffc0205b28 <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc0205718:	4641                	li	a2,16
ffffffffc020571a:	4581                	li	a1,0
ffffffffc020571c:	1808                	addi	a0,sp,48
ffffffffc020571e:	643000ef          	jal	ra,ffffffffc0206560 <memset>
    memcpy(local_name, name, len);
ffffffffc0205722:	47bd                	li	a5,15
ffffffffc0205724:	8626                	mv	a2,s1
ffffffffc0205726:	1e97e263          	bltu	a5,s1,ffffffffc020590a <do_execve+0x236>
ffffffffc020572a:	85ca                	mv	a1,s2
ffffffffc020572c:	1808                	addi	a0,sp,48
ffffffffc020572e:	645000ef          	jal	ra,ffffffffc0206572 <memcpy>
    if (mm != NULL) {
ffffffffc0205732:	1e098363          	beqz	s3,ffffffffc0205918 <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc0205736:	00002517          	auipc	a0,0x2
ffffffffc020573a:	33250513          	addi	a0,a0,818 # ffffffffc0207a68 <default_pmm_manager+0x788>
ffffffffc020573e:	a7bfa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc0205742:	000ad797          	auipc	a5,0xad
ffffffffc0205746:	3d67b783          	ld	a5,982(a5) # ffffffffc02b2b18 <boot_cr3>
ffffffffc020574a:	577d                	li	a4,-1
ffffffffc020574c:	177e                	slli	a4,a4,0x3f
ffffffffc020574e:	83b1                	srli	a5,a5,0xc
ffffffffc0205750:	8fd9                	or	a5,a5,a4
ffffffffc0205752:	18079073          	csrw	satp,a5
ffffffffc0205756:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7bb0>
ffffffffc020575a:	fff7871b          	addiw	a4,a5,-1
ffffffffc020575e:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205762:	2c070463          	beqz	a4,ffffffffc0205a2a <do_execve+0x356>
        current->mm = NULL;
ffffffffc0205766:	000db783          	ld	a5,0(s11)
ffffffffc020576a:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc020576e:	9b3fe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc0205772:	84aa                	mv	s1,a0
ffffffffc0205774:	1c050d63          	beqz	a0,ffffffffc020594e <do_execve+0x27a>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205778:	4505                	li	a0,1
ffffffffc020577a:	d66fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc020577e:	3a050963          	beqz	a0,ffffffffc0205b30 <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc0205782:	000adc97          	auipc	s9,0xad
ffffffffc0205786:	3aec8c93          	addi	s9,s9,942 # ffffffffc02b2b30 <pages>
ffffffffc020578a:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc020578e:	000adc17          	auipc	s8,0xad
ffffffffc0205792:	39ac0c13          	addi	s8,s8,922 # ffffffffc02b2b28 <npage>
    return page - pages + nbase;
ffffffffc0205796:	00003717          	auipc	a4,0x3
ffffffffc020579a:	4b273703          	ld	a4,1202(a4) # ffffffffc0208c48 <nbase>
ffffffffc020579e:	40d506b3          	sub	a3,a0,a3
ffffffffc02057a2:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02057a4:	5afd                	li	s5,-1
ffffffffc02057a6:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc02057aa:	96ba                	add	a3,a3,a4
ffffffffc02057ac:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc02057ae:	00cad713          	srli	a4,s5,0xc
ffffffffc02057b2:	ec3a                	sd	a4,24(sp)
ffffffffc02057b4:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc02057b6:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02057b8:	38f77063          	bgeu	a4,a5,ffffffffc0205b38 <do_execve+0x464>
ffffffffc02057bc:	000adb17          	auipc	s6,0xad
ffffffffc02057c0:	384b0b13          	addi	s6,s6,900 # ffffffffc02b2b40 <va_pa_offset>
ffffffffc02057c4:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc02057c8:	6605                	lui	a2,0x1
ffffffffc02057ca:	000ad597          	auipc	a1,0xad
ffffffffc02057ce:	3565b583          	ld	a1,854(a1) # ffffffffc02b2b20 <boot_pgdir>
ffffffffc02057d2:	9936                	add	s2,s2,a3
ffffffffc02057d4:	854a                	mv	a0,s2
ffffffffc02057d6:	59d000ef          	jal	ra,ffffffffc0206572 <memcpy>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc02057da:	7782                	ld	a5,32(sp)
ffffffffc02057dc:	4398                	lw	a4,0(a5)
ffffffffc02057de:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc02057e2:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc02057e6:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9427>
ffffffffc02057ea:	14f71863          	bne	a4,a5,ffffffffc020593a <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc02057ee:	7682                	ld	a3,32(sp)
ffffffffc02057f0:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc02057f4:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc02057f8:	00371793          	slli	a5,a4,0x3
ffffffffc02057fc:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc02057fe:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205800:	078e                	slli	a5,a5,0x3
ffffffffc0205802:	97ce                	add	a5,a5,s3
ffffffffc0205804:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc0205806:	00f9fc63          	bgeu	s3,a5,ffffffffc020581e <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc020580a:	0009a783          	lw	a5,0(s3)
ffffffffc020580e:	4705                	li	a4,1
ffffffffc0205810:	14e78163          	beq	a5,a4,ffffffffc0205952 <do_execve+0x27e>
    for (; ph < ph_end; ph ++) {
ffffffffc0205814:	77a2                	ld	a5,40(sp)
ffffffffc0205816:	03898993          	addi	s3,s3,56
ffffffffc020581a:	fef9e8e3          	bltu	s3,a5,ffffffffc020580a <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc020581e:	4701                	li	a4,0
ffffffffc0205820:	46ad                	li	a3,11
ffffffffc0205822:	00100637          	lui	a2,0x100
ffffffffc0205826:	7ff005b7          	lui	a1,0x7ff00
ffffffffc020582a:	8526                	mv	a0,s1
ffffffffc020582c:	acdfe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205830:	8a2a                	mv	s4,a0
ffffffffc0205832:	1e051263          	bnez	a0,ffffffffc0205a16 <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205836:	6c88                	ld	a0,24(s1)
ffffffffc0205838:	467d                	li	a2,31
ffffffffc020583a:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc020583e:	b0ffd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205842:	38050363          	beqz	a0,ffffffffc0205bc8 <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205846:	6c88                	ld	a0,24(s1)
ffffffffc0205848:	467d                	li	a2,31
ffffffffc020584a:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc020584e:	afffd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205852:	34050b63          	beqz	a0,ffffffffc0205ba8 <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205856:	6c88                	ld	a0,24(s1)
ffffffffc0205858:	467d                	li	a2,31
ffffffffc020585a:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc020585e:	aeffd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205862:	32050363          	beqz	a0,ffffffffc0205b88 <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205866:	6c88                	ld	a0,24(s1)
ffffffffc0205868:	467d                	li	a2,31
ffffffffc020586a:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc020586e:	adffd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205872:	2e050b63          	beqz	a0,ffffffffc0205b68 <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc0205876:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc0205878:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc020587c:	6c94                	ld	a3,24(s1)
ffffffffc020587e:	2785                	addiw	a5,a5,1
ffffffffc0205880:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc0205882:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205884:	c02007b7          	lui	a5,0xc0200
ffffffffc0205888:	2cf6e463          	bltu	a3,a5,ffffffffc0205b50 <do_execve+0x47c>
ffffffffc020588c:	000b3783          	ld	a5,0(s6)
ffffffffc0205890:	577d                	li	a4,-1
ffffffffc0205892:	177e                	slli	a4,a4,0x3f
ffffffffc0205894:	8e9d                	sub	a3,a3,a5
ffffffffc0205896:	00c6d793          	srli	a5,a3,0xc
ffffffffc020589a:	f654                	sd	a3,168(a2)
ffffffffc020589c:	8fd9                	or	a5,a5,a4
ffffffffc020589e:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc02058a2:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058a4:	4581                	li	a1,0
ffffffffc02058a6:	12000613          	li	a2,288
ffffffffc02058aa:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc02058ac:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058b0:	4b1000ef          	jal	ra,ffffffffc0206560 <memset>
    tf->epc = elf->e_entry;
ffffffffc02058b4:	7782                	ld	a5,32(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058b6:	000db903          	ld	s2,0(s11)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc02058ba:	edf4f493          	andi	s1,s1,-289
    tf->epc = elf->e_entry;
ffffffffc02058be:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;
ffffffffc02058c0:	4785                	li	a5,1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058c2:	0b490913          	addi	s2,s2,180 # ffffffff800000b4 <_binary_obj___user_exit_out_size+0xffffffff7fff4f5c>
    tf->gpr.sp = USTACKTOP;
ffffffffc02058c6:	07fe                	slli	a5,a5,0x1f
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc02058c8:	0204e493          	ori	s1,s1,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058cc:	4641                	li	a2,16
ffffffffc02058ce:	4581                	li	a1,0
    tf->gpr.sp = USTACKTOP;
ffffffffc02058d0:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc02058d2:	10e43423          	sd	a4,264(s0)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc02058d6:	10943023          	sd	s1,256(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058da:	854a                	mv	a0,s2
ffffffffc02058dc:	485000ef          	jal	ra,ffffffffc0206560 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02058e0:	463d                	li	a2,15
ffffffffc02058e2:	180c                	addi	a1,sp,48
ffffffffc02058e4:	854a                	mv	a0,s2
ffffffffc02058e6:	48d000ef          	jal	ra,ffffffffc0206572 <memcpy>
}
ffffffffc02058ea:	70aa                	ld	ra,168(sp)
ffffffffc02058ec:	740a                	ld	s0,160(sp)
ffffffffc02058ee:	64ea                	ld	s1,152(sp)
ffffffffc02058f0:	694a                	ld	s2,144(sp)
ffffffffc02058f2:	69aa                	ld	s3,136(sp)
ffffffffc02058f4:	7ae6                	ld	s5,120(sp)
ffffffffc02058f6:	7b46                	ld	s6,112(sp)
ffffffffc02058f8:	7ba6                	ld	s7,104(sp)
ffffffffc02058fa:	7c06                	ld	s8,96(sp)
ffffffffc02058fc:	6ce6                	ld	s9,88(sp)
ffffffffc02058fe:	6d46                	ld	s10,80(sp)
ffffffffc0205900:	6da6                	ld	s11,72(sp)
ffffffffc0205902:	8552                	mv	a0,s4
ffffffffc0205904:	6a0a                	ld	s4,128(sp)
ffffffffc0205906:	614d                	addi	sp,sp,176
ffffffffc0205908:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc020590a:	463d                	li	a2,15
ffffffffc020590c:	85ca                	mv	a1,s2
ffffffffc020590e:	1808                	addi	a0,sp,48
ffffffffc0205910:	463000ef          	jal	ra,ffffffffc0206572 <memcpy>
    if (mm != NULL) {
ffffffffc0205914:	e20991e3          	bnez	s3,ffffffffc0205736 <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc0205918:	000db783          	ld	a5,0(s11)
ffffffffc020591c:	779c                	ld	a5,40(a5)
ffffffffc020591e:	e40788e3          	beqz	a5,ffffffffc020576e <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc0205922:	00003617          	auipc	a2,0x3
ffffffffc0205926:	c5660613          	addi	a2,a2,-938 # ffffffffc0208578 <default_pmm_manager+0x1298>
ffffffffc020592a:	20c00593          	li	a1,524
ffffffffc020592e:	00003517          	auipc	a0,0x3
ffffffffc0205932:	a8250513          	addi	a0,a0,-1406 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205936:	b45fa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc020593a:	8526                	mv	a0,s1
ffffffffc020593c:	c18ff0ef          	jal	ra,ffffffffc0204d54 <put_pgdir>
    mm_destroy(mm);
ffffffffc0205940:	8526                	mv	a0,s1
ffffffffc0205942:	965fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc0205946:	5a61                	li	s4,-8
    do_exit(ret);
ffffffffc0205948:	8552                	mv	a0,s4
ffffffffc020594a:	94bff0ef          	jal	ra,ffffffffc0205294 <do_exit>
    int ret = -E_NO_MEM;
ffffffffc020594e:	5a71                	li	s4,-4
ffffffffc0205950:	bfe5                	j	ffffffffc0205948 <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc0205952:	0289b603          	ld	a2,40(s3)
ffffffffc0205956:	0209b783          	ld	a5,32(s3)
ffffffffc020595a:	1cf66d63          	bltu	a2,a5,ffffffffc0205b34 <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc020595e:	0049a783          	lw	a5,4(s3)
ffffffffc0205962:	0017f693          	andi	a3,a5,1
ffffffffc0205966:	c291                	beqz	a3,ffffffffc020596a <do_execve+0x296>
ffffffffc0205968:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc020596a:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc020596e:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205970:	e779                	bnez	a4,ffffffffc0205a3e <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205972:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205974:	c781                	beqz	a5,ffffffffc020597c <do_execve+0x2a8>
ffffffffc0205976:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc020597a:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc020597c:	0026f793          	andi	a5,a3,2
ffffffffc0205980:	e3f1                	bnez	a5,ffffffffc0205a44 <do_execve+0x370>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205982:	0046f793          	andi	a5,a3,4
ffffffffc0205986:	c399                	beqz	a5,ffffffffc020598c <do_execve+0x2b8>
ffffffffc0205988:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc020598c:	0109b583          	ld	a1,16(s3)
ffffffffc0205990:	4701                	li	a4,0
ffffffffc0205992:	8526                	mv	a0,s1
ffffffffc0205994:	965fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205998:	8a2a                	mv	s4,a0
ffffffffc020599a:	ed35                	bnez	a0,ffffffffc0205a16 <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc020599c:	0109bb83          	ld	s7,16(s3)
ffffffffc02059a0:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc02059a2:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059a6:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059aa:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059ae:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc02059b0:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059b2:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc02059b4:	054be963          	bltu	s7,s4,ffffffffc0205a06 <do_execve+0x332>
ffffffffc02059b8:	aa95                	j	ffffffffc0205b2c <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc02059ba:	6785                	lui	a5,0x1
ffffffffc02059bc:	415b8533          	sub	a0,s7,s5
ffffffffc02059c0:	9abe                	add	s5,s5,a5
ffffffffc02059c2:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc02059c6:	015a7463          	bgeu	s4,s5,ffffffffc02059ce <do_execve+0x2fa>
                size -= la - end;
ffffffffc02059ca:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc02059ce:	000cb683          	ld	a3,0(s9)
ffffffffc02059d2:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc02059d4:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc02059d8:	40d406b3          	sub	a3,s0,a3
ffffffffc02059dc:	8699                	srai	a3,a3,0x6
ffffffffc02059de:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc02059e0:	67e2                	ld	a5,24(sp)
ffffffffc02059e2:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc02059e6:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02059e8:	14b87863          	bgeu	a6,a1,ffffffffc0205b38 <do_execve+0x464>
ffffffffc02059ec:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc02059f0:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc02059f2:	9bb2                	add	s7,s7,a2
ffffffffc02059f4:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc02059f6:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc02059f8:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc02059fa:	379000ef          	jal	ra,ffffffffc0206572 <memcpy>
            start += size, from += size;
ffffffffc02059fe:	6622                	ld	a2,8(sp)
ffffffffc0205a00:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a02:	054bf363          	bgeu	s7,s4,ffffffffc0205a48 <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a06:	6c88                	ld	a0,24(s1)
ffffffffc0205a08:	866a                	mv	a2,s10
ffffffffc0205a0a:	85d6                	mv	a1,s5
ffffffffc0205a0c:	941fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a10:	842a                	mv	s0,a0
ffffffffc0205a12:	f545                	bnez	a0,ffffffffc02059ba <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0205a14:	5a71                	li	s4,-4
    exit_mmap(mm);
...
ffffffffc0205a24:	883fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205a28:	b705                	j	ffffffffc0205948 <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0205a2a:	854e                	mv	a0,s3
ffffffffc0205a2c:	a17fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205a30:	854e                	mv	a0,s3
ffffffffc0205a32:	b22ff0ef          	jal	ra,ffffffffc0204d54 <put_pgdir>
            mm_destroy(mm);
ffffffffc0205a36:	854e                	mv	a0,s3
ffffffffc0205a38:	86ffe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205a3c:	b32d                	j	ffffffffc0205766 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a3e:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a42:	fb95                	bnez	a5,ffffffffc0205976 <do_execve+0x2a2>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a44:	4d5d                	li	s10,23
ffffffffc0205a46:	bf35                	j	ffffffffc0205982 <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205a48:	0109b683          	ld	a3,16(s3)
ffffffffc0205a4c:	0289b903          	ld	s2,40(s3)
ffffffffc0205a50:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205a52:	075bfd63          	bgeu	s7,s5,ffffffffc0205acc <do_execve+0x3f8>
            if (start == end) {
ffffffffc0205a56:	db790fe3          	beq	s2,s7,ffffffffc0205814 <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205a5a:	6785                	lui	a5,0x1
ffffffffc0205a5c:	00fb8533          	add	a0,s7,a5
ffffffffc0205a60:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205a64:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205a68:	0b597d63          	bgeu	s2,s5,ffffffffc0205b22 <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0205a6c:	000cb683          	ld	a3,0(s9)
ffffffffc0205a70:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a72:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
...
ffffffffc0205a80:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a84:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a86:	0ac5f963          	bgeu	a1,a2,ffffffffc0205b38 <do_execve+0x464>
ffffffffc0205a8a:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205a8e:	8652                	mv	a2,s4
ffffffffc0205a90:	4581                	li	a1,0
ffffffffc0205a92:	96c2                	add	a3,a3,a6
ffffffffc0205a94:	9536                	add	a0,a0,a3
ffffffffc0205a96:	2cb000ef          	jal	ra,ffffffffc0206560 <memset>
            start += size;
ffffffffc0205a9a:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205a9e:	03597463          	bgeu	s2,s5,ffffffffc0205ac6 <do_execve+0x3f2>
ffffffffc0205aa2:	d6e909e3          	beq	s2,a4,ffffffffc0205814 <do_execve+0x140>
ffffffffc0205aa6:	00003697          	auipc	a3,0x3
ffffffffc0205aaa:	afa68693          	addi	a3,a3,-1286 # ffffffffc02085a0 <default_pmm_manager+0x12c0>
ffffffffc0205aae:	00001617          	auipc	a2,0x1
ffffffffc0205ab2:	19a60613          	addi	a2,a2,410 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205ab6:	26100593          	li	a1,609
ffffffffc0205aba:	00003517          	auipc	a0,0x3
ffffffffc0205abe:	8f650513          	addi	a0,a0,-1802 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205ac2:	9b9fa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205ac6:	ff5710e3          	bne	a4,s5,ffffffffc0205aa6 <do_execve+0x3d2>
ffffffffc0205aca:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205acc:	d52bf4e3          	bgeu	s7,s2,ffffffffc0205814 <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205ad0:	6c88                	ld	a0,24(s1)
ffffffffc0205ad2:	866a                	mv	a2,s10
ffffffffc0205ad4:	85d6                	mv	a1,s5
ffffffffc0205ad6:	877fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205ada:	842a                	mv	s0,a0
ffffffffc0205adc:	dd05                	beqz	a0,ffffffffc0205a14 <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
...
ffffffffc0205ae6:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205aea:	01597463          	bgeu	s2,s5,ffffffffc0205af2 <do_execve+0x41e>
                size -= la - end;
ffffffffc0205aee:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
...
ffffffffc0205b0a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b0c:	02b87663          	bgeu	a6,a1,ffffffffc0205b38 <do_execve+0x464>
...
ffffffffc0205b1c:	245000ef          	jal	ra,ffffffffc0206560 <memset>
ffffffffc0205b20:	b775                	j	ffffffffc0205acc <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205b22:	417a8a33          	sub	s4,s5,s7
ffffffffc0205b26:	b799                	j	ffffffffc0205a6c <do_execve+0x398>
        return -E_INVAL;
ffffffffc0205b28:	5a75                	li	s4,-3
ffffffffc0205b2a:	b3c1                	j	ffffffffc02058ea <do_execve+0x216>
        while (start < end) {
ffffffffc0205b2c:	86de                	mv	a3,s7
ffffffffc0205b2e:	bf39                	j	ffffffffc0205a4c <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0205b30:	5a71                	li	s4,-4
ffffffffc0205b32:	bdc5                	j	ffffffffc0205a22 <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0205b34:	5a61                	li	s4,-8
ffffffffc0205b36:	b5c5                	j	ffffffffc0205a16 <do_execve+0x342>
ffffffffc0205b38:	00001617          	auipc	a2,0x1
ffffffffc0205b3c:	7e060613          	addi	a2,a2,2016 # ffffffffc0207318 <default_pmm_manager+0x38>
ffffffffc0205b40:	06900593          	li	a1,105
ffffffffc0205b44:	00001517          	auipc	a0,0x1
ffffffffc0205b48:	7fc50513          	addi	a0,a0,2044 # ffffffffc0207340 <default_pmm_manager+0x60>
ffffffffc0205b4c:	92ffa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205b50:	00002617          	auipc	a2,0x2
ffffffffc0205b54:	87060613          	addi	a2,a2,-1936 # ffffffffc02073c0 <default_pmm_manager+0xe0>
ffffffffc0205b58:	27c00593          	li	a1,636
ffffffffc0205b5c:	00003517          	auipc	a0,0x3
ffffffffc0205b60:	85450513          	addi	a0,a0,-1964 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205b64:	917fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205b68:	00003697          	auipc	a3,0x3
ffffffffc0205b6c:	b5068693          	addi	a3,a3,-1200 # ffffffffc02086b8 <default_pmm_manager+0x13d8>
ffffffffc0205b70:	00001617          	auipc	a2,0x1
ffffffffc0205b74:	0d860613          	addi	a2,a2,216 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205b78:	27700593          	li	a1,631
ffffffffc0205b7c:	00003517          	auipc	a0,0x3
ffffffffc0205b80:	83450513          	addi	a0,a0,-1996 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205b84:	8f7fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205b88:	00003697          	auipc	a3,0x3
ffffffffc0205b8c:	ae868693          	addi	a3,a3,-1304 # ffffffffc0208670 <default_pmm_manager+0x1390>
ffffffffc0205b90:	00001617          	auipc	a2,0x1
ffffffffc0205b94:	0b860613          	addi	a2,a2,184 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205b98:	27600593          	li	a1,630
ffffffffc0205b9c:	00003517          	auipc	a0,0x3
ffffffffc0205ba0:	81450513          	addi	a0,a0,-2028 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205ba4:	8d7fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205ba8:	00003697          	auipc	a3,0x3
ffffffffc0205bac:	a8068693          	addi	a3,a3,-1408 # ffffffffc0208628 <default_pmm_manager+0x1348>
ffffffffc0205bb0:	00001617          	auipc	a2,0x1
ffffffffc0205bb4:	09860613          	addi	a2,a2,152 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205bb8:	27500593          	li	a1,629
ffffffffc0205bbc:	00002517          	auipc	a0,0x2
ffffffffc0205bc0:	7f450513          	addi	a0,a0,2036 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205bc4:	8b7fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205bc8:	00003697          	auipc	a3,0x3
ffffffffc0205bcc:	a1868693          	addi	a3,a3,-1512 # ffffffffc02085e0 <default_pmm_manager+0x1300>
ffffffffc0205bd0:	00001617          	auipc	a2,0x1
ffffffffc0205bd4:	07860613          	addi	a2,a2,120 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205bd8:	27400593          	li	a1,628
ffffffffc0205bdc:	00002517          	auipc	a0,0x2
ffffffffc0205be0:	7d450513          	addi	a0,a0,2004 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205be4:	897fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205be8 <do_yield>:
    current->need_resched = 1;
ffffffffc0205be8:	000ad797          	auipc	a5,0xad
ffffffffc0205bec:	f887b783          	ld	a5,-120(a5) # ffffffffc02b2b70 <current>
ffffffffc0205bf0:	4705                	li	a4,1
ffffffffc0205bf2:	ef98                	sd	a4,24(a5)
}
ffffffffc0205bf4:	4501                	li	a0,0
ffffffffc0205bf6:	8082                	ret

ffffffffc0205bf8 <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205bf8:	1101                	addi	sp,sp,-32
ffffffffc0205bfa:	e822                	sd	s0,16(sp)
ffffffffc0205bfc:	e426                	sd	s1,8(sp)
ffffffffc0205bfe:	ec06                	sd	ra,24(sp)
ffffffffc0205c00:	842e                	mv	s0,a1
ffffffffc0205c02:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c04:	c999                	beqz	a1,ffffffffc0205c1a <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c06:	000ad797          	auipc	a5,0xad
ffffffffc0205c0a:	f6a7b783          	ld	a5,-150(a5) # ffffffffc02b2b70 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c0e:	7788                	ld	a0,40(a5)
ffffffffc0205c10:	4685                	li	a3,1
ffffffffc0205c12:	4611                	li	a2,4
ffffffffc0205c14:	ec5fe0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc0205c18:	c909                	beqz	a0,ffffffffc0205c2a <do_wait+0x32>
ffffffffc0205c1a:	85a2                	mv	a1,s0
}
ffffffffc0205c1c:	6442                	ld	s0,16(sp)
ffffffffc0205c1e:	60e2                	ld	ra,24(sp)
ffffffffc0205c20:	8526                	mv	a0,s1
ffffffffc0205c22:	64a2                	ld	s1,8(sp)
ffffffffc0205c24:	6105                	addi	sp,sp,32
ffffffffc0205c26:	fb8ff06f          	j	ffffffffc02053de <do_wait.part.0>
ffffffffc0205c2a:	60e2                	ld	ra,24(sp)
ffffffffc0205c2c:	6442                	ld	s0,16(sp)
ffffffffc0205c2e:	64a2                	ld	s1,8(sp)
ffffffffc0205c30:	5575                	li	a0,-3
ffffffffc0205c32:	6105                	addi	sp,sp,32
ffffffffc0205c34:	8082                	ret

ffffffffc0205c36 <do_kill>:
do_kill(int pid) {
ffffffffc0205c36:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c38:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205c3a:	e406                	sd	ra,8(sp)
ffffffffc0205c3c:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c3e:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205c42:	17f9                	addi	a5,a5,-2
ffffffffc0205c44:	02e7e963          	bltu	a5,a4,ffffffffc0205c76 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205c48:	842a                	mv	s0,a0
ffffffffc0205c4a:	45a9                	li	a1,10
ffffffffc0205c4c:	2501                	sext.w	a0,a0
ffffffffc0205c4e:	492000ef          	jal	ra,ffffffffc02060e0 <hash32>
ffffffffc0205c52:	02051793          	slli	a5,a0,0x20
ffffffffc0205c56:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205c5a:	000a9797          	auipc	a5,0xa9
ffffffffc0205c5e:	e8e78793          	addi	a5,a5,-370 # ffffffffc02aeae8 <hash_list>
ffffffffc0205c62:	953e                	add	a0,a0,a5
ffffffffc0205c64:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205c66:	a029                	j	ffffffffc0205c70 <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205c68:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205c6c:	00870b63          	beq	a4,s0,ffffffffc0205c82 <do_kill+0x4c>
ffffffffc0205c70:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205c72:	fef51be3          	bne	a0,a5,ffffffffc0205c68 <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205c76:	5475                	li	s0,-3
}
ffffffffc0205c78:	60a2                	ld	ra,8(sp)
ffffffffc0205c7a:	8522                	mv	a0,s0
ffffffffc0205c7c:	6402                	ld	s0,0(sp)
ffffffffc0205c7e:	0141                	addi	sp,sp,16
ffffffffc0205c80:	8082                	ret
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205c82:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205c86:	00177693          	andi	a3,a4,1
ffffffffc0205c8a:	e295                	bnez	a3,ffffffffc0205cae <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205c8c:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205c8e:	00176713          	ori	a4,a4,1
ffffffffc0205c92:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205c96:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205c98:	fe06d0e3          	bgez	a3,ffffffffc0205c78 <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205c9c:	f2878513          	addi	a0,a5,-216
ffffffffc0205ca0:	254000ef          	jal	ra,ffffffffc0205ef4 <wakeup_proc>
}
ffffffffc0205ca4:	60a2                	ld	ra,8(sp)
ffffffffc0205ca6:	8522                	mv	a0,s0
ffffffffc0205ca8:	6402                	ld	s0,0(sp)
ffffffffc0205caa:	0141                	addi	sp,sp,16
ffffffffc0205cac:	8082                	ret
        return -E_KILLED;
ffffffffc0205cae:	545d                	li	s0,-9
ffffffffc0205cb0:	b7e1                	j	ffffffffc0205c78 <do_kill+0x42>

ffffffffc0205cb2 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205cb2:	7179                	addi	sp,sp,-48
ffffffffc0205cb4:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0205cb6:	000ad797          	auipc	a5,0xad
ffffffffc0205cba:	e3278793          	addi	a5,a5,-462 # ffffffffc02b2ae8 <proc_list>
ffffffffc0205cbe:	f406                	sd	ra,40(sp)
ffffffffc0205cc0:	f022                	sd	s0,32(sp)
ffffffffc0205cc2:	e84a                	sd	s2,16(sp)
ffffffffc0205cc4:	e44e                	sd	s3,8(sp)
ffffffffc0205cc6:	000a9497          	auipc	s1,0xa9
ffffffffc0205cca:	e2248493          	addi	s1,s1,-478 # ffffffffc02aeae8 <hash_list>
ffffffffc0205cce:	e79c                	sd	a5,8(a5)
ffffffffc0205cd0:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205cd2:	000ad717          	auipc	a4,0xad
ffffffffc0205cd6:	e1670713          	addi	a4,a4,-490 # ffffffffc02b2ae8 <proc_list>
ffffffffc0205cda:	87a6                	mv	a5,s1
ffffffffc0205cdc:	e79c                	sd	a5,8(a5)
ffffffffc0205cde:	e39c                	sd	a5,0(a5)
ffffffffc0205ce0:	07c1                	addi	a5,a5,16
ffffffffc0205ce2:	fee79de3          	bne	a5,a4,ffffffffc0205cdc <proc_init+0x2a>
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0205ce6:	10800513          	li	a0,264
ffffffffc0205cea:	e19fb0ef          	jal	ra,ffffffffc0201b02 <kmalloc>
ffffffffc0205cee:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0205cf0:	12050063          	beqz	a0,ffffffffc0205e10 <proc_init+0x15e>
        memset(proc, 0, sizeof(struct proc_struct));//初始化proc_struct结构体
ffffffffc0205cf4:	10800613          	li	a2,264
ffffffffc0205cf8:	4581                	li	a1,0
ffffffffc0205cfa:	067000ef          	jal	ra,ffffffffc0206560 <memset>
        proc->cr3 = boot_cr3;//进程的页目录表
ffffffffc0205cfe:	000ad797          	auipc	a5,0xad
ffffffffc0205d02:	e1a7b783          	ld	a5,-486(a5) # ffffffffc02b2b18 <boot_cr3>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205d06:	000ad917          	auipc	s2,0xad
ffffffffc0205d0a:	e7290913          	addi	s2,s2,-398 # ffffffffc02b2b78 <idleproc>
ffffffffc0205d0e:	00893023          	sd	s0,0(s2)
        proc->cr3 = boot_cr3;//进程的页目录表
ffffffffc0205d12:	f45c                	sd	a5,168(s0)
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205d14:	4789                	li	a5,2
ffffffffc0205d16:	e01c                	sd	a5,0(s0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d18:	00003797          	auipc	a5,0x3
ffffffffc0205d1c:	2e878793          	addi	a5,a5,744 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d20:	0b440993          	addi	s3,s0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d24:	e81c                	sd	a5,16(s0)
    idleproc->need_resched = 1;
ffffffffc0205d26:	4785                	li	a5,1
ffffffffc0205d28:	ec1c                	sd	a5,24(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d2a:	4641                	li	a2,16
ffffffffc0205d2c:	4581                	li	a1,0
ffffffffc0205d2e:	854e                	mv	a0,s3
ffffffffc0205d30:	031000ef          	jal	ra,ffffffffc0206560 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205d34:	463d                	li	a2,15
ffffffffc0205d36:	00003597          	auipc	a1,0x3
ffffffffc0205d3a:	9ca58593          	addi	a1,a1,-1590 # ffffffffc0208700 <default_pmm_manager+0x1420>
ffffffffc0205d3e:	854e                	mv	a0,s3
ffffffffc0205d40:	033000ef          	jal	ra,ffffffffc0206572 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205d44:	000ad717          	auipc	a4,0xad
ffffffffc0205d48:	e4470713          	addi	a4,a4,-444 # ffffffffc02b2b88 <nr_process>
ffffffffc0205d4c:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205d4e:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d52:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205d54:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d56:	4581                	li	a1,0
ffffffffc0205d58:	00000517          	auipc	a0,0x0
ffffffffc0205d5c:	85850513          	addi	a0,a0,-1960 # ffffffffc02055b0 <init_main>
    nr_process ++;
ffffffffc0205d60:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205d62:	000ad797          	auipc	a5,0xad
ffffffffc0205d66:	e0d7b723          	sd	a3,-498(a5) # ffffffffc02b2b70 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d6a:	cdaff0ef          	jal	ra,ffffffffc0205244 <kernel_thread>
ffffffffc0205d6e:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205d70:	08a05463          	blez	a0,ffffffffc0205df8 <proc_init+0x146>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205d74:	6789                	lui	a5,0x2
ffffffffc0205d76:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205d7a:	17f9                	addi	a5,a5,-2
ffffffffc0205d7c:	2501                	sext.w	a0,a0
ffffffffc0205d7e:	02e7e363          	bltu	a5,a4,ffffffffc0205da4 <proc_init+0xf2>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205d82:	45a9                	li	a1,10
ffffffffc0205d84:	35c000ef          	jal	ra,ffffffffc02060e0 <hash32>
ffffffffc0205d88:	02051793          	slli	a5,a0,0x20
ffffffffc0205d8c:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205d90:	96a6                	add	a3,a3,s1
ffffffffc0205d92:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205d94:	a029                	j	ffffffffc0205d9e <proc_init+0xec>
            if (proc->pid == pid) {
ffffffffc0205d96:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7cb4>
ffffffffc0205d9a:	04870c63          	beq	a4,s0,ffffffffc0205df2 <proc_init+0x140>
    return listelm->next;
ffffffffc0205d9e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205da0:	fef69be3          	bne	a3,a5,ffffffffc0205d96 <proc_init+0xe4>
    return NULL;
ffffffffc0205da4:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205da6:	0b478493          	addi	s1,a5,180
ffffffffc0205daa:	4641                	li	a2,16
ffffffffc0205dac:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205dae:	000ad417          	auipc	s0,0xad
ffffffffc0205db2:	dd240413          	addi	s0,s0,-558 # ffffffffc02b2b80 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205db6:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205db8:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205dba:	7a6000ef          	jal	ra,ffffffffc0206560 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205dbe:	463d                	li	a2,15
ffffffffc0205dc0:	00003597          	auipc	a1,0x3
ffffffffc0205dc4:	96858593          	addi	a1,a1,-1688 # ffffffffc0208728 <default_pmm_manager+0x1448>
ffffffffc0205dc8:	8526                	mv	a0,s1
ffffffffc0205dca:	7a8000ef          	jal	ra,ffffffffc0206572 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205dce:	00093783          	ld	a5,0(s2)
ffffffffc0205dd2:	cfbd                	beqz	a5,ffffffffc0205e50 <proc_init+0x19e>
ffffffffc0205dd4:	43dc                	lw	a5,4(a5)
ffffffffc0205dd6:	efad                	bnez	a5,ffffffffc0205e50 <proc_init+0x19e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205dd8:	601c                	ld	a5,0(s0)
ffffffffc0205dda:	cbb9                	beqz	a5,ffffffffc0205e30 <proc_init+0x17e>
ffffffffc0205ddc:	43d8                	lw	a4,4(a5)
ffffffffc0205dde:	4785                	li	a5,1
ffffffffc0205de0:	04f71863          	bne	a4,a5,ffffffffc0205e30 <proc_init+0x17e>
}
ffffffffc0205de4:	70a2                	ld	ra,40(sp)
ffffffffc0205de6:	7402                	ld	s0,32(sp)
ffffffffc0205de8:	64e2                	ld	s1,24(sp)
ffffffffc0205dea:	6942                	ld	s2,16(sp)
ffffffffc0205dec:	69a2                	ld	s3,8(sp)
ffffffffc0205dee:	6145                	addi	sp,sp,48
ffffffffc0205df0:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205df2:	f2878793          	addi	a5,a5,-216
ffffffffc0205df6:	bf45                	j	ffffffffc0205da6 <proc_init+0xf4>
        panic("create init_main failed.\n");
ffffffffc0205df8:	00003617          	auipc	a2,0x3
ffffffffc0205dfc:	91060613          	addi	a2,a2,-1776 # ffffffffc0208708 <default_pmm_manager+0x1428>
ffffffffc0205e00:	38500593          	li	a1,901
ffffffffc0205e04:	00002517          	auipc	a0,0x2
ffffffffc0205e08:	5ac50513          	addi	a0,a0,1452 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205e0c:	e6efa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e10:	00003617          	auipc	a2,0x3
ffffffffc0205e14:	97060613          	addi	a2,a2,-1680 # ffffffffc0208780 <default_pmm_manager+0x14a0>
ffffffffc0205e18:	37700593          	li	a1,887
ffffffffc0205e1c:	00002517          	auipc	a0,0x2
ffffffffc0205e20:	59450513          	addi	a0,a0,1428 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205e24:	000ad797          	auipc	a5,0xad
ffffffffc0205e28:	d407ba23          	sd	zero,-684(a5) # ffffffffc02b2b78 <idleproc>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e2c:	e4efa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e30:	00003697          	auipc	a3,0x3
ffffffffc0205e34:	92868693          	addi	a3,a3,-1752 # ffffffffc0208758 <default_pmm_manager+0x1478>
ffffffffc0205e38:	00001617          	auipc	a2,0x1
ffffffffc0205e3c:	e1060613          	addi	a2,a2,-496 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205e40:	38c00593          	li	a1,908
ffffffffc0205e44:	00002517          	auipc	a0,0x2
ffffffffc0205e48:	56c50513          	addi	a0,a0,1388 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205e4c:	e2efa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e50:	00003697          	auipc	a3,0x3
ffffffffc0205e54:	8e068693          	addi	a3,a3,-1824 # ffffffffc0208730 <default_pmm_manager+0x1450>
ffffffffc0205e58:	00001617          	auipc	a2,0x1
ffffffffc0205e5c:	df060613          	addi	a2,a2,-528 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205e60:	38b00593          	li	a1,907
ffffffffc0205e64:	00002517          	auipc	a0,0x2
ffffffffc0205e68:	54c50513          	addi	a0,a0,1356 # ffffffffc02083b0 <default_pmm_manager+0x10d0>
ffffffffc0205e6c:	e0efa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205e70 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205e70:	1141                	addi	sp,sp,-16
ffffffffc0205e72:	e022                	sd	s0,0(sp)
ffffffffc0205e74:	e406                	sd	ra,8(sp)
ffffffffc0205e76:	000ad417          	auipc	s0,0xad
ffffffffc0205e7a:	cfa40413          	addi	s0,s0,-774 # ffffffffc02b2b70 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205e7e:	6018                	ld	a4,0(s0)
ffffffffc0205e80:	6f1c                	ld	a5,24(a4)
ffffffffc0205e82:	dffd                	beqz	a5,ffffffffc0205e80 <cpu_idle+0x10>
            schedule();
ffffffffc0205e84:	0f0000ef          	jal	ra,ffffffffc0205f74 <schedule>
ffffffffc0205e88:	bfdd                	j	ffffffffc0205e7e <cpu_idle+0xe>

ffffffffc0205e8a <switch_to>:
.text
...
ffffffffc0205e8a:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205e8e:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205e92:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205e94:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205e96:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205e9a:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205e9e:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205ea2:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205ea6:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205eaa:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205eae:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205eb2:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205eb6:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205eba:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205ebe:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205ec2:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205ec6:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205ec8:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205eca:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205ece:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205ed2:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205ed6:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205eda:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205ede:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205ee2:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205ee6:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205eea:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205eee:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205ef2:	8082                	ret

ffffffffc0205ef4 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0205ef4:	4118                	lw	a4,0(a0)
wakeup_proc(struct proc_struct *proc) {
ffffffffc0205ef6:	1101                	addi	sp,sp,-32
ffffffffc0205ef8:	ec06                	sd	ra,24(sp)
ffffffffc0205efa:	e822                	sd	s0,16(sp)
ffffffffc0205efc:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205efe:	478d                	li	a5,3
ffffffffc0205f00:	04f70b63          	beq	a4,a5,ffffffffc0205f56 <wakeup_proc+0x62>
ffffffffc0205f04:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f06:	100027f3          	csrr	a5,sstatus
ffffffffc0205f0a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205f0c:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f0e:	ef9d                	bnez	a5,ffffffffc0205f4c <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f10:	4789                	li	a5,2
ffffffffc0205f12:	02f70163          	beq	a4,a5,ffffffffc0205f34 <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0205f16:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205f18:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0205f1c:	e491                	bnez	s1,ffffffffc0205f28 <wakeup_proc+0x34>
        else {
...
ffffffffc0205f1e:	60e2                	ld	ra,24(sp)
ffffffffc0205f20:	6442                	ld	s0,16(sp)
ffffffffc0205f22:	64a2                	ld	s1,8(sp)
ffffffffc0205f24:	6105                	addi	sp,sp,32
ffffffffc0205f26:	8082                	ret
ffffffffc0205f28:	6442                	ld	s0,16(sp)
ffffffffc0205f2a:	60e2                	ld	ra,24(sp)
ffffffffc0205f2c:	64a2                	ld	s1,8(sp)
ffffffffc0205f2e:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f30:	f10fa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f34:	00003617          	auipc	a2,0x3
ffffffffc0205f38:	89c60613          	addi	a2,a2,-1892 # ffffffffc02087d0 <default_pmm_manager+0x14f0>
ffffffffc0205f3c:	45c9                	li	a1,18
ffffffffc0205f3e:	00003517          	auipc	a0,0x3
ffffffffc0205f42:	87a50513          	addi	a0,a0,-1926 # ffffffffc02087b8 <default_pmm_manager+0x14d8>
ffffffffc0205f46:	d9cfa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205f4a:	bfc9                	j	ffffffffc0205f1c <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205f4c:	efafa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f50:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205f52:	4485                	li	s1,1
ffffffffc0205f54:	bf75                	j	ffffffffc0205f10 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f56:	00003697          	auipc	a3,0x3
ffffffffc0205f5a:	84268693          	addi	a3,a3,-1982 # ffffffffc0208798 <default_pmm_manager+0x14b8>
ffffffffc0205f5e:	00001617          	auipc	a2,0x1
ffffffffc0205f62:	cea60613          	addi	a2,a2,-790 # ffffffffc0206c48 <commands+0x450>
ffffffffc0205f66:	45a5                	li	a1,9
ffffffffc0205f68:	00003517          	auipc	a0,0x3
ffffffffc0205f6c:	85050513          	addi	a0,a0,-1968 # ffffffffc02087b8 <default_pmm_manager+0x14d8>
ffffffffc0205f70:	d0afa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205f74 <schedule>:

void
schedule(void) {
ffffffffc0205f74:	1141                	addi	sp,sp,-16
ffffffffc0205f76:	e406                	sd	ra,8(sp)
ffffffffc0205f78:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f7a:	100027f3          	csrr	a5,sstatus
ffffffffc0205f7e:	8b89                	andi	a5,a5,2
ffffffffc0205f80:	4401                	li	s0,0
ffffffffc0205f82:	efbd                	bnez	a5,ffffffffc0206000 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0205f84:	000ad897          	auipc	a7,0xad
ffffffffc0205f88:	bec8b883          	ld	a7,-1044(a7) # ffffffffc02b2b70 <current>
ffffffffc0205f8c:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205f90:	000ad517          	auipc	a0,0xad
ffffffffc0205f94:	be853503          	ld	a0,-1048(a0) # ffffffffc02b2b78 <idleproc>
ffffffffc0205f98:	04a88e63          	beq	a7,a0,ffffffffc0205ff4 <schedule+0x80>
ffffffffc0205f9c:	0c888693          	addi	a3,a7,200
ffffffffc0205fa0:	000ad617          	auipc	a2,0xad
ffffffffc0205fa4:	b4860613          	addi	a2,a2,-1208 # ffffffffc02b2ae8 <proc_list>
        le = last;
...
ffffffffc0205fac:	4809                	li	a6,2
ffffffffc0205fae:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0205fb0:	00c78863          	beq	a5,a2,ffffffffc0205fc0 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fb4:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0205fb8:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fbc:	03070163          	beq	a4,a6,ffffffffc0205fde <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0205fc0:	fef697e3          	bne	a3,a5,ffffffffc0205fae <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205fc4:	ed89                	bnez	a1,ffffffffc0205fde <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0205fc6:	451c                	lw	a5,8(a0)
ffffffffc0205fc8:	2785                	addiw	a5,a5,1
ffffffffc0205fca:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0205fcc:	00a88463          	beq	a7,a0,ffffffffc0205fd4 <schedule+0x60>
            proc_run(next);
ffffffffc0205fd0:	dfbfe0ef          	jal	ra,ffffffffc0204dca <proc_run>
    if (flag) {
ffffffffc0205fd4:	e819                	bnez	s0,ffffffffc0205fea <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0205fd6:	60a2                	ld	ra,8(sp)
ffffffffc0205fd8:	6402                	ld	s0,0(sp)
...
ffffffffc0205fe2:	fef712e3          	bne	a4,a5,ffffffffc0205fc6 <schedule+0x52>
ffffffffc0205fe6:	852e                	mv	a0,a1
ffffffffc0205fe8:	bff9                	j	ffffffffc0205fc6 <schedule+0x52>
}
ffffffffc0205fea:	6402                	ld	s0,0(sp)
ffffffffc0205fec:	60a2                	ld	ra,8(sp)
ffffffffc0205fee:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0205ff0:	e50fa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205ff4:	000ad617          	auipc	a2,0xad
ffffffffc0205ff8:	af460613          	addi	a2,a2,-1292 # ffffffffc02b2ae8 <proc_list>
ffffffffc0205ffc:	86b2                	mv	a3,a2
ffffffffc0205ffe:	b76d                	j	ffffffffc0205fa8 <schedule+0x34>
        intr_disable();
ffffffffc0206000:	e46fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0206004:	4405                	li	s0,1
ffffffffc0206006:	bfbd                	j	ffffffffc0205f84 <schedule+0x10>

ffffffffc0206008 <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0206008:	000ad797          	auipc	a5,0xad
ffffffffc020600c:	b687b783          	ld	a5,-1176(a5) # ffffffffc02b2b70 <current>
}
ffffffffc0206010:	43c8                	lw	a0,4(a5)
ffffffffc0206012:	8082                	ret

ffffffffc0206014 <sys_pgdir>:
...
ffffffffc0206014:	4501                	li	a0,0
ffffffffc0206016:	8082                	ret

ffffffffc0206018 <sys_putc>:
    cputchar(c);
ffffffffc0206018:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc020601a:	1141                	addi	sp,sp,-16
ffffffffc020601c:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020601e:	998fa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
...
ffffffffc020602a <sys_kill>:
    return do_kill(pid);
ffffffffc020602a:	4108                	lw	a0,0(a0)
ffffffffc020602c:	c0bff06f          	j	ffffffffc0205c36 <do_kill>

ffffffffc0206030 <sys_yield>:
    return do_yield();
ffffffffc0206030:	bb9ff06f          	j	ffffffffc0205be8 <do_yield>

ffffffffc0206034 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0206034:	6d14                	ld	a3,24(a0)
ffffffffc0206036:	6910                	ld	a2,16(a0)
ffffffffc0206038:	650c                	ld	a1,8(a0)
ffffffffc020603a:	6108                	ld	a0,0(a0)
ffffffffc020603c:	e98ff06f          	j	ffffffffc02056d4 <do_execve>

ffffffffc0206040 <sys_wait>:
    return do_wait(pid, store);
ffffffffc0206040:	650c                	ld	a1,8(a0)
ffffffffc0206042:	4108                	lw	a0,0(a0)
ffffffffc0206044:	bb5ff06f          	j	ffffffffc0205bf8 <do_wait>

ffffffffc0206048 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc0206048:	000ad797          	auipc	a5,0xad
ffffffffc020604c:	b287b783          	ld	a5,-1240(a5) # ffffffffc02b2b70 <current>
ffffffffc0206050:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc0206052:	4501                	li	a0,0
ffffffffc0206054:	6a0c                	ld	a1,16(a2)
ffffffffc0206056:	de1fe06f          	j	ffffffffc0204e36 <do_fork>

ffffffffc020605a <sys_exit>:
    return do_exit(error_code);
ffffffffc020605a:	4108                	lw	a0,0(a0)
ffffffffc020605c:	a38ff06f          	j	ffffffffc0205294 <do_exit>

ffffffffc0206060 <syscall>:
};
...
void
syscall(void) {
ffffffffc0206060:	715d                	addi	sp,sp,-80
ffffffffc0206062:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206064:	000ad497          	auipc	s1,0xad
ffffffffc0206068:	b0c48493          	addi	s1,s1,-1268 # ffffffffc02b2b70 <current>
ffffffffc020606c:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc020606e:	e0a2                	sd	s0,64(sp)
ffffffffc0206070:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206072:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc0206074:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc0206076:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc0206078:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc020607c:	0327ee63          	bltu	a5,s2,ffffffffc02060b8 <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc0206080:	00391713          	slli	a4,s2,0x3
ffffffffc0206084:	00002797          	auipc	a5,0x2
ffffffffc0206088:	7b478793          	addi	a5,a5,1972 # ffffffffc0208838 <syscalls>
ffffffffc020608c:	97ba                	add	a5,a5,a4
ffffffffc020608e:	639c                	ld	a5,0(a5)
ffffffffc0206090:	c785                	beqz	a5,ffffffffc02060b8 <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc0206092:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc0206094:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc0206096:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc0206098:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc020609a:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc020609c:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc020609e:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02060a0:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02060a2:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02060a4:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060a6:	0028                	addi	a0,sp,8
ffffffffc02060a8:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc02060aa:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060ac:	e828                	sd	a0,80(s0)
}
ffffffffc02060ae:	6406                	ld	s0,64(sp)
ffffffffc02060b0:	74e2                	ld	s1,56(sp)
ffffffffc02060b2:	7942                	ld	s2,48(sp)
ffffffffc02060b4:	6161                	addi	sp,sp,80
ffffffffc02060b6:	8082                	ret
    print_trapframe(tf);
ffffffffc02060b8:	8522                	mv	a0,s0
ffffffffc02060ba:	f7afa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02060be:	609c                	ld	a5,0(s1)
ffffffffc02060c0:	86ca                	mv	a3,s2
ffffffffc02060c2:	00002617          	auipc	a2,0x2
ffffffffc02060c6:	72e60613          	addi	a2,a2,1838 # ffffffffc02087f0 <default_pmm_manager+0x1510>
ffffffffc02060ca:	43d8                	lw	a4,4(a5)
ffffffffc02060cc:	06200593          	li	a1,98
ffffffffc02060d0:	0b478793          	addi	a5,a5,180
ffffffffc02060d4:	00002517          	auipc	a0,0x2
ffffffffc02060d8:	74c50513          	addi	a0,a0,1868 # ffffffffc0208820 <default_pmm_manager+0x1540>
ffffffffc02060dc:	b9efa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02060e0 <hash32>:
 *
...
ffffffffc02060e0:	9e3707b7          	lui	a5,0x9e370
ffffffffc02060e4:	2785                	addiw	a5,a5,1
ffffffffc02060e6:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02060ea:	02000793          	li	a5,32
ffffffffc02060ee:	9f8d                	subw	a5,a5,a1
}
ffffffffc02060f0:	00f5553b          	srlw	a0,a0,a5
ffffffffc02060f4:	8082                	ret

ffffffffc02060f6 <printnum>:
 * */
static void
...
ffffffffc02060f6:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02060fa:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02060fc:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206100:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0206102:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206106:	f022                	sd	s0,32(sp)
ffffffffc0206108:	ec26                	sd	s1,24(sp)
ffffffffc020610a:	e84a                	sd	s2,16(sp)
ffffffffc020610c:	f406                	sd	ra,40(sp)
ffffffffc020610e:	e44e                	sd	s3,8(sp)
ffffffffc0206110:	84aa                	mv	s1,a0
ffffffffc0206112:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0206114:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0206118:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc020611a:	03067e63          	bgeu	a2,a6,ffffffffc0206156 <printnum+0x60>
ffffffffc020611e:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0206120:	00805763          	blez	s0,ffffffffc020612e <printnum+0x38>
ffffffffc0206124:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0206126:	85ca                	mv	a1,s2
ffffffffc0206128:	854e                	mv	a0,s3
ffffffffc020612a:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc020612c:	fc65                	bnez	s0,ffffffffc0206124 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020612e:	1a02                	slli	s4,s4,0x20
ffffffffc0206130:	00003797          	auipc	a5,0x3
ffffffffc0206134:	80878793          	addi	a5,a5,-2040 # ffffffffc0208938 <syscalls+0x100>
ffffffffc0206138:	020a5a13          	srli	s4,s4,0x20
ffffffffc020613c:	9a3e                	add	s4,s4,a5
...
ffffffffc020613e:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206140:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0206144:	70a2                	ld	ra,40(sp)
ffffffffc0206146:	69a2                	ld	s3,8(sp)
ffffffffc0206148:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020614a:	85ca                	mv	a1,s2
ffffffffc020614c:	87a6                	mv	a5,s1
}
ffffffffc020614e:	6942                	ld	s2,16(sp)
ffffffffc0206150:	64e2                	ld	s1,24(sp)
ffffffffc0206152:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206154:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0206156:	03065633          	divu	a2,a2,a6
ffffffffc020615a:	8722                	mv	a4,s0
ffffffffc020615c:	f9bff0ef          	jal	ra,ffffffffc02060f6 <printnum>
ffffffffc0206160:	b7f9                	j	ffffffffc020612e <printnum+0x38>

ffffffffc0206162 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0206162:	7119                	addi	sp,sp,-128
ffffffffc0206164:	f4a6                	sd	s1,104(sp)
ffffffffc0206166:	f0ca                	sd	s2,96(sp)
ffffffffc0206168:	ecce                	sd	s3,88(sp)
ffffffffc020616a:	e8d2                	sd	s4,80(sp)
ffffffffc020616c:	e4d6                	sd	s5,72(sp)
ffffffffc020616e:	e0da                	sd	s6,64(sp)
ffffffffc0206170:	fc5e                	sd	s7,56(sp)
ffffffffc0206172:	f06a                	sd	s10,32(sp)
ffffffffc0206174:	fc86                	sd	ra,120(sp)
ffffffffc0206176:	f8a2                	sd	s0,112(sp)
ffffffffc0206178:	f862                	sd	s8,48(sp)
ffffffffc020617a:	f466                	sd	s9,40(sp)
ffffffffc020617c:	ec6e                	sd	s11,24(sp)
ffffffffc020617e:	892a                	mv	s2,a0
ffffffffc0206180:	84ae                	mv	s1,a1
ffffffffc0206182:	8d32                	mv	s10,a2
ffffffffc0206184:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0206186:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc020618a:	5b7d                	li	s6,-1
ffffffffc020618c:	00002a97          	auipc	s5,0x2
ffffffffc0206190:	7d8a8a93          	addi	s5,s5,2008 # ffffffffc0208964 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0206194:	00003b97          	auipc	s7,0x3
ffffffffc0206198:	9ecb8b93          	addi	s7,s7,-1556 # ffffffffc0208b80 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020619c:	000d4503          	lbu	a0,0(s10)
ffffffffc02061a0:	001d0413          	addi	s0,s10,1
ffffffffc02061a4:	01350a63          	beq	a0,s3,ffffffffc02061b8 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02061a8:	c121                	beqz	a0,ffffffffc02061e8 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02061aa:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061ac:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02061ae:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061b0:	fff44503          	lbu	a0,-1(s0)
ffffffffc02061b4:	ff351ae3          	bne	a0,s3,ffffffffc02061a8 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061b8:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02061bc:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02061c0:	4c81                	li	s9,0
ffffffffc02061c2:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02061c4:	5c7d                	li	s8,-1
ffffffffc02061c6:	5dfd                	li	s11,-1
ffffffffc02061c8:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02061cc:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061ce:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02061d2:	0ff5f593          	zext.b	a1,a1
ffffffffc02061d6:	00140d13          	addi	s10,s0,1
ffffffffc02061da:	04b56263          	bltu	a0,a1,ffffffffc020621e <vprintfmt+0xbc>
ffffffffc02061de:	058a                	slli	a1,a1,0x2
ffffffffc02061e0:	95d6                	add	a1,a1,s5
ffffffffc02061e2:	4194                	lw	a3,0(a1)
ffffffffc02061e4:	96d6                	add	a3,a3,s5
ffffffffc02061e6:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc02061e8:	70e6                	ld	ra,120(sp)
ffffffffc02061ea:	7446                	ld	s0,112(sp)
ffffffffc02061ec:	74a6                	ld	s1,104(sp)
ffffffffc02061ee:	7906                	ld	s2,96(sp)
ffffffffc02061f0:	69e6                	ld	s3,88(sp)
ffffffffc02061f2:	6a46                	ld	s4,80(sp)
ffffffffc02061f4:	6aa6                	ld	s5,72(sp)
ffffffffc02061f6:	6b06                	ld	s6,64(sp)
ffffffffc02061f8:	7be2                	ld	s7,56(sp)
ffffffffc02061fa:	7c42                	ld	s8,48(sp)
ffffffffc02061fc:	7ca2                	ld	s9,40(sp)
ffffffffc02061fe:	7d02                	ld	s10,32(sp)
ffffffffc0206200:	6de2                	ld	s11,24(sp)
ffffffffc0206202:	6109                	addi	sp,sp,128
ffffffffc0206204:	8082                	ret
            padc = '0';
ffffffffc0206206:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0206208:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020620c:	846a                	mv	s0,s10
ffffffffc020620e:	00140d13          	addi	s10,s0,1
ffffffffc0206212:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206216:	0ff5f593          	zext.b	a1,a1
ffffffffc020621a:	fcb572e3          	bgeu	a0,a1,ffffffffc02061de <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020621e:	85a6                	mv	a1,s1
ffffffffc0206220:	02500513          	li	a0,37
ffffffffc0206224:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206226:	fff44783          	lbu	a5,-1(s0)
ffffffffc020622a:	8d22                	mv	s10,s0
ffffffffc020622c:	f73788e3          	beq	a5,s3,ffffffffc020619c <vprintfmt+0x3a>
ffffffffc0206230:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206234:	1d7d                	addi	s10,s10,-1
ffffffffc0206236:	ff379de3          	bne	a5,s3,ffffffffc0206230 <vprintfmt+0xce>
ffffffffc020623a:	b78d                	j	ffffffffc020619c <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020623c:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0206240:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206244:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0206246:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020624a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020624e:	02d86463          	bltu	a6,a3,ffffffffc0206276 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0206252:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0206256:	002c169b          	slliw	a3,s8,0x2
ffffffffc020625a:	0186873b          	addw	a4,a3,s8
ffffffffc020625e:	0017171b          	slliw	a4,a4,0x1
ffffffffc0206262:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0206264:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0206268:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020626a:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020626e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206272:	fed870e3          	bgeu	a6,a3,ffffffffc0206252 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0206276:	f40ddce3          	bgez	s11,ffffffffc02061ce <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020627a:	8de2                	mv	s11,s8
ffffffffc020627c:	5c7d                	li	s8,-1
ffffffffc020627e:	bf81                	j	ffffffffc02061ce <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0206280:	fffdc693          	not	a3,s11
ffffffffc0206284:	96fd                	srai	a3,a3,0x3f
ffffffffc0206286:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020628a:	00144603          	lbu	a2,1(s0)
ffffffffc020628e:	2d81                	sext.w	s11,s11
ffffffffc0206290:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206292:	bf35                	j	ffffffffc02061ce <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0206294:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206298:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc020629c:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020629e:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02062a0:	bfd9                	j	ffffffffc0206276 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02062a2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062a4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062a8:	01174463          	blt	a4,a7,ffffffffc02062b0 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02062ac:	1a088e63          	beqz	a7,ffffffffc0206468 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02062b0:	000a3603          	ld	a2,0(s4)
ffffffffc02062b4:	46c1                	li	a3,16
ffffffffc02062b6:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02062b8:	2781                	sext.w	a5,a5
ffffffffc02062ba:	876e                	mv	a4,s11
ffffffffc02062bc:	85a6                	mv	a1,s1
ffffffffc02062be:	854a                	mv	a0,s2
ffffffffc02062c0:	e37ff0ef          	jal	ra,ffffffffc02060f6 <printnum>
            break;
ffffffffc02062c4:	bde1                	j	ffffffffc020619c <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02062c6:	000a2503          	lw	a0,0(s4)
ffffffffc02062ca:	85a6                	mv	a1,s1
ffffffffc02062cc:	0a21                	addi	s4,s4,8
ffffffffc02062ce:	9902                	jalr	s2
            break;
ffffffffc02062d0:	b5f1                	j	ffffffffc020619c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02062d2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062d4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062d8:	01174463          	blt	a4,a7,ffffffffc02062e0 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02062dc:	18088163          	beqz	a7,ffffffffc020645e <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02062e0:	000a3603          	ld	a2,0(s4)
ffffffffc02062e4:	46a9                	li	a3,10
ffffffffc02062e6:	8a2e                	mv	s4,a1
ffffffffc02062e8:	bfc1                	j	ffffffffc02062b8 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062ea:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02062ee:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062f0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062f2:	bdf1                	j	ffffffffc02061ce <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc02062f4:	85a6                	mv	a1,s1
ffffffffc02062f6:	02500513          	li	a0,37
ffffffffc02062fa:	9902                	jalr	s2
            break;
ffffffffc02062fc:	b545                	j	ffffffffc020619c <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062fe:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0206302:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206304:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206306:	b5e1                	j	ffffffffc02061ce <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0206308:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020630a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020630e:	01174463          	blt	a4,a7,ffffffffc0206316 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0206312:	14088163          	beqz	a7,ffffffffc0206454 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0206316:	000a3603          	ld	a2,0(s4)
ffffffffc020631a:	46a1                	li	a3,8
ffffffffc020631c:	8a2e                	mv	s4,a1
ffffffffc020631e:	bf69                	j	ffffffffc02062b8 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0206320:	03000513          	li	a0,48
ffffffffc0206324:	85a6                	mv	a1,s1
ffffffffc0206326:	e03e                	sd	a5,0(sp)
ffffffffc0206328:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc020632a:	85a6                	mv	a1,s1
ffffffffc020632c:	07800513          	li	a0,120
ffffffffc0206330:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206332:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206334:	6782                	ld	a5,0(sp)
ffffffffc0206336:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206338:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020633c:	bfb5                	j	ffffffffc02062b8 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020633e:	000a3403          	ld	s0,0(s4)
ffffffffc0206342:	008a0713          	addi	a4,s4,8
ffffffffc0206346:	e03a                	sd	a4,0(sp)
ffffffffc0206348:	14040263          	beqz	s0,ffffffffc020648c <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc020634c:	0fb05763          	blez	s11,ffffffffc020643a <vprintfmt+0x2d8>
ffffffffc0206350:	02d00693          	li	a3,45
ffffffffc0206354:	0cd79163          	bne	a5,a3,ffffffffc0206416 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206358:	00044783          	lbu	a5,0(s0)
ffffffffc020635c:	0007851b          	sext.w	a0,a5
ffffffffc0206360:	cf85                	beqz	a5,ffffffffc0206398 <vprintfmt+0x236>
ffffffffc0206362:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206366:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020636a:	000c4563          	bltz	s8,ffffffffc0206374 <vprintfmt+0x212>
ffffffffc020636e:	3c7d                	addiw	s8,s8,-1
ffffffffc0206370:	036c0263          	beq	s8,s6,ffffffffc0206394 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0206374:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206376:	0e0c8e63          	beqz	s9,ffffffffc0206472 <vprintfmt+0x310>
ffffffffc020637a:	3781                	addiw	a5,a5,-32
ffffffffc020637c:	0ef47b63          	bgeu	s0,a5,ffffffffc0206472 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0206380:	03f00513          	li	a0,63
ffffffffc0206384:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206386:	000a4783          	lbu	a5,0(s4)
ffffffffc020638a:	3dfd                	addiw	s11,s11,-1
ffffffffc020638c:	0a05                	addi	s4,s4,1
ffffffffc020638e:	0007851b          	sext.w	a0,a5
ffffffffc0206392:	ffe1                	bnez	a5,ffffffffc020636a <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0206394:	01b05963          	blez	s11,ffffffffc02063a6 <vprintfmt+0x244>
...
ffffffffc02063a0:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063a2:	fe0d9be3          	bnez	s11,ffffffffc0206398 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02063a6:	6a02                	ld	s4,0(sp)
ffffffffc02063a8:	bbd5                	j	ffffffffc020619c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02063aa:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02063ac:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02063b0:	01174463          	blt	a4,a7,ffffffffc02063b8 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02063b4:	08088d63          	beqz	a7,ffffffffc020644e <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02063b8:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02063bc:	0a044d63          	bltz	s0,ffffffffc0206476 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02063c0:	8622                	mv	a2,s0
ffffffffc02063c2:	8a66                	mv	s4,s9
ffffffffc02063c4:	46a9                	li	a3,10
ffffffffc02063c6:	bdcd                	j	ffffffffc02062b8 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02063c8:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063cc:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02063ce:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02063d0:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02063d4:	8fb5                	xor	a5,a5,a3
ffffffffc02063d6:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063da:	02d74163          	blt	a4,a3,ffffffffc02063fc <vprintfmt+0x29a>
ffffffffc02063de:	00369793          	slli	a5,a3,0x3
ffffffffc02063e2:	97de                	add	a5,a5,s7
ffffffffc02063e4:	639c                	ld	a5,0(a5)
ffffffffc02063e6:	cb99                	beqz	a5,ffffffffc02063fc <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc02063e8:	86be                	mv	a3,a5
ffffffffc02063ea:	00000617          	auipc	a2,0x0
ffffffffc02063ee:	1ce60613          	addi	a2,a2,462 # ffffffffc02065b8 <etext+0x2e>
ffffffffc02063f2:	85a6                	mv	a1,s1
ffffffffc02063f4:	854a                	mv	a0,s2
ffffffffc02063f6:	0ce000ef          	jal	ra,ffffffffc02064c4 <printfmt>
ffffffffc02063fa:	b34d                	j	ffffffffc020619c <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc02063fc:	00002617          	auipc	a2,0x2
ffffffffc0206400:	55c60613          	addi	a2,a2,1372 # ffffffffc0208958 <syscalls+0x120>
ffffffffc0206404:	85a6                	mv	a1,s1
ffffffffc0206406:	854a                	mv	a0,s2
ffffffffc0206408:	0bc000ef          	jal	ra,ffffffffc02064c4 <printfmt>
ffffffffc020640c:	bb41                	j	ffffffffc020619c <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020640e:	00002417          	auipc	s0,0x2
ffffffffc0206412:	54240413          	addi	s0,s0,1346 # ffffffffc0208950 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206416:	85e2                	mv	a1,s8
ffffffffc0206418:	8522                	mv	a0,s0
ffffffffc020641a:	e43e                	sd	a5,8(sp)
ffffffffc020641c:	0e2000ef          	jal	ra,ffffffffc02064fe <strnlen>
ffffffffc0206420:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206424:	01b05b63          	blez	s11,ffffffffc020643a <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0206428:	67a2                	ld	a5,8(sp)
ffffffffc020642a:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020642e:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0206430:	85a6                	mv	a1,s1
ffffffffc0206432:	8552                	mv	a0,s4
ffffffffc0206434:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206436:	fe0d9ce3          	bnez	s11,ffffffffc020642e <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020643a:	00044783          	lbu	a5,0(s0)
ffffffffc020643e:	00140a13          	addi	s4,s0,1
ffffffffc0206442:	0007851b          	sext.w	a0,a5
ffffffffc0206446:	d3a5                	beqz	a5,ffffffffc02063a6 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206448:	05e00413          	li	s0,94
ffffffffc020644c:	bf39                	j	ffffffffc020636a <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020644e:	000a2403          	lw	s0,0(s4)
ffffffffc0206452:	b7ad                	j	ffffffffc02063bc <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0206454:	000a6603          	lwu	a2,0(s4)
ffffffffc0206458:	46a1                	li	a3,8
ffffffffc020645a:	8a2e                	mv	s4,a1
ffffffffc020645c:	bdb1                	j	ffffffffc02062b8 <vprintfmt+0x156>
ffffffffc020645e:	000a6603          	lwu	a2,0(s4)
ffffffffc0206462:	46a9                	li	a3,10
ffffffffc0206464:	8a2e                	mv	s4,a1
ffffffffc0206466:	bd89                	j	ffffffffc02062b8 <vprintfmt+0x156>
ffffffffc0206468:	000a6603          	lwu	a2,0(s4)
ffffffffc020646c:	46c1                	li	a3,16
ffffffffc020646e:	8a2e                	mv	s4,a1
ffffffffc0206470:	b5a1                	j	ffffffffc02062b8 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0206472:	9902                	jalr	s2
ffffffffc0206474:	bf09                	j	ffffffffc0206386 <vprintfmt+0x224>
                putch('-', putdat);
...
ffffffffc020647e:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0206480:	6782                	ld	a5,0(sp)
ffffffffc0206482:	8a66                	mv	s4,s9
ffffffffc0206484:	40800633          	neg	a2,s0
ffffffffc0206488:	46a9                	li	a3,10
ffffffffc020648a:	b53d                	j	ffffffffc02062b8 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc020648c:	03b05163          	blez	s11,ffffffffc02064ae <vprintfmt+0x34c>
ffffffffc0206490:	02d00693          	li	a3,45
ffffffffc0206494:	f6d79de3          	bne	a5,a3,ffffffffc020640e <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0206498:	00002417          	auipc	s0,0x2
ffffffffc020649c:	4b840413          	addi	s0,s0,1208 # ffffffffc0208950 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064a0:	02800793          	li	a5,40
ffffffffc02064a4:	02800513          	li	a0,40
ffffffffc02064a8:	00140a13          	addi	s4,s0,1
ffffffffc02064ac:	bd6d                	j	ffffffffc0206366 <vprintfmt+0x204>
ffffffffc02064ae:	00002a17          	auipc	s4,0x2
ffffffffc02064b2:	4a3a0a13          	addi	s4,s4,1187 # ffffffffc0208951 <syscalls+0x119>
ffffffffc02064b6:	02800513          	li	a0,40
ffffffffc02064ba:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064be:	05e00413          	li	s0,94
ffffffffc02064c2:	b565                	j	ffffffffc020636a <vprintfmt+0x208>

ffffffffc02064c4 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064c4:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02064c6:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064ca:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064cc:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064ce:	ec06                	sd	ra,24(sp)
ffffffffc02064d0:	f83a                	sd	a4,48(sp)
ffffffffc02064d2:	fc3e                	sd	a5,56(sp)
ffffffffc02064d4:	e0c2                	sd	a6,64(sp)
ffffffffc02064d6:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02064d8:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064da:	c89ff0ef          	jal	ra,ffffffffc0206162 <vprintfmt>
}
ffffffffc02064de:	60e2                	ld	ra,24(sp)
ffffffffc02064e0:	6161                	addi	sp,sp,80
ffffffffc02064e2:	8082                	ret

ffffffffc02064e4 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc02064e4:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc02064e8:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02064ea:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02064ec:	cb81                	beqz	a5,ffffffffc02064fc <strlen+0x18>
        cnt ++;
ffffffffc02064ee:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02064f0:	00a707b3          	add	a5,a4,a0
ffffffffc02064f4:	0007c783          	lbu	a5,0(a5)
ffffffffc02064f8:	fbfd                	bnez	a5,ffffffffc02064ee <strlen+0xa>
ffffffffc02064fa:	8082                	ret
    }
    return cnt;
}
ffffffffc02064fc:	8082                	ret

ffffffffc02064fe <strnlen>:
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc02064fe:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206500:	e589                	bnez	a1,ffffffffc020650a <strnlen+0xc>
ffffffffc0206502:	a811                	j	ffffffffc0206516 <strnlen+0x18>
        cnt ++;
ffffffffc0206504:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206506:	00f58863          	beq	a1,a5,ffffffffc0206516 <strnlen+0x18>
ffffffffc020650a:	00f50733          	add	a4,a0,a5
ffffffffc020650e:	00074703          	lbu	a4,0(a4)
ffffffffc0206512:	fb6d                	bnez	a4,ffffffffc0206504 <strnlen+0x6>
ffffffffc0206514:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0206516:	852e                	mv	a0,a1
ffffffffc0206518:	8082                	ret

ffffffffc020651a <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc020651a:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020651c:	0005c703          	lbu	a4,0(a1)
ffffffffc0206520:	0785                	addi	a5,a5,1
ffffffffc0206522:	0585                	addi	a1,a1,1
ffffffffc0206524:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0206528:	fb75                	bnez	a4,ffffffffc020651c <strcpy+0x2>
        /* nothing */;
    return dst;
#endif /* __HAVE_ARCH_STRCPY */
}
ffffffffc020652a:	8082                	ret

ffffffffc020652c <strcmp>:
int
...
ffffffffc0206530:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206534:	cb89                	beqz	a5,ffffffffc0206546 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0206536:	0505                	addi	a0,a0,1
ffffffffc0206538:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020653a:	fee789e3          	beq	a5,a4,ffffffffc020652c <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020653e:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0206542:	9d19                	subw	a0,a0,a4
ffffffffc0206544:	8082                	ret
ffffffffc0206546:	4501                	li	a0,0
ffffffffc0206548:	bfed                	j	ffffffffc0206542 <strcmp+0x16>
...
ffffffffc020654e:	c799                	beqz	a5,ffffffffc020655c <strchr+0x12>
        if (*s == c) {
ffffffffc0206550:	00f58763          	beq	a1,a5,ffffffffc020655e <strchr+0x14>
    while (*s != '\0') {
ffffffffc0206554:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0206558:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020655a:	fbfd                	bnez	a5,ffffffffc0206550 <strchr+0x6>
    }
    return NULL;
ffffffffc020655c:	4501                	li	a0,0
}
ffffffffc020655e:	8082                	ret

ffffffffc0206560 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0206560:	ca01                	beqz	a2,ffffffffc0206570 <memset+0x10>
ffffffffc0206562:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0206564:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0206566:	0785                	addi	a5,a5,1
ffffffffc0206568:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020656c:	fec79de3          	bne	a5,a2,ffffffffc0206566 <memset+0x6>
    }
    return s;
...
ffffffffc0206572 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0206572:	ca19                	beqz	a2,ffffffffc0206588 <memcpy+0x16>
ffffffffc0206574:	962e                	add	a2,a2,a1
    char *d = dst;
...
ffffffffc0206580:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0206584:	fec59ae3          	bne	a1,a2,ffffffffc0206578 <memcpy+0x6>
    }
    return dst;
