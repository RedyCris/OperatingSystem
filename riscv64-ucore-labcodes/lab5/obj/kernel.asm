...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	722060ef          	jal	ra,ffffffffc020676c <memset>
...
ffffffffc0200056:	74658593          	addi	a1,a1,1862 # ffffffffc0206798 <etext+0x2>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	75e50513          	addi	a0,a0,1886 # ffffffffc02067b8 <etext+0x22>
...
ffffffffc020007a:	66b050ef          	jal	ra,ffffffffc0205ee4 <proc_init>
...
ffffffffc020008e:	7ef050ef          	jal	ra,ffffffffc020607c <cpu_idle>
...
ffffffffc02000ac:	71850513          	addi	a0,a0,1816 # ffffffffc02067c0 <etext+0x2a>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	1fa060ef          	jal	ra,ffffffffc020636e <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	1c4060ef          	jal	ra,ffffffffc020636e <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	5be50513          	addi	a0,a0,1470 # ffffffffc02067c8 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc0200224:	5c850513          	addi	a0,a0,1480 # ffffffffc02067e8 <etext+0x52>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	56a58593          	addi	a1,a1,1386 # ffffffffc0206796 <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	5d450513          	addi	a0,a0,1492 # ffffffffc0206808 <etext+0x72>
...
ffffffffc020024c:	5e050513          	addi	a0,a0,1504 # ffffffffc0206828 <etext+0x92>
...
ffffffffc0200260:	5ec50513          	addi	a0,a0,1516 # ffffffffc0206848 <etext+0xb2>
...
ffffffffc020028e:	5de50513          	addi	a0,a0,1502 # ffffffffc0206868 <etext+0xd2>
}
...
ffffffffc020029c:	60060613          	addi	a2,a2,1536 # ffffffffc0206898 <etext+0x102>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	60c50513          	addi	a0,a0,1548 # ffffffffc02068b0 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc02002b8:	61460613          	addi	a2,a2,1556 # ffffffffc02068c8 <etext+0x132>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	62c58593          	addi	a1,a1,1580 # ffffffffc02068e8 <etext+0x152>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	62c50513          	addi	a0,a0,1580 # ffffffffc02068f0 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	62e60613          	addi	a2,a2,1582 # ffffffffc0206900 <etext+0x16a>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	64e58593          	addi	a1,a1,1614 # ffffffffc0206928 <etext+0x192>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	60e50513          	addi	a0,a0,1550 # ffffffffc02068f0 <etext+0x15a>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	64a60613          	addi	a2,a2,1610 # ffffffffc0206938 <etext+0x1a2>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	66258593          	addi	a1,a1,1634 # ffffffffc0206958 <etext+0x1c2>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	5f250513          	addi	a0,a0,1522 # ffffffffc02068f0 <etext+0x15a>
...
ffffffffc020033c:	63050513          	addi	a0,a0,1584 # ffffffffc0206968 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	63650513          	addi	a0,a0,1590 # ffffffffc0206990 <etext+0x1fa>
...
ffffffffc0200374:	690c0c13          	addi	s8,s8,1680 # ffffffffc0206a00 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200378:	00006917          	auipc	s2,0x6
ffffffffc020037c:	64090913          	addi	s2,s2,1600 # ffffffffc02069b8 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	64048493          	addi	s1,s1,1600 # ffffffffc02069c0 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	63eb0b13          	addi	s6,s6,1598 # ffffffffc02069c8 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	556a0a13          	addi	s4,s4,1366 # ffffffffc02068e8 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003b8:	64cd0d13          	addi	s10,s10,1612 # ffffffffc0206a00 <commands>
        argv[argc ++] = buf;
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	376060ef          	jal	ra,ffffffffc0206738 <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	362060ef          	jal	ra,ffffffffc0206738 <strcmp>
...
ffffffffc0200414:	342060ef          	jal	ra,ffffffffc0206756 <strchr>
...
ffffffffc0200452:	304060ef          	jal	ra,ffffffffc0206756 <strchr>
...
ffffffffc0200470:	57c50513          	addi	a0,a0,1404 # ffffffffc02069e8 <etext+0x252>
...
ffffffffc02004ac:	5a050513          	addi	a0,a0,1440 # ffffffffc0206a48 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02004c2:	54250513          	addi	a0,a0,1346 # ffffffffc0207a00 <default_pmm_manager+0x518>
...
ffffffffc02004f6:	57650513          	addi	a0,a0,1398 # ffffffffc0206a68 <commands+0x68>
__warn(const char *file, int line, const char *fmt, ...) {
...
ffffffffc0200516:	4ee50513          	addi	a0,a0,1262 # ffffffffc0207a00 <default_pmm_manager+0x518>
...
ffffffffc0200550:	53c50513          	addi	a0,a0,1340 # ffffffffc0206a88 <commands+0x88>
    ticks = 0;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	16e060ef          	jal	ra,ffffffffc020677e <memcpy>
    return 0;
}
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	14a060ef          	jal	ra,ffffffffc020677e <memcpy>
    return 0;
}
...
ffffffffc0200674:	43850513          	addi	a0,a0,1080 # ffffffffc0206aa8 <commands+0xa8>
void print_regs(struct pushregs* gpr) {
...
ffffffffc0200684:	44050513          	addi	a0,a0,1088 # ffffffffc0206ac0 <commands+0xc0>
...
ffffffffc0200692:	44a50513          	addi	a0,a0,1098 # ffffffffc0206ad8 <commands+0xd8>
...
ffffffffc02006a0:	45450513          	addi	a0,a0,1108 # ffffffffc0206af0 <commands+0xf0>
...
ffffffffc02006ae:	45e50513          	addi	a0,a0,1118 # ffffffffc0206b08 <commands+0x108>
...
ffffffffc02006bc:	46850513          	addi	a0,a0,1128 # ffffffffc0206b20 <commands+0x120>
...
ffffffffc02006ca:	47250513          	addi	a0,a0,1138 # ffffffffc0206b38 <commands+0x138>
...
ffffffffc02006d8:	47c50513          	addi	a0,a0,1148 # ffffffffc0206b50 <commands+0x150>
...
ffffffffc02006e6:	48650513          	addi	a0,a0,1158 # ffffffffc0206b68 <commands+0x168>
...
ffffffffc02006f4:	49050513          	addi	a0,a0,1168 # ffffffffc0206b80 <commands+0x180>
...
ffffffffc0200702:	49a50513          	addi	a0,a0,1178 # ffffffffc0206b98 <commands+0x198>
...
ffffffffc0200710:	4a450513          	addi	a0,a0,1188 # ffffffffc0206bb0 <commands+0x1b0>
...
ffffffffc020071e:	4ae50513          	addi	a0,a0,1198 # ffffffffc0206bc8 <commands+0x1c8>
...
ffffffffc020072c:	4b850513          	addi	a0,a0,1208 # ffffffffc0206be0 <commands+0x1e0>
...
ffffffffc020073a:	4c250513          	addi	a0,a0,1218 # ffffffffc0206bf8 <commands+0x1f8>
...
ffffffffc0200748:	4cc50513          	addi	a0,a0,1228 # ffffffffc0206c10 <commands+0x210>
...
ffffffffc0200756:	4d650513          	addi	a0,a0,1238 # ffffffffc0206c28 <commands+0x228>
...
ffffffffc0200764:	4e050513          	addi	a0,a0,1248 # ffffffffc0206c40 <commands+0x240>
...
ffffffffc0200772:	4ea50513          	addi	a0,a0,1258 # ffffffffc0206c58 <commands+0x258>
...
ffffffffc0200780:	4f450513          	addi	a0,a0,1268 # ffffffffc0206c70 <commands+0x270>
...
ffffffffc020078e:	4fe50513          	addi	a0,a0,1278 # ffffffffc0206c88 <commands+0x288>
...
ffffffffc020079c:	50850513          	addi	a0,a0,1288 # ffffffffc0206ca0 <commands+0x2a0>
...
ffffffffc02007aa:	51250513          	addi	a0,a0,1298 # ffffffffc0206cb8 <commands+0x2b8>
...
ffffffffc02007b8:	51c50513          	addi	a0,a0,1308 # ffffffffc0206cd0 <commands+0x2d0>
...
ffffffffc02007c6:	52650513          	addi	a0,a0,1318 # ffffffffc0206ce8 <commands+0x2e8>
...
ffffffffc02007d4:	53050513          	addi	a0,a0,1328 # ffffffffc0206d00 <commands+0x300>
...
ffffffffc02007e2:	53a50513          	addi	a0,a0,1338 # ffffffffc0206d18 <commands+0x318>
...
ffffffffc02007f0:	54450513          	addi	a0,a0,1348 # ffffffffc0206d30 <commands+0x330>
...
ffffffffc02007fe:	54e50513          	addi	a0,a0,1358 # ffffffffc0206d48 <commands+0x348>
...
ffffffffc020080c:	55850513          	addi	a0,a0,1368 # ffffffffc0206d60 <commands+0x360>
...
ffffffffc020081a:	56250513          	addi	a0,a0,1378 # ffffffffc0206d78 <commands+0x378>
...
ffffffffc020082c:	56850513          	addi	a0,a0,1384 # ffffffffc0206d90 <commands+0x390>
}
...
ffffffffc0200840:	56c50513          	addi	a0,a0,1388 # ffffffffc0206da8 <commands+0x3a8>
print_trapframe(struct trapframe *tf) {
...
ffffffffc0200858:	56c50513          	addi	a0,a0,1388 # ffffffffc0206dc0 <commands+0x3c0>
...
ffffffffc0200868:	57450513          	addi	a0,a0,1396 # ffffffffc0206dd8 <commands+0x3d8>
...
ffffffffc0200878:	57c50513          	addi	a0,a0,1404 # ffffffffc0206df0 <commands+0x3f0>
...
ffffffffc020088c:	57850513          	addi	a0,a0,1400 # ffffffffc0206e00 <commands+0x400>
}
...
ffffffffc02008d4:	54850513          	addi	a0,a0,1352 # ffffffffc0206e18 <commands+0x418>
...
ffffffffc0200940:	4fc68693          	addi	a3,a3,1276 # ffffffffc0206e38 <commands+0x438>
ffffffffc0200944:	00006617          	auipc	a2,0x6
ffffffffc0200948:	50c60613          	addi	a2,a2,1292 # ffffffffc0206e50 <commands+0x450>
ffffffffc020094c:	06b00593          	li	a1,107
ffffffffc0200950:	00006517          	auipc	a0,0x6
ffffffffc0200954:	51850513          	addi	a0,a0,1304 # ffffffffc0206e68 <commands+0x468>
...
ffffffffc020098a:	49250513          	addi	a0,a0,1170 # ffffffffc0206e18 <commands+0x418>
ffffffffc020098e:	ff2ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
            panic("unhandled page fault.\n");
ffffffffc0200992:	00006617          	auipc	a2,0x6
ffffffffc0200996:	4ee60613          	addi	a2,a2,1262 # ffffffffc0206e80 <commands+0x480>
ffffffffc020099a:	07200593          	li	a1,114
ffffffffc020099e:	00006517          	auipc	a0,0x6
ffffffffc02009a2:	4ca50513          	addi	a0,a0,1226 # ffffffffc0206e68 <commands+0x468>
...
ffffffffc02009c2:	57a70713          	addi	a4,a4,1402 # ffffffffc0206f38 <commands+0x538>
...
ffffffffc02009d4:	52850513          	addi	a0,a0,1320 # ffffffffc0206ef8 <commands+0x4f8>
ffffffffc02009d8:	fa8ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02009dc:	00006517          	auipc	a0,0x6
ffffffffc02009e0:	4fc50513          	addi	a0,a0,1276 # ffffffffc0206ed8 <commands+0x4d8>
ffffffffc02009e4:	f9cff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02009e8:	00006517          	auipc	a0,0x6
ffffffffc02009ec:	4b050513          	addi	a0,a0,1200 # ffffffffc0206e98 <commands+0x498>
ffffffffc02009f0:	f90ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02009f4:	00006517          	auipc	a0,0x6
ffffffffc02009f8:	4c450513          	addi	a0,a0,1220 # ffffffffc0206eb8 <commands+0x4b8>
...
ffffffffc0200a38:	4e450513          	addi	a0,a0,1252 # ffffffffc0206f18 <commands+0x518>
...
ffffffffc0200a5a:	6aa70713          	addi	a4,a4,1706 # ffffffffc0207100 <commands+0x700>
...
ffffffffc0200a6c:	5f050513          	addi	a0,a0,1520 # ffffffffc0207058 <commands+0x658>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	7e60506f          	j	ffffffffc020626c <syscall>
            cprintf("Environment call from H-mode\n");
ffffffffc0200a8a:	00006517          	auipc	a0,0x6
ffffffffc0200a8e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0207078 <commands+0x678>
}
...
ffffffffc0200aa2:	5fa50513          	addi	a0,a0,1530 # ffffffffc0207098 <commands+0x698>
ffffffffc0200aa6:	b7f5                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Instruction page fault\n");
ffffffffc0200aa8:	00006517          	auipc	a0,0x6
ffffffffc0200aac:	61050513          	addi	a0,a0,1552 # ffffffffc02070b8 <commands+0x6b8>
ffffffffc0200ab0:	b7cd                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Load page fault\n");
ffffffffc0200ab2:	00006517          	auipc	a0,0x6
ffffffffc0200ab6:	61e50513          	addi	a0,a0,1566 # ffffffffc02070d0 <commands+0x6d0>
...
ffffffffc0200ad8:	61450513          	addi	a0,a0,1556 # ffffffffc02070e8 <commands+0x6e8>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	726050ef          	jal	ra,ffffffffc020626c <syscall>
...
ffffffffc0200b68:	46c50513          	addi	a0,a0,1132 # ffffffffc0206fd0 <commands+0x5d0>
ffffffffc0200b6c:	b71d                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc0200b6e:	00006517          	auipc	a0,0x6
ffffffffc0200b72:	48250513          	addi	a0,a0,1154 # ffffffffc0206ff0 <commands+0x5f0>
...
ffffffffc0200b90:	47c60613          	addi	a2,a2,1148 # ffffffffc0207008 <commands+0x608>
ffffffffc0200b94:	0cd00593          	li	a1,205
ffffffffc0200b98:	00006517          	auipc	a0,0x6
ffffffffc0200b9c:	2d050513          	addi	a0,a0,720 # ffffffffc0206e68 <commands+0x468>
ffffffffc0200ba0:	8dbff0ef          	jal	ra,ffffffffc020047a <__panic>
            cprintf("Store/AMO access fault\n");
ffffffffc0200ba4:	00006517          	auipc	a0,0x6
ffffffffc0200ba8:	49c50513          	addi	a0,a0,1180 # ffffffffc0207040 <commands+0x640>
...
ffffffffc0200bc8:	44460613          	addi	a2,a2,1092 # ffffffffc0207008 <commands+0x608>
ffffffffc0200bcc:	0d700593          	li	a1,215
ffffffffc0200bd0:	00006517          	auipc	a0,0x6
ffffffffc0200bd4:	29850513          	addi	a0,a0,664 # ffffffffc0206e68 <commands+0x468>
...
ffffffffc0200bec:	44060613          	addi	a2,a2,1088 # ffffffffc0207028 <commands+0x628>
ffffffffc0200bf0:	0d100593          	li	a1,209
ffffffffc0200bf4:	00006517          	auipc	a0,0x6
ffffffffc0200bf8:	27450513          	addi	a0,a0,628 # ffffffffc0206e68 <commands+0x468>
...
ffffffffc0200c0c:	40060613          	addi	a2,a2,1024 # ffffffffc0207008 <commands+0x608>
ffffffffc0200c10:	0f100593          	li	a1,241
ffffffffc0200c14:	00006517          	auipc	a0,0x6
ffffffffc0200c18:	25450513          	addi	a0,a0,596 # ffffffffc0206e68 <commands+0x468>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	4e40506f          	j	ffffffffc0206180 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	025040ef          	jal	ra,ffffffffc02054c6 <do_exit>
            if (current->need_resched) {
...
ffffffffc0200ede:	f8e63603          	ld	a2,-114(a2) # ffffffffc0208e68 <nbase>
...
ffffffffc0201124:	02068693          	addi	a3,a3,32 # ffffffffc0207140 <commands+0x740>
ffffffffc0201128:	00006617          	auipc	a2,0x6
ffffffffc020112c:	d2860613          	addi	a2,a2,-728 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201130:	0f000593          	li	a1,240
ffffffffc0201134:	00006517          	auipc	a0,0x6
ffffffffc0201138:	01c50513          	addi	a0,a0,28 # ffffffffc0207150 <commands+0x750>
ffffffffc020113c:	b3eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0201140:	00006697          	auipc	a3,0x6
ffffffffc0201144:	0a868693          	addi	a3,a3,168 # ffffffffc02071e8 <commands+0x7e8>
ffffffffc0201148:	00006617          	auipc	a2,0x6
ffffffffc020114c:	d0860613          	addi	a2,a2,-760 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201150:	0bd00593          	li	a1,189
ffffffffc0201154:	00006517          	auipc	a0,0x6
ffffffffc0201158:	ffc50513          	addi	a0,a0,-4 # ffffffffc0207150 <commands+0x750>
ffffffffc020115c:	b1eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201160:	00006697          	auipc	a3,0x6
ffffffffc0201164:	0b068693          	addi	a3,a3,176 # ffffffffc0207210 <commands+0x810>
ffffffffc0201168:	00006617          	auipc	a2,0x6
ffffffffc020116c:	ce860613          	addi	a2,a2,-792 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201170:	0be00593          	li	a1,190
ffffffffc0201174:	00006517          	auipc	a0,0x6
ffffffffc0201178:	fdc50513          	addi	a0,a0,-36 # ffffffffc0207150 <commands+0x750>
ffffffffc020117c:	afeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201180:	00006697          	auipc	a3,0x6
ffffffffc0201184:	0d068693          	addi	a3,a3,208 # ffffffffc0207250 <commands+0x850>
ffffffffc0201188:	00006617          	auipc	a2,0x6
ffffffffc020118c:	cc860613          	addi	a2,a2,-824 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201190:	0c000593          	li	a1,192
ffffffffc0201194:	00006517          	auipc	a0,0x6
ffffffffc0201198:	fbc50513          	addi	a0,a0,-68 # ffffffffc0207150 <commands+0x750>
ffffffffc020119c:	adeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(!list_empty(&free_list));
ffffffffc02011a0:	00006697          	auipc	a3,0x6
ffffffffc02011a4:	13868693          	addi	a3,a3,312 # ffffffffc02072d8 <commands+0x8d8>
ffffffffc02011a8:	00006617          	auipc	a2,0x6
ffffffffc02011ac:	ca860613          	addi	a2,a2,-856 # ffffffffc0206e50 <commands+0x450>
ffffffffc02011b0:	0d900593          	li	a1,217
ffffffffc02011b4:	00006517          	auipc	a0,0x6
ffffffffc02011b8:	f9c50513          	addi	a0,a0,-100 # ffffffffc0207150 <commands+0x750>
ffffffffc02011bc:	abeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02011c0:	00006697          	auipc	a3,0x6
ffffffffc02011c4:	fc868693          	addi	a3,a3,-56 # ffffffffc0207188 <commands+0x788>
ffffffffc02011c8:	00006617          	auipc	a2,0x6
ffffffffc02011cc:	c8860613          	addi	a2,a2,-888 # ffffffffc0206e50 <commands+0x450>
ffffffffc02011d0:	0d200593          	li	a1,210
ffffffffc02011d4:	00006517          	auipc	a0,0x6
ffffffffc02011d8:	f7c50513          	addi	a0,a0,-132 # ffffffffc0207150 <commands+0x750>
ffffffffc02011dc:	a9eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 3);
ffffffffc02011e0:	00006697          	auipc	a3,0x6
ffffffffc02011e4:	0e868693          	addi	a3,a3,232 # ffffffffc02072c8 <commands+0x8c8>
ffffffffc02011e8:	00006617          	auipc	a2,0x6
ffffffffc02011ec:	c6860613          	addi	a2,a2,-920 # ffffffffc0206e50 <commands+0x450>
ffffffffc02011f0:	0d000593          	li	a1,208
ffffffffc02011f4:	00006517          	auipc	a0,0x6
ffffffffc02011f8:	f5c50513          	addi	a0,a0,-164 # ffffffffc0207150 <commands+0x750>
ffffffffc02011fc:	a7eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201200:	00006697          	auipc	a3,0x6
ffffffffc0201204:	0b068693          	addi	a3,a3,176 # ffffffffc02072b0 <commands+0x8b0>
ffffffffc0201208:	00006617          	auipc	a2,0x6
ffffffffc020120c:	c4860613          	addi	a2,a2,-952 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201210:	0cb00593          	li	a1,203
ffffffffc0201214:	00006517          	auipc	a0,0x6
ffffffffc0201218:	f3c50513          	addi	a0,a0,-196 # ffffffffc0207150 <commands+0x750>
ffffffffc020121c:	a5eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0201220:	00006697          	auipc	a3,0x6
ffffffffc0201224:	07068693          	addi	a3,a3,112 # ffffffffc0207290 <commands+0x890>
ffffffffc0201228:	00006617          	auipc	a2,0x6
ffffffffc020122c:	c2860613          	addi	a2,a2,-984 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201230:	0c200593          	li	a1,194
ffffffffc0201234:	00006517          	auipc	a0,0x6
ffffffffc0201238:	f1c50513          	addi	a0,a0,-228 # ffffffffc0207150 <commands+0x750>
ffffffffc020123c:	a3eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 != NULL);
ffffffffc0201240:	00006697          	auipc	a3,0x6
ffffffffc0201244:	0e068693          	addi	a3,a3,224 # ffffffffc0207320 <commands+0x920>
ffffffffc0201248:	00006617          	auipc	a2,0x6
ffffffffc020124c:	c0860613          	addi	a2,a2,-1016 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201250:	0f800593          	li	a1,248
ffffffffc0201254:	00006517          	auipc	a0,0x6
ffffffffc0201258:	efc50513          	addi	a0,a0,-260 # ffffffffc0207150 <commands+0x750>
ffffffffc020125c:	a1eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 0);
ffffffffc0201260:	00006697          	auipc	a3,0x6
ffffffffc0201264:	0b068693          	addi	a3,a3,176 # ffffffffc0207310 <commands+0x910>
ffffffffc0201268:	00006617          	auipc	a2,0x6
ffffffffc020126c:	be860613          	addi	a2,a2,-1048 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201270:	0df00593          	li	a1,223
ffffffffc0201274:	00006517          	auipc	a0,0x6
ffffffffc0201278:	edc50513          	addi	a0,a0,-292 # ffffffffc0207150 <commands+0x750>
ffffffffc020127c:	9feff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201280:	00006697          	auipc	a3,0x6
ffffffffc0201284:	03068693          	addi	a3,a3,48 # ffffffffc02072b0 <commands+0x8b0>
ffffffffc0201288:	00006617          	auipc	a2,0x6
ffffffffc020128c:	bc860613          	addi	a2,a2,-1080 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201290:	0dd00593          	li	a1,221
ffffffffc0201294:	00006517          	auipc	a0,0x6
ffffffffc0201298:	ebc50513          	addi	a0,a0,-324 # ffffffffc0207150 <commands+0x750>
ffffffffc020129c:	9deff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc02012a0:	00006697          	auipc	a3,0x6
ffffffffc02012a4:	05068693          	addi	a3,a3,80 # ffffffffc02072f0 <commands+0x8f0>
ffffffffc02012a8:	00006617          	auipc	a2,0x6
ffffffffc02012ac:	ba860613          	addi	a2,a2,-1112 # ffffffffc0206e50 <commands+0x450>
ffffffffc02012b0:	0dc00593          	li	a1,220
ffffffffc02012b4:	00006517          	auipc	a0,0x6
ffffffffc02012b8:	e9c50513          	addi	a0,a0,-356 # ffffffffc0207150 <commands+0x750>
ffffffffc02012bc:	9beff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02012c0:	00006697          	auipc	a3,0x6
ffffffffc02012c4:	ec868693          	addi	a3,a3,-312 # ffffffffc0207188 <commands+0x788>
ffffffffc02012c8:	00006617          	auipc	a2,0x6
ffffffffc02012cc:	b8860613          	addi	a2,a2,-1144 # ffffffffc0206e50 <commands+0x450>
ffffffffc02012d0:	0b900593          	li	a1,185
ffffffffc02012d4:	00006517          	auipc	a0,0x6
ffffffffc02012d8:	e7c50513          	addi	a0,a0,-388 # ffffffffc0207150 <commands+0x750>
ffffffffc02012dc:	99eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012e0:	00006697          	auipc	a3,0x6
ffffffffc02012e4:	fd068693          	addi	a3,a3,-48 # ffffffffc02072b0 <commands+0x8b0>
ffffffffc02012e8:	00006617          	auipc	a2,0x6
ffffffffc02012ec:	b6860613          	addi	a2,a2,-1176 # ffffffffc0206e50 <commands+0x450>
ffffffffc02012f0:	0d600593          	li	a1,214
ffffffffc02012f4:	00006517          	auipc	a0,0x6
ffffffffc02012f8:	e5c50513          	addi	a0,a0,-420 # ffffffffc0207150 <commands+0x750>
ffffffffc02012fc:	97eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201300:	00006697          	auipc	a3,0x6
ffffffffc0201304:	ec868693          	addi	a3,a3,-312 # ffffffffc02071c8 <commands+0x7c8>
ffffffffc0201308:	00006617          	auipc	a2,0x6
ffffffffc020130c:	b4860613          	addi	a2,a2,-1208 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201310:	0d400593          	li	a1,212
ffffffffc0201314:	00006517          	auipc	a0,0x6
ffffffffc0201318:	e3c50513          	addi	a0,a0,-452 # ffffffffc0207150 <commands+0x750>
ffffffffc020131c:	95eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201320:	00006697          	auipc	a3,0x6
ffffffffc0201324:	e8868693          	addi	a3,a3,-376 # ffffffffc02071a8 <commands+0x7a8>
ffffffffc0201328:	00006617          	auipc	a2,0x6
ffffffffc020132c:	b2860613          	addi	a2,a2,-1240 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201330:	0d300593          	li	a1,211
ffffffffc0201334:	00006517          	auipc	a0,0x6
ffffffffc0201338:	e1c50513          	addi	a0,a0,-484 # ffffffffc0207150 <commands+0x750>
ffffffffc020133c:	93eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201340:	00006697          	auipc	a3,0x6
ffffffffc0201344:	e8868693          	addi	a3,a3,-376 # ffffffffc02071c8 <commands+0x7c8>
ffffffffc0201348:	00006617          	auipc	a2,0x6
ffffffffc020134c:	b0860613          	addi	a2,a2,-1272 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201350:	0bb00593          	li	a1,187
ffffffffc0201354:	00006517          	auipc	a0,0x6
ffffffffc0201358:	dfc50513          	addi	a0,a0,-516 # ffffffffc0207150 <commands+0x750>
ffffffffc020135c:	91eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(count == 0);
ffffffffc0201360:	00006697          	auipc	a3,0x6
ffffffffc0201364:	11068693          	addi	a3,a3,272 # ffffffffc0207470 <commands+0xa70>
ffffffffc0201368:	00006617          	auipc	a2,0x6
ffffffffc020136c:	ae860613          	addi	a2,a2,-1304 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201370:	12500593          	li	a1,293
ffffffffc0201374:	00006517          	auipc	a0,0x6
ffffffffc0201378:	ddc50513          	addi	a0,a0,-548 # ffffffffc0207150 <commands+0x750>
ffffffffc020137c:	8feff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 0);
ffffffffc0201380:	00006697          	auipc	a3,0x6
ffffffffc0201384:	f9068693          	addi	a3,a3,-112 # ffffffffc0207310 <commands+0x910>
ffffffffc0201388:	00006617          	auipc	a2,0x6
ffffffffc020138c:	ac860613          	addi	a2,a2,-1336 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201390:	11a00593          	li	a1,282
ffffffffc0201394:	00006517          	auipc	a0,0x6
ffffffffc0201398:	dbc50513          	addi	a0,a0,-580 # ffffffffc0207150 <commands+0x750>
ffffffffc020139c:	8deff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02013a0:	00006697          	auipc	a3,0x6
ffffffffc02013a4:	f1068693          	addi	a3,a3,-240 # ffffffffc02072b0 <commands+0x8b0>
ffffffffc02013a8:	00006617          	auipc	a2,0x6
ffffffffc02013ac:	aa860613          	addi	a2,a2,-1368 # ffffffffc0206e50 <commands+0x450>
ffffffffc02013b0:	11800593          	li	a1,280
ffffffffc02013b4:	00006517          	auipc	a0,0x6
ffffffffc02013b8:	d9c50513          	addi	a0,a0,-612 # ffffffffc0207150 <commands+0x750>
ffffffffc02013bc:	8beff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc02013c0:	00006697          	auipc	a3,0x6
ffffffffc02013c4:	eb068693          	addi	a3,a3,-336 # ffffffffc0207270 <commands+0x870>
ffffffffc02013c8:	00006617          	auipc	a2,0x6
ffffffffc02013cc:	a8860613          	addi	a2,a2,-1400 # ffffffffc0206e50 <commands+0x450>
ffffffffc02013d0:	0c100593          	li	a1,193
ffffffffc02013d4:	00006517          	auipc	a0,0x6
ffffffffc02013d8:	d7c50513          	addi	a0,a0,-644 # ffffffffc0207150 <commands+0x750>
ffffffffc02013dc:	89eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02013e0:	00006697          	auipc	a3,0x6
ffffffffc02013e4:	05068693          	addi	a3,a3,80 # ffffffffc0207430 <commands+0xa30>
ffffffffc02013e8:	00006617          	auipc	a2,0x6
ffffffffc02013ec:	a6860613          	addi	a2,a2,-1432 # ffffffffc0206e50 <commands+0x450>
ffffffffc02013f0:	11200593          	li	a1,274
ffffffffc02013f4:	00006517          	auipc	a0,0x6
ffffffffc02013f8:	d5c50513          	addi	a0,a0,-676 # ffffffffc0207150 <commands+0x750>
ffffffffc02013fc:	87eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201400:	00006697          	auipc	a3,0x6
ffffffffc0201404:	01068693          	addi	a3,a3,16 # ffffffffc0207410 <commands+0xa10>
ffffffffc0201408:	00006617          	auipc	a2,0x6
ffffffffc020140c:	a4860613          	addi	a2,a2,-1464 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201410:	11000593          	li	a1,272
ffffffffc0201414:	00006517          	auipc	a0,0x6
ffffffffc0201418:	d3c50513          	addi	a0,a0,-708 # ffffffffc0207150 <commands+0x750>
ffffffffc020141c:	85eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201420:	00006697          	auipc	a3,0x6
ffffffffc0201424:	fc868693          	addi	a3,a3,-56 # ffffffffc02073e8 <commands+0x9e8>
ffffffffc0201428:	00006617          	auipc	a2,0x6
ffffffffc020142c:	a2860613          	addi	a2,a2,-1496 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201430:	10e00593          	li	a1,270
ffffffffc0201434:	00006517          	auipc	a0,0x6
ffffffffc0201438:	d1c50513          	addi	a0,a0,-740 # ffffffffc0207150 <commands+0x750>
ffffffffc020143c:	83eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201440:	00006697          	auipc	a3,0x6
ffffffffc0201444:	f8068693          	addi	a3,a3,-128 # ffffffffc02073c0 <commands+0x9c0>
ffffffffc0201448:	00006617          	auipc	a2,0x6
ffffffffc020144c:	a0860613          	addi	a2,a2,-1528 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201450:	10d00593          	li	a1,269
ffffffffc0201454:	00006517          	auipc	a0,0x6
ffffffffc0201458:	cfc50513          	addi	a0,a0,-772 # ffffffffc0207150 <commands+0x750>
ffffffffc020145c:	81eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201460:	00006697          	auipc	a3,0x6
ffffffffc0201464:	f5068693          	addi	a3,a3,-176 # ffffffffc02073b0 <commands+0x9b0>
ffffffffc0201468:	00006617          	auipc	a2,0x6
ffffffffc020146c:	9e860613          	addi	a2,a2,-1560 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201470:	10800593          	li	a1,264
ffffffffc0201474:	00006517          	auipc	a0,0x6
ffffffffc0201478:	cdc50513          	addi	a0,a0,-804 # ffffffffc0207150 <commands+0x750>
ffffffffc020147c:	ffffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201480:	00006697          	auipc	a3,0x6
ffffffffc0201484:	e3068693          	addi	a3,a3,-464 # ffffffffc02072b0 <commands+0x8b0>
ffffffffc0201488:	00006617          	auipc	a2,0x6
ffffffffc020148c:	9c860613          	addi	a2,a2,-1592 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201490:	10700593          	li	a1,263
ffffffffc0201494:	00006517          	auipc	a0,0x6
ffffffffc0201498:	cbc50513          	addi	a0,a0,-836 # ffffffffc0207150 <commands+0x750>
ffffffffc020149c:	fdffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02014a0:	00006697          	auipc	a3,0x6
ffffffffc02014a4:	ef068693          	addi	a3,a3,-272 # ffffffffc0207390 <commands+0x990>
ffffffffc02014a8:	00006617          	auipc	a2,0x6
ffffffffc02014ac:	9a860613          	addi	a2,a2,-1624 # ffffffffc0206e50 <commands+0x450>
ffffffffc02014b0:	10600593          	li	a1,262
ffffffffc02014b4:	00006517          	auipc	a0,0x6
ffffffffc02014b8:	c9c50513          	addi	a0,a0,-868 # ffffffffc0207150 <commands+0x750>
ffffffffc02014bc:	fbffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc02014c0:	00006697          	auipc	a3,0x6
ffffffffc02014c4:	ea068693          	addi	a3,a3,-352 # ffffffffc0207360 <commands+0x960>
ffffffffc02014c8:	00006617          	auipc	a2,0x6
ffffffffc02014cc:	98860613          	addi	a2,a2,-1656 # ffffffffc0206e50 <commands+0x450>
ffffffffc02014d0:	10500593          	li	a1,261
ffffffffc02014d4:	00006517          	auipc	a0,0x6
ffffffffc02014d8:	c7c50513          	addi	a0,a0,-900 # ffffffffc0207150 <commands+0x750>
ffffffffc02014dc:	f9ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02014e0:	00006697          	auipc	a3,0x6
ffffffffc02014e4:	e6868693          	addi	a3,a3,-408 # ffffffffc0207348 <commands+0x948>
ffffffffc02014e8:	00006617          	auipc	a2,0x6
ffffffffc02014ec:	96860613          	addi	a2,a2,-1688 # ffffffffc0206e50 <commands+0x450>
ffffffffc02014f0:	10400593          	li	a1,260
ffffffffc02014f4:	00006517          	auipc	a0,0x6
ffffffffc02014f8:	c5c50513          	addi	a0,a0,-932 # ffffffffc0207150 <commands+0x750>
ffffffffc02014fc:	f7ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201500:	00006697          	auipc	a3,0x6
ffffffffc0201504:	db068693          	addi	a3,a3,-592 # ffffffffc02072b0 <commands+0x8b0>
ffffffffc0201508:	00006617          	auipc	a2,0x6
ffffffffc020150c:	94860613          	addi	a2,a2,-1720 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201510:	0fe00593          	li	a1,254
ffffffffc0201514:	00006517          	auipc	a0,0x6
ffffffffc0201518:	c3c50513          	addi	a0,a0,-964 # ffffffffc0207150 <commands+0x750>
ffffffffc020151c:	f5ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(!PageProperty(p0));
ffffffffc0201520:	00006697          	auipc	a3,0x6
ffffffffc0201524:	e1068693          	addi	a3,a3,-496 # ffffffffc0207330 <commands+0x930>
ffffffffc0201528:	00006617          	auipc	a2,0x6
ffffffffc020152c:	92860613          	addi	a2,a2,-1752 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201530:	0f900593          	li	a1,249
ffffffffc0201534:	00006517          	auipc	a0,0x6
ffffffffc0201538:	c1c50513          	addi	a0,a0,-996 # ffffffffc0207150 <commands+0x750>
ffffffffc020153c:	f3ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201540:	00006697          	auipc	a3,0x6
ffffffffc0201544:	f1068693          	addi	a3,a3,-240 # ffffffffc0207450 <commands+0xa50>
ffffffffc0201548:	00006617          	auipc	a2,0x6
ffffffffc020154c:	90860613          	addi	a2,a2,-1784 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201550:	11700593          	li	a1,279
ffffffffc0201554:	00006517          	auipc	a0,0x6
ffffffffc0201558:	bfc50513          	addi	a0,a0,-1028 # ffffffffc0207150 <commands+0x750>
ffffffffc020155c:	f1ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(total == 0);
ffffffffc0201560:	00006697          	auipc	a3,0x6
ffffffffc0201564:	f2068693          	addi	a3,a3,-224 # ffffffffc0207480 <commands+0xa80>
ffffffffc0201568:	00006617          	auipc	a2,0x6
ffffffffc020156c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201570:	12600593          	li	a1,294
ffffffffc0201574:	00006517          	auipc	a0,0x6
ffffffffc0201578:	bdc50513          	addi	a0,a0,-1060 # ffffffffc0207150 <commands+0x750>
ffffffffc020157c:	efffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(total == nr_free_pages());
ffffffffc0201580:	00006697          	auipc	a3,0x6
ffffffffc0201584:	be868693          	addi	a3,a3,-1048 # ffffffffc0207168 <commands+0x768>
ffffffffc0201588:	00006617          	auipc	a2,0x6
ffffffffc020158c:	8c860613          	addi	a2,a2,-1848 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201590:	0f300593          	li	a1,243
ffffffffc0201594:	00006517          	auipc	a0,0x6
ffffffffc0201598:	bbc50513          	addi	a0,a0,-1092 # ffffffffc0207150 <commands+0x750>
ffffffffc020159c:	edffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02015a0:	00006697          	auipc	a3,0x6
ffffffffc02015a4:	c0868693          	addi	a3,a3,-1016 # ffffffffc02071a8 <commands+0x7a8>
ffffffffc02015a8:	00006617          	auipc	a2,0x6
ffffffffc02015ac:	8a860613          	addi	a2,a2,-1880 # ffffffffc0206e50 <commands+0x450>
ffffffffc02015b0:	0ba00593          	li	a1,186
ffffffffc02015b4:	00006517          	auipc	a0,0x6
ffffffffc02015b8:	b9c50513          	addi	a0,a0,-1124 # ffffffffc0207150 <commands+0x750>
...
ffffffffc02016f0:	dac68693          	addi	a3,a3,-596 # ffffffffc0207498 <commands+0xa98>
ffffffffc02016f4:	00005617          	auipc	a2,0x5
ffffffffc02016f8:	75c60613          	addi	a2,a2,1884 # ffffffffc0206e50 <commands+0x450>
ffffffffc02016fc:	08300593          	li	a1,131
ffffffffc0201700:	00006517          	auipc	a0,0x6
ffffffffc0201704:	a5050513          	addi	a0,a0,-1456 # ffffffffc0207150 <commands+0x750>
ffffffffc0201708:	d73fe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc020170c:	00006697          	auipc	a3,0x6
ffffffffc0201710:	d8468693          	addi	a3,a3,-636 # ffffffffc0207490 <commands+0xa90>
ffffffffc0201714:	00005617          	auipc	a2,0x5
ffffffffc0201718:	73c60613          	addi	a2,a2,1852 # ffffffffc0206e50 <commands+0x450>
ffffffffc020171c:	08000593          	li	a1,128
ffffffffc0201720:	00006517          	auipc	a0,0x6
ffffffffc0201724:	a3050513          	addi	a0,a0,-1488 # ffffffffc0207150 <commands+0x750>
...
ffffffffc02017c2:	cd268693          	addi	a3,a3,-814 # ffffffffc0207490 <commands+0xa90>
ffffffffc02017c6:	00005617          	auipc	a2,0x5
ffffffffc02017ca:	68a60613          	addi	a2,a2,1674 # ffffffffc0206e50 <commands+0x450>
ffffffffc02017ce:	06200593          	li	a1,98
ffffffffc02017d2:	00006517          	auipc	a0,0x6
ffffffffc02017d6:	97e50513          	addi	a0,a0,-1666 # ffffffffc0207150 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc0201894:	c3068693          	addi	a3,a3,-976 # ffffffffc02074c0 <commands+0xac0>
ffffffffc0201898:	00005617          	auipc	a2,0x5
ffffffffc020189c:	5b860613          	addi	a2,a2,1464 # ffffffffc0206e50 <commands+0x450>
ffffffffc02018a0:	04900593          	li	a1,73
ffffffffc02018a4:	00006517          	auipc	a0,0x6
ffffffffc02018a8:	8ac50513          	addi	a0,a0,-1876 # ffffffffc0207150 <commands+0x750>
ffffffffc02018ac:	bcffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc02018b0:	00006697          	auipc	a3,0x6
ffffffffc02018b4:	be068693          	addi	a3,a3,-1056 # ffffffffc0207490 <commands+0xa90>
ffffffffc02018b8:	00005617          	auipc	a2,0x5
ffffffffc02018bc:	59860613          	addi	a2,a2,1432 # ffffffffc0206e50 <commands+0x450>
ffffffffc02018c0:	04600593          	li	a1,70
ffffffffc02018c4:	00006517          	auipc	a0,0x6
ffffffffc02018c8:	88c50513          	addi	a0,a0,-1908 # ffffffffc0207150 <commands+0x750>
...
ffffffffc02019a4:	4c86b683          	ld	a3,1224(a3) # ffffffffc0208e68 <nbase>
...
ffffffffc02019d4:	b5060613          	addi	a2,a2,-1200 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc02019d8:	06900593          	li	a1,105
ffffffffc02019dc:	00006517          	auipc	a0,0x6
ffffffffc02019e0:	b6c50513          	addi	a0,a0,-1172 # ffffffffc0207548 <default_pmm_manager+0x60>
...
ffffffffc0201ac2:	a9a68693          	addi	a3,a3,-1382 # ffffffffc0207558 <default_pmm_manager+0x70>
ffffffffc0201ac6:	00005617          	auipc	a2,0x5
ffffffffc0201aca:	38a60613          	addi	a2,a2,906 # ffffffffc0206e50 <commands+0x450>
ffffffffc0201ace:	06400593          	li	a1,100
ffffffffc0201ad2:	00006517          	auipc	a0,0x6
ffffffffc0201ad6:	aa650513          	addi	a0,a0,-1370 # ffffffffc0207578 <default_pmm_manager+0x90>
...
ffffffffc0201ae4:	ab050513          	addi	a0,a0,-1360 # ffffffffc0207590 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201af4:	ab850513          	addi	a0,a0,-1352 # ffffffffc02075a8 <default_pmm_manager+0xc0>
}
...
ffffffffc0201c1c:	25053503          	ld	a0,592(a0) # ffffffffc0208e68 <nbase>
...
ffffffffc0201c7a:	97a60613          	addi	a2,a2,-1670 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc0201c7e:	06200593          	li	a1,98
ffffffffc0201c82:	00006517          	auipc	a0,0x6
ffffffffc0201c86:	8c650513          	addi	a0,a0,-1850 # ffffffffc0207548 <default_pmm_manager+0x60>
...
ffffffffc0201c94:	93860613          	addi	a2,a2,-1736 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc0201c98:	06e00593          	li	a1,110
ffffffffc0201c9c:	00006517          	auipc	a0,0x6
ffffffffc0201ca0:	8ac50513          	addi	a0,a0,-1876 # ffffffffc0207548 <default_pmm_manager+0x60>
...
ffffffffc0201cae:	94660613          	addi	a2,a2,-1722 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc0201cb2:	06200593          	li	a1,98
ffffffffc0201cb6:	00006517          	auipc	a0,0x6
ffffffffc0201cba:	89250513          	addi	a0,a0,-1902 # ffffffffc0207548 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201cca:	94a60613          	addi	a2,a2,-1718 # ffffffffc0207610 <default_pmm_manager+0x128>
ffffffffc0201cce:	07400593          	li	a1,116
ffffffffc0201cd2:	00006517          	auipc	a0,0x6
ffffffffc0201cd6:	87650513          	addi	a0,a0,-1930 # ffffffffc0207548 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201e72:	0fb040ef          	jal	ra,ffffffffc020676c <memset>
    return page - pages + nbase;
...
ffffffffc0201f04:	069040ef          	jal	ra,ffffffffc020676c <memset>
    return page - pages + nbase;
...
ffffffffc0201f5e:	5c660613          	addi	a2,a2,1478 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0201f62:	0e300593          	li	a1,227
ffffffffc0201f66:	00005517          	auipc	a0,0x5
ffffffffc0201f6a:	6d250513          	addi	a0,a0,1746 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0201f6e:	d0cfe0ef          	jal	ra,ffffffffc020047a <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201f72:	00005617          	auipc	a2,0x5
ffffffffc0201f76:	5ae60613          	addi	a2,a2,1454 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0201f7a:	0ee00593          	li	a1,238
ffffffffc0201f7e:	00005517          	auipc	a0,0x5
ffffffffc0201f82:	6ba50513          	addi	a0,a0,1722 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0201f90:	59460613          	addi	a2,a2,1428 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0201f94:	0eb00593          	li	a1,235
ffffffffc0201f98:	00005517          	auipc	a0,0x5
ffffffffc0201f9c:	6a050513          	addi	a0,a0,1696 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0201faa:	57a60613          	addi	a2,a2,1402 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0201fae:	0df00593          	li	a1,223
ffffffffc0201fb2:	00005517          	auipc	a0,0x5
ffffffffc0201fb6:	68650513          	addi	a0,a0,1670 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0202118:	53468693          	addi	a3,a3,1332 # ffffffffc0207648 <default_pmm_manager+0x160>
ffffffffc020211c:	00005617          	auipc	a2,0x5
ffffffffc0202120:	d3460613          	addi	a2,a2,-716 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202124:	10f00593          	li	a1,271
ffffffffc0202128:	00005517          	auipc	a0,0x5
ffffffffc020212c:	51050513          	addi	a0,a0,1296 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202130:	b4afe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0202134:	00005697          	auipc	a3,0x5
ffffffffc0202138:	54468693          	addi	a3,a3,1348 # ffffffffc0207678 <default_pmm_manager+0x190>
ffffffffc020213c:	00005617          	auipc	a2,0x5
ffffffffc0202140:	d1460613          	addi	a2,a2,-748 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202144:	11000593          	li	a1,272
ffffffffc0202148:	00005517          	auipc	a0,0x5
ffffffffc020214c:	4f050513          	addi	a0,a0,1264 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0202392:	2ba68693          	addi	a3,a3,698 # ffffffffc0207648 <default_pmm_manager+0x160>
ffffffffc0202396:	00005617          	auipc	a2,0x5
ffffffffc020239a:	aba60613          	addi	a2,a2,-1350 # ffffffffc0206e50 <commands+0x450>
ffffffffc020239e:	12000593          	li	a1,288
ffffffffc02023a2:	00005517          	auipc	a0,0x5
ffffffffc02023a6:	29650513          	addi	a0,a0,662 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc02023aa:	8d0fe0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02023ae:	00005617          	auipc	a2,0x5
ffffffffc02023b2:	17260613          	addi	a2,a2,370 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc02023b6:	06900593          	li	a1,105
ffffffffc02023ba:	00005517          	auipc	a0,0x5
ffffffffc02023be:	18e50513          	addi	a0,a0,398 # ffffffffc0207548 <default_pmm_manager+0x60>
...
ffffffffc02023ce:	2ae68693          	addi	a3,a3,686 # ffffffffc0207678 <default_pmm_manager+0x190>
ffffffffc02023d2:	00005617          	auipc	a2,0x5
ffffffffc02023d6:	a7e60613          	addi	a2,a2,-1410 # ffffffffc0206e50 <commands+0x450>
ffffffffc02023da:	12100593          	li	a1,289
ffffffffc02023de:	00005517          	auipc	a0,0x5
ffffffffc02023e2:	25a50513          	addi	a0,a0,602 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0202580:	f6c78793          	addi	a5,a5,-148 # ffffffffc02074e8 <default_pmm_manager>
...
ffffffffc020258e:	10650513          	addi	a0,a0,262 # ffffffffc0207690 <default_pmm_manager+0x1a8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02025dc:	0d050513          	addi	a0,a0,208 # ffffffffc02076a8 <default_pmm_manager+0x1c0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc02025fc:	0c850513          	addi	a0,a0,200 # ffffffffc02076c0 <default_pmm_manager+0x1d8>
...
ffffffffc0202664:	08850513          	addi	a0,a0,136 # ffffffffc02076e8 <default_pmm_manager+0x200>
...
ffffffffc0202680:	08450513          	addi	a0,a0,132 # ffffffffc0207700 <default_pmm_manager+0x218>
...
ffffffffc0202920:	0cc50513          	addi	a0,a0,204 # ffffffffc02079e8 <default_pmm_manager+0x500>
...
ffffffffc02029d6:	14e58593          	addi	a1,a1,334 # ffffffffc0207b20 <default_pmm_manager+0x638>
ffffffffc02029da:	10000513          	li	a0,256
ffffffffc02029de:	549030ef          	jal	ra,ffffffffc0206726 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	54f030ef          	jal	ra,ffffffffc0206738 <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	4d1030ef          	jal	ra,ffffffffc02066f0 <strlen>
...
ffffffffc0202ae4:	0b850513          	addi	a0,a0,184 # ffffffffc0207b98 <default_pmm_manager+0x6b0>
...
ffffffffc0202bfe:	e4e68693          	addi	a3,a3,-434 # ffffffffc0207a48 <default_pmm_manager+0x560>
ffffffffc0202c02:	00004617          	auipc	a2,0x4
ffffffffc0202c06:	24e60613          	addi	a2,a2,590 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202c0a:	22900593          	li	a1,553
ffffffffc0202c0e:	00005517          	auipc	a0,0x5
ffffffffc0202c12:	a2a50513          	addi	a0,a0,-1494 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202c16:	865fd0ef          	jal	ra,ffffffffc020047a <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202c1a:	00005697          	auipc	a3,0x5
ffffffffc0202c1e:	dee68693          	addi	a3,a3,-530 # ffffffffc0207a08 <default_pmm_manager+0x520>
ffffffffc0202c22:	00004617          	auipc	a2,0x4
ffffffffc0202c26:	22e60613          	addi	a2,a2,558 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202c2a:	22800593          	li	a1,552
ffffffffc0202c2e:	00005517          	auipc	a0,0x5
ffffffffc0202c32:	a0a50513          	addi	a0,a0,-1526 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0202c40:	8e460613          	addi	a2,a2,-1820 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0202c44:	22800593          	li	a1,552
ffffffffc0202c48:	00005517          	auipc	a0,0x5
ffffffffc0202c4c:	9f050513          	addi	a0,a0,-1552 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0202c5c:	97060613          	addi	a2,a2,-1680 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc0202c60:	07f00593          	li	a1,127
ffffffffc0202c64:	00005517          	auipc	a0,0x5
ffffffffc0202c68:	9d450513          	addi	a0,a0,-1580 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202c6c:	80ffd0ef          	jal	ra,ffffffffc020047a <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202c70:	00005617          	auipc	a2,0x5
ffffffffc0202c74:	95860613          	addi	a2,a2,-1704 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc0202c78:	0c100593          	li	a1,193
ffffffffc0202c7c:	00005517          	auipc	a0,0x5
ffffffffc0202c80:	9bc50513          	addi	a0,a0,-1604 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202c84:	ff6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc0202c88:	00005697          	auipc	a3,0x5
ffffffffc0202c8c:	ab868693          	addi	a3,a3,-1352 # ffffffffc0207740 <default_pmm_manager+0x258>
ffffffffc0202c90:	00004617          	auipc	a2,0x4
ffffffffc0202c94:	1c060613          	addi	a2,a2,448 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202c98:	1ec00593          	li	a1,492
ffffffffc0202c9c:	00005517          	auipc	a0,0x5
ffffffffc0202ca0:	99c50513          	addi	a0,a0,-1636 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202ca4:	fd6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202ca8:	00005697          	auipc	a3,0x5
ffffffffc0202cac:	a7868693          	addi	a3,a3,-1416 # ffffffffc0207720 <default_pmm_manager+0x238>
ffffffffc0202cb0:	00004617          	auipc	a2,0x4
ffffffffc0202cb4:	1a060613          	addi	a2,a2,416 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202cb8:	1eb00593          	li	a1,491
ffffffffc0202cbc:	00005517          	auipc	a0,0x5
ffffffffc0202cc0:	97c50513          	addi	a0,a0,-1668 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0202cd0:	b0468693          	addi	a3,a3,-1276 # ffffffffc02077d0 <default_pmm_manager+0x2e8>
ffffffffc0202cd4:	00004617          	auipc	a2,0x4
ffffffffc0202cd8:	17c60613          	addi	a2,a2,380 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202cdc:	1f400593          	li	a1,500
ffffffffc0202ce0:	00005517          	auipc	a0,0x5
ffffffffc0202ce4:	95850513          	addi	a0,a0,-1704 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202ce8:	f92fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202cec:	00005697          	auipc	a3,0x5
ffffffffc0202cf0:	ab468693          	addi	a3,a3,-1356 # ffffffffc02077a0 <default_pmm_manager+0x2b8>
ffffffffc0202cf4:	00004617          	auipc	a2,0x4
ffffffffc0202cf8:	15c60613          	addi	a2,a2,348 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202cfc:	1f100593          	li	a1,497
ffffffffc0202d00:	00005517          	auipc	a0,0x5
ffffffffc0202d04:	93850513          	addi	a0,a0,-1736 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202d08:	f72fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202d0c:	00005697          	auipc	a3,0x5
ffffffffc0202d10:	a6c68693          	addi	a3,a3,-1428 # ffffffffc0207778 <default_pmm_manager+0x290>
ffffffffc0202d14:	00004617          	auipc	a2,0x4
ffffffffc0202d18:	13c60613          	addi	a2,a2,316 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202d1c:	1ed00593          	li	a1,493
ffffffffc0202d20:	00005517          	auipc	a0,0x5
ffffffffc0202d24:	91850513          	addi	a0,a0,-1768 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202d28:	f52fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202d2c:	00005697          	auipc	a3,0x5
ffffffffc0202d30:	b2c68693          	addi	a3,a3,-1236 # ffffffffc0207858 <default_pmm_manager+0x370>
ffffffffc0202d34:	00004617          	auipc	a2,0x4
ffffffffc0202d38:	11c60613          	addi	a2,a2,284 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202d3c:	1fd00593          	li	a1,509
ffffffffc0202d40:	00005517          	auipc	a0,0x5
ffffffffc0202d44:	8f850513          	addi	a0,a0,-1800 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202d48:	f32fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202d4c:	00005697          	auipc	a3,0x5
ffffffffc0202d50:	bac68693          	addi	a3,a3,-1108 # ffffffffc02078f8 <default_pmm_manager+0x410>
ffffffffc0202d54:	00004617          	auipc	a2,0x4
ffffffffc0202d58:	0fc60613          	addi	a2,a2,252 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202d5c:	20200593          	li	a1,514
ffffffffc0202d60:	00005517          	auipc	a0,0x5
ffffffffc0202d64:	8d850513          	addi	a0,a0,-1832 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202d68:	f12fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202d6c:	00005697          	auipc	a3,0x5
ffffffffc0202d70:	ac468693          	addi	a3,a3,-1340 # ffffffffc0207830 <default_pmm_manager+0x348>
ffffffffc0202d74:	00004617          	auipc	a2,0x4
ffffffffc0202d78:	0dc60613          	addi	a2,a2,220 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202d7c:	1fa00593          	li	a1,506
ffffffffc0202d80:	00005517          	auipc	a0,0x5
ffffffffc0202d84:	8b850513          	addi	a0,a0,-1864 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0202d92:	79260613          	addi	a2,a2,1938 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0202d96:	1f900593          	li	a1,505
ffffffffc0202d9a:	00005517          	auipc	a0,0x5
ffffffffc0202d9e:	89e50513          	addi	a0,a0,-1890 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202da2:	ed8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202da6:	00005697          	auipc	a3,0x5
ffffffffc0202daa:	aea68693          	addi	a3,a3,-1302 # ffffffffc0207890 <default_pmm_manager+0x3a8>
ffffffffc0202dae:	00004617          	auipc	a2,0x4
ffffffffc0202db2:	0a260613          	addi	a2,a2,162 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202db6:	20700593          	li	a1,519
ffffffffc0202dba:	00005517          	auipc	a0,0x5
ffffffffc0202dbe:	87e50513          	addi	a0,a0,-1922 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202dc2:	eb8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202dc6:	00005697          	auipc	a3,0x5
ffffffffc0202dca:	b9268693          	addi	a3,a3,-1134 # ffffffffc0207958 <default_pmm_manager+0x470>
ffffffffc0202dce:	00004617          	auipc	a2,0x4
ffffffffc0202dd2:	08260613          	addi	a2,a2,130 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202dd6:	20600593          	li	a1,518
ffffffffc0202dda:	00005517          	auipc	a0,0x5
ffffffffc0202dde:	85e50513          	addi	a0,a0,-1954 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202de2:	e98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202de6:	00005697          	auipc	a3,0x5
ffffffffc0202dea:	b5a68693          	addi	a3,a3,-1190 # ffffffffc0207940 <default_pmm_manager+0x458>
ffffffffc0202dee:	00004617          	auipc	a2,0x4
ffffffffc0202df2:	06260613          	addi	a2,a2,98 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202df6:	20500593          	li	a1,517
ffffffffc0202dfa:	00005517          	auipc	a0,0x5
ffffffffc0202dfe:	83e50513          	addi	a0,a0,-1986 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202e02:	e78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202e06:	00005697          	auipc	a3,0x5
ffffffffc0202e0a:	b0a68693          	addi	a3,a3,-1270 # ffffffffc0207910 <default_pmm_manager+0x428>
ffffffffc0202e0e:	00004617          	auipc	a2,0x4
ffffffffc0202e12:	04260613          	addi	a2,a2,66 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202e16:	20400593          	li	a1,516
ffffffffc0202e1a:	00005517          	auipc	a0,0x5
ffffffffc0202e1e:	81e50513          	addi	a0,a0,-2018 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202e22:	e58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202e26:	00005697          	auipc	a3,0x5
ffffffffc0202e2a:	ca268693          	addi	a3,a3,-862 # ffffffffc0207ac8 <default_pmm_manager+0x5e0>
ffffffffc0202e2e:	00004617          	auipc	a2,0x4
ffffffffc0202e32:	02260613          	addi	a2,a2,34 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202e36:	23300593          	li	a1,563
ffffffffc0202e3a:	00004517          	auipc	a0,0x4
ffffffffc0202e3e:	7fe50513          	addi	a0,a0,2046 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202e42:	e38fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc0202e46:	00005697          	auipc	a3,0x5
ffffffffc0202e4a:	a9a68693          	addi	a3,a3,-1382 # ffffffffc02078e0 <default_pmm_manager+0x3f8>
ffffffffc0202e4e:	00004617          	auipc	a2,0x4
ffffffffc0202e52:	00260613          	addi	a2,a2,2 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202e56:	20100593          	li	a1,513
ffffffffc0202e5a:	00004517          	auipc	a0,0x4
ffffffffc0202e5e:	7de50513          	addi	a0,a0,2014 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202e62:	e18fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202e66:	00005697          	auipc	a3,0x5
ffffffffc0202e6a:	a6a68693          	addi	a3,a3,-1430 # ffffffffc02078d0 <default_pmm_manager+0x3e8>
ffffffffc0202e6e:	00004617          	auipc	a2,0x4
ffffffffc0202e72:	fe260613          	addi	a2,a2,-30 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202e76:	20000593          	li	a1,512
ffffffffc0202e7a:	00004517          	auipc	a0,0x4
ffffffffc0202e7e:	7be50513          	addi	a0,a0,1982 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202e82:	df8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202e86:	00005697          	auipc	a3,0x5
ffffffffc0202e8a:	b4268693          	addi	a3,a3,-1214 # ffffffffc02079c8 <default_pmm_manager+0x4e0>
ffffffffc0202e8e:	00004617          	auipc	a2,0x4
ffffffffc0202e92:	fc260613          	addi	a2,a2,-62 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202e96:	24400593          	li	a1,580
ffffffffc0202e9a:	00004517          	auipc	a0,0x4
ffffffffc0202e9e:	79e50513          	addi	a0,a0,1950 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202ea2:	dd8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202ea6:	00005697          	auipc	a3,0x5
ffffffffc0202eaa:	a1a68693          	addi	a3,a3,-1510 # ffffffffc02078c0 <default_pmm_manager+0x3d8>
ffffffffc0202eae:	00004617          	auipc	a2,0x4
ffffffffc0202eb2:	fa260613          	addi	a2,a2,-94 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202eb6:	1ff00593          	li	a1,511
ffffffffc0202eba:	00004517          	auipc	a0,0x4
ffffffffc0202ebe:	77e50513          	addi	a0,a0,1918 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202ec2:	db8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202ec6:	00005697          	auipc	a3,0x5
ffffffffc0202eca:	95268693          	addi	a3,a3,-1710 # ffffffffc0207818 <default_pmm_manager+0x330>
ffffffffc0202ece:	00004617          	auipc	a2,0x4
ffffffffc0202ed2:	f8260613          	addi	a2,a2,-126 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202ed6:	20c00593          	li	a1,524
ffffffffc0202eda:	00004517          	auipc	a0,0x4
ffffffffc0202ede:	75e50513          	addi	a0,a0,1886 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202ee2:	d98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202ee6:	00005697          	auipc	a3,0x5
ffffffffc0202eea:	a8a68693          	addi	a3,a3,-1398 # ffffffffc0207970 <default_pmm_manager+0x488>
ffffffffc0202eee:	00004617          	auipc	a2,0x4
ffffffffc0202ef2:	f6260613          	addi	a2,a2,-158 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202ef6:	20900593          	li	a1,521
ffffffffc0202efa:	00004517          	auipc	a0,0x4
ffffffffc0202efe:	73e50513          	addi	a0,a0,1854 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202f02:	d78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202f06:	00005697          	auipc	a3,0x5
ffffffffc0202f0a:	8fa68693          	addi	a3,a3,-1798 # ffffffffc0207800 <default_pmm_manager+0x318>
ffffffffc0202f0e:	00004617          	auipc	a2,0x4
ffffffffc0202f12:	f4260613          	addi	a2,a2,-190 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202f16:	20800593          	li	a1,520
ffffffffc0202f1a:	00004517          	auipc	a0,0x4
ffffffffc0202f1e:	71e50513          	addi	a0,a0,1822 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202f22:	d58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202f26:	00004617          	auipc	a2,0x4
ffffffffc0202f2a:	5fa60613          	addi	a2,a2,1530 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0202f2e:	06900593          	li	a1,105
ffffffffc0202f32:	00004517          	auipc	a0,0x4
ffffffffc0202f36:	61650513          	addi	a0,a0,1558 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0202f3a:	d40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc0202f3e:	00005697          	auipc	a3,0x5
ffffffffc0202f42:	a6268693          	addi	a3,a3,-1438 # ffffffffc02079a0 <default_pmm_manager+0x4b8>
ffffffffc0202f46:	00004617          	auipc	a2,0x4
ffffffffc0202f4a:	f0a60613          	addi	a2,a2,-246 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202f4e:	21300593          	li	a1,531
ffffffffc0202f52:	00004517          	auipc	a0,0x4
ffffffffc0202f56:	6e650513          	addi	a0,a0,1766 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202f5a:	d20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f5e:	00005697          	auipc	a3,0x5
ffffffffc0202f62:	9fa68693          	addi	a3,a3,-1542 # ffffffffc0207958 <default_pmm_manager+0x470>
ffffffffc0202f66:	00004617          	auipc	a2,0x4
ffffffffc0202f6a:	eea60613          	addi	a2,a2,-278 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202f6e:	21100593          	li	a1,529
ffffffffc0202f72:	00004517          	auipc	a0,0x4
ffffffffc0202f76:	6c650513          	addi	a0,a0,1734 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202f7a:	d00fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202f7e:	00005697          	auipc	a3,0x5
ffffffffc0202f82:	a0a68693          	addi	a3,a3,-1526 # ffffffffc0207988 <default_pmm_manager+0x4a0>
ffffffffc0202f86:	00004617          	auipc	a2,0x4
ffffffffc0202f8a:	eca60613          	addi	a2,a2,-310 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202f8e:	21000593          	li	a1,528
ffffffffc0202f92:	00004517          	auipc	a0,0x4
ffffffffc0202f96:	6a650513          	addi	a0,a0,1702 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202f9a:	ce0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f9e:	00005697          	auipc	a3,0x5
ffffffffc0202fa2:	9ba68693          	addi	a3,a3,-1606 # ffffffffc0207958 <default_pmm_manager+0x470>
ffffffffc0202fa6:	00004617          	auipc	a2,0x4
ffffffffc0202faa:	eaa60613          	addi	a2,a2,-342 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202fae:	20d00593          	li	a1,525
ffffffffc0202fb2:	00004517          	auipc	a0,0x4
ffffffffc0202fb6:	68650513          	addi	a0,a0,1670 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202fba:	cc0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202fbe:	00005697          	auipc	a3,0x5
ffffffffc0202fc2:	af268693          	addi	a3,a3,-1294 # ffffffffc0207ab0 <default_pmm_manager+0x5c8>
ffffffffc0202fc6:	00004617          	auipc	a2,0x4
ffffffffc0202fca:	e8a60613          	addi	a2,a2,-374 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202fce:	23200593          	li	a1,562
ffffffffc0202fd2:	00004517          	auipc	a0,0x4
ffffffffc0202fd6:	66650513          	addi	a0,a0,1638 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202fda:	ca0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202fde:	00005697          	auipc	a3,0x5
ffffffffc0202fe2:	a9a68693          	addi	a3,a3,-1382 # ffffffffc0207a78 <default_pmm_manager+0x590>
ffffffffc0202fe6:	00004617          	auipc	a2,0x4
ffffffffc0202fea:	e6a60613          	addi	a2,a2,-406 # ffffffffc0206e50 <commands+0x450>
ffffffffc0202fee:	23100593          	li	a1,561
ffffffffc0202ff2:	00004517          	auipc	a0,0x4
ffffffffc0202ff6:	64650513          	addi	a0,a0,1606 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0202ffa:	c80fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202ffe:	00005697          	auipc	a3,0x5
ffffffffc0203002:	a6268693          	addi	a3,a3,-1438 # ffffffffc0207a60 <default_pmm_manager+0x578>
ffffffffc0203006:	00004617          	auipc	a2,0x4
ffffffffc020300a:	e4a60613          	addi	a2,a2,-438 # ffffffffc0206e50 <commands+0x450>
ffffffffc020300e:	22d00593          	li	a1,557
ffffffffc0203012:	00004517          	auipc	a0,0x4
ffffffffc0203016:	62650513          	addi	a0,a0,1574 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc020301a:	c60fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020301e:	00005697          	auipc	a3,0x5
ffffffffc0203022:	9aa68693          	addi	a3,a3,-1622 # ffffffffc02079c8 <default_pmm_manager+0x4e0>
ffffffffc0203026:	00004617          	auipc	a2,0x4
ffffffffc020302a:	e2a60613          	addi	a2,a2,-470 # ffffffffc0206e50 <commands+0x450>
ffffffffc020302e:	21b00593          	li	a1,539
ffffffffc0203032:	00004517          	auipc	a0,0x4
ffffffffc0203036:	60650513          	addi	a0,a0,1542 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc020303a:	c40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020303e:	00004697          	auipc	a3,0x4
ffffffffc0203042:	7c268693          	addi	a3,a3,1986 # ffffffffc0207800 <default_pmm_manager+0x318>
ffffffffc0203046:	00004617          	auipc	a2,0x4
ffffffffc020304a:	e0a60613          	addi	a2,a2,-502 # ffffffffc0206e50 <commands+0x450>
ffffffffc020304e:	1f500593          	li	a1,501
ffffffffc0203052:	00004517          	auipc	a0,0x4
ffffffffc0203056:	5e650513          	addi	a0,a0,1510 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc020305a:	c20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc020305e:	00004617          	auipc	a2,0x4
ffffffffc0203062:	4c260613          	addi	a2,a2,1218 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0203066:	1f800593          	li	a1,504
ffffffffc020306a:	00004517          	auipc	a0,0x4
ffffffffc020306e:	5ce50513          	addi	a0,a0,1486 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0203072:	c08fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0203076:	00004697          	auipc	a3,0x4
ffffffffc020307a:	7a268693          	addi	a3,a3,1954 # ffffffffc0207818 <default_pmm_manager+0x330>
ffffffffc020307e:	00004617          	auipc	a2,0x4
ffffffffc0203082:	dd260613          	addi	a2,a2,-558 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203086:	1f600593          	li	a1,502
ffffffffc020308a:	00004517          	auipc	a0,0x4
ffffffffc020308e:	5ae50513          	addi	a0,a0,1454 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc0203092:	be8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0203096:	00004697          	auipc	a3,0x4
ffffffffc020309a:	7fa68693          	addi	a3,a3,2042 # ffffffffc0207890 <default_pmm_manager+0x3a8>
ffffffffc020309e:	00004617          	auipc	a2,0x4
ffffffffc02030a2:	db260613          	addi	a2,a2,-590 # ffffffffc0206e50 <commands+0x450>
ffffffffc02030a6:	1fe00593          	li	a1,510
ffffffffc02030aa:	00004517          	auipc	a0,0x4
ffffffffc02030ae:	58e50513          	addi	a0,a0,1422 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc02030b2:	bc8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02030b6:	00005697          	auipc	a3,0x5
ffffffffc02030ba:	aba68693          	addi	a3,a3,-1350 # ffffffffc0207b70 <default_pmm_manager+0x688>
ffffffffc02030be:	00004617          	auipc	a2,0x4
ffffffffc02030c2:	d9260613          	addi	a2,a2,-622 # ffffffffc0206e50 <commands+0x450>
ffffffffc02030c6:	23b00593          	li	a1,571
ffffffffc02030ca:	00004517          	auipc	a0,0x4
ffffffffc02030ce:	56e50513          	addi	a0,a0,1390 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc02030d2:	ba8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02030d6:	00005697          	auipc	a3,0x5
ffffffffc02030da:	a6268693          	addi	a3,a3,-1438 # ffffffffc0207b38 <default_pmm_manager+0x650>
ffffffffc02030de:	00004617          	auipc	a2,0x4
ffffffffc02030e2:	d7260613          	addi	a2,a2,-654 # ffffffffc0206e50 <commands+0x450>
ffffffffc02030e6:	23800593          	li	a1,568
ffffffffc02030ea:	00004517          	auipc	a0,0x4
ffffffffc02030ee:	54e50513          	addi	a0,a0,1358 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc02030f2:	b88fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 2);
ffffffffc02030f6:	00005697          	auipc	a3,0x5
ffffffffc02030fa:	a1268693          	addi	a3,a3,-1518 # ffffffffc0207b08 <default_pmm_manager+0x620>
ffffffffc02030fe:	00004617          	auipc	a2,0x4
ffffffffc0203102:	d5260613          	addi	a2,a2,-686 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203106:	23400593          	li	a1,564
ffffffffc020310a:	00004517          	auipc	a0,0x4
ffffffffc020310e:	52e50513          	addi	a0,a0,1326 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0203232:	54c030ef          	jal	ra,ffffffffc020677e <memcpy>
...
ffffffffc0203248:	99468693          	addi	a3,a3,-1644 # ffffffffc0207bd8 <default_pmm_manager+0x6f0>
ffffffffc020324c:	00004617          	auipc	a2,0x4
ffffffffc0203250:	c0460613          	addi	a2,a2,-1020 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203254:	18d00593          	li	a1,397
ffffffffc0203258:	00004517          	auipc	a0,0x4
ffffffffc020325c:	3e050513          	addi	a0,a0,992 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc0203282:	2a260613          	addi	a2,a2,674 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0203286:	06900593          	li	a1,105
ffffffffc020328a:	00004517          	auipc	a0,0x4
ffffffffc020328e:	2be50513          	addi	a0,a0,702 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0203292:	9e8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(page != NULL);
ffffffffc0203296:	00005697          	auipc	a3,0x5
ffffffffc020329a:	92268693          	addi	a3,a3,-1758 # ffffffffc0207bb8 <default_pmm_manager+0x6d0>
ffffffffc020329e:	00004617          	auipc	a2,0x4
ffffffffc02032a2:	bb260613          	addi	a2,a2,-1102 # ffffffffc0206e50 <commands+0x450>
ffffffffc02032a6:	17200593          	li	a1,370
ffffffffc02032aa:	00004517          	auipc	a0,0x4
ffffffffc02032ae:	38e50513          	addi	a0,a0,910 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc02032b2:	9c8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc02032b6:	00004697          	auipc	a3,0x4
ffffffffc02032ba:	3c268693          	addi	a3,a3,962 # ffffffffc0207678 <default_pmm_manager+0x190>
ffffffffc02032be:	00004617          	auipc	a2,0x4
ffffffffc02032c2:	b9260613          	addi	a2,a2,-1134 # ffffffffc0206e50 <commands+0x450>
ffffffffc02032c6:	15e00593          	li	a1,350
ffffffffc02032ca:	00004517          	auipc	a0,0x4
ffffffffc02032ce:	36e50513          	addi	a0,a0,878 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc02032d2:	9a8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(npage != NULL);
ffffffffc02032d6:	00005697          	auipc	a3,0x5
ffffffffc02032da:	8f268693          	addi	a3,a3,-1806 # ffffffffc0207bc8 <default_pmm_manager+0x6e0>
ffffffffc02032de:	00004617          	auipc	a2,0x4
ffffffffc02032e2:	b7260613          	addi	a2,a2,-1166 # ffffffffc0206e50 <commands+0x450>
ffffffffc02032e6:	17300593          	li	a1,371
ffffffffc02032ea:	00004517          	auipc	a0,0x4
ffffffffc02032ee:	34e50513          	addi	a0,a0,846 # ffffffffc0207638 <default_pmm_manager+0x150>
ffffffffc02032f2:	988fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02032f6:	00004617          	auipc	a2,0x4
ffffffffc02032fa:	2fa60613          	addi	a2,a2,762 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc02032fe:	06200593          	li	a1,98
ffffffffc0203302:	00004517          	auipc	a0,0x4
ffffffffc0203306:	24650513          	addi	a0,a0,582 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc020330a:	970fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc020330e:	00004617          	auipc	a2,0x4
ffffffffc0203312:	30260613          	addi	a2,a2,770 # ffffffffc0207610 <default_pmm_manager+0x128>
ffffffffc0203316:	07400593          	li	a1,116
ffffffffc020331a:	00004517          	auipc	a0,0x4
ffffffffc020331e:	22e50513          	addi	a0,a0,558 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0203322:	958fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc0203326:	00004697          	auipc	a3,0x4
ffffffffc020332a:	32268693          	addi	a3,a3,802 # ffffffffc0207648 <default_pmm_manager+0x160>
ffffffffc020332e:	00004617          	auipc	a2,0x4
ffffffffc0203332:	b2260613          	addi	a2,a2,-1246 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203336:	15d00593          	li	a1,349
ffffffffc020333a:	00004517          	auipc	a0,0x4
ffffffffc020333e:	2fe50513          	addi	a0,a0,766 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc02033e4:	bf6d                	j	ffffffffc020339e <pgdir_alloc_page+0x52>
                assert(page_ref(page) == 1);
ffffffffc02033e6:	00005697          	auipc	a3,0x5
ffffffffc02033ea:	80268693          	addi	a3,a3,-2046 # ffffffffc0207be8 <default_pmm_manager+0x700>
ffffffffc02033ee:	00004617          	auipc	a2,0x4
ffffffffc02033f2:	a6260613          	addi	a2,a2,-1438 # ffffffffc0206e50 <commands+0x450>
ffffffffc02033f6:	1cc00593          	li	a1,460
ffffffffc02033fa:	00004517          	auipc	a0,0x4
ffffffffc02033fe:	23e50513          	addi	a0,a0,574 # ffffffffc0207638 <default_pmm_manager+0x150>
...
ffffffffc020340c:	1e860613          	addi	a2,a2,488 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc0203410:	06200593          	li	a1,98
ffffffffc0203414:	00004517          	auipc	a0,0x4
ffffffffc0203418:	13450513          	addi	a0,a0,308 # ffffffffc0207548 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc020349c:	79850513          	addi	a0,a0,1944 # ffffffffc0207c30 <default_pmm_manager+0x748>
    return listelm->next;
...
ffffffffc02034ee:	75e50513          	addi	a0,a0,1886 # ffffffffc0207c48 <default_pmm_manager+0x760>
...
ffffffffc0203542:	77a50513          	addi	a0,a0,1914 # ffffffffc0207cb8 <default_pmm_manager+0x7d0>
...
ffffffffc020355e:	7ae50513          	addi	a0,a0,1966 # ffffffffc0207d08 <default_pmm_manager+0x820>
...
ffffffffc02035d2:	7c250513          	addi	a0,a0,1986 # ffffffffc0207d90 <default_pmm_manager+0x8a8>
...
ffffffffc02036ea:	78260613          	addi	a2,a2,1922 # ffffffffc0208e68 <nbase>
...
ffffffffc0203716:	72650513          	addi	a0,a0,1830 # ffffffffc0207e38 <default_pmm_manager+0x950>
...
ffffffffc02037f6:	69650513          	addi	a0,a0,1686 # ffffffffc0207e88 <default_pmm_manager+0x9a0>
...
ffffffffc0203808:	93c68693          	addi	a3,a3,-1732 # ffffffffc0207140 <commands+0x740>
ffffffffc020380c:	00003617          	auipc	a2,0x3
ffffffffc0203810:	64460613          	addi	a2,a2,1604 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203814:	0bc00593          	li	a1,188
ffffffffc0203818:	00004517          	auipc	a0,0x4
ffffffffc020381c:	40850513          	addi	a0,a0,1032 # ffffffffc0207c20 <default_pmm_manager+0x738>
...
ffffffffc020382c:	dc860613          	addi	a2,a2,-568 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc0203830:	06200593          	li	a1,98
ffffffffc0203834:	00004517          	auipc	a0,0x4
ffffffffc0203838:	d1450513          	addi	a0,a0,-748 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc020383c:	c3ffc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0203840:	00004697          	auipc	a3,0x4
ffffffffc0203844:	5d068693          	addi	a3,a3,1488 # ffffffffc0207e10 <default_pmm_manager+0x928>
ffffffffc0203848:	00003617          	auipc	a2,0x3
ffffffffc020384c:	60860613          	addi	a2,a2,1544 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203850:	0fc00593          	li	a1,252
ffffffffc0203854:	00004517          	auipc	a0,0x4
ffffffffc0203858:	3cc50513          	addi	a0,a0,972 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc020385c:	c1ffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0203860:	00004697          	auipc	a3,0x4
ffffffffc0203864:	4d068693          	addi	a3,a3,1232 # ffffffffc0207d30 <default_pmm_manager+0x848>
ffffffffc0203868:	00003617          	auipc	a2,0x3
ffffffffc020386c:	5e860613          	addi	a2,a2,1512 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203870:	0dc00593          	li	a1,220
ffffffffc0203874:	00004517          	auipc	a0,0x4
ffffffffc0203878:	3ac50513          	addi	a0,a0,940 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc020387c:	bfffc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203880:	00004617          	auipc	a2,0x4
ffffffffc0203884:	38060613          	addi	a2,a2,896 # ffffffffc0207c00 <default_pmm_manager+0x718>
ffffffffc0203888:	02800593          	li	a1,40
ffffffffc020388c:	00004517          	auipc	a0,0x4
ffffffffc0203890:	39450513          	addi	a0,a0,916 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203894:	be7fc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0203898:	00004697          	auipc	a3,0x4
ffffffffc020389c:	56068693          	addi	a3,a3,1376 # ffffffffc0207df8 <default_pmm_manager+0x910>
ffffffffc02038a0:	00003617          	auipc	a2,0x3
ffffffffc02038a4:	5b060613          	addi	a2,a2,1456 # ffffffffc0206e50 <commands+0x450>
ffffffffc02038a8:	0fb00593          	li	a1,251
ffffffffc02038ac:	00004517          	auipc	a0,0x4
ffffffffc02038b0:	37450513          	addi	a0,a0,884 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc02038b4:	bc7fc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02038b8:	00004617          	auipc	a2,0x4
ffffffffc02038bc:	d5860613          	addi	a2,a2,-680 # ffffffffc0207610 <default_pmm_manager+0x128>
ffffffffc02038c0:	07400593          	li	a1,116
ffffffffc02038c4:	00004517          	auipc	a0,0x4
ffffffffc02038c8:	c8450513          	addi	a0,a0,-892 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc02038cc:	baffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc02038d0:	00004697          	auipc	a3,0x4
ffffffffc02038d4:	47868693          	addi	a3,a3,1144 # ffffffffc0207d48 <default_pmm_manager+0x860>
ffffffffc02038d8:	00003617          	auipc	a2,0x3
ffffffffc02038dc:	57860613          	addi	a2,a2,1400 # ffffffffc0206e50 <commands+0x450>
ffffffffc02038e0:	0dd00593          	li	a1,221
ffffffffc02038e4:	00004517          	auipc	a0,0x4
ffffffffc02038e8:	33c50513          	addi	a0,a0,828 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc02038ec:	b8ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(check_mm_struct == NULL);
ffffffffc02038f0:	00004697          	auipc	a3,0x4
ffffffffc02038f4:	39068693          	addi	a3,a3,912 # ffffffffc0207c80 <default_pmm_manager+0x798>
ffffffffc02038f8:	00003617          	auipc	a2,0x3
ffffffffc02038fc:	55860613          	addi	a2,a2,1368 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203900:	0c700593          	li	a1,199
ffffffffc0203904:	00004517          	auipc	a0,0x4
ffffffffc0203908:	31c50513          	addi	a0,a0,796 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc020390c:	b6ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total == nr_free_pages());
ffffffffc0203910:	00004697          	auipc	a3,0x4
ffffffffc0203914:	85868693          	addi	a3,a3,-1960 # ffffffffc0207168 <commands+0x768>
ffffffffc0203918:	00003617          	auipc	a2,0x3
ffffffffc020391c:	53860613          	addi	a2,a2,1336 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203920:	0bf00593          	li	a1,191
ffffffffc0203924:	00004517          	auipc	a0,0x4
ffffffffc0203928:	2fc50513          	addi	a0,a0,764 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc020392c:	b4ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert( nr_free == 0);         
ffffffffc0203930:	00004697          	auipc	a3,0x4
ffffffffc0203934:	9e068693          	addi	a3,a3,-1568 # ffffffffc0207310 <commands+0x910>
ffffffffc0203938:	00003617          	auipc	a2,0x3
ffffffffc020393c:	51860613          	addi	a2,a2,1304 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203940:	0f300593          	li	a1,243
ffffffffc0203944:	00004517          	auipc	a0,0x4
ffffffffc0203948:	2dc50513          	addi	a0,a0,732 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc020394c:	b2ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203950:	00004697          	auipc	a3,0x4
ffffffffc0203954:	34868693          	addi	a3,a3,840 # ffffffffc0207c98 <default_pmm_manager+0x7b0>
ffffffffc0203958:	00003617          	auipc	a2,0x3
ffffffffc020395c:	4f860613          	addi	a2,a2,1272 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203960:	0cc00593          	li	a1,204
ffffffffc0203964:	00004517          	auipc	a0,0x4
ffffffffc0203968:	2bc50513          	addi	a0,a0,700 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc020396c:	b0ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(mm != NULL);
ffffffffc0203970:	00004697          	auipc	a3,0x4
ffffffffc0203974:	30068693          	addi	a3,a3,768 # ffffffffc0207c70 <default_pmm_manager+0x788>
ffffffffc0203978:	00003617          	auipc	a2,0x3
ffffffffc020397c:	4d860613          	addi	a2,a2,1240 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203980:	0c400593          	li	a1,196
ffffffffc0203984:	00004517          	auipc	a0,0x4
ffffffffc0203988:	29c50513          	addi	a0,a0,668 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc020398c:	aeffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total==0);
ffffffffc0203990:	00004697          	auipc	a3,0x4
ffffffffc0203994:	4e868693          	addi	a3,a3,1256 # ffffffffc0207e78 <default_pmm_manager+0x990>
ffffffffc0203998:	00003617          	auipc	a2,0x3
ffffffffc020399c:	4b860613          	addi	a2,a2,1208 # ffffffffc0206e50 <commands+0x450>
ffffffffc02039a0:	11e00593          	li	a1,286
ffffffffc02039a4:	00004517          	auipc	a0,0x4
ffffffffc02039a8:	27c50513          	addi	a0,a0,636 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc02039ac:	acffc0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02039b0:	00004617          	auipc	a2,0x4
ffffffffc02039b4:	b7060613          	addi	a2,a2,-1168 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc02039b8:	06900593          	li	a1,105
ffffffffc02039bc:	00004517          	auipc	a0,0x4
ffffffffc02039c0:	b8c50513          	addi	a0,a0,-1140 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc02039c4:	ab7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(count==0);
ffffffffc02039c8:	00004697          	auipc	a3,0x4
ffffffffc02039cc:	4a068693          	addi	a3,a3,1184 # ffffffffc0207e68 <default_pmm_manager+0x980>
ffffffffc02039d0:	00003617          	auipc	a2,0x3
ffffffffc02039d4:	48060613          	addi	a2,a2,1152 # ffffffffc0206e50 <commands+0x450>
ffffffffc02039d8:	11d00593          	li	a1,285
ffffffffc02039dc:	00004517          	auipc	a0,0x4
ffffffffc02039e0:	24450513          	addi	a0,a0,580 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc02039e4:	a97fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc02039e8:	00004697          	auipc	a3,0x4
ffffffffc02039ec:	3d068693          	addi	a3,a3,976 # ffffffffc0207db8 <default_pmm_manager+0x8d0>
ffffffffc02039f0:	00003617          	auipc	a2,0x3
ffffffffc02039f4:	46060613          	addi	a2,a2,1120 # ffffffffc0206e50 <commands+0x450>
ffffffffc02039f8:	09500593          	li	a1,149
ffffffffc02039fc:	00004517          	auipc	a0,0x4
ffffffffc0203a00:	22450513          	addi	a0,a0,548 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203a04:	a77fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203a08:	00004697          	auipc	a3,0x4
ffffffffc0203a0c:	36068693          	addi	a3,a3,864 # ffffffffc0207d68 <default_pmm_manager+0x880>
ffffffffc0203a10:	00003617          	auipc	a2,0x3
ffffffffc0203a14:	44060613          	addi	a2,a2,1088 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203a18:	0ea00593          	li	a1,234
ffffffffc0203a1c:	00004517          	auipc	a0,0x4
ffffffffc0203a20:	20450513          	addi	a0,a0,516 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203a24:	a57fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0203a28:	00004697          	auipc	a3,0x4
ffffffffc0203a2c:	2c868693          	addi	a3,a3,712 # ffffffffc0207cf0 <default_pmm_manager+0x808>
ffffffffc0203a30:	00003617          	auipc	a2,0x3
ffffffffc0203a34:	42060613          	addi	a2,a2,1056 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203a38:	0d700593          	li	a1,215
ffffffffc0203a3c:	00004517          	auipc	a0,0x4
ffffffffc0203a40:	1e450513          	addi	a0,a0,484 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203a44:	a37fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(ret==0);
ffffffffc0203a48:	00004697          	auipc	a3,0x4
ffffffffc0203a4c:	41868693          	addi	a3,a3,1048 # ffffffffc0207e60 <default_pmm_manager+0x978>
ffffffffc0203a50:	00003617          	auipc	a2,0x3
ffffffffc0203a54:	40060613          	addi	a2,a2,1024 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203a58:	10200593          	li	a1,258
ffffffffc0203a5c:	00004517          	auipc	a0,0x4
ffffffffc0203a60:	1c450513          	addi	a0,a0,452 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203a64:	a17fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(vma != NULL);
ffffffffc0203a68:	00004697          	auipc	a3,0x4
ffffffffc0203a6c:	24068693          	addi	a3,a3,576 # ffffffffc0207ca8 <default_pmm_manager+0x7c0>
ffffffffc0203a70:	00003617          	auipc	a2,0x3
ffffffffc0203a74:	3e060613          	addi	a2,a2,992 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203a78:	0cf00593          	li	a1,207
ffffffffc0203a7c:	00004517          	auipc	a0,0x4
ffffffffc0203a80:	1a450513          	addi	a0,a0,420 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203a84:	9f7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203a88:	00004697          	auipc	a3,0x4
ffffffffc0203a8c:	36068693          	addi	a3,a3,864 # ffffffffc0207de8 <default_pmm_manager+0x900>
ffffffffc0203a90:	00003617          	auipc	a2,0x3
ffffffffc0203a94:	3c060613          	addi	a2,a2,960 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203a98:	09f00593          	li	a1,159
ffffffffc0203a9c:	00004517          	auipc	a0,0x4
ffffffffc0203aa0:	18450513          	addi	a0,a0,388 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203aa4:	9d7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203aa8:	00004697          	auipc	a3,0x4
ffffffffc0203aac:	34068693          	addi	a3,a3,832 # ffffffffc0207de8 <default_pmm_manager+0x900>
ffffffffc0203ab0:	00003617          	auipc	a2,0x3
ffffffffc0203ab4:	3a060613          	addi	a2,a2,928 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203ab8:	0a100593          	li	a1,161
ffffffffc0203abc:	00004517          	auipc	a0,0x4
ffffffffc0203ac0:	16450513          	addi	a0,a0,356 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203ac4:	9b7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ac8:	00004697          	auipc	a3,0x4
ffffffffc0203acc:	30068693          	addi	a3,a3,768 # ffffffffc0207dc8 <default_pmm_manager+0x8e0>
ffffffffc0203ad0:	00003617          	auipc	a2,0x3
ffffffffc0203ad4:	38060613          	addi	a2,a2,896 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203ad8:	09700593          	li	a1,151
ffffffffc0203adc:	00004517          	auipc	a0,0x4
ffffffffc0203ae0:	14450513          	addi	a0,a0,324 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203ae4:	997fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ae8:	00004697          	auipc	a3,0x4
ffffffffc0203aec:	2e068693          	addi	a3,a3,736 # ffffffffc0207dc8 <default_pmm_manager+0x8e0>
ffffffffc0203af0:	00003617          	auipc	a2,0x3
ffffffffc0203af4:	36060613          	addi	a2,a2,864 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203af8:	09900593          	li	a1,153
ffffffffc0203afc:	00004517          	auipc	a0,0x4
ffffffffc0203b00:	12450513          	addi	a0,a0,292 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203b04:	977fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b08:	00004697          	auipc	a3,0x4
ffffffffc0203b0c:	2d068693          	addi	a3,a3,720 # ffffffffc0207dd8 <default_pmm_manager+0x8f0>
ffffffffc0203b10:	00003617          	auipc	a2,0x3
ffffffffc0203b14:	34060613          	addi	a2,a2,832 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203b18:	09b00593          	li	a1,155
ffffffffc0203b1c:	00004517          	auipc	a0,0x4
ffffffffc0203b20:	10450513          	addi	a0,a0,260 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203b24:	957fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b28:	00004697          	auipc	a3,0x4
ffffffffc0203b2c:	2b068693          	addi	a3,a3,688 # ffffffffc0207dd8 <default_pmm_manager+0x8f0>
ffffffffc0203b30:	00003617          	auipc	a2,0x3
ffffffffc0203b34:	32060613          	addi	a2,a2,800 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203b38:	09d00593          	li	a1,157
ffffffffc0203b3c:	00004517          	auipc	a0,0x4
ffffffffc0203b40:	0e450513          	addi	a0,a0,228 # ffffffffc0207c20 <default_pmm_manager+0x738>
ffffffffc0203b44:	937fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc0203b48:	00004697          	auipc	a3,0x4
ffffffffc0203b4c:	27068693          	addi	a3,a3,624 # ffffffffc0207db8 <default_pmm_manager+0x8d0>
ffffffffc0203b50:	00003617          	auipc	a2,0x3
ffffffffc0203b54:	30060613          	addi	a2,a2,768 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203b58:	09300593          	li	a1,147
ffffffffc0203b5c:	00004517          	auipc	a0,0x4
ffffffffc0203b60:	0c450513          	addi	a0,a0,196 # ffffffffc0207c20 <default_pmm_manager+0x738>
...
ffffffffc0203bac:	360b0b13          	addi	s6,s6,864 # ffffffffc0207f08 <default_pmm_manager+0xa20>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203bb0:	00004b97          	auipc	s7,0x4
ffffffffc0203bb4:	340b8b93          	addi	s7,s7,832 # ffffffffc0207ef0 <default_pmm_manager+0xa08>
...
ffffffffc0203c66:	24650513          	addi	a0,a0,582 # ffffffffc0207ea8 <default_pmm_manager+0x9c0>
...
ffffffffc0203c78:	26468693          	addi	a3,a3,612 # ffffffffc0207ed8 <default_pmm_manager+0x9f0>
ffffffffc0203c7c:	00003617          	auipc	a2,0x3
ffffffffc0203c80:	1d460613          	addi	a2,a2,468 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203c84:	06800593          	li	a1,104
ffffffffc0203c88:	00004517          	auipc	a0,0x4
ffffffffc0203c8c:	f9850513          	addi	a0,a0,-104 # ffffffffc0207c20 <default_pmm_manager+0x738>
...
ffffffffc0203cd0:	28c50513          	addi	a0,a0,652 # ffffffffc0207f58 <default_pmm_manager+0xa70>
...
ffffffffc0203cf2:	25a68693          	addi	a3,a3,602 # ffffffffc0207f48 <default_pmm_manager+0xa60>
ffffffffc0203cf6:	00003617          	auipc	a2,0x3
ffffffffc0203cfa:	15a60613          	addi	a2,a2,346 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203cfe:	07e00593          	li	a1,126
ffffffffc0203d02:	00004517          	auipc	a0,0x4
ffffffffc0203d06:	f1e50513          	addi	a0,a0,-226 # ffffffffc0207c20 <default_pmm_manager+0x738>
...
ffffffffc0203d36:	26650513          	addi	a0,a0,614 # ffffffffc0207f98 <default_pmm_manager+0xab0>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc0203d6c:	27050513          	addi	a0,a0,624 # ffffffffc0207fd8 <default_pmm_manager+0xaf0>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203d90:	27450513          	addi	a0,a0,628 # ffffffffc0208000 <default_pmm_manager+0xb18>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc0203dae:	27e50513          	addi	a0,a0,638 # ffffffffc0208028 <default_pmm_manager+0xb40>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203dca:	28a50513          	addi	a0,a0,650 # ffffffffc0208050 <default_pmm_manager+0xb68>
...
ffffffffc0203de8:	24450513          	addi	a0,a0,580 # ffffffffc0208028 <default_pmm_manager+0xb40>
...
ffffffffc0203e00:	1dc50513          	addi	a0,a0,476 # ffffffffc0207fd8 <default_pmm_manager+0xaf0>
...
ffffffffc0203e1a:	21250513          	addi	a0,a0,530 # ffffffffc0208028 <default_pmm_manager+0xb40>
...
ffffffffc0203e34:	16850513          	addi	a0,a0,360 # ffffffffc0207f98 <default_pmm_manager+0xab0>
...
ffffffffc0203e4e:	1b650513          	addi	a0,a0,438 # ffffffffc0208000 <default_pmm_manager+0xb18>
...
ffffffffc0203e68:	1ec50513          	addi	a0,a0,492 # ffffffffc0208050 <default_pmm_manager+0xb68>
...
ffffffffc0203e86:	15650513          	addi	a0,a0,342 # ffffffffc0207fd8 <default_pmm_manager+0xaf0>
...
ffffffffc0203ec4:	f2868693          	addi	a3,a3,-216 # ffffffffc0207de8 <default_pmm_manager+0x900>
ffffffffc0203ec8:	00003617          	auipc	a2,0x3
ffffffffc0203ecc:	f8860613          	addi	a2,a2,-120 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203ed0:	05100593          	li	a1,81
ffffffffc0203ed4:	00004517          	auipc	a0,0x4
ffffffffc0203ed8:	0ec50513          	addi	a0,a0,236 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203edc:	d9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==11);
ffffffffc0203ee0:	00004697          	auipc	a3,0x4
ffffffffc0203ee4:	22068693          	addi	a3,a3,544 # ffffffffc0208100 <default_pmm_manager+0xc18>
ffffffffc0203ee8:	00003617          	auipc	a2,0x3
ffffffffc0203eec:	f6860613          	addi	a2,a2,-152 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203ef0:	07300593          	li	a1,115
ffffffffc0203ef4:	00004517          	auipc	a0,0x4
ffffffffc0203ef8:	0cc50513          	addi	a0,a0,204 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203efc:	d7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203f00:	00004697          	auipc	a3,0x4
ffffffffc0203f04:	1d868693          	addi	a3,a3,472 # ffffffffc02080d8 <default_pmm_manager+0xbf0>
ffffffffc0203f08:	00003617          	auipc	a2,0x3
ffffffffc0203f0c:	f4860613          	addi	a2,a2,-184 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203f10:	07100593          	li	a1,113
ffffffffc0203f14:	00004517          	auipc	a0,0x4
ffffffffc0203f18:	0ac50513          	addi	a0,a0,172 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203f1c:	d5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==10);
ffffffffc0203f20:	00004697          	auipc	a3,0x4
ffffffffc0203f24:	1a868693          	addi	a3,a3,424 # ffffffffc02080c8 <default_pmm_manager+0xbe0>
ffffffffc0203f28:	00003617          	auipc	a2,0x3
ffffffffc0203f2c:	f2860613          	addi	a2,a2,-216 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203f30:	06f00593          	li	a1,111
ffffffffc0203f34:	00004517          	auipc	a0,0x4
ffffffffc0203f38:	08c50513          	addi	a0,a0,140 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203f3c:	d3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==9);
ffffffffc0203f40:	00004697          	auipc	a3,0x4
ffffffffc0203f44:	17868693          	addi	a3,a3,376 # ffffffffc02080b8 <default_pmm_manager+0xbd0>
ffffffffc0203f48:	00003617          	auipc	a2,0x3
ffffffffc0203f4c:	f0860613          	addi	a2,a2,-248 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203f50:	06c00593          	li	a1,108
ffffffffc0203f54:	00004517          	auipc	a0,0x4
ffffffffc0203f58:	06c50513          	addi	a0,a0,108 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203f5c:	d1efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==8);
ffffffffc0203f60:	00004697          	auipc	a3,0x4
ffffffffc0203f64:	14868693          	addi	a3,a3,328 # ffffffffc02080a8 <default_pmm_manager+0xbc0>
ffffffffc0203f68:	00003617          	auipc	a2,0x3
ffffffffc0203f6c:	ee860613          	addi	a2,a2,-280 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203f70:	06900593          	li	a1,105
ffffffffc0203f74:	00004517          	auipc	a0,0x4
ffffffffc0203f78:	04c50513          	addi	a0,a0,76 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203f7c:	cfefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==7);
ffffffffc0203f80:	00004697          	auipc	a3,0x4
ffffffffc0203f84:	11868693          	addi	a3,a3,280 # ffffffffc0208098 <default_pmm_manager+0xbb0>
ffffffffc0203f88:	00003617          	auipc	a2,0x3
ffffffffc0203f8c:	ec860613          	addi	a2,a2,-312 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203f90:	06600593          	li	a1,102
ffffffffc0203f94:	00004517          	auipc	a0,0x4
ffffffffc0203f98:	02c50513          	addi	a0,a0,44 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203f9c:	cdefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==6);
ffffffffc0203fa0:	00004697          	auipc	a3,0x4
ffffffffc0203fa4:	0e868693          	addi	a3,a3,232 # ffffffffc0208088 <default_pmm_manager+0xba0>
ffffffffc0203fa8:	00003617          	auipc	a2,0x3
ffffffffc0203fac:	ea860613          	addi	a2,a2,-344 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203fb0:	06300593          	li	a1,99
ffffffffc0203fb4:	00004517          	auipc	a0,0x4
ffffffffc0203fb8:	00c50513          	addi	a0,a0,12 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203fbc:	cbefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fc0:	00004697          	auipc	a3,0x4
ffffffffc0203fc4:	0b868693          	addi	a3,a3,184 # ffffffffc0208078 <default_pmm_manager+0xb90>
ffffffffc0203fc8:	00003617          	auipc	a2,0x3
ffffffffc0203fcc:	e8860613          	addi	a2,a2,-376 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203fd0:	06000593          	li	a1,96
ffffffffc0203fd4:	00004517          	auipc	a0,0x4
ffffffffc0203fd8:	fec50513          	addi	a0,a0,-20 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203fdc:	c9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fe0:	00004697          	auipc	a3,0x4
ffffffffc0203fe4:	09868693          	addi	a3,a3,152 # ffffffffc0208078 <default_pmm_manager+0xb90>
ffffffffc0203fe8:	00003617          	auipc	a2,0x3
ffffffffc0203fec:	e6860613          	addi	a2,a2,-408 # ffffffffc0206e50 <commands+0x450>
ffffffffc0203ff0:	05d00593          	li	a1,93
ffffffffc0203ff4:	00004517          	auipc	a0,0x4
ffffffffc0203ff8:	fcc50513          	addi	a0,a0,-52 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc0203ffc:	c7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204000:	00004697          	auipc	a3,0x4
ffffffffc0204004:	de868693          	addi	a3,a3,-536 # ffffffffc0207de8 <default_pmm_manager+0x900>
ffffffffc0204008:	00003617          	auipc	a2,0x3
ffffffffc020400c:	e4860613          	addi	a2,a2,-440 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204010:	05a00593          	li	a1,90
ffffffffc0204014:	00004517          	auipc	a0,0x4
ffffffffc0204018:	fac50513          	addi	a0,a0,-84 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc020401c:	c5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204020:	00004697          	auipc	a3,0x4
ffffffffc0204024:	dc868693          	addi	a3,a3,-568 # ffffffffc0207de8 <default_pmm_manager+0x900>
ffffffffc0204028:	00003617          	auipc	a2,0x3
ffffffffc020402c:	e2860613          	addi	a2,a2,-472 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204030:	05700593          	li	a1,87
ffffffffc0204034:	00004517          	auipc	a0,0x4
ffffffffc0204038:	f8c50513          	addi	a0,a0,-116 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc020403c:	c3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204040:	00004697          	auipc	a3,0x4
ffffffffc0204044:	da868693          	addi	a3,a3,-600 # ffffffffc0207de8 <default_pmm_manager+0x900>
ffffffffc0204048:	00003617          	auipc	a2,0x3
ffffffffc020404c:	e0860613          	addi	a2,a2,-504 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204050:	05400593          	li	a1,84
ffffffffc0204054:	00004517          	auipc	a0,0x4
ffffffffc0204058:	f6c50513          	addi	a0,a0,-148 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
...
ffffffffc0204086:	08e68693          	addi	a3,a3,142 # ffffffffc0208110 <default_pmm_manager+0xc28>
ffffffffc020408a:	00003617          	auipc	a2,0x3
ffffffffc020408e:	dc660613          	addi	a2,a2,-570 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204092:	04100593          	li	a1,65
ffffffffc0204096:	00004517          	auipc	a0,0x4
ffffffffc020409a:	f2a50513          	addi	a0,a0,-214 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
ffffffffc020409e:	bdcfc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(in_tick==0);
ffffffffc02040a2:	00004697          	auipc	a3,0x4
ffffffffc02040a6:	07e68693          	addi	a3,a3,126 # ffffffffc0208120 <default_pmm_manager+0xc38>
ffffffffc02040aa:	00003617          	auipc	a2,0x3
ffffffffc02040ae:	da660613          	addi	a2,a2,-602 # ffffffffc0206e50 <commands+0x450>
ffffffffc02040b2:	04200593          	li	a1,66
ffffffffc02040b6:	00004517          	auipc	a0,0x4
ffffffffc02040ba:	f0a50513          	addi	a0,a0,-246 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
...
ffffffffc02040de:	05668693          	addi	a3,a3,86 # ffffffffc0208130 <default_pmm_manager+0xc48>
ffffffffc02040e2:	00003617          	auipc	a2,0x3
ffffffffc02040e6:	d6e60613          	addi	a2,a2,-658 # ffffffffc0206e50 <commands+0x450>
ffffffffc02040ea:	03200593          	li	a1,50
ffffffffc02040ee:	00004517          	auipc	a0,0x4
ffffffffc02040f2:	ed250513          	addi	a0,a0,-302 # ffffffffc0207fc0 <default_pmm_manager+0xad8>
{
...
ffffffffc0204102:	06a68693          	addi	a3,a3,106 # ffffffffc0208168 <default_pmm_manager+0xc80>
ffffffffc0204106:	00003617          	auipc	a2,0x3
ffffffffc020410a:	d4a60613          	addi	a2,a2,-694 # ffffffffc0206e50 <commands+0x450>
ffffffffc020410e:	06d00593          	li	a1,109
ffffffffc0204112:	00004517          	auipc	a0,0x4
ffffffffc0204116:	07650513          	addi	a0,a0,118 # ffffffffc0208188 <default_pmm_manager+0xca0>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc020424a:	f5268693          	addi	a3,a3,-174 # ffffffffc0208198 <default_pmm_manager+0xcb0>
ffffffffc020424e:	00003617          	auipc	a2,0x3
ffffffffc0204252:	c0260613          	addi	a2,a2,-1022 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204256:	07400593          	li	a1,116
ffffffffc020425a:	00004517          	auipc	a0,0x4
ffffffffc020425e:	f2e50513          	addi	a0,a0,-210 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204262:	a18fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0204266:	00004697          	auipc	a3,0x4
ffffffffc020426a:	f7268693          	addi	a3,a3,-142 # ffffffffc02081d8 <default_pmm_manager+0xcf0>
ffffffffc020426e:	00003617          	auipc	a2,0x3
ffffffffc0204272:	be260613          	addi	a2,a2,-1054 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204276:	06c00593          	li	a1,108
ffffffffc020427a:	00004517          	auipc	a0,0x4
ffffffffc020427e:	f0e50513          	addi	a0,a0,-242 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204282:	9f8fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0204286:	00004697          	auipc	a3,0x4
ffffffffc020428a:	f3268693          	addi	a3,a3,-206 # ffffffffc02081b8 <default_pmm_manager+0xcd0>
ffffffffc020428e:	00003617          	auipc	a2,0x3
ffffffffc0204292:	bc260613          	addi	a2,a2,-1086 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204296:	06b00593          	li	a1,107
ffffffffc020429a:	00004517          	auipc	a0,0x4
ffffffffc020429e:	eee50513          	addi	a0,a0,-274 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc02042dc:	f2068693          	addi	a3,a3,-224 # ffffffffc02081f8 <default_pmm_manager+0xd10>
ffffffffc02042e0:	00003617          	auipc	a2,0x3
ffffffffc02042e4:	b7060613          	addi	a2,a2,-1168 # ffffffffc0206e50 <commands+0x450>
ffffffffc02042e8:	09400593          	li	a1,148
ffffffffc02042ec:	00004517          	auipc	a0,0x4
ffffffffc02042f0:	e9c50513          	addi	a0,a0,-356 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc0204386:	b7f5                	j	ffffffffc0204372 <mm_map+0x7a>
    assert(mm != NULL);
ffffffffc0204388:	00004697          	auipc	a3,0x4
ffffffffc020438c:	8e868693          	addi	a3,a3,-1816 # ffffffffc0207c70 <default_pmm_manager+0x788>
ffffffffc0204390:	00003617          	auipc	a2,0x3
ffffffffc0204394:	ac060613          	addi	a2,a2,-1344 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204398:	0a700593          	li	a1,167
ffffffffc020439c:	00004517          	auipc	a0,0x4
ffffffffc02043a0:	dec50513          	addi	a0,a0,-532 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc0204426:	dee68693          	addi	a3,a3,-530 # ffffffffc0208210 <default_pmm_manager+0xd28>
ffffffffc020442a:	00003617          	auipc	a2,0x3
ffffffffc020442e:	a2660613          	addi	a2,a2,-1498 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204432:	0c000593          	li	a1,192
ffffffffc0204436:	00004517          	auipc	a0,0x4
ffffffffc020443a:	d5250513          	addi	a0,a0,-686 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc020449c:	d9868693          	addi	a3,a3,-616 # ffffffffc0208230 <default_pmm_manager+0xd48>
ffffffffc02044a0:	00003617          	auipc	a2,0x3
ffffffffc02044a4:	9b060613          	addi	a2,a2,-1616 # ffffffffc0206e50 <commands+0x450>
ffffffffc02044a8:	0d600593          	li	a1,214
ffffffffc02044ac:	00004517          	auipc	a0,0x4
ffffffffc02044b0:	cdc50513          	addi	a0,a0,-804 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc02044fc:	7b068693          	addi	a3,a3,1968 # ffffffffc0207ca8 <default_pmm_manager+0x7c0>
ffffffffc0204500:	00003617          	auipc	a2,0x3
ffffffffc0204504:	95060613          	addi	a2,a2,-1712 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204508:	11300593          	li	a1,275
ffffffffc020450c:	00004517          	auipc	a0,0x4
ffffffffc0204510:	c7c50513          	addi	a0,a0,-900 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc020454a:	76268693          	addi	a3,a3,1890 # ffffffffc0207ca8 <default_pmm_manager+0x7c0>
ffffffffc020454e:	00003617          	auipc	a2,0x3
ffffffffc0204552:	90260613          	addi	a2,a2,-1790 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204556:	11900593          	li	a1,281
ffffffffc020455a:	00004517          	auipc	a0,0x4
ffffffffc020455e:	c2e50513          	addi	a0,a0,-978 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc020461e:	d3650513          	addi	a0,a0,-714 # ffffffffc0208350 <default_pmm_manager+0xe68>
ffffffffc0204622:	b5ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0204626:	00004697          	auipc	a3,0x4
ffffffffc020462a:	d5268693          	addi	a3,a3,-686 # ffffffffc0208378 <default_pmm_manager+0xe90>
ffffffffc020462e:	00003617          	auipc	a2,0x3
ffffffffc0204632:	82260613          	addi	a2,a2,-2014 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204636:	13b00593          	li	a1,315
ffffffffc020463a:	00004517          	auipc	a0,0x4
ffffffffc020463e:	b4e50513          	addi	a0,a0,-1202 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc0204656:	d3e50513          	addi	a0,a0,-706 # ffffffffc0208390 <default_pmm_manager+0xea8>
...
ffffffffc0204706:	766a3a03          	ld	s4,1894(s4) # ffffffffc0208e68 <nbase>
...
ffffffffc02047a4:	c8050513          	addi	a0,a0,-896 # ffffffffc0208420 <default_pmm_manager+0xf38>
...
ffffffffc02047be:	c8650513          	addi	a0,a0,-890 # ffffffffc0208440 <default_pmm_manager+0xf58>
}
...
ffffffffc02047cc:	aa068693          	addi	a3,a3,-1376 # ffffffffc0208268 <default_pmm_manager+0xd80>
ffffffffc02047d0:	00002617          	auipc	a2,0x2
ffffffffc02047d4:	68060613          	addi	a2,a2,1664 # ffffffffc0206e50 <commands+0x450>
ffffffffc02047d8:	12200593          	li	a1,290
ffffffffc02047dc:	00004517          	auipc	a0,0x4
ffffffffc02047e0:	9ac50513          	addi	a0,a0,-1620 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc02047e4:	c97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02047e8:	00004697          	auipc	a3,0x4
ffffffffc02047ec:	b0868693          	addi	a3,a3,-1272 # ffffffffc02082f0 <default_pmm_manager+0xe08>
ffffffffc02047f0:	00002617          	auipc	a2,0x2
ffffffffc02047f4:	66060613          	addi	a2,a2,1632 # ffffffffc0206e50 <commands+0x450>
ffffffffc02047f8:	13200593          	li	a1,306
ffffffffc02047fc:	00004517          	auipc	a0,0x4
ffffffffc0204800:	98c50513          	addi	a0,a0,-1652 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204804:	c77fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0204808:	00004697          	auipc	a3,0x4
ffffffffc020480c:	b1868693          	addi	a3,a3,-1256 # ffffffffc0208320 <default_pmm_manager+0xe38>
ffffffffc0204810:	00002617          	auipc	a2,0x2
ffffffffc0204814:	64060613          	addi	a2,a2,1600 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204818:	13300593          	li	a1,307
ffffffffc020481c:	00004517          	auipc	a0,0x4
ffffffffc0204820:	96c50513          	addi	a0,a0,-1684 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204824:	c57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(vma != NULL);
ffffffffc0204828:	00003697          	auipc	a3,0x3
ffffffffc020482c:	48068693          	addi	a3,a3,1152 # ffffffffc0207ca8 <default_pmm_manager+0x7c0>
ffffffffc0204830:	00002617          	auipc	a2,0x2
ffffffffc0204834:	62060613          	addi	a2,a2,1568 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204838:	15200593          	li	a1,338
ffffffffc020483c:	00004517          	auipc	a0,0x4
ffffffffc0204840:	94c50513          	addi	a0,a0,-1716 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204844:	c37fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0204848:	00004697          	auipc	a3,0x4
ffffffffc020484c:	a0868693          	addi	a3,a3,-1528 # ffffffffc0208250 <default_pmm_manager+0xd68>
ffffffffc0204850:	00002617          	auipc	a2,0x2
ffffffffc0204854:	60060613          	addi	a2,a2,1536 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204858:	12000593          	li	a1,288
ffffffffc020485c:	00004517          	auipc	a0,0x4
ffffffffc0204860:	92c50513          	addi	a0,a0,-1748 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204864:	c17fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma3 == NULL);
ffffffffc0204868:	00004697          	auipc	a3,0x4
ffffffffc020486c:	a5868693          	addi	a3,a3,-1448 # ffffffffc02082c0 <default_pmm_manager+0xdd8>
ffffffffc0204870:	00002617          	auipc	a2,0x2
ffffffffc0204874:	5e060613          	addi	a2,a2,1504 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204878:	12c00593          	li	a1,300
ffffffffc020487c:	00004517          	auipc	a0,0x4
ffffffffc0204880:	90c50513          	addi	a0,a0,-1780 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204884:	bf7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2 != NULL);
ffffffffc0204888:	00004697          	auipc	a3,0x4
ffffffffc020488c:	a2868693          	addi	a3,a3,-1496 # ffffffffc02082b0 <default_pmm_manager+0xdc8>
ffffffffc0204890:	00002617          	auipc	a2,0x2
ffffffffc0204894:	5c060613          	addi	a2,a2,1472 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204898:	12a00593          	li	a1,298
ffffffffc020489c:	00004517          	auipc	a0,0x4
ffffffffc02048a0:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc02048a4:	bd7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1 != NULL);
ffffffffc02048a8:	00004697          	auipc	a3,0x4
ffffffffc02048ac:	9f868693          	addi	a3,a3,-1544 # ffffffffc02082a0 <default_pmm_manager+0xdb8>
ffffffffc02048b0:	00002617          	auipc	a2,0x2
ffffffffc02048b4:	5a060613          	addi	a2,a2,1440 # ffffffffc0206e50 <commands+0x450>
ffffffffc02048b8:	12800593          	li	a1,296
ffffffffc02048bc:	00004517          	auipc	a0,0x4
ffffffffc02048c0:	8cc50513          	addi	a0,a0,-1844 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc02048c4:	bb7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma5 == NULL);
ffffffffc02048c8:	00004697          	auipc	a3,0x4
ffffffffc02048cc:	a1868693          	addi	a3,a3,-1512 # ffffffffc02082e0 <default_pmm_manager+0xdf8>
ffffffffc02048d0:	00002617          	auipc	a2,0x2
ffffffffc02048d4:	58060613          	addi	a2,a2,1408 # ffffffffc0206e50 <commands+0x450>
ffffffffc02048d8:	13000593          	li	a1,304
ffffffffc02048dc:	00004517          	auipc	a0,0x4
ffffffffc02048e0:	8ac50513          	addi	a0,a0,-1876 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc02048e4:	b97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma4 == NULL);
ffffffffc02048e8:	00004697          	auipc	a3,0x4
ffffffffc02048ec:	9e868693          	addi	a3,a3,-1560 # ffffffffc02082d0 <default_pmm_manager+0xde8>
ffffffffc02048f0:	00002617          	auipc	a2,0x2
ffffffffc02048f4:	56060613          	addi	a2,a2,1376 # ffffffffc0206e50 <commands+0x450>
ffffffffc02048f8:	12e00593          	li	a1,302
ffffffffc02048fc:	00004517          	auipc	a0,0x4
ffffffffc0204900:	88c50513          	addi	a0,a0,-1908 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204904:	b77fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0204908:	00004697          	auipc	a3,0x4
ffffffffc020490c:	aa868693          	addi	a3,a3,-1368 # ffffffffc02083b0 <default_pmm_manager+0xec8>
ffffffffc0204910:	00002617          	auipc	a2,0x2
ffffffffc0204914:	54060613          	addi	a2,a2,1344 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204918:	14b00593          	li	a1,331
ffffffffc020491c:	00004517          	auipc	a0,0x4
ffffffffc0204920:	86c50513          	addi	a0,a0,-1940 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204924:	b57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(mm != NULL);
ffffffffc0204928:	00003697          	auipc	a3,0x3
ffffffffc020492c:	34868693          	addi	a3,a3,840 # ffffffffc0207c70 <default_pmm_manager+0x788>
ffffffffc0204930:	00002617          	auipc	a2,0x2
ffffffffc0204934:	52060613          	addi	a2,a2,1312 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204938:	10c00593          	li	a1,268
ffffffffc020493c:	00004517          	auipc	a0,0x4
ffffffffc0204940:	84c50513          	addi	a0,a0,-1972 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204944:	b37fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0204948:	00004697          	auipc	a3,0x4
ffffffffc020494c:	ab068693          	addi	a3,a3,-1360 # ffffffffc02083f8 <default_pmm_manager+0xf10>
ffffffffc0204950:	00002617          	auipc	a2,0x2
ffffffffc0204954:	50060613          	addi	a2,a2,1280 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204958:	17000593          	li	a1,368
ffffffffc020495c:	00004517          	auipc	a0,0x4
ffffffffc0204960:	82c50513          	addi	a0,a0,-2004 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc0204964:	b17fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0204968:	00003617          	auipc	a2,0x3
ffffffffc020496c:	bb860613          	addi	a2,a2,-1096 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0204970:	06900593          	li	a1,105
ffffffffc0204974:	00003517          	auipc	a0,0x3
ffffffffc0204978:	bd450513          	addi	a0,a0,-1068 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc020497c:	afffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir[0] == 0);
ffffffffc0204980:	00003697          	auipc	a3,0x3
ffffffffc0204984:	31868693          	addi	a3,a3,792 # ffffffffc0207c98 <default_pmm_manager+0x7b0>
ffffffffc0204988:	00002617          	auipc	a2,0x2
ffffffffc020498c:	4c860613          	addi	a2,a2,1224 # ffffffffc0206e50 <commands+0x450>
ffffffffc0204990:	14f00593          	li	a1,335
ffffffffc0204994:	00003517          	auipc	a0,0x3
ffffffffc0204998:	7f450513          	addi	a0,a0,2036 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc020499c:	adffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc02049a0:	00004697          	auipc	a3,0x4
ffffffffc02049a4:	a2868693          	addi	a3,a3,-1496 # ffffffffc02083c8 <default_pmm_manager+0xee0>
ffffffffc02049a8:	00002617          	auipc	a2,0x2
ffffffffc02049ac:	4a860613          	addi	a2,a2,1192 # ffffffffc0206e50 <commands+0x450>
ffffffffc02049b0:	15700593          	li	a1,343
ffffffffc02049b4:	00003517          	auipc	a0,0x3
ffffffffc02049b8:	7d450513          	addi	a0,a0,2004 # ffffffffc0208188 <default_pmm_manager+0xca0>
ffffffffc02049bc:	abffb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02049c0:	00003617          	auipc	a2,0x3
ffffffffc02049c4:	c3060613          	addi	a2,a2,-976 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc02049c8:	06200593          	li	a1,98
ffffffffc02049cc:	00003517          	auipc	a0,0x3
ffffffffc02049d0:	b7c50513          	addi	a0,a0,-1156 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc02049d4:	aa7fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(sum == 0);
ffffffffc02049d8:	00004697          	auipc	a3,0x4
ffffffffc02049dc:	a1068693          	addi	a3,a3,-1520 # ffffffffc02083e8 <default_pmm_manager+0xf00>
ffffffffc02049e0:	00002617          	auipc	a2,0x2
ffffffffc02049e4:	47060613          	addi	a2,a2,1136 # ffffffffc0206e50 <commands+0x450>
ffffffffc02049e8:	16300593          	li	a1,355
ffffffffc02049ec:	00003517          	auipc	a0,0x3
ffffffffc02049f0:	79c50513          	addi	a0,a0,1948 # ffffffffc0208188 <default_pmm_manager+0xca0>
...
ffffffffc0204a9a:	a1250513          	addi	a0,a0,-1518 # ffffffffc02084a8 <default_pmm_manager+0xfc0>
...
ffffffffc0204aac:	9b050513          	addi	a0,a0,-1616 # ffffffffc0208458 <default_pmm_manager+0xf70>
...
ffffffffc0204abc:	a1850513          	addi	a0,a0,-1512 # ffffffffc02084d0 <default_pmm_manager+0xfe8>
...
ffffffffc0204acc:	9c050513          	addi	a0,a0,-1600 # ffffffffc0208488 <default_pmm_manager+0xfa0>
...
ffffffffc0204b92:	96a60613          	addi	a2,a2,-1686 # ffffffffc02084f8 <default_pmm_manager+0x1010>
ffffffffc0204b96:	45b5                	li	a1,13
ffffffffc0204b98:	00004517          	auipc	a0,0x4
ffffffffc0204b9c:	98050513          	addi	a0,a0,-1664 # ffffffffc0208518 <default_pmm_manager+0x1030>
...
ffffffffc0204bcc:	2a073703          	ld	a4,672(a4) # ffffffffc0208e68 <nbase>
...
ffffffffc0204c02:	00004617          	auipc	a2,0x4
ffffffffc0204c06:	92e60613          	addi	a2,a2,-1746 # ffffffffc0208530 <default_pmm_manager+0x1048>
ffffffffc0204c0a:	45d1                	li	a1,20
ffffffffc0204c0c:	00004517          	auipc	a0,0x4
ffffffffc0204c10:	90c50513          	addi	a0,a0,-1780 # ffffffffc0208518 <default_pmm_manager+0x1030>
...
ffffffffc0204c22:	90260613          	addi	a2,a2,-1790 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0204c26:	00003517          	auipc	a0,0x3
ffffffffc0204c2a:	92250513          	addi	a0,a0,-1758 # ffffffffc0207548 <default_pmm_manager+0x60>
...
ffffffffc0204c5a:	21273703          	ld	a4,530(a4) # ffffffffc0208e68 <nbase>
...
ffffffffc0204c90:	00004617          	auipc	a2,0x4
ffffffffc0204c94:	8a060613          	addi	a2,a2,-1888 # ffffffffc0208530 <default_pmm_manager+0x1048>
ffffffffc0204c98:	45e5                	li	a1,25
ffffffffc0204c9a:	00004517          	auipc	a0,0x4
ffffffffc0204c9e:	87e50513          	addi	a0,a0,-1922 # ffffffffc0208518 <default_pmm_manager+0x1030>
...
ffffffffc0204cb0:	87460613          	addi	a2,a2,-1932 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0204cb4:	00003517          	auipc	a0,0x3
ffffffffc0204cb8:	89450513          	addi	a0,a0,-1900 # ffffffffc0207548 <default_pmm_manager+0x60>
...
ffffffffc0204cc2:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cc4:	003000ef          	jal	ra,ffffffffc02054c6 <do_exit>

ffffffffc0204cc8 <get_pid>:
get_pid(void) {
    ...
    if (++ last_pid >= MAX_PID) {
ffffffffc0204cc8:	000a3897          	auipc	a7,0xa3
ffffffffc0204ccc:	96088893          	addi	a7,a7,-1696 # ffffffffc02a7628 <last_pid.1>
ffffffffc0204cd0:	0008a783          	lw	a5,0(a7)
ffffffffc0204cd4:	6709                	lui	a4,0x2
ffffffffc0204cd6:	0017851b          	addiw	a0,a5,1
ffffffffc0204cda:	00a8a023          	sw	a0,0(a7)
ffffffffc0204cde:	06e55d63          	bge	a0,a4,ffffffffc0204d58 <get_pid+0x90>
        last_pid = 1;
        goto inside;
    }
    if (last_pid >= next_safe) {
ffffffffc0204ce2:	000a3e17          	auipc	t3,0xa3
ffffffffc0204ce6:	94ae0e13          	addi	t3,t3,-1718 # ffffffffc02a762c <next_safe.0>
ffffffffc0204cea:	000e2783          	lw	a5,0(t3)
ffffffffc0204cee:	06f54463          	blt	a0,a5,ffffffffc0204d56 <get_pid+0x8e>
ffffffffc0204cf2:	000ae617          	auipc	a2,0xae
ffffffffc0204cf6:	df660613          	addi	a2,a2,-522 # ffffffffc02b2ae8 <proc_list>
ffffffffc0204cfa:	00863e83          	ld	t4,8(a2)
    inside:
        next_safe = MAX_PID;
ffffffffc0204cfe:	6789                	lui	a5,0x2
ffffffffc0204d00:	00fe2023          	sw	a5,0(t3)
ffffffffc0204d04:	86aa                	mv	a3,a0
ffffffffc0204d06:	4801                	li	a6,0
    repeat:
        le = list;
        while ((le = list_next(le)) != list) {
ffffffffc0204d08:	6f09                	lui	t5,0x2
ffffffffc0204d0a:	08ce8163          	beq	t4,a2,ffffffffc0204d8c <get_pid+0xc4>
ffffffffc0204d0e:	8342                	mv	t1,a6
ffffffffc0204d10:	87f6                	mv	a5,t4
ffffffffc0204d12:	6589                	lui	a1,0x2
ffffffffc0204d14:	a811                	j	ffffffffc0204d28 <get_pid+0x60>
                    }
                    next_safe = MAX_PID;
                    goto repeat;
                }
...
ffffffffc0204d16:	00e6d663          	bge	a3,a4,ffffffffc0204d22 <get_pid+0x5a>
ffffffffc0204d1a:	00b75463          	bge	a4,a1,ffffffffc0204d22 <get_pid+0x5a>
ffffffffc0204d1e:	85ba                	mv	a1,a4
ffffffffc0204d20:	4305                	li	t1,1
ffffffffc0204d22:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204d24:	00c78d63          	beq	a5,a2,ffffffffc0204d3e <get_pid+0x76>
            if (proc->pid == last_pid) {
ffffffffc0204d28:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7ca4>
ffffffffc0204d2c:	fed715e3          	bne	a4,a3,ffffffffc0204d16 <get_pid+0x4e>
                if (++ last_pid >= next_safe) {
ffffffffc0204d30:	2685                	addiw	a3,a3,1
ffffffffc0204d32:	04b6d863          	bge	a3,a1,ffffffffc0204d82 <get_pid+0xba>
ffffffffc0204d36:	679c                	ld	a5,8(a5)
ffffffffc0204d38:	4805                	li	a6,1
        while ((le = list_next(le)) != list) {
ffffffffc0204d3a:	fec797e3          	bne	a5,a2,ffffffffc0204d28 <get_pid+0x60>
ffffffffc0204d3e:	00080563          	beqz	a6,ffffffffc0204d48 <get_pid+0x80>
ffffffffc0204d42:	00d8a023          	sw	a3,0(a7)
ffffffffc0204d46:	8536                	mv	a0,a3
ffffffffc0204d48:	00030763          	beqz	t1,ffffffffc0204d56 <get_pid+0x8e>
ffffffffc0204d4c:	00be2023          	sw	a1,0(t3)
ffffffffc0204d50:	8082                	ret
    ...
    return last_pid;
ffffffffc0204d52:	0008a503          	lw	a0,0(a7)
}
ffffffffc0204d56:	8082                	ret
        last_pid = 1;
ffffffffc0204d58:	4785                	li	a5,1
ffffffffc0204d5a:	00f8a023          	sw	a5,0(a7)
        goto inside;
ffffffffc0204d5e:	4505                	li	a0,1
ffffffffc0204d60:	000a3e17          	auipc	t3,0xa3
ffffffffc0204d64:	8cce0e13          	addi	t3,t3,-1844 # ffffffffc02a762c <next_safe.0>
ffffffffc0204d68:	000ae617          	auipc	a2,0xae
ffffffffc0204d6c:	d8060613          	addi	a2,a2,-640 # ffffffffc02b2ae8 <proc_list>
        next_safe = MAX_PID;
ffffffffc0204d70:	6789                	lui	a5,0x2
ffffffffc0204d72:	00863e83          	ld	t4,8(a2)
ffffffffc0204d76:	00fe2023          	sw	a5,0(t3)
ffffffffc0204d7a:	86aa                	mv	a3,a0
ffffffffc0204d7c:	4801                	li	a6,0
        while ((le = list_next(le)) != list) {
ffffffffc0204d7e:	6f09                	lui	t5,0x2
ffffffffc0204d80:	b769                	j	ffffffffc0204d0a <get_pid+0x42>
                    if (last_pid >= MAX_PID) {
ffffffffc0204d82:	01e6c363          	blt	a3,t5,ffffffffc0204d88 <get_pid+0xc0>
                        last_pid = 1;
ffffffffc0204d86:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204d88:	4805                	li	a6,1
ffffffffc0204d8a:	b741                	j	ffffffffc0204d0a <get_pid+0x42>
ffffffffc0204d8c:	fc0803e3          	beqz	a6,ffffffffc0204d52 <get_pid+0x8a>
ffffffffc0204d90:	00d8a023          	sw	a3,0(a7)
    return last_pid;
ffffffffc0204d94:	8536                	mv	a0,a3
...
alloc_proc(void) {
ffffffffc0204d9e:	e822                	sd	s0,16(sp)
ffffffffc0204da0:	ec06                	sd	ra,24(sp)
ffffffffc0204da2:	e426                	sd	s1,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204da4:	d5ffc0ef          	jal	ra,ffffffffc0201b02 <kmalloc>
ffffffffc0204da8:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204daa:	c525                	beqz	a0,ffffffffc0204e12 <alloc_proc+0x7a>
        memset(proc, 0, sizeof(struct proc_struct));//初始化proc_struct结构体
ffffffffc0204dac:	10800613          	li	a2,264
ffffffffc0204db0:	4581                	li	a1,0
ffffffffc0204db2:	1bb010ef          	jal	ra,ffffffffc020676c <memset>
        proc->cr3 = boot_cr3;//进程的页目录表
ffffffffc0204db6:	000ae497          	auipc	s1,0xae
ffffffffc0204dba:	d6248493          	addi	s1,s1,-670 # ffffffffc02b2b18 <boot_cr3>
ffffffffc0204dbe:	609c                	ld	a5,0(s1)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0204dc0:	07000613          	li	a2,112
ffffffffc0204dc4:	4581                	li	a1,0
        proc->cr3 = boot_cr3;//进程的页目录表
ffffffffc0204dc6:	f45c                	sd	a5,168(s0)
        proc->state = PROC_UNINIT;
ffffffffc0204dc8:	57fd                	li	a5,-1
ffffffffc0204dca:	1782                	slli	a5,a5,0x20
ffffffffc0204dcc:	e01c                	sd	a5,0(s0)
        proc->runs = 0;
ffffffffc0204dce:	00042423          	sw	zero,8(s0)
        proc->kstack = 0;
ffffffffc0204dd2:	00043823          	sd	zero,16(s0)
        proc->need_resched = 0;
ffffffffc0204dd6:	00043c23          	sd	zero,24(s0)
        proc->parent = NULL;
ffffffffc0204dda:	02043023          	sd	zero,32(s0)
        proc->mm = NULL;
ffffffffc0204dde:	02043423          	sd	zero,40(s0)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0204de2:	03040513          	addi	a0,s0,48
ffffffffc0204de6:	187010ef          	jal	ra,ffffffffc020676c <memset>
        proc->cr3 = boot_cr3;
ffffffffc0204dea:	609c                	ld	a5,0(s1)
        proc->tf = NULL;
ffffffffc0204dec:	0a043023          	sd	zero,160(s0)
        proc->flags = 0;
ffffffffc0204df0:	0a042823          	sw	zero,176(s0)
        proc->cr3 = boot_cr3;
ffffffffc0204df4:	f45c                	sd	a5,168(s0)
        memset(proc->name, 0, PROC_NAME_LEN);
ffffffffc0204df6:	463d                	li	a2,15
ffffffffc0204df8:	4581                	li	a1,0
ffffffffc0204dfa:	0b440513          	addi	a0,s0,180
ffffffffc0204dfe:	16f010ef          	jal	ra,ffffffffc020676c <memset>
        proc->wait_state = 0;
ffffffffc0204e02:	0e042623          	sw	zero,236(s0)
        proc->cptr = proc->optr = proc->yptr = NULL;
ffffffffc0204e06:	0e043c23          	sd	zero,248(s0)
ffffffffc0204e0a:	10043023          	sd	zero,256(s0)
ffffffffc0204e0e:	0e043823          	sd	zero,240(s0)
}
ffffffffc0204e12:	60e2                	ld	ra,24(sp)
ffffffffc0204e14:	8522                	mv	a0,s0
ffffffffc0204e16:	6442                	ld	s0,16(sp)
ffffffffc0204e18:	64a2                	ld	s1,8(sp)
ffffffffc0204e1a:	6105                	addi	sp,sp,32
ffffffffc0204e1c:	8082                	ret

ffffffffc0204e1e <forkret>:
...
ffffffffc0204e26:	73c8                	ld	a0,160(a5)
ffffffffc0204e28:	f4ffb06f          	j	ffffffffc0200d76 <forkrets>

ffffffffc0204e2c <user_main>:
static int
user_main(void *arg) {
#ifdef TEST
...
ffffffffc0204e30:	d447b783          	ld	a5,-700(a5) # ffffffffc02b2b70 <current>
ffffffffc0204e34:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204e36:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE(exit);
ffffffffc0204e38:	00003617          	auipc	a2,0x3
ffffffffc0204e3c:	71860613          	addi	a2,a2,1816 # ffffffffc0208550 <default_pmm_manager+0x1068>
ffffffffc0204e40:	00003517          	auipc	a0,0x3
ffffffffc0204e44:	71850513          	addi	a0,a0,1816 # ffffffffc0208558 <default_pmm_manager+0x1070>
user_main(void *arg) {
ffffffffc0204e48:	fc06                	sd	ra,56(sp)
    KERNEL_EXECVE(exit);
ffffffffc0204e4a:	b36fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc0204e4e:	3fe06797          	auipc	a5,0x3fe06
ffffffffc0204e52:	30a78793          	addi	a5,a5,778 # b158 <_binary_obj___user_exit_out_size>
ffffffffc0204e56:	e43e                	sd	a5,8(sp)
ffffffffc0204e58:	00003517          	auipc	a0,0x3
ffffffffc0204e5c:	6f850513          	addi	a0,a0,1784 # ffffffffc0208550 <default_pmm_manager+0x1068>
ffffffffc0204e60:	00026797          	auipc	a5,0x26
ffffffffc0204e64:	75878793          	addi	a5,a5,1880 # ffffffffc022b5b8 <_binary_obj___user_exit_out_start>
ffffffffc0204e68:	f03e                	sd	a5,32(sp)
ffffffffc0204e6a:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204e6c:	e802                	sd	zero,16(sp)
ffffffffc0204e6e:	083010ef          	jal	ra,ffffffffc02066f0 <strlen>
ffffffffc0204e72:	ec2a                	sd	a0,24(sp)
    asm volatile(
ffffffffc0204e74:	4511                	li	a0,4
ffffffffc0204e76:	55a2                	lw	a1,40(sp)
ffffffffc0204e78:	4662                	lw	a2,24(sp)
ffffffffc0204e7a:	5682                	lw	a3,32(sp)
ffffffffc0204e7c:	4722                	lw	a4,8(sp)
ffffffffc0204e7e:	48a9                	li	a7,10
ffffffffc0204e80:	9002                	ebreak
ffffffffc0204e82:	c82a                	sw	a0,16(sp)
    cprintf("ret = %d\n", ret);
ffffffffc0204e84:	65c2                	ld	a1,16(sp)
ffffffffc0204e86:	00003517          	auipc	a0,0x3
ffffffffc0204e8a:	6fa50513          	addi	a0,a0,1786 # ffffffffc0208580 <default_pmm_manager+0x1098>
ffffffffc0204e8e:	af2fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
#endif
    panic("user_main execve failed.\n");
ffffffffc0204e92:	00003617          	auipc	a2,0x3
ffffffffc0204e96:	6fe60613          	addi	a2,a2,1790 # ffffffffc0208590 <default_pmm_manager+0x10a8>
ffffffffc0204e9a:	37900593          	li	a1,889
ffffffffc0204e9e:	00003517          	auipc	a0,0x3
ffffffffc0204ea2:	71250513          	addi	a0,a0,1810 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0204ea6:	dd4fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204eaa <put_pgdir>:
    return pa2page(PADDR(kva));
ffffffffc0204eaa:	6d14                	ld	a3,24(a0)
put_pgdir(struct mm_struct *mm) {
ffffffffc0204eac:	1141                	addi	sp,sp,-16
ffffffffc0204eae:	e406                	sd	ra,8(sp)
ffffffffc0204eb0:	c02007b7          	lui	a5,0xc0200
ffffffffc0204eb4:	02f6ee63          	bltu	a3,a5,ffffffffc0204ef0 <put_pgdir+0x46>
ffffffffc0204eb8:	000ae517          	auipc	a0,0xae
ffffffffc0204ebc:	c8853503          	ld	a0,-888(a0) # ffffffffc02b2b40 <va_pa_offset>
ffffffffc0204ec0:	8e89                	sub	a3,a3,a0
    if (PPN(pa) >= npage) {
ffffffffc0204ec2:	82b1                	srli	a3,a3,0xc
ffffffffc0204ec4:	000ae797          	auipc	a5,0xae
ffffffffc0204ec8:	c647b783          	ld	a5,-924(a5) # ffffffffc02b2b28 <npage>
ffffffffc0204ecc:	02f6fe63          	bgeu	a3,a5,ffffffffc0204f08 <put_pgdir+0x5e>
    return &pages[PPN(pa) - nbase];
ffffffffc0204ed0:	00004517          	auipc	a0,0x4
ffffffffc0204ed4:	f9853503          	ld	a0,-104(a0) # ffffffffc0208e68 <nbase>
}
ffffffffc0204ed8:	60a2                	ld	ra,8(sp)
ffffffffc0204eda:	8e89                	sub	a3,a3,a0
ffffffffc0204edc:	069a                	slli	a3,a3,0x6
    free_page(kva2page(mm->pgdir));
ffffffffc0204ede:	000ae517          	auipc	a0,0xae
ffffffffc0204ee2:	c5253503          	ld	a0,-942(a0) # ffffffffc02b2b30 <pages>
ffffffffc0204ee6:	4585                	li	a1,1
ffffffffc0204ee8:	9536                	add	a0,a0,a3
}
ffffffffc0204eea:	0141                	addi	sp,sp,16
    free_page(kva2page(mm->pgdir));
ffffffffc0204eec:	e87fc06f          	j	ffffffffc0201d72 <free_pages>
    return pa2page(PADDR(kva));
ffffffffc0204ef0:	00002617          	auipc	a2,0x2
ffffffffc0204ef4:	6d860613          	addi	a2,a2,1752 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc0204ef8:	06e00593          	li	a1,110
ffffffffc0204efc:	00002517          	auipc	a0,0x2
ffffffffc0204f00:	64c50513          	addi	a0,a0,1612 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0204f04:	d76fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204f08:	00002617          	auipc	a2,0x2
ffffffffc0204f0c:	6e860613          	addi	a2,a2,1768 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc0204f10:	06200593          	li	a1,98
ffffffffc0204f14:	00002517          	auipc	a0,0x2
ffffffffc0204f18:	63450513          	addi	a0,a0,1588 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0204f1c:	d5efb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204f20 <copy_mm>:
copy_mm(uint32_t clone_flags, struct proc_struct *proc) {
ffffffffc0204f20:	7179                	addi	sp,sp,-48
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f22:	000ae797          	auipc	a5,0xae
ffffffffc0204f26:	c4e7b783          	ld	a5,-946(a5) # ffffffffc02b2b70 <current>
copy_mm(uint32_t clone_flags, struct proc_struct *proc) {
ffffffffc0204f2a:	ec26                	sd	s1,24(sp)
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f2c:	7784                	ld	s1,40(a5)
copy_mm(uint32_t clone_flags, struct proc_struct *proc) {
ffffffffc0204f2e:	f406                	sd	ra,40(sp)
ffffffffc0204f30:	f022                	sd	s0,32(sp)
ffffffffc0204f32:	e84a                	sd	s2,16(sp)
ffffffffc0204f34:	e44e                	sd	s3,8(sp)
ffffffffc0204f36:	e052                	sd	s4,0(sp)
    if (oldmm == NULL) {
ffffffffc0204f38:	0e048263          	beqz	s1,ffffffffc020501c <copy_mm+0xfc>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f3c:	10057513          	andi	a0,a0,256
ffffffffc0204f40:	892e                	mv	s2,a1
ffffffffc0204f42:	cd05                	beqz	a0,ffffffffc0204f7a <copy_mm+0x5a>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f44:	589c                	lw	a5,48(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f46:	6c94                	ld	a3,24(s1)
ffffffffc0204f48:	c0200737          	lui	a4,0xc0200
ffffffffc0204f4c:	2785                	addiw	a5,a5,1
ffffffffc0204f4e:	d89c                	sw	a5,48(s1)
    proc->mm = mm;
ffffffffc0204f50:	02993423          	sd	s1,40(s2)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f54:	0ee6e663          	bltu	a3,a4,ffffffffc0205040 <copy_mm+0x120>
ffffffffc0204f58:	000ae797          	auipc	a5,0xae
ffffffffc0204f5c:	be87b783          	ld	a5,-1048(a5) # ffffffffc02b2b40 <va_pa_offset>
ffffffffc0204f60:	8e9d                	sub	a3,a3,a5
ffffffffc0204f62:	0ad93423          	sd	a3,168(s2)
    return 0;
ffffffffc0204f66:	4401                	li	s0,0
}
ffffffffc0204f68:	70a2                	ld	ra,40(sp)
ffffffffc0204f6a:	8522                	mv	a0,s0
ffffffffc0204f6c:	7402                	ld	s0,32(sp)
ffffffffc0204f6e:	64e2                	ld	s1,24(sp)
ffffffffc0204f70:	6942                	ld	s2,16(sp)
ffffffffc0204f72:	69a2                	ld	s3,8(sp)
ffffffffc0204f74:	6a02                	ld	s4,0(sp)
ffffffffc0204f76:	6145                	addi	sp,sp,48
ffffffffc0204f78:	8082                	ret
    if ((mm = mm_create()) == NULL) {
ffffffffc0204f7a:	9a6ff0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc0204f7e:	89aa                	mv	s3,a0
ffffffffc0204f80:	c145                	beqz	a0,ffffffffc0205020 <copy_mm+0x100>
    if ((page = alloc_page()) == NULL) {
ffffffffc0204f82:	4505                	li	a0,1
ffffffffc0204f84:	d5dfc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc0204f88:	cd51                	beqz	a0,ffffffffc0205024 <copy_mm+0x104>
    return page - pages + nbase;
ffffffffc0204f8a:	000ae697          	auipc	a3,0xae
ffffffffc0204f8e:	ba66b683          	ld	a3,-1114(a3) # ffffffffc02b2b30 <pages>
ffffffffc0204f92:	40d506b3          	sub	a3,a0,a3
ffffffffc0204f96:	8699                	srai	a3,a3,0x6
ffffffffc0204f98:	00004417          	auipc	s0,0x4
ffffffffc0204f9c:	ed043403          	ld	s0,-304(s0) # ffffffffc0208e68 <nbase>
ffffffffc0204fa0:	96a2                	add	a3,a3,s0
    return KADDR(page2pa(page));
ffffffffc0204fa2:	00c69793          	slli	a5,a3,0xc
ffffffffc0204fa6:	83b1                	srli	a5,a5,0xc
ffffffffc0204fa8:	000ae717          	auipc	a4,0xae
ffffffffc0204fac:	b8073703          	ld	a4,-1152(a4) # ffffffffc02b2b28 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc0204fb0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204fb2:	06e7fb63          	bgeu	a5,a4,ffffffffc0205028 <copy_mm+0x108>
ffffffffc0204fb6:	000ae417          	auipc	s0,0xae
ffffffffc0204fba:	b8a43403          	ld	s0,-1142(s0) # ffffffffc02b2b40 <va_pa_offset>
ffffffffc0204fbe:	9436                	add	s0,s0,a3
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0204fc0:	6605                	lui	a2,0x1
ffffffffc0204fc2:	000ae597          	auipc	a1,0xae
ffffffffc0204fc6:	b5e5b583          	ld	a1,-1186(a1) # ffffffffc02b2b20 <boot_pgdir>
ffffffffc0204fca:	8522                	mv	a0,s0
ffffffffc0204fcc:	7b2010ef          	jal	ra,ffffffffc020677e <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc0204fd0:	03848a13          	addi	s4,s1,56
    mm->pgdir = pgdir;
ffffffffc0204fd4:	0089bc23          	sd	s0,24(s3)
...
ffffffffc0204fda:	40fa37af          	amoor.d	a5,a5,(s4)
...
ffffffffc0204fe0:	cb81                	beqz	a5,ffffffffc0204ff0 <copy_mm+0xd0>
ffffffffc0204fe2:	4405                	li	s0,1
        schedule();
ffffffffc0204fe4:	19c010ef          	jal	ra,ffffffffc0206180 <schedule>
ffffffffc0204fe8:	408a37af          	amoor.d	a5,s0,(s4)
    while (!try_lock(lock)) {
ffffffffc0204fec:	8b85                	andi	a5,a5,1
ffffffffc0204fee:	fbfd                	bnez	a5,ffffffffc0204fe4 <copy_mm+0xc4>
        ret = dup_mmap(mm, oldmm);
ffffffffc0204ff0:	85a6                	mv	a1,s1
ffffffffc0204ff2:	854e                	mv	a0,s3
ffffffffc0204ff4:	bb4ff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc0204ffa:	57f9                	li	a5,-2
ffffffffc0204ffc:	60fa37af          	amoand.d	a5,a5,(s4)
ffffffffc0205000:	8b85                	andi	a5,a5,1
    }
}
...
ffffffffc0205002:	cbb9                	beqz	a5,ffffffffc0205058 <copy_mm+0x138>
good_mm:
ffffffffc0205004:	84ce                	mv	s1,s3
    if (ret != 0) {
ffffffffc0205006:	dd1d                	beqz	a0,ffffffffc0204f44 <copy_mm+0x24>
    exit_mmap(mm);
ffffffffc0205008:	854e                	mv	a0,s3
ffffffffc020500a:	c38ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc020500e:	854e                	mv	a0,s3
ffffffffc0205010:	e9bff0ef          	jal	ra,ffffffffc0204eaa <put_pgdir>
    mm_destroy(mm);
ffffffffc0205014:	854e                	mv	a0,s3
ffffffffc0205016:	a90ff0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc020501a:	b7b9                	j	ffffffffc0204f68 <copy_mm+0x48>
        return 0;
ffffffffc020501c:	4401                	li	s0,0
ffffffffc020501e:	b7a9                	j	ffffffffc0204f68 <copy_mm+0x48>
    int ret = -E_NO_MEM;
ffffffffc0205020:	5471                	li	s0,-4
ffffffffc0205022:	b799                	j	ffffffffc0204f68 <copy_mm+0x48>
ffffffffc0205024:	5471                	li	s0,-4
ffffffffc0205026:	b7fd                	j	ffffffffc0205014 <copy_mm+0xf4>
ffffffffc0205028:	00002617          	auipc	a2,0x2
ffffffffc020502c:	4f860613          	addi	a2,a2,1272 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0205030:	06900593          	li	a1,105
ffffffffc0205034:	00002517          	auipc	a0,0x2
ffffffffc0205038:	51450513          	addi	a0,a0,1300 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc020503c:	c3efb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0205040:	00002617          	auipc	a2,0x2
ffffffffc0205044:	58860613          	addi	a2,a2,1416 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc0205048:	16b00593          	li	a1,363
ffffffffc020504c:	00003517          	auipc	a0,0x3
ffffffffc0205050:	56450513          	addi	a0,a0,1380 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205054:	c26fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("Unlock failed.\n");
ffffffffc0205058:	00003617          	auipc	a2,0x3
ffffffffc020505c:	57060613          	addi	a2,a2,1392 # ffffffffc02085c8 <default_pmm_manager+0x10e0>
ffffffffc0205060:	03100593          	li	a1,49
ffffffffc0205064:	00003517          	auipc	a0,0x3
ffffffffc0205068:	57450513          	addi	a0,a0,1396 # ffffffffc02085d8 <default_pmm_manager+0x10f0>
ffffffffc020506c:	c0efb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205070 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0205070:	7179                	addi	sp,sp,-48
ffffffffc0205072:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0205074:	000ae917          	auipc	s2,0xae
ffffffffc0205078:	afc90913          	addi	s2,s2,-1284 # ffffffffc02b2b70 <current>
proc_run(struct proc_struct *proc) {
ffffffffc020507c:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc020507e:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0205082:	f406                	sd	ra,40(sp)
ffffffffc0205084:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0205086:	02a48863          	beq	s1,a0,ffffffffc02050b6 <proc_run+0x46>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020508a:	100027f3          	csrr	a5,sstatus
ffffffffc020508e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205090:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205092:	ef9d                	bnez	a5,ffffffffc02050d0 <proc_run+0x60>
...
ffffffffc0205094:	755c                	ld	a5,168(a0)
ffffffffc0205096:	577d                	li	a4,-1
ffffffffc0205098:	177e                	slli	a4,a4,0x3f
ffffffffc020509a:	83b1                	srli	a5,a5,0xc
            current = proc; //当前进程设为待调度的进程
ffffffffc020509c:	00a93023          	sd	a0,0(s2)
ffffffffc02050a0:	8fd9                	or	a5,a5,a4
ffffffffc02050a2:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context));//switch_to进行上下文切换
ffffffffc02050a6:	03050593          	addi	a1,a0,48
ffffffffc02050aa:	03048513          	addi	a0,s1,48
ffffffffc02050ae:	7e9000ef          	jal	ra,ffffffffc0206096 <switch_to>
    if (flag) {
ffffffffc02050b2:	00099863          	bnez	s3,ffffffffc02050c2 <proc_run+0x52>
}
ffffffffc02050b6:	70a2                	ld	ra,40(sp)
ffffffffc02050b8:	7482                	ld	s1,32(sp)
ffffffffc02050ba:	6962                	ld	s2,24(sp)
ffffffffc02050bc:	69c2                	ld	s3,16(sp)
ffffffffc02050be:	6145                	addi	sp,sp,48
ffffffffc02050c0:	8082                	ret
ffffffffc02050c2:	70a2                	ld	ra,40(sp)
ffffffffc02050c4:	7482                	ld	s1,32(sp)
ffffffffc02050c6:	6962                	ld	s2,24(sp)
ffffffffc02050c8:	69c2                	ld	s3,16(sp)
ffffffffc02050ca:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc02050cc:	d74fb06f          	j	ffffffffc0200640 <intr_enable>
ffffffffc02050d0:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc02050d2:	d74fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02050d6:	6522                	ld	a0,8(sp)
ffffffffc02050d8:	4985                	li	s3,1
ffffffffc02050da:	bf6d                	j	ffffffffc0205094 <proc_run+0x24>

ffffffffc02050dc <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc02050dc:	7159                	addi	sp,sp,-112
ffffffffc02050de:	e4ce                	sd	s3,72(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc02050e0:	000ae997          	auipc	s3,0xae
ffffffffc02050e4:	aa898993          	addi	s3,s3,-1368 # ffffffffc02b2b88 <nr_process>
ffffffffc02050e8:	0009a703          	lw	a4,0(s3)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc02050ec:	f486                	sd	ra,104(sp)
ffffffffc02050ee:	f0a2                	sd	s0,96(sp)
ffffffffc02050f0:	eca6                	sd	s1,88(sp)
ffffffffc02050f2:	e8ca                	sd	s2,80(sp)
ffffffffc02050f4:	e0d2                	sd	s4,64(sp)
ffffffffc02050f6:	fc56                	sd	s5,56(sp)
ffffffffc02050f8:	f85a                	sd	s6,48(sp)
ffffffffc02050fa:	f45e                	sd	s7,40(sp)
ffffffffc02050fc:	f062                	sd	s8,32(sp)
ffffffffc02050fe:	ec66                	sd	s9,24(sp)
ffffffffc0205100:	e86a                	sd	s10,16(sp)
ffffffffc0205102:	e46e                	sd	s11,8(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0205104:	6785                	lui	a5,0x1
ffffffffc0205106:	2ef75863          	bge	a4,a5,ffffffffc02053f6 <do_fork+0x31a>
ffffffffc020510a:	84aa                	mv	s1,a0
ffffffffc020510c:	892e                	mv	s2,a1
ffffffffc020510e:	8432                	mv	s0,a2
    proc = alloc_proc();    // 调用alloc_proc函数分配一个proc_struct结构体
ffffffffc0205110:	c89ff0ef          	jal	ra,ffffffffc0204d98 <alloc_proc>
ffffffffc0205114:	8daa                	mv	s11,a0
    if (proc == NULL) { // 如果分配失败，返回错误码
ffffffffc0205116:	2e050963          	beqz	a0,ffffffffc0205408 <do_fork+0x32c>
    proc->parent = current; // 设置父进程为当前进程
ffffffffc020511a:	000aea97          	auipc	s5,0xae
ffffffffc020511e:	a56a8a93          	addi	s5,s5,-1450 # ffffffffc02b2b70 <current>
ffffffffc0205122:	000ab703          	ld	a4,0(s5)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0205126:	4509                	li	a0,2
    proc->parent = current; // 设置父进程为当前进程
ffffffffc0205128:	02edb023          	sd	a4,32(s11)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020512c:	bb5fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0205130:	26050d63          	beqz	a0,ffffffffc02053aa <do_fork+0x2ce>
    return page - pages + nbase;
ffffffffc0205134:	000aec97          	auipc	s9,0xae
ffffffffc0205138:	9fcc8c93          	addi	s9,s9,-1540 # ffffffffc02b2b30 <pages>
ffffffffc020513c:	000cb683          	ld	a3,0(s9)
ffffffffc0205140:	00004b97          	auipc	s7,0x4
ffffffffc0205144:	d28bbb83          	ld	s7,-728(s7) # ffffffffc0208e68 <nbase>
    return KADDR(page2pa(page));
ffffffffc0205148:	000aec17          	auipc	s8,0xae
ffffffffc020514c:	9e0c0c13          	addi	s8,s8,-1568 # ffffffffc02b2b28 <npage>
    return page - pages + nbase;
ffffffffc0205150:	40d506b3          	sub	a3,a0,a3
ffffffffc0205154:	8699                	srai	a3,a3,0x6
ffffffffc0205156:	96de                	add	a3,a3,s7
    return KADDR(page2pa(page));
ffffffffc0205158:	000c3603          	ld	a2,0(s8)
ffffffffc020515c:	00c69713          	slli	a4,a3,0xc
ffffffffc0205160:	8331                	srli	a4,a4,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0205162:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205164:	2ac77563          	bgeu	a4,a2,ffffffffc020540e <do_fork+0x332>
ffffffffc0205168:	000aeb17          	auipc	s6,0xae
ffffffffc020516c:	9d8b0b13          	addi	s6,s6,-1576 # ffffffffc02b2b40 <va_pa_offset>
ffffffffc0205170:	000b3703          	ld	a4,0(s6)
    if (copy_mm(clone_flags, proc) != 0) {  // 调用copy_mm函数复制父进程的内存管理信息
ffffffffc0205174:	85ee                	mv	a1,s11
ffffffffc0205176:	8526                	mv	a0,s1
ffffffffc0205178:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc020517a:	00ddb823          	sd	a3,16(s11)
    if (copy_mm(clone_flags, proc) != 0) {  // 调用copy_mm函数复制父进程的内存管理信息
ffffffffc020517e:	da3ff0ef          	jal	ra,ffffffffc0204f20 <copy_mm>
    ret = -E_NO_MEM;
ffffffffc0205182:	5a71                	li	s4,-4
    if (copy_mm(clone_flags, proc) != 0) {  // 调用copy_mm函数复制父进程的内存管理信息
ffffffffc0205184:	c505                	beqz	a0,ffffffffc02051ac <do_fork+0xd0>
    kfree(proc);
ffffffffc0205186:	856e                	mv	a0,s11
ffffffffc0205188:	a2bfc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
}
ffffffffc020518c:	70a6                	ld	ra,104(sp)
ffffffffc020518e:	7406                	ld	s0,96(sp)
ffffffffc0205190:	64e6                	ld	s1,88(sp)
ffffffffc0205192:	6946                	ld	s2,80(sp)
ffffffffc0205194:	69a6                	ld	s3,72(sp)
ffffffffc0205196:	7ae2                	ld	s5,56(sp)
ffffffffc0205198:	7b42                	ld	s6,48(sp)
ffffffffc020519a:	7ba2                	ld	s7,40(sp)
ffffffffc020519c:	7c02                	ld	s8,32(sp)
ffffffffc020519e:	6ce2                	ld	s9,24(sp)
ffffffffc02051a0:	6d42                	ld	s10,16(sp)
ffffffffc02051a2:	6da2                	ld	s11,8(sp)
ffffffffc02051a4:	8552                	mv	a0,s4
ffffffffc02051a6:	6a06                	ld	s4,64(sp)
ffffffffc02051a8:	6165                	addi	sp,sp,112
ffffffffc02051aa:	8082                	ret
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc02051ac:	010db603          	ld	a2,16(s11)
ffffffffc02051b0:	6709                	lui	a4,0x2
ffffffffc02051b2:	ee070713          	addi	a4,a4,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7d00>
ffffffffc02051b6:	963a                	add	a2,a2,a4
ffffffffc02051b8:	0acdb023          	sd	a2,160(s11)
    *(proc->tf) = *tf;
ffffffffc02051bc:	8722                	mv	a4,s0
ffffffffc02051be:	86b2                	mv	a3,a2
ffffffffc02051c0:	12040d13          	addi	s10,s0,288
ffffffffc02051c4:	00073883          	ld	a7,0(a4)
ffffffffc02051c8:	00873803          	ld	a6,8(a4)
ffffffffc02051cc:	6b08                	ld	a0,16(a4)
ffffffffc02051ce:	6f0c                	ld	a1,24(a4)
ffffffffc02051d0:	0116b023          	sd	a7,0(a3)
ffffffffc02051d4:	0106b423          	sd	a6,8(a3)
ffffffffc02051d8:	ea88                	sd	a0,16(a3)
ffffffffc02051da:	ee8c                	sd	a1,24(a3)
ffffffffc02051dc:	02070713          	addi	a4,a4,32
ffffffffc02051e0:	02068693          	addi	a3,a3,32
ffffffffc02051e4:	ffa710e3          	bne	a4,s10,ffffffffc02051c4 <do_fork+0xe8>
    proc->tf->gpr.a0 = 0;
ffffffffc02051e8:	04063823          	sd	zero,80(a2)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02051ec:	874a                	mv	a4,s2
ffffffffc02051ee:	00091363          	bnez	s2,ffffffffc02051f4 <do_fork+0x118>
ffffffffc02051f2:	8732                	mv	a4,a2
ffffffffc02051f4:	ea18                	sd	a4,16(a2)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02051f6:	00000797          	auipc	a5,0x0
ffffffffc02051fa:	c2878793          	addi	a5,a5,-984 # ffffffffc0204e1e <forkret>
ffffffffc02051fe:	02fdb823          	sd	a5,48(s11)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205202:	02cdbc23          	sd	a2,56(s11)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205206:	10002773          	csrr	a4,sstatus
ffffffffc020520a:	8b09                	andi	a4,a4,2
    return 0;
ffffffffc020520c:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020520e:	1e071063          	bnez	a4,ffffffffc02053ee <do_fork+0x312>
    proc->pid = get_pid();  // 为子进程分配pid
ffffffffc0205212:	ab7ff0ef          	jal	ra,ffffffffc0204cc8 <get_pid>
ffffffffc0205216:	00ada223          	sw	a0,4(s11)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020521a:	45a9                	li	a1,10
ffffffffc020521c:	2501                	sext.w	a0,a0
ffffffffc020521e:	0ce010ef          	jal	ra,ffffffffc02062ec <hash32>
ffffffffc0205222:	02051793          	slli	a5,a0,0x20
ffffffffc0205226:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020522a:	000aa797          	auipc	a5,0xaa
ffffffffc020522e:	8be78793          	addi	a5,a5,-1858 # ffffffffc02aeae8 <hash_list>
ffffffffc0205232:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0205234:	650c                	ld	a1,8(a0)
ffffffffc0205236:	0d8d8713          	addi	a4,s11,216
ffffffffc020523a:	000ae797          	auipc	a5,0xae
ffffffffc020523e:	8ae78793          	addi	a5,a5,-1874 # ffffffffc02b2ae8 <proc_list>
    prev->next = next->prev = elm;
ffffffffc0205242:	e198                	sd	a4,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0205244:	6790                	ld	a2,8(a5)
    nr_process++;
ffffffffc0205246:	0009a683          	lw	a3,0(s3)
    prev->next = next->prev = elm;
ffffffffc020524a:	e518                	sd	a4,8(a0)
    elm->next = next;
ffffffffc020524c:	0ebdb023          	sd	a1,224(s11)
    list_add(&proc_list, &(proc->list_link));   // 将子进程添加到proc_list中
ffffffffc0205250:	0c8d8713          	addi	a4,s11,200
    elm->prev = prev;
ffffffffc0205254:	0cadbc23          	sd	a0,216(s11)
    prev->next = next->prev = elm;
ffffffffc0205258:	e218                	sd	a4,0(a2)
    nr_process++;
ffffffffc020525a:	2685                	addiw	a3,a3,1
ffffffffc020525c:	e798                	sd	a4,8(a5)
    elm->next = next;
ffffffffc020525e:	0ccdb823          	sd	a2,208(s11)
    elm->prev = prev;
ffffffffc0205262:	0cfdb423          	sd	a5,200(s11)
ffffffffc0205266:	00d9a023          	sw	a3,0(s3)
    if (flag) {
ffffffffc020526a:	120a1d63          	bnez	s4,ffffffffc02053a4 <do_fork+0x2c8>
    wakeup_proc(proc);  // 唤醒子进程
ffffffffc020526e:	856e                	mv	a0,s11
ffffffffc0205270:	691000ef          	jal	ra,ffffffffc0206100 <wakeup_proc>
    ret = proc->pid;    // 设置返回值为子进程的pid
ffffffffc0205274:	004daa03          	lw	s4,4(s11)
 if ((proc = alloc_proc()) == NULL) {
ffffffffc0205278:	b21ff0ef          	jal	ra,ffffffffc0204d98 <alloc_proc>
ffffffffc020527c:	8daa                	mv	s11,a0
ffffffffc020527e:	f00507e3          	beqz	a0,ffffffffc020518c <do_fork+0xb0>
    proc->parent = current;
ffffffffc0205282:	000ab703          	ld	a4,0(s5)
    assert(current->wait_state == 0);
ffffffffc0205286:	0ec72683          	lw	a3,236(a4)
    proc->parent = current;
ffffffffc020528a:	f118                	sd	a4,32(a0)
    assert(current->wait_state == 0);
ffffffffc020528c:	1c069563          	bnez	a3,ffffffffc0205456 <do_fork+0x37a>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0205290:	4509                	li	a0,2
ffffffffc0205292:	a4ffc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0205296:	ee0508e3          	beqz	a0,ffffffffc0205186 <do_fork+0xaa>
    return page - pages + nbase;
ffffffffc020529a:	000cb703          	ld	a4,0(s9)
    return KADDR(page2pa(page));
ffffffffc020529e:	000c3683          	ld	a3,0(s8)
    return page - pages + nbase;
ffffffffc02052a2:	8d19                	sub	a0,a0,a4
ffffffffc02052a4:	8519                	srai	a0,a0,0x6
ffffffffc02052a6:	9baa                	add	s7,s7,a0
    return KADDR(page2pa(page));
ffffffffc02052a8:	00cb9713          	slli	a4,s7,0xc
ffffffffc02052ac:	8331                	srli	a4,a4,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc02052ae:	0bb2                	slli	s7,s7,0xc
    return KADDR(page2pa(page));
ffffffffc02052b0:	14d77e63          	bgeu	a4,a3,ffffffffc020540c <do_fork+0x330>
ffffffffc02052b4:	000b3703          	ld	a4,0(s6)
    if (copy_mm(clone_flags, proc) != 0) {
ffffffffc02052b8:	85ee                	mv	a1,s11
ffffffffc02052ba:	8526                	mv	a0,s1
ffffffffc02052bc:	9bba                	add	s7,s7,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02052be:	017db823          	sd	s7,16(s11)
    if (copy_mm(clone_flags, proc) != 0) {
ffffffffc02052c2:	c5fff0ef          	jal	ra,ffffffffc0204f20 <copy_mm>
ffffffffc02052c6:	e17d                	bnez	a0,ffffffffc02053ac <do_fork+0x2d0>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc02052c8:	010db683          	ld	a3,16(s11)
ffffffffc02052cc:	6709                	lui	a4,0x2
ffffffffc02052ce:	ee070713          	addi	a4,a4,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7d00>
ffffffffc02052d2:	96ba                	add	a3,a3,a4
ffffffffc02052d4:	0addb023          	sd	a3,160(s11)
    *(proc->tf) = *tf;
ffffffffc02052d8:	8736                	mv	a4,a3
ffffffffc02052da:	00043803          	ld	a6,0(s0)
ffffffffc02052de:	6408                	ld	a0,8(s0)
ffffffffc02052e0:	680c                	ld	a1,16(s0)
ffffffffc02052e2:	6c10                	ld	a2,24(s0)
ffffffffc02052e4:	01073023          	sd	a6,0(a4)
ffffffffc02052e8:	e708                	sd	a0,8(a4)
ffffffffc02052ea:	eb0c                	sd	a1,16(a4)
ffffffffc02052ec:	ef10                	sd	a2,24(a4)
ffffffffc02052ee:	02040413          	addi	s0,s0,32
ffffffffc02052f2:	02070713          	addi	a4,a4,32
ffffffffc02052f6:	ffa412e3          	bne	s0,s10,ffffffffc02052da <do_fork+0x1fe>
    proc->tf->gpr.a0 = 0;
ffffffffc02052fa:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02052fe:	00091363          	bnez	s2,ffffffffc0205304 <do_fork+0x228>
ffffffffc0205302:	8936                	mv	s2,a3
ffffffffc0205304:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0205308:	00000797          	auipc	a5,0x0
ffffffffc020530c:	b1678793          	addi	a5,a5,-1258 # ffffffffc0204e1e <forkret>
ffffffffc0205310:	02fdb823          	sd	a5,48(s11)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205314:	02ddbc23          	sd	a3,56(s11)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205318:	10002773          	csrr	a4,sstatus
ffffffffc020531c:	8b09                	andi	a4,a4,2
    return 0;
ffffffffc020531e:	4401                	li	s0,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205320:	e365                	bnez	a4,ffffffffc0205400 <do_fork+0x324>
        proc->pid = get_pid();
ffffffffc0205322:	9a7ff0ef          	jal	ra,ffffffffc0204cc8 <get_pid>
ffffffffc0205326:	00ada223          	sw	a0,4(s11)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020532a:	45a9                	li	a1,10
ffffffffc020532c:	2501                	sext.w	a0,a0
ffffffffc020532e:	7bf000ef          	jal	ra,ffffffffc02062ec <hash32>
ffffffffc0205332:	02051793          	slli	a5,a0,0x20
ffffffffc0205336:	01c7d713          	srli	a4,a5,0x1c
ffffffffc020533a:	000a9797          	auipc	a5,0xa9
ffffffffc020533e:	7ae78793          	addi	a5,a5,1966 # ffffffffc02aeae8 <hash_list>
ffffffffc0205342:	973e                	add	a4,a4,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0205344:	00873803          	ld	a6,8(a4)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205348:	020db583          	ld	a1,32(s11)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020534c:	0d8d8693          	addi	a3,s11,216
ffffffffc0205350:	000ad797          	auipc	a5,0xad
ffffffffc0205354:	79878793          	addi	a5,a5,1944 # ffffffffc02b2ae8 <proc_list>
    prev->next = next->prev = elm;
ffffffffc0205358:	00d83023          	sd	a3,0(a6) # fffffffffff80000 <end+0x3fccd474>
    __list_add(elm, listelm, listelm->next);
ffffffffc020535c:	6788                	ld	a0,8(a5)
    prev->next = next->prev = elm;
ffffffffc020535e:	e714                	sd	a3,8(a4)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205360:	79f0                	ld	a2,240(a1)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0205362:	0c8d8693          	addi	a3,s11,200
    elm->next = next;
ffffffffc0205366:	0f0db023          	sd	a6,224(s11)
    elm->prev = prev;
ffffffffc020536a:	0cedbc23          	sd	a4,216(s11)
    prev->next = next->prev = elm;
ffffffffc020536e:	e114                	sd	a3,0(a0)
ffffffffc0205370:	e794                	sd	a3,8(a5)
    elm->next = next;
ffffffffc0205372:	0cadb823          	sd	a0,208(s11)
    elm->prev = prev;
ffffffffc0205376:	0cfdb423          	sd	a5,200(s11)
    proc->yptr = NULL;
ffffffffc020537a:	0e0dbc23          	sd	zero,248(s11)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020537e:	10cdb023          	sd	a2,256(s11)
ffffffffc0205382:	c219                	beqz	a2,ffffffffc0205388 <do_fork+0x2ac>
        proc->optr->yptr = proc;
ffffffffc0205384:	0fb63c23          	sd	s11,248(a2)
    nr_process ++;
ffffffffc0205388:	0009a703          	lw	a4,0(s3)
    proc->parent->cptr = proc;
ffffffffc020538c:	0fb5b823          	sd	s11,240(a1)
    nr_process ++;
ffffffffc0205390:	2705                	addiw	a4,a4,1
ffffffffc0205392:	00e9a023          	sw	a4,0(s3)
    if (flag) {
ffffffffc0205396:	e035                	bnez	s0,ffffffffc02053fa <do_fork+0x31e>
    wakeup_proc(proc);
ffffffffc0205398:	856e                	mv	a0,s11
ffffffffc020539a:	567000ef          	jal	ra,ffffffffc0206100 <wakeup_proc>
    ret = proc->pid;
ffffffffc020539e:	004daa03          	lw	s4,4(s11)
ffffffffc02053a2:	b3ed                	j	ffffffffc020518c <do_fork+0xb0>
        intr_enable();
ffffffffc02053a4:	a9cfb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02053a8:	b5d9                	j	ffffffffc020526e <do_fork+0x192>
    ret = -E_NO_MEM;
ffffffffc02053aa:	5a71                	li	s4,-4
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02053ac:	010db683          	ld	a3,16(s11)
    return pa2page(PADDR(kva));
ffffffffc02053b0:	c0200737          	lui	a4,0xc0200
ffffffffc02053b4:	08e6e563          	bltu	a3,a4,ffffffffc020543e <do_fork+0x362>
ffffffffc02053b8:	000ad517          	auipc	a0,0xad
ffffffffc02053bc:	78853503          	ld	a0,1928(a0) # ffffffffc02b2b40 <va_pa_offset>
ffffffffc02053c0:	8e89                	sub	a3,a3,a0
    if (PPN(pa) >= npage) {
ffffffffc02053c2:	82b1                	srli	a3,a3,0xc
ffffffffc02053c4:	000ad717          	auipc	a4,0xad
ffffffffc02053c8:	76473703          	ld	a4,1892(a4) # ffffffffc02b2b28 <npage>
ffffffffc02053cc:	04e6fd63          	bgeu	a3,a4,ffffffffc0205426 <do_fork+0x34a>
    return &pages[PPN(pa) - nbase];
ffffffffc02053d0:	00004517          	auipc	a0,0x4
ffffffffc02053d4:	a9853503          	ld	a0,-1384(a0) # ffffffffc0208e68 <nbase>
ffffffffc02053d8:	8e89                	sub	a3,a3,a0
ffffffffc02053da:	069a                	slli	a3,a3,0x6
ffffffffc02053dc:	000ad517          	auipc	a0,0xad
ffffffffc02053e0:	75453503          	ld	a0,1876(a0) # ffffffffc02b2b30 <pages>
ffffffffc02053e4:	4589                	li	a1,2
ffffffffc02053e6:	9536                	add	a0,a0,a3
ffffffffc02053e8:	98bfc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
}
ffffffffc02053ec:	bb69                	j	ffffffffc0205186 <do_fork+0xaa>
        intr_disable();
ffffffffc02053ee:	a58fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02053f2:	4a05                	li	s4,1
ffffffffc02053f4:	bd39                	j	ffffffffc0205212 <do_fork+0x136>
    int ret = -E_NO_FREE_PROC;
ffffffffc02053f6:	5a6d                	li	s4,-5
ffffffffc02053f8:	bb51                	j	ffffffffc020518c <do_fork+0xb0>
        intr_enable();
ffffffffc02053fa:	a46fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02053fe:	bf69                	j	ffffffffc0205398 <do_fork+0x2bc>
        intr_disable();
ffffffffc0205400:	a46fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205404:	4405                	li	s0,1
ffffffffc0205406:	bf31                	j	ffffffffc0205322 <do_fork+0x246>
    ret = -E_NO_MEM;
ffffffffc0205408:	5a71                	li	s4,-4
ffffffffc020540a:	b349                	j	ffffffffc020518c <do_fork+0xb0>
    return KADDR(page2pa(page));
ffffffffc020540c:	86de                	mv	a3,s7
ffffffffc020540e:	00002617          	auipc	a2,0x2
ffffffffc0205412:	11260613          	addi	a2,a2,274 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0205416:	06900593          	li	a1,105
ffffffffc020541a:	00002517          	auipc	a0,0x2
ffffffffc020541e:	12e50513          	addi	a0,a0,302 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0205422:	858fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205426:	00002617          	auipc	a2,0x2
ffffffffc020542a:	1ca60613          	addi	a2,a2,458 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc020542e:	06200593          	li	a1,98
ffffffffc0205432:	00002517          	auipc	a0,0x2
ffffffffc0205436:	11650513          	addi	a0,a0,278 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc020543a:	840fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc020543e:	00002617          	auipc	a2,0x2
ffffffffc0205442:	18a60613          	addi	a2,a2,394 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc0205446:	06e00593          	li	a1,110
ffffffffc020544a:	00002517          	auipc	a0,0x2
ffffffffc020544e:	0fe50513          	addi	a0,a0,254 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0205452:	828fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(current->wait_state == 0);
ffffffffc0205456:	00003697          	auipc	a3,0x3
ffffffffc020545a:	19a68693          	addi	a3,a3,410 # ffffffffc02085f0 <default_pmm_manager+0x1108>
ffffffffc020545e:	00002617          	auipc	a2,0x2
ffffffffc0205462:	9f260613          	addi	a2,a2,-1550 # ffffffffc0206e50 <commands+0x450>
ffffffffc0205466:	1d800593          	li	a1,472
ffffffffc020546a:	00003517          	auipc	a0,0x3
ffffffffc020546e:	14650513          	addi	a0,a0,326 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205472:	808fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205476 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0205476:	7129                	addi	sp,sp,-320
ffffffffc0205478:	fa22                	sd	s0,304(sp)
ffffffffc020547a:	f626                	sd	s1,296(sp)
ffffffffc020547c:	f24a                	sd	s2,288(sp)
ffffffffc020547e:	84ae                	mv	s1,a1
ffffffffc0205480:	892a                	mv	s2,a0
ffffffffc0205482:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0205484:	4581                	li	a1,0
ffffffffc0205486:	12000613          	li	a2,288
ffffffffc020548a:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020548c:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020548e:	2de010ef          	jal	ra,ffffffffc020676c <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc0205492:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc0205494:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0205496:	100027f3          	csrr	a5,sstatus
ffffffffc020549a:	edd7f793          	andi	a5,a5,-291
ffffffffc020549e:	1207e793          	ori	a5,a5,288
ffffffffc02054a2:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02054a4:	860a                	mv	a2,sp
ffffffffc02054a6:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02054aa:	00000797          	auipc	a5,0x0
ffffffffc02054ae:	81678793          	addi	a5,a5,-2026 # ffffffffc0204cc0 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02054b2:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02054b4:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02054b6:	c27ff0ef          	jal	ra,ffffffffc02050dc <do_fork>
}
ffffffffc02054ba:	70f2                	ld	ra,312(sp)
ffffffffc02054bc:	7452                	ld	s0,304(sp)
ffffffffc02054be:	74b2                	ld	s1,296(sp)
ffffffffc02054c0:	7912                	ld	s2,288(sp)
ffffffffc02054c2:	6131                	addi	sp,sp,320
ffffffffc02054c4:	8082                	ret

ffffffffc02054c6 <do_exit>:
do_exit(int error_code) {
ffffffffc02054c6:	7179                	addi	sp,sp,-48
ffffffffc02054c8:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc02054ca:	000ad417          	auipc	s0,0xad
ffffffffc02054ce:	6a640413          	addi	s0,s0,1702 # ffffffffc02b2b70 <current>
ffffffffc02054d2:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc02054d4:	f406                	sd	ra,40(sp)
ffffffffc02054d6:	ec26                	sd	s1,24(sp)
ffffffffc02054d8:	e84a                	sd	s2,16(sp)
ffffffffc02054da:	e44e                	sd	s3,8(sp)
ffffffffc02054dc:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc02054de:	000ad717          	auipc	a4,0xad
ffffffffc02054e2:	69a73703          	ld	a4,1690(a4) # ffffffffc02b2b78 <idleproc>
ffffffffc02054e6:	0ce78c63          	beq	a5,a4,ffffffffc02055be <do_exit+0xf8>
    if (current == initproc) {
ffffffffc02054ea:	000ad497          	auipc	s1,0xad
ffffffffc02054ee:	69648493          	addi	s1,s1,1686 # ffffffffc02b2b80 <initproc>
ffffffffc02054f2:	6098                	ld	a4,0(s1)
ffffffffc02054f4:	0ee78b63          	beq	a5,a4,ffffffffc02055ea <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc02054f8:	0287b983          	ld	s3,40(a5)
ffffffffc02054fc:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc02054fe:	02098663          	beqz	s3,ffffffffc020552a <do_exit+0x64>
ffffffffc0205502:	000ad797          	auipc	a5,0xad
ffffffffc0205506:	6167b783          	ld	a5,1558(a5) # ffffffffc02b2b18 <boot_cr3>
ffffffffc020550a:	577d                	li	a4,-1
ffffffffc020550c:	177e                	slli	a4,a4,0x3f
ffffffffc020550e:	83b1                	srli	a5,a5,0xc
ffffffffc0205510:	8fd9                	or	a5,a5,a4
ffffffffc0205512:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc0205516:	0309a783          	lw	a5,48(s3)
ffffffffc020551a:	fff7871b          	addiw	a4,a5,-1
ffffffffc020551e:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205522:	cb55                	beqz	a4,ffffffffc02055d6 <do_exit+0x110>
        current->mm = NULL;
ffffffffc0205524:	601c                	ld	a5,0(s0)
ffffffffc0205526:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc020552a:	601c                	ld	a5,0(s0)
ffffffffc020552c:	470d                	li	a4,3
ffffffffc020552e:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0205530:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205534:	100027f3          	csrr	a5,sstatus
ffffffffc0205538:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020553a:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020553c:	e3f9                	bnez	a5,ffffffffc0205602 <do_exit+0x13c>
        proc = current->parent;
ffffffffc020553e:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205540:	800007b7          	lui	a5,0x80000
ffffffffc0205544:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc0205546:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205548:	0ec52703          	lw	a4,236(a0)
ffffffffc020554c:	0af70f63          	beq	a4,a5,ffffffffc020560a <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc0205550:	6018                	ld	a4,0(s0)
ffffffffc0205552:	7b7c                	ld	a5,240(a4)
ffffffffc0205554:	c3a1                	beqz	a5,ffffffffc0205594 <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205556:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020555a:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020555c:	0985                	addi	s3,s3,1
ffffffffc020555e:	a021                	j	ffffffffc0205566 <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc0205560:	6018                	ld	a4,0(s0)
ffffffffc0205562:	7b7c                	ld	a5,240(a4)
ffffffffc0205564:	cb85                	beqz	a5,ffffffffc0205594 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc0205566:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fa8>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020556a:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc020556c:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020556e:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc0205570:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205574:	10e7b023          	sd	a4,256(a5)
ffffffffc0205578:	c311                	beqz	a4,ffffffffc020557c <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc020557a:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020557c:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc020557e:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc0205580:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205582:	fd271fe3          	bne	a4,s2,ffffffffc0205560 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205586:	0ec52783          	lw	a5,236(a0)
ffffffffc020558a:	fd379be3          	bne	a5,s3,ffffffffc0205560 <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc020558e:	373000ef          	jal	ra,ffffffffc0206100 <wakeup_proc>
ffffffffc0205592:	b7f9                	j	ffffffffc0205560 <do_exit+0x9a>
    if (flag) {
ffffffffc0205594:	020a1263          	bnez	s4,ffffffffc02055b8 <do_exit+0xf2>
    schedule();
ffffffffc0205598:	3e9000ef          	jal	ra,ffffffffc0206180 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc020559c:	601c                	ld	a5,0(s0)
ffffffffc020559e:	00003617          	auipc	a2,0x3
ffffffffc02055a2:	09260613          	addi	a2,a2,146 # ffffffffc0208630 <default_pmm_manager+0x1148>
ffffffffc02055a6:	22c00593          	li	a1,556
ffffffffc02055aa:	43d4                	lw	a3,4(a5)
ffffffffc02055ac:	00003517          	auipc	a0,0x3
ffffffffc02055b0:	00450513          	addi	a0,a0,4 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc02055b4:	ec7fa0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc02055b8:	888fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02055bc:	bff1                	j	ffffffffc0205598 <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc02055be:	00003617          	auipc	a2,0x3
ffffffffc02055c2:	05260613          	addi	a2,a2,82 # ffffffffc0208610 <default_pmm_manager+0x1128>
ffffffffc02055c6:	20000593          	li	a1,512
ffffffffc02055ca:	00003517          	auipc	a0,0x3
ffffffffc02055ce:	fe650513          	addi	a0,a0,-26 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc02055d2:	ea9fa0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc02055d6:	854e                	mv	a0,s3
ffffffffc02055d8:	e6bfe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc02055dc:	854e                	mv	a0,s3
ffffffffc02055de:	8cdff0ef          	jal	ra,ffffffffc0204eaa <put_pgdir>
            mm_destroy(mm);
ffffffffc02055e2:	854e                	mv	a0,s3
ffffffffc02055e4:	cc3fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc02055e8:	bf35                	j	ffffffffc0205524 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc02055ea:	00003617          	auipc	a2,0x3
ffffffffc02055ee:	03660613          	addi	a2,a2,54 # ffffffffc0208620 <default_pmm_manager+0x1138>
ffffffffc02055f2:	20300593          	li	a1,515
ffffffffc02055f6:	00003517          	auipc	a0,0x3
ffffffffc02055fa:	fba50513          	addi	a0,a0,-70 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
...
ffffffffc0205608:	bf1d                	j	ffffffffc020553e <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc020560a:	2f7000ef          	jal	ra,ffffffffc0206100 <wakeup_proc>
ffffffffc020560e:	b789                	j	ffffffffc0205550 <do_exit+0x8a>

ffffffffc0205610 <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc0205610:	715d                	addi	sp,sp,-80
ffffffffc0205612:	f84a                	sd	s2,48(sp)
ffffffffc0205614:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc0205616:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc020561a:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc020561c:	fc26                	sd	s1,56(sp)
ffffffffc020561e:	f052                	sd	s4,32(sp)
ffffffffc0205620:	ec56                	sd	s5,24(sp)
ffffffffc0205622:	e85a                	sd	s6,16(sp)
ffffffffc0205624:	e45e                	sd	s7,8(sp)
ffffffffc0205626:	e486                	sd	ra,72(sp)
ffffffffc0205628:	e0a2                	sd	s0,64(sp)
ffffffffc020562a:	84aa                	mv	s1,a0
ffffffffc020562c:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc020562e:	000adb97          	auipc	s7,0xad
ffffffffc0205632:	542b8b93          	addi	s7,s7,1346 # ffffffffc02b2b70 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205636:	00050b1b          	sext.w	s6,a0
ffffffffc020563a:	fff50a9b          	addiw	s5,a0,-1
ffffffffc020563e:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc0205640:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc0205642:	ccbd                	beqz	s1,ffffffffc02056c0 <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205644:	0359e863          	bltu	s3,s5,ffffffffc0205674 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205648:	45a9                	li	a1,10
ffffffffc020564a:	855a                	mv	a0,s6
ffffffffc020564c:	4a1000ef          	jal	ra,ffffffffc02062ec <hash32>
ffffffffc0205650:	02051793          	slli	a5,a0,0x20
ffffffffc0205654:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205658:	000a9797          	auipc	a5,0xa9
ffffffffc020565c:	49078793          	addi	a5,a5,1168 # ffffffffc02aeae8 <hash_list>
ffffffffc0205660:	953e                	add	a0,a0,a5
ffffffffc0205662:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205664:	a029                	j	ffffffffc020566e <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc0205666:	f2c42783          	lw	a5,-212(s0)
ffffffffc020566a:	02978163          	beq	a5,s1,ffffffffc020568c <do_wait.part.0+0x7c>
    return listelm->next;
ffffffffc020566e:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc0205670:	fe851be3          	bne	a0,s0,ffffffffc0205666 <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc0205674:	5579                	li	a0,-2
}
ffffffffc0205676:	60a6                	ld	ra,72(sp)
ffffffffc0205678:	6406                	ld	s0,64(sp)
ffffffffc020567a:	74e2                	ld	s1,56(sp)
ffffffffc020567c:	7942                	ld	s2,48(sp)
ffffffffc020567e:	79a2                	ld	s3,40(sp)
ffffffffc0205680:	7a02                	ld	s4,32(sp)
ffffffffc0205682:	6ae2                	ld	s5,24(sp)
ffffffffc0205684:	6b42                	ld	s6,16(sp)
ffffffffc0205686:	6ba2                	ld	s7,8(sp)
ffffffffc0205688:	6161                	addi	sp,sp,80
ffffffffc020568a:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc020568c:	000bb683          	ld	a3,0(s7)
ffffffffc0205690:	f4843783          	ld	a5,-184(s0)
ffffffffc0205694:	fed790e3          	bne	a5,a3,ffffffffc0205674 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205698:	f2842703          	lw	a4,-216(s0)
ffffffffc020569c:	478d                	li	a5,3
ffffffffc020569e:	0ef70b63          	beq	a4,a5,ffffffffc0205794 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02056a2:	4785                	li	a5,1
ffffffffc02056a4:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc02056a6:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc02056aa:	2d7000ef          	jal	ra,ffffffffc0206180 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc02056ae:	000bb783          	ld	a5,0(s7)
ffffffffc02056b2:	0b07a783          	lw	a5,176(a5)
ffffffffc02056b6:	8b85                	andi	a5,a5,1
ffffffffc02056b8:	d7c9                	beqz	a5,ffffffffc0205642 <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc02056ba:	555d                	li	a0,-9
ffffffffc02056bc:	e0bff0ef          	jal	ra,ffffffffc02054c6 <do_exit>
        proc = current->cptr;
ffffffffc02056c0:	000bb683          	ld	a3,0(s7)
ffffffffc02056c4:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02056c6:	d45d                	beqz	s0,ffffffffc0205674 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02056c8:	470d                	li	a4,3
ffffffffc02056ca:	a021                	j	ffffffffc02056d2 <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02056cc:	10043403          	ld	s0,256(s0)
ffffffffc02056d0:	d869                	beqz	s0,ffffffffc02056a2 <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02056d2:	401c                	lw	a5,0(s0)
ffffffffc02056d4:	fee79ce3          	bne	a5,a4,ffffffffc02056cc <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc02056d8:	000ad797          	auipc	a5,0xad
ffffffffc02056dc:	4a07b783          	ld	a5,1184(a5) # ffffffffc02b2b78 <idleproc>
ffffffffc02056e0:	0c878963          	beq	a5,s0,ffffffffc02057b2 <do_wait.part.0+0x1a2>
ffffffffc02056e4:	000ad797          	auipc	a5,0xad
ffffffffc02056e8:	49c7b783          	ld	a5,1180(a5) # ffffffffc02b2b80 <initproc>
ffffffffc02056ec:	0cf40363          	beq	s0,a5,ffffffffc02057b2 <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc02056f0:	000a0663          	beqz	s4,ffffffffc02056fc <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc02056f4:	0e842783          	lw	a5,232(s0)
ffffffffc02056f8:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8be0>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0205702:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205704:	e7c1                	bnez	a5,ffffffffc020578c <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc020571a:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc020571c:	c319                	beqz	a4,ffffffffc0205722 <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc020571e:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc0205720:	7c7c                	ld	a5,248(s0)
ffffffffc0205722:	c3b5                	beqz	a5,ffffffffc0205786 <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc0205724:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc0205728:	000ad717          	auipc	a4,0xad
ffffffffc020572c:	46070713          	addi	a4,a4,1120 # ffffffffc02b2b88 <nr_process>
ffffffffc0205730:	431c                	lw	a5,0(a4)
ffffffffc0205732:	37fd                	addiw	a5,a5,-1
ffffffffc0205734:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc0205736:	e5a9                	bnez	a1,ffffffffc0205780 <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205738:	6814                	ld	a3,16(s0)
ffffffffc020573a:	c02007b7          	lui	a5,0xc0200
ffffffffc020573e:	04f6ee63          	bltu	a3,a5,ffffffffc020579a <do_wait.part.0+0x18a>
ffffffffc0205742:	000ad797          	auipc	a5,0xad
ffffffffc0205746:	3fe7b783          	ld	a5,1022(a5) # ffffffffc02b2b40 <va_pa_offset>
ffffffffc020574a:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc020574c:	82b1                	srli	a3,a3,0xc
ffffffffc020574e:	000ad797          	auipc	a5,0xad
ffffffffc0205752:	3da7b783          	ld	a5,986(a5) # ffffffffc02b2b28 <npage>
ffffffffc0205756:	06f6fa63          	bgeu	a3,a5,ffffffffc02057ca <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc020575a:	00003517          	auipc	a0,0x3
ffffffffc020575e:	70e53503          	ld	a0,1806(a0) # ffffffffc0208e68 <nbase>
ffffffffc0205762:	8e89                	sub	a3,a3,a0
ffffffffc0205764:	069a                	slli	a3,a3,0x6
ffffffffc0205766:	000ad517          	auipc	a0,0xad
ffffffffc020576a:	3ca53503          	ld	a0,970(a0) # ffffffffc02b2b30 <pages>
ffffffffc020576e:	9536                	add	a0,a0,a3
ffffffffc0205770:	4589                	li	a1,2
ffffffffc0205772:	e00fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc0205776:	8522                	mv	a0,s0
ffffffffc0205778:	c3afc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc020577c:	4501                	li	a0,0
ffffffffc020577e:	bde5                	j	ffffffffc0205676 <do_wait.part.0+0x66>
        intr_enable();
ffffffffc0205780:	ec1fa0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205784:	bf55                	j	ffffffffc0205738 <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc0205786:	701c                	ld	a5,32(s0)
ffffffffc0205788:	fbf8                	sd	a4,240(a5)
ffffffffc020578a:	bf79                	j	ffffffffc0205728 <do_wait.part.0+0x118>
        intr_disable();
ffffffffc020578c:	ebbfa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205790:	4585                	li	a1,1
ffffffffc0205792:	bf95                	j	ffffffffc0205706 <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205794:	f2840413          	addi	s0,s0,-216
ffffffffc0205798:	b781                	j	ffffffffc02056d8 <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc020579a:	00002617          	auipc	a2,0x2
ffffffffc020579e:	e2e60613          	addi	a2,a2,-466 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc02057a2:	06e00593          	li	a1,110
ffffffffc02057a6:	00002517          	auipc	a0,0x2
ffffffffc02057aa:	da250513          	addi	a0,a0,-606 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc02057ae:	ccdfa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc02057b2:	00003617          	auipc	a2,0x3
ffffffffc02057b6:	e9e60613          	addi	a2,a2,-354 # ffffffffc0208650 <default_pmm_manager+0x1168>
ffffffffc02057ba:	32700593          	li	a1,807
ffffffffc02057be:	00003517          	auipc	a0,0x3
ffffffffc02057c2:	df250513          	addi	a0,a0,-526 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc02057c6:	cb5fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02057ca:	00002617          	auipc	a2,0x2
ffffffffc02057ce:	e2660613          	addi	a2,a2,-474 # ffffffffc02075f0 <default_pmm_manager+0x108>
ffffffffc02057d2:	06200593          	li	a1,98
ffffffffc02057d6:	00002517          	auipc	a0,0x2
ffffffffc02057da:	d7250513          	addi	a0,a0,-654 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc02057de:	c9dfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02057e2 <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc02057e2:	1141                	addi	sp,sp,-16
ffffffffc02057e4:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02057e6:	dccfc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc02057ea:	b14fc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc02057ee:	4601                	li	a2,0
ffffffffc02057f0:	4581                	li	a1,0
ffffffffc02057f2:	fffff517          	auipc	a0,0xfffff
ffffffffc02057f6:	63a50513          	addi	a0,a0,1594 # ffffffffc0204e2c <user_main>
ffffffffc02057fa:	c7dff0ef          	jal	ra,ffffffffc0205476 <kernel_thread>
    if (pid <= 0) {
ffffffffc02057fe:	00a04563          	bgtz	a0,ffffffffc0205808 <init_main+0x26>
ffffffffc0205802:	a071                	j	ffffffffc020588e <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc0205804:	17d000ef          	jal	ra,ffffffffc0206180 <schedule>
    if (code_store != NULL) {
ffffffffc0205808:	4581                	li	a1,0
ffffffffc020580a:	4501                	li	a0,0
ffffffffc020580c:	e05ff0ef          	jal	ra,ffffffffc0205610 <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
ffffffffc0205810:	d975                	beqz	a0,ffffffffc0205804 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc0205812:	00003517          	auipc	a0,0x3
ffffffffc0205816:	e7e50513          	addi	a0,a0,-386 # ffffffffc0208690 <default_pmm_manager+0x11a8>
ffffffffc020581a:	967fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020581e:	000ad797          	auipc	a5,0xad
ffffffffc0205822:	3627b783          	ld	a5,866(a5) # ffffffffc02b2b80 <initproc>
ffffffffc0205826:	7bf8                	ld	a4,240(a5)
ffffffffc0205828:	e339                	bnez	a4,ffffffffc020586e <init_main+0x8c>
ffffffffc020582a:	7ff8                	ld	a4,248(a5)
ffffffffc020582c:	e329                	bnez	a4,ffffffffc020586e <init_main+0x8c>
ffffffffc020582e:	1007b703          	ld	a4,256(a5)
ffffffffc0205832:	ef15                	bnez	a4,ffffffffc020586e <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0205834:	000ad697          	auipc	a3,0xad
ffffffffc0205838:	3546a683          	lw	a3,852(a3) # ffffffffc02b2b88 <nr_process>
ffffffffc020583c:	4709                	li	a4,2
ffffffffc020583e:	0ae69463          	bne	a3,a4,ffffffffc02058e6 <init_main+0x104>
    return listelm->next;
ffffffffc0205842:	000ad697          	auipc	a3,0xad
ffffffffc0205846:	2a668693          	addi	a3,a3,678 # ffffffffc02b2ae8 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020584a:	6698                	ld	a4,8(a3)
ffffffffc020584c:	0c878793          	addi	a5,a5,200
ffffffffc0205850:	06f71b63          	bne	a4,a5,ffffffffc02058c6 <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205854:	629c                	ld	a5,0(a3)
ffffffffc0205856:	04f71863          	bne	a4,a5,ffffffffc02058a6 <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc020585a:	00003517          	auipc	a0,0x3
ffffffffc020585e:	f1e50513          	addi	a0,a0,-226 # ffffffffc0208778 <default_pmm_manager+0x1290>
ffffffffc0205862:	91ffa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc0205866:	60a2                	ld	ra,8(sp)
ffffffffc0205868:	4501                	li	a0,0
ffffffffc020586a:	0141                	addi	sp,sp,16
ffffffffc020586c:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020586e:	00003697          	auipc	a3,0x3
ffffffffc0205872:	e4a68693          	addi	a3,a3,-438 # ffffffffc02086b8 <default_pmm_manager+0x11d0>
ffffffffc0205876:	00001617          	auipc	a2,0x1
ffffffffc020587a:	5da60613          	addi	a2,a2,1498 # ffffffffc0206e50 <commands+0x450>
ffffffffc020587e:	38c00593          	li	a1,908
ffffffffc0205882:	00003517          	auipc	a0,0x3
ffffffffc0205886:	d2e50513          	addi	a0,a0,-722 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc020588a:	bf1fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc020588e:	00003617          	auipc	a2,0x3
ffffffffc0205892:	de260613          	addi	a2,a2,-542 # ffffffffc0208670 <default_pmm_manager+0x1188>
ffffffffc0205896:	38400593          	li	a1,900
ffffffffc020589a:	00003517          	auipc	a0,0x3
ffffffffc020589e:	d1650513          	addi	a0,a0,-746 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc02058a2:	bd9fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02058a6:	00003697          	auipc	a3,0x3
ffffffffc02058aa:	ea268693          	addi	a3,a3,-350 # ffffffffc0208748 <default_pmm_manager+0x1260>
ffffffffc02058ae:	00001617          	auipc	a2,0x1
ffffffffc02058b2:	5a260613          	addi	a2,a2,1442 # ffffffffc0206e50 <commands+0x450>
ffffffffc02058b6:	38f00593          	li	a1,911
ffffffffc02058ba:	00003517          	auipc	a0,0x3
ffffffffc02058be:	cf650513          	addi	a0,a0,-778 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc02058c2:	bb9fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02058c6:	00003697          	auipc	a3,0x3
ffffffffc02058ca:	e5268693          	addi	a3,a3,-430 # ffffffffc0208718 <default_pmm_manager+0x1230>
ffffffffc02058ce:	00001617          	auipc	a2,0x1
ffffffffc02058d2:	58260613          	addi	a2,a2,1410 # ffffffffc0206e50 <commands+0x450>
ffffffffc02058d6:	38e00593          	li	a1,910
ffffffffc02058da:	00003517          	auipc	a0,0x3
ffffffffc02058de:	cd650513          	addi	a0,a0,-810 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc02058e2:	b99fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc02058e6:	00003697          	auipc	a3,0x3
ffffffffc02058ea:	e2268693          	addi	a3,a3,-478 # ffffffffc0208708 <default_pmm_manager+0x1220>
ffffffffc02058ee:	00001617          	auipc	a2,0x1
ffffffffc02058f2:	56260613          	addi	a2,a2,1378 # ffffffffc0206e50 <commands+0x450>
ffffffffc02058f6:	38d00593          	li	a1,909
ffffffffc02058fa:	00003517          	auipc	a0,0x3
ffffffffc02058fe:	cb650513          	addi	a0,a0,-842 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205902:	b79fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205906 <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205906:	7171                	addi	sp,sp,-176
ffffffffc0205908:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020590a:	000add97          	auipc	s11,0xad
ffffffffc020590e:	266d8d93          	addi	s11,s11,614 # ffffffffc02b2b70 <current>
ffffffffc0205912:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205916:	e54e                	sd	s3,136(sp)
ffffffffc0205918:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020591a:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020591e:	e94a                	sd	s2,144(sp)
ffffffffc0205920:	f4de                	sd	s7,104(sp)
ffffffffc0205922:	892a                	mv	s2,a0
ffffffffc0205924:	8bb2                	mv	s7,a2
ffffffffc0205926:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205928:	862e                	mv	a2,a1
ffffffffc020592a:	4681                	li	a3,0
ffffffffc020592c:	85aa                	mv	a1,a0
ffffffffc020592e:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205930:	f506                	sd	ra,168(sp)
ffffffffc0205932:	f122                	sd	s0,160(sp)
ffffffffc0205934:	e152                	sd	s4,128(sp)
ffffffffc0205936:	fcd6                	sd	s5,120(sp)
ffffffffc0205938:	f8da                	sd	s6,112(sp)
ffffffffc020593a:	f0e2                	sd	s8,96(sp)
ffffffffc020593c:	ece6                	sd	s9,88(sp)
ffffffffc020593e:	e8ea                	sd	s10,80(sp)
ffffffffc0205940:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205942:	996ff0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc0205946:	40050a63          	beqz	a0,ffffffffc0205d5a <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc020594a:	4641                	li	a2,16
ffffffffc020594c:	4581                	li	a1,0
ffffffffc020594e:	1808                	addi	a0,sp,48
ffffffffc0205950:	61d000ef          	jal	ra,ffffffffc020676c <memset>
    memcpy(local_name, name, len);
ffffffffc0205954:	47bd                	li	a5,15
ffffffffc0205956:	8626                	mv	a2,s1
ffffffffc0205958:	1e97e263          	bltu	a5,s1,ffffffffc0205b3c <do_execve+0x236>
ffffffffc020595c:	85ca                	mv	a1,s2
ffffffffc020595e:	1808                	addi	a0,sp,48
ffffffffc0205960:	61f000ef          	jal	ra,ffffffffc020677e <memcpy>
    if (mm != NULL) {
ffffffffc0205964:	1e098363          	beqz	s3,ffffffffc0205b4a <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc0205968:	00002517          	auipc	a0,0x2
ffffffffc020596c:	30850513          	addi	a0,a0,776 # ffffffffc0207c70 <default_pmm_manager+0x788>
ffffffffc0205970:	849fa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc0205974:	000ad797          	auipc	a5,0xad
ffffffffc0205978:	1a47b783          	ld	a5,420(a5) # ffffffffc02b2b18 <boot_cr3>
ffffffffc020597c:	577d                	li	a4,-1
ffffffffc020597e:	177e                	slli	a4,a4,0x3f
ffffffffc0205980:	83b1                	srli	a5,a5,0xc
ffffffffc0205982:	8fd9                	or	a5,a5,a4
ffffffffc0205984:	18079073          	csrw	satp,a5
ffffffffc0205988:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7bb0>
ffffffffc020598c:	fff7871b          	addiw	a4,a5,-1
ffffffffc0205990:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205994:	2c070463          	beqz	a4,ffffffffc0205c5c <do_execve+0x356>
        current->mm = NULL;
ffffffffc0205998:	000db783          	ld	a5,0(s11)
ffffffffc020599c:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc02059a0:	f80fe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc02059a4:	84aa                	mv	s1,a0
ffffffffc02059a6:	1c050d63          	beqz	a0,ffffffffc0205b80 <do_execve+0x27a>
    if ((page = alloc_page()) == NULL) {
ffffffffc02059aa:	4505                	li	a0,1
ffffffffc02059ac:	b34fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc02059b0:	3a050963          	beqz	a0,ffffffffc0205d62 <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc02059b4:	000adc97          	auipc	s9,0xad
ffffffffc02059b8:	17cc8c93          	addi	s9,s9,380 # ffffffffc02b2b30 <pages>
ffffffffc02059bc:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc02059c0:	000adc17          	auipc	s8,0xad
ffffffffc02059c4:	168c0c13          	addi	s8,s8,360 # ffffffffc02b2b28 <npage>
    return page - pages + nbase;
ffffffffc02059c8:	00003717          	auipc	a4,0x3
ffffffffc02059cc:	4a073703          	ld	a4,1184(a4) # ffffffffc0208e68 <nbase>
ffffffffc02059d0:	40d506b3          	sub	a3,a0,a3
ffffffffc02059d4:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02059d6:	5afd                	li	s5,-1
ffffffffc02059d8:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc02059dc:	96ba                	add	a3,a3,a4
ffffffffc02059de:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc02059e0:	00cad713          	srli	a4,s5,0xc
ffffffffc02059e4:	ec3a                	sd	a4,24(sp)
ffffffffc02059e6:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc02059e8:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02059ea:	38f77063          	bgeu	a4,a5,ffffffffc0205d6a <do_execve+0x464>
ffffffffc02059ee:	000adb17          	auipc	s6,0xad
ffffffffc02059f2:	152b0b13          	addi	s6,s6,338 # ffffffffc02b2b40 <va_pa_offset>
ffffffffc02059f6:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc02059fa:	6605                	lui	a2,0x1
ffffffffc02059fc:	000ad597          	auipc	a1,0xad
ffffffffc0205a00:	1245b583          	ld	a1,292(a1) # ffffffffc02b2b20 <boot_pgdir>
ffffffffc0205a04:	9936                	add	s2,s2,a3
ffffffffc0205a06:	854a                	mv	a0,s2
ffffffffc0205a08:	577000ef          	jal	ra,ffffffffc020677e <memcpy>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205a0c:	7782                	ld	a5,32(sp)
ffffffffc0205a0e:	4398                	lw	a4,0(a5)
ffffffffc0205a10:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0205a14:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205a18:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9427>
ffffffffc0205a1c:	14f71863          	bne	a4,a5,ffffffffc0205b6c <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205a20:	7682                	ld	a3,32(sp)
ffffffffc0205a22:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205a26:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205a2a:	00371793          	slli	a5,a4,0x3
ffffffffc0205a2e:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205a30:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205a32:	078e                	slli	a5,a5,0x3
ffffffffc0205a34:	97ce                	add	a5,a5,s3
ffffffffc0205a36:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc0205a38:	00f9fc63          	bgeu	s3,a5,ffffffffc0205a50 <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc0205a3c:	0009a783          	lw	a5,0(s3)
ffffffffc0205a40:	4705                	li	a4,1
ffffffffc0205a42:	14e78163          	beq	a5,a4,ffffffffc0205b84 <do_execve+0x27e>
    for (; ph < ph_end; ph ++) {
ffffffffc0205a46:	77a2                	ld	a5,40(sp)
ffffffffc0205a48:	03898993          	addi	s3,s3,56
ffffffffc0205a4c:	fef9e8e3          	bltu	s3,a5,ffffffffc0205a3c <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc0205a50:	4701                	li	a4,0
ffffffffc0205a52:	46ad                	li	a3,11
ffffffffc0205a54:	00100637          	lui	a2,0x100
ffffffffc0205a58:	7ff005b7          	lui	a1,0x7ff00
ffffffffc0205a5c:	8526                	mv	a0,s1
ffffffffc0205a5e:	89bfe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205a62:	8a2a                	mv	s4,a0
ffffffffc0205a64:	1e051263          	bnez	a0,ffffffffc0205c48 <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205a68:	6c88                	ld	a0,24(s1)
ffffffffc0205a6a:	467d                	li	a2,31
ffffffffc0205a6c:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0205a70:	8ddfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a74:	38050363          	beqz	a0,ffffffffc0205dfa <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205a78:	6c88                	ld	a0,24(s1)
ffffffffc0205a7a:	467d                	li	a2,31
ffffffffc0205a7c:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc0205a80:	8cdfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a84:	34050b63          	beqz	a0,ffffffffc0205dda <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205a88:	6c88                	ld	a0,24(s1)
ffffffffc0205a8a:	467d                	li	a2,31
ffffffffc0205a8c:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc0205a90:	8bdfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a94:	32050363          	beqz	a0,ffffffffc0205dba <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205a98:	6c88                	ld	a0,24(s1)
ffffffffc0205a9a:	467d                	li	a2,31
ffffffffc0205a9c:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc0205aa0:	8adfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205aa4:	2e050b63          	beqz	a0,ffffffffc0205d9a <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc0205aa8:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc0205aaa:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205aae:	6c94                	ld	a3,24(s1)
ffffffffc0205ab0:	2785                	addiw	a5,a5,1
ffffffffc0205ab2:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc0205ab4:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205ab6:	c02007b7          	lui	a5,0xc0200
ffffffffc0205aba:	2cf6e463          	bltu	a3,a5,ffffffffc0205d82 <do_execve+0x47c>
ffffffffc0205abe:	000b3783          	ld	a5,0(s6)
ffffffffc0205ac2:	577d                	li	a4,-1
ffffffffc0205ac4:	177e                	slli	a4,a4,0x3f
ffffffffc0205ac6:	8e9d                	sub	a3,a3,a5
ffffffffc0205ac8:	00c6d793          	srli	a5,a3,0xc
ffffffffc0205acc:	f654                	sd	a3,168(a2)
ffffffffc0205ace:	8fd9                	or	a5,a5,a4
ffffffffc0205ad0:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc0205ad4:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0205ad6:	4581                	li	a1,0
ffffffffc0205ad8:	12000613          	li	a2,288
ffffffffc0205adc:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc0205ade:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0205ae2:	48b000ef          	jal	ra,ffffffffc020676c <memset>
    tf->epc = elf->e_entry;
ffffffffc0205ae6:	7782                	ld	a5,32(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205ae8:	000db903          	ld	s2,0(s11)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205aec:	edf4f493          	andi	s1,s1,-289
    tf->epc = elf->e_entry;
ffffffffc0205af0:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;
ffffffffc0205af2:	4785                	li	a5,1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205af4:	0b490913          	addi	s2,s2,180 # ffffffff800000b4 <_binary_obj___user_exit_out_size+0xffffffff7fff4f5c>
    tf->gpr.sp = USTACKTOP;
ffffffffc0205af8:	07fe                	slli	a5,a5,0x1f
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205afa:	0204e493          	ori	s1,s1,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205afe:	4641                	li	a2,16
ffffffffc0205b00:	4581                	li	a1,0
    tf->gpr.sp = USTACKTOP;
ffffffffc0205b02:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc0205b04:	10e43423          	sd	a4,264(s0)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205b08:	10943023          	sd	s1,256(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205b0c:	854a                	mv	a0,s2
ffffffffc0205b0e:	45f000ef          	jal	ra,ffffffffc020676c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205b12:	463d                	li	a2,15
ffffffffc0205b14:	180c                	addi	a1,sp,48
ffffffffc0205b16:	854a                	mv	a0,s2
ffffffffc0205b18:	467000ef          	jal	ra,ffffffffc020677e <memcpy>
}
ffffffffc0205b1c:	70aa                	ld	ra,168(sp)
ffffffffc0205b1e:	740a                	ld	s0,160(sp)
ffffffffc0205b20:	64ea                	ld	s1,152(sp)
ffffffffc0205b22:	694a                	ld	s2,144(sp)
ffffffffc0205b24:	69aa                	ld	s3,136(sp)
ffffffffc0205b26:	7ae6                	ld	s5,120(sp)
ffffffffc0205b28:	7b46                	ld	s6,112(sp)
ffffffffc0205b2a:	7ba6                	ld	s7,104(sp)
ffffffffc0205b2c:	7c06                	ld	s8,96(sp)
ffffffffc0205b2e:	6ce6                	ld	s9,88(sp)
ffffffffc0205b30:	6d46                	ld	s10,80(sp)
ffffffffc0205b32:	6da6                	ld	s11,72(sp)
ffffffffc0205b34:	8552                	mv	a0,s4
ffffffffc0205b36:	6a0a                	ld	s4,128(sp)
ffffffffc0205b38:	614d                	addi	sp,sp,176
ffffffffc0205b3a:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0205b3c:	463d                	li	a2,15
ffffffffc0205b3e:	85ca                	mv	a1,s2
ffffffffc0205b40:	1808                	addi	a0,sp,48
ffffffffc0205b42:	43d000ef          	jal	ra,ffffffffc020677e <memcpy>
    if (mm != NULL) {
ffffffffc0205b46:	e20991e3          	bnez	s3,ffffffffc0205968 <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc0205b4a:	000db783          	ld	a5,0(s11)
ffffffffc0205b4e:	779c                	ld	a5,40(a5)
ffffffffc0205b50:	e40788e3          	beqz	a5,ffffffffc02059a0 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc0205b54:	00003617          	auipc	a2,0x3
ffffffffc0205b58:	c4460613          	addi	a2,a2,-956 # ffffffffc0208798 <default_pmm_manager+0x12b0>
ffffffffc0205b5c:	23600593          	li	a1,566
ffffffffc0205b60:	00003517          	auipc	a0,0x3
ffffffffc0205b64:	a5050513          	addi	a0,a0,-1456 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205b68:	913fa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc0205b6c:	8526                	mv	a0,s1
ffffffffc0205b6e:	b3cff0ef          	jal	ra,ffffffffc0204eaa <put_pgdir>
    mm_destroy(mm);
ffffffffc0205b72:	8526                	mv	a0,s1
ffffffffc0205b74:	f32fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc0205b78:	5a61                	li	s4,-8
    do_exit(ret);
ffffffffc0205b7a:	8552                	mv	a0,s4
ffffffffc0205b7c:	94bff0ef          	jal	ra,ffffffffc02054c6 <do_exit>
    int ret = -E_NO_MEM;
ffffffffc0205b80:	5a71                	li	s4,-4
ffffffffc0205b82:	bfe5                	j	ffffffffc0205b7a <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc0205b84:	0289b603          	ld	a2,40(s3)
ffffffffc0205b88:	0209b783          	ld	a5,32(s3)
ffffffffc0205b8c:	1cf66d63          	bltu	a2,a5,ffffffffc0205d66 <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205b90:	0049a783          	lw	a5,4(s3)
ffffffffc0205b94:	0017f693          	andi	a3,a5,1
ffffffffc0205b98:	c291                	beqz	a3,ffffffffc0205b9c <do_execve+0x296>
ffffffffc0205b9a:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205b9c:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205ba0:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205ba2:	e779                	bnez	a4,ffffffffc0205c70 <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205ba4:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205ba6:	c781                	beqz	a5,ffffffffc0205bae <do_execve+0x2a8>
ffffffffc0205ba8:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205bac:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205bae:	0026f793          	andi	a5,a3,2
ffffffffc0205bb2:	e3f1                	bnez	a5,ffffffffc0205c76 <do_execve+0x370>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205bb4:	0046f793          	andi	a5,a3,4
ffffffffc0205bb8:	c399                	beqz	a5,ffffffffc0205bbe <do_execve+0x2b8>
ffffffffc0205bba:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc0205bbe:	0109b583          	ld	a1,16(s3)
ffffffffc0205bc2:	4701                	li	a4,0
ffffffffc0205bc4:	8526                	mv	a0,s1
ffffffffc0205bc6:	f32fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205bca:	8a2a                	mv	s4,a0
ffffffffc0205bcc:	ed35                	bnez	a0,ffffffffc0205c48 <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205bce:	0109bb83          	ld	s7,16(s3)
ffffffffc0205bd2:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0205bd4:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205bd8:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205bdc:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205be0:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc0205be2:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205be4:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc0205be6:	054be963          	bltu	s7,s4,ffffffffc0205c38 <do_execve+0x332>
ffffffffc0205bea:	aa95                	j	ffffffffc0205d5e <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205bec:	6785                	lui	a5,0x1
ffffffffc0205bee:	415b8533          	sub	a0,s7,s5
ffffffffc0205bf2:	9abe                	add	s5,s5,a5
ffffffffc0205bf4:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205bf8:	015a7463          	bgeu	s4,s5,ffffffffc0205c00 <do_execve+0x2fa>
                size -= la - end;
ffffffffc0205bfc:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0205c00:	000cb683          	ld	a3,0(s9)
ffffffffc0205c04:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205c06:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205c0a:	40d406b3          	sub	a3,s0,a3
ffffffffc0205c0e:	8699                	srai	a3,a3,0x6
ffffffffc0205c10:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205c12:	67e2                	ld	a5,24(sp)
ffffffffc0205c14:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205c18:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205c1a:	14b87863          	bgeu	a6,a1,ffffffffc0205d6a <do_execve+0x464>
ffffffffc0205c1e:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205c22:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205c24:	9bb2                	add	s7,s7,a2
ffffffffc0205c26:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205c28:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205c2a:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205c2c:	353000ef          	jal	ra,ffffffffc020677e <memcpy>
            start += size, from += size;
ffffffffc0205c30:	6622                	ld	a2,8(sp)
ffffffffc0205c32:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205c34:	054bf363          	bgeu	s7,s4,ffffffffc0205c7a <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205c38:	6c88                	ld	a0,24(s1)
ffffffffc0205c3a:	866a                	mv	a2,s10
ffffffffc0205c3c:	85d6                	mv	a1,s5
ffffffffc0205c3e:	f0efd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205c42:	842a                	mv	s0,a0
ffffffffc0205c44:	f545                	bnez	a0,ffffffffc0205bec <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0205c46:	5a71                	li	s4,-4
    exit_mmap(mm);
ffffffffc0205c48:	8526                	mv	a0,s1
ffffffffc0205c4a:	ff8fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205c4e:	8526                	mv	a0,s1
ffffffffc0205c50:	a5aff0ef          	jal	ra,ffffffffc0204eaa <put_pgdir>
    mm_destroy(mm);
ffffffffc0205c54:	8526                	mv	a0,s1
ffffffffc0205c56:	e50fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205c5a:	b705                	j	ffffffffc0205b7a <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0205c5c:	854e                	mv	a0,s3
ffffffffc0205c5e:	fe4fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205c62:	854e                	mv	a0,s3
ffffffffc0205c64:	a46ff0ef          	jal	ra,ffffffffc0204eaa <put_pgdir>
            mm_destroy(mm);
ffffffffc0205c68:	854e                	mv	a0,s3
ffffffffc0205c6a:	e3cfe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205c6e:	b32d                	j	ffffffffc0205998 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205c70:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205c74:	fb95                	bnez	a5,ffffffffc0205ba8 <do_execve+0x2a2>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205c76:	4d5d                	li	s10,23
ffffffffc0205c78:	bf35                	j	ffffffffc0205bb4 <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205c7a:	0109b683          	ld	a3,16(s3)
ffffffffc0205c7e:	0289b903          	ld	s2,40(s3)
ffffffffc0205c82:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205c84:	075bfd63          	bgeu	s7,s5,ffffffffc0205cfe <do_execve+0x3f8>
            if (start == end) {
ffffffffc0205c88:	db790fe3          	beq	s2,s7,ffffffffc0205a46 <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205c8c:	6785                	lui	a5,0x1
ffffffffc0205c8e:	00fb8533          	add	a0,s7,a5
ffffffffc0205c92:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205c96:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205c9a:	0b597d63          	bgeu	s2,s5,ffffffffc0205d54 <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0205c9e:	000cb683          	ld	a3,0(s9)
ffffffffc0205ca2:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205ca4:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0205ca8:	40d406b3          	sub	a3,s0,a3
ffffffffc0205cac:	8699                	srai	a3,a3,0x6
ffffffffc0205cae:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205cb0:	67e2                	ld	a5,24(sp)
ffffffffc0205cb2:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205cb6:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205cb8:	0ac5f963          	bgeu	a1,a2,ffffffffc0205d6a <do_execve+0x464>
ffffffffc0205cbc:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205cc0:	8652                	mv	a2,s4
ffffffffc0205cc2:	4581                	li	a1,0
ffffffffc0205cc4:	96c2                	add	a3,a3,a6
ffffffffc0205cc6:	9536                	add	a0,a0,a3
ffffffffc0205cc8:	2a5000ef          	jal	ra,ffffffffc020676c <memset>
            start += size;
ffffffffc0205ccc:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205cd0:	03597463          	bgeu	s2,s5,ffffffffc0205cf8 <do_execve+0x3f2>
ffffffffc0205cd4:	d6e909e3          	beq	s2,a4,ffffffffc0205a46 <do_execve+0x140>
ffffffffc0205cd8:	00003697          	auipc	a3,0x3
ffffffffc0205cdc:	ae868693          	addi	a3,a3,-1304 # ffffffffc02087c0 <default_pmm_manager+0x12d8>
ffffffffc0205ce0:	00001617          	auipc	a2,0x1
ffffffffc0205ce4:	17060613          	addi	a2,a2,368 # ffffffffc0206e50 <commands+0x450>
ffffffffc0205ce8:	28b00593          	li	a1,651
ffffffffc0205cec:	00003517          	auipc	a0,0x3
ffffffffc0205cf0:	8c450513          	addi	a0,a0,-1852 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205cf4:	f86fa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205cf8:	ff5710e3          	bne	a4,s5,ffffffffc0205cd8 <do_execve+0x3d2>
ffffffffc0205cfc:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205cfe:	d52bf4e3          	bgeu	s7,s2,ffffffffc0205a46 <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205d02:	6c88                	ld	a0,24(s1)
ffffffffc0205d04:	866a                	mv	a2,s10
ffffffffc0205d06:	85d6                	mv	a1,s5
ffffffffc0205d08:	e44fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205d0c:	842a                	mv	s0,a0
ffffffffc0205d0e:	dd05                	beqz	a0,ffffffffc0205c46 <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205d10:	6785                	lui	a5,0x1
ffffffffc0205d12:	415b8533          	sub	a0,s7,s5
ffffffffc0205d16:	9abe                	add	s5,s5,a5
ffffffffc0205d18:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205d1c:	01597463          	bgeu	s2,s5,ffffffffc0205d24 <do_execve+0x41e>
                size -= la - end;
ffffffffc0205d20:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205d24:	000cb683          	ld	a3,0(s9)
ffffffffc0205d28:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205d2a:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205d2e:	40d406b3          	sub	a3,s0,a3
ffffffffc0205d32:	8699                	srai	a3,a3,0x6
ffffffffc0205d34:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205d36:	67e2                	ld	a5,24(sp)
ffffffffc0205d38:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205d3c:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205d3e:	02b87663          	bgeu	a6,a1,ffffffffc0205d6a <do_execve+0x464>
ffffffffc0205d42:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205d46:	4581                	li	a1,0
            start += size;
ffffffffc0205d48:	9bb2                	add	s7,s7,a2
ffffffffc0205d4a:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205d4c:	9536                	add	a0,a0,a3
ffffffffc0205d4e:	21f000ef          	jal	ra,ffffffffc020676c <memset>
ffffffffc0205d52:	b775                	j	ffffffffc0205cfe <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205d54:	417a8a33          	sub	s4,s5,s7
ffffffffc0205d58:	b799                	j	ffffffffc0205c9e <do_execve+0x398>
        return -E_INVAL;
ffffffffc0205d5a:	5a75                	li	s4,-3
ffffffffc0205d5c:	b3c1                	j	ffffffffc0205b1c <do_execve+0x216>
        while (start < end) {
ffffffffc0205d5e:	86de                	mv	a3,s7
ffffffffc0205d60:	bf39                	j	ffffffffc0205c7e <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0205d62:	5a71                	li	s4,-4
ffffffffc0205d64:	bdc5                	j	ffffffffc0205c54 <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0205d66:	5a61                	li	s4,-8
ffffffffc0205d68:	b5c5                	j	ffffffffc0205c48 <do_execve+0x342>
ffffffffc0205d6a:	00001617          	auipc	a2,0x1
ffffffffc0205d6e:	7b660613          	addi	a2,a2,1974 # ffffffffc0207520 <default_pmm_manager+0x38>
ffffffffc0205d72:	06900593          	li	a1,105
ffffffffc0205d76:	00001517          	auipc	a0,0x1
ffffffffc0205d7a:	7d250513          	addi	a0,a0,2002 # ffffffffc0207548 <default_pmm_manager+0x60>
ffffffffc0205d7e:	efcfa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205d82:	00002617          	auipc	a2,0x2
ffffffffc0205d86:	84660613          	addi	a2,a2,-1978 # ffffffffc02075c8 <default_pmm_manager+0xe0>
ffffffffc0205d8a:	2a600593          	li	a1,678
ffffffffc0205d8e:	00003517          	auipc	a0,0x3
ffffffffc0205d92:	82250513          	addi	a0,a0,-2014 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205d96:	ee4fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205d9a:	00003697          	auipc	a3,0x3
ffffffffc0205d9e:	b3e68693          	addi	a3,a3,-1218 # ffffffffc02088d8 <default_pmm_manager+0x13f0>
ffffffffc0205da2:	00001617          	auipc	a2,0x1
ffffffffc0205da6:	0ae60613          	addi	a2,a2,174 # ffffffffc0206e50 <commands+0x450>
ffffffffc0205daa:	2a100593          	li	a1,673
ffffffffc0205dae:	00003517          	auipc	a0,0x3
ffffffffc0205db2:	80250513          	addi	a0,a0,-2046 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205db6:	ec4fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205dba:	00003697          	auipc	a3,0x3
ffffffffc0205dbe:	ad668693          	addi	a3,a3,-1322 # ffffffffc0208890 <default_pmm_manager+0x13a8>
ffffffffc0205dc2:	00001617          	auipc	a2,0x1
ffffffffc0205dc6:	08e60613          	addi	a2,a2,142 # ffffffffc0206e50 <commands+0x450>
ffffffffc0205dca:	2a000593          	li	a1,672
ffffffffc0205dce:	00002517          	auipc	a0,0x2
ffffffffc0205dd2:	7e250513          	addi	a0,a0,2018 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205dd6:	ea4fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205dda:	00003697          	auipc	a3,0x3
ffffffffc0205dde:	a6e68693          	addi	a3,a3,-1426 # ffffffffc0208848 <default_pmm_manager+0x1360>
ffffffffc0205de2:	00001617          	auipc	a2,0x1
ffffffffc0205de6:	06e60613          	addi	a2,a2,110 # ffffffffc0206e50 <commands+0x450>
ffffffffc0205dea:	29f00593          	li	a1,671
ffffffffc0205dee:	00002517          	auipc	a0,0x2
ffffffffc0205df2:	7c250513          	addi	a0,a0,1986 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205df6:	e84fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205dfa:	00003697          	auipc	a3,0x3
ffffffffc0205dfe:	a0668693          	addi	a3,a3,-1530 # ffffffffc0208800 <default_pmm_manager+0x1318>
ffffffffc0205e02:	00001617          	auipc	a2,0x1
ffffffffc0205e06:	04e60613          	addi	a2,a2,78 # ffffffffc0206e50 <commands+0x450>
ffffffffc0205e0a:	29e00593          	li	a1,670
ffffffffc0205e0e:	00002517          	auipc	a0,0x2
ffffffffc0205e12:	7a250513          	addi	a0,a0,1954 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0205e16:	e64fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205e1a <do_yield>:
    current->need_resched = 1;
ffffffffc0205e1a:	000ad797          	auipc	a5,0xad
ffffffffc0205e1e:	d567b783          	ld	a5,-682(a5) # ffffffffc02b2b70 <current>
ffffffffc0205e22:	4705                	li	a4,1
ffffffffc0205e24:	ef98                	sd	a4,24(a5)
}
ffffffffc0205e26:	4501                	li	a0,0
ffffffffc0205e28:	8082                	ret

ffffffffc0205e2a <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205e2a:	1101                	addi	sp,sp,-32
ffffffffc0205e2c:	e822                	sd	s0,16(sp)
ffffffffc0205e2e:	e426                	sd	s1,8(sp)
ffffffffc0205e30:	ec06                	sd	ra,24(sp)
ffffffffc0205e32:	842e                	mv	s0,a1
ffffffffc0205e34:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205e36:	c999                	beqz	a1,ffffffffc0205e4c <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205e38:	000ad797          	auipc	a5,0xad
ffffffffc0205e3c:	d387b783          	ld	a5,-712(a5) # ffffffffc02b2b70 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205e40:	7788                	ld	a0,40(a5)
ffffffffc0205e42:	4685                	li	a3,1
ffffffffc0205e44:	4611                	li	a2,4
ffffffffc0205e46:	c93fe0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc0205e4a:	c909                	beqz	a0,ffffffffc0205e5c <do_wait+0x32>
ffffffffc0205e4c:	85a2                	mv	a1,s0
}
ffffffffc0205e4e:	6442                	ld	s0,16(sp)
ffffffffc0205e50:	60e2                	ld	ra,24(sp)
ffffffffc0205e52:	8526                	mv	a0,s1
ffffffffc0205e54:	64a2                	ld	s1,8(sp)
ffffffffc0205e56:	6105                	addi	sp,sp,32
ffffffffc0205e58:	fb8ff06f          	j	ffffffffc0205610 <do_wait.part.0>
ffffffffc0205e5c:	60e2                	ld	ra,24(sp)
ffffffffc0205e5e:	6442                	ld	s0,16(sp)
ffffffffc0205e60:	64a2                	ld	s1,8(sp)
ffffffffc0205e62:	5575                	li	a0,-3
ffffffffc0205e64:	6105                	addi	sp,sp,32
ffffffffc0205e66:	8082                	ret

ffffffffc0205e68 <do_kill>:
do_kill(int pid) {
ffffffffc0205e68:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205e6a:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205e6c:	e406                	sd	ra,8(sp)
ffffffffc0205e6e:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205e70:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205e74:	17f9                	addi	a5,a5,-2
ffffffffc0205e76:	02e7e963          	bltu	a5,a4,ffffffffc0205ea8 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205e7a:	842a                	mv	s0,a0
ffffffffc0205e7c:	45a9                	li	a1,10
ffffffffc0205e7e:	2501                	sext.w	a0,a0
ffffffffc0205e80:	46c000ef          	jal	ra,ffffffffc02062ec <hash32>
ffffffffc0205e84:	02051793          	slli	a5,a0,0x20
ffffffffc0205e88:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205e8c:	000a9797          	auipc	a5,0xa9
ffffffffc0205e90:	c5c78793          	addi	a5,a5,-932 # ffffffffc02aeae8 <hash_list>
ffffffffc0205e94:	953e                	add	a0,a0,a5
ffffffffc0205e96:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205e98:	a029                	j	ffffffffc0205ea2 <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205e9a:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205e9e:	00870b63          	beq	a4,s0,ffffffffc0205eb4 <do_kill+0x4c>
ffffffffc0205ea2:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205ea4:	fef51be3          	bne	a0,a5,ffffffffc0205e9a <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205ea8:	5475                	li	s0,-3
}
ffffffffc0205eaa:	60a2                	ld	ra,8(sp)
ffffffffc0205eac:	8522                	mv	a0,s0
ffffffffc0205eae:	6402                	ld	s0,0(sp)
ffffffffc0205eb0:	0141                	addi	sp,sp,16
ffffffffc0205eb2:	8082                	ret
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205eb4:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205eb8:	00177693          	andi	a3,a4,1
ffffffffc0205ebc:	e295                	bnez	a3,ffffffffc0205ee0 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205ebe:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205ec0:	00176713          	ori	a4,a4,1
ffffffffc0205ec4:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205ec8:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205eca:	fe06d0e3          	bgez	a3,ffffffffc0205eaa <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205ece:	f2878513          	addi	a0,a5,-216
ffffffffc0205ed2:	22e000ef          	jal	ra,ffffffffc0206100 <wakeup_proc>
}
ffffffffc0205ed6:	60a2                	ld	ra,8(sp)
ffffffffc0205ed8:	8522                	mv	a0,s0
ffffffffc0205eda:	6402                	ld	s0,0(sp)
ffffffffc0205edc:	0141                	addi	sp,sp,16
ffffffffc0205ede:	8082                	ret
        return -E_KILLED;
ffffffffc0205ee0:	545d                	li	s0,-9
ffffffffc0205ee2:	b7e1                	j	ffffffffc0205eaa <do_kill+0x42>

ffffffffc0205ee4 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205ee4:	1101                	addi	sp,sp,-32
ffffffffc0205ee6:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205ee8:	000ad797          	auipc	a5,0xad
ffffffffc0205eec:	c0078793          	addi	a5,a5,-1024 # ffffffffc02b2ae8 <proc_list>
ffffffffc0205ef0:	ec06                	sd	ra,24(sp)
ffffffffc0205ef2:	e822                	sd	s0,16(sp)
ffffffffc0205ef4:	e04a                	sd	s2,0(sp)
ffffffffc0205ef6:	000a9497          	auipc	s1,0xa9
ffffffffc0205efa:	bf248493          	addi	s1,s1,-1038 # ffffffffc02aeae8 <hash_list>
ffffffffc0205efe:	e79c                	sd	a5,8(a5)
ffffffffc0205f00:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205f02:	000ad717          	auipc	a4,0xad
ffffffffc0205f06:	be670713          	addi	a4,a4,-1050 # ffffffffc02b2ae8 <proc_list>
ffffffffc0205f0a:	87a6                	mv	a5,s1
ffffffffc0205f0c:	e79c                	sd	a5,8(a5)
ffffffffc0205f0e:	e39c                	sd	a5,0(a5)
ffffffffc0205f10:	07c1                	addi	a5,a5,16
ffffffffc0205f12:	fef71de3          	bne	a4,a5,ffffffffc0205f0c <proc_init+0x28>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205f16:	e83fe0ef          	jal	ra,ffffffffc0204d98 <alloc_proc>
ffffffffc0205f1a:	000ad917          	auipc	s2,0xad
ffffffffc0205f1e:	c5e90913          	addi	s2,s2,-930 # ffffffffc02b2b78 <idleproc>
ffffffffc0205f22:	00a93023          	sd	a0,0(s2)
ffffffffc0205f26:	0e050f63          	beqz	a0,ffffffffc0206024 <proc_init+0x140>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205f2a:	4789                	li	a5,2
ffffffffc0205f2c:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205f2e:	00003797          	auipc	a5,0x3
ffffffffc0205f32:	0d278793          	addi	a5,a5,210 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205f36:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205f3a:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205f3c:	4785                	li	a5,1
ffffffffc0205f3e:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205f40:	4641                	li	a2,16
ffffffffc0205f42:	4581                	li	a1,0
ffffffffc0205f44:	8522                	mv	a0,s0
ffffffffc0205f46:	027000ef          	jal	ra,ffffffffc020676c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205f4a:	463d                	li	a2,15
ffffffffc0205f4c:	00003597          	auipc	a1,0x3
ffffffffc0205f50:	9ec58593          	addi	a1,a1,-1556 # ffffffffc0208938 <default_pmm_manager+0x1450>
ffffffffc0205f54:	8522                	mv	a0,s0
ffffffffc0205f56:	029000ef          	jal	ra,ffffffffc020677e <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205f5a:	000ad717          	auipc	a4,0xad
ffffffffc0205f5e:	c2e70713          	addi	a4,a4,-978 # ffffffffc02b2b88 <nr_process>
ffffffffc0205f62:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205f64:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205f68:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205f6a:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205f6c:	4581                	li	a1,0
ffffffffc0205f6e:	00000517          	auipc	a0,0x0
ffffffffc0205f72:	87450513          	addi	a0,a0,-1932 # ffffffffc02057e2 <init_main>
    nr_process ++;
ffffffffc0205f76:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205f78:	000ad797          	auipc	a5,0xad
ffffffffc0205f7c:	bed7bc23          	sd	a3,-1032(a5) # ffffffffc02b2b70 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205f80:	cf6ff0ef          	jal	ra,ffffffffc0205476 <kernel_thread>
ffffffffc0205f84:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205f86:	08a05363          	blez	a0,ffffffffc020600c <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205f8a:	6789                	lui	a5,0x2
ffffffffc0205f8c:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205f90:	17f9                	addi	a5,a5,-2
ffffffffc0205f92:	2501                	sext.w	a0,a0
ffffffffc0205f94:	02e7e363          	bltu	a5,a4,ffffffffc0205fba <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205f98:	45a9                	li	a1,10
ffffffffc0205f9a:	352000ef          	jal	ra,ffffffffc02062ec <hash32>
ffffffffc0205f9e:	02051793          	slli	a5,a0,0x20
ffffffffc0205fa2:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205fa6:	96a6                	add	a3,a3,s1
ffffffffc0205fa8:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205faa:	a029                	j	ffffffffc0205fb4 <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205fac:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7cb4>
ffffffffc0205fb0:	04870b63          	beq	a4,s0,ffffffffc0206006 <proc_init+0x122>
    return listelm->next;
ffffffffc0205fb4:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205fb6:	fef69be3          	bne	a3,a5,ffffffffc0205fac <proc_init+0xc8>
    return NULL;
ffffffffc0205fba:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205fbc:	0b478493          	addi	s1,a5,180
ffffffffc0205fc0:	4641                	li	a2,16
ffffffffc0205fc2:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205fc4:	000ad417          	auipc	s0,0xad
ffffffffc0205fc8:	bbc40413          	addi	s0,s0,-1092 # ffffffffc02b2b80 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205fcc:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205fce:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205fd0:	79c000ef          	jal	ra,ffffffffc020676c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205fd4:	463d                	li	a2,15
ffffffffc0205fd6:	00003597          	auipc	a1,0x3
ffffffffc0205fda:	98a58593          	addi	a1,a1,-1654 # ffffffffc0208960 <default_pmm_manager+0x1478>
ffffffffc0205fde:	8526                	mv	a0,s1
ffffffffc0205fe0:	79e000ef          	jal	ra,ffffffffc020677e <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205fe4:	00093783          	ld	a5,0(s2)
ffffffffc0205fe8:	cbb5                	beqz	a5,ffffffffc020605c <proc_init+0x178>
ffffffffc0205fea:	43dc                	lw	a5,4(a5)
ffffffffc0205fec:	eba5                	bnez	a5,ffffffffc020605c <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205fee:	601c                	ld	a5,0(s0)
ffffffffc0205ff0:	c7b1                	beqz	a5,ffffffffc020603c <proc_init+0x158>
ffffffffc0205ff2:	43d8                	lw	a4,4(a5)
ffffffffc0205ff4:	4785                	li	a5,1
ffffffffc0205ff6:	04f71363          	bne	a4,a5,ffffffffc020603c <proc_init+0x158>
}
ffffffffc0205ffa:	60e2                	ld	ra,24(sp)
ffffffffc0205ffc:	6442                	ld	s0,16(sp)
ffffffffc0205ffe:	64a2                	ld	s1,8(sp)
ffffffffc0206000:	6902                	ld	s2,0(sp)
ffffffffc0206002:	6105                	addi	sp,sp,32
ffffffffc0206004:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0206006:	f2878793          	addi	a5,a5,-216
ffffffffc020600a:	bf4d                	j	ffffffffc0205fbc <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc020600c:	00003617          	auipc	a2,0x3
ffffffffc0206010:	93460613          	addi	a2,a2,-1740 # ffffffffc0208940 <default_pmm_manager+0x1458>
ffffffffc0206014:	3af00593          	li	a1,943
ffffffffc0206018:	00002517          	auipc	a0,0x2
ffffffffc020601c:	59850513          	addi	a0,a0,1432 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0206020:	c5afa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0206024:	00003617          	auipc	a2,0x3
ffffffffc0206028:	8fc60613          	addi	a2,a2,-1796 # ffffffffc0208920 <default_pmm_manager+0x1438>
ffffffffc020602c:	3a100593          	li	a1,929
ffffffffc0206030:	00002517          	auipc	a0,0x2
ffffffffc0206034:	58050513          	addi	a0,a0,1408 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0206038:	c42fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020603c:	00003697          	auipc	a3,0x3
ffffffffc0206040:	95468693          	addi	a3,a3,-1708 # ffffffffc0208990 <default_pmm_manager+0x14a8>
ffffffffc0206044:	00001617          	auipc	a2,0x1
ffffffffc0206048:	e0c60613          	addi	a2,a2,-500 # ffffffffc0206e50 <commands+0x450>
ffffffffc020604c:	3b600593          	li	a1,950
ffffffffc0206050:	00002517          	auipc	a0,0x2
ffffffffc0206054:	56050513          	addi	a0,a0,1376 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0206058:	c22fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020605c:	00003697          	auipc	a3,0x3
ffffffffc0206060:	90c68693          	addi	a3,a3,-1780 # ffffffffc0208968 <default_pmm_manager+0x1480>
ffffffffc0206064:	00001617          	auipc	a2,0x1
ffffffffc0206068:	dec60613          	addi	a2,a2,-532 # ffffffffc0206e50 <commands+0x450>
ffffffffc020606c:	3b500593          	li	a1,949
ffffffffc0206070:	00002517          	auipc	a0,0x2
ffffffffc0206074:	54050513          	addi	a0,a0,1344 # ffffffffc02085b0 <default_pmm_manager+0x10c8>
ffffffffc0206078:	c02fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc020607c <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc020607c:	1141                	addi	sp,sp,-16
ffffffffc020607e:	e022                	sd	s0,0(sp)
ffffffffc0206080:	e406                	sd	ra,8(sp)
ffffffffc0206082:	000ad417          	auipc	s0,0xad
ffffffffc0206086:	aee40413          	addi	s0,s0,-1298 # ffffffffc02b2b70 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc020608a:	6018                	ld	a4,0(s0)
ffffffffc020608c:	6f1c                	ld	a5,24(a4)
ffffffffc020608e:	dffd                	beqz	a5,ffffffffc020608c <cpu_idle+0x10>
            schedule();
ffffffffc0206090:	0f0000ef          	jal	ra,ffffffffc0206180 <schedule>
ffffffffc0206094:	bfdd                	j	ffffffffc020608a <cpu_idle+0xe>

ffffffffc0206096 <switch_to>:
.text
...
ffffffffc0206096:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc020609a:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc020609e:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02060a0:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02060a2:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02060a6:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02060aa:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02060ae:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02060b2:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02060b6:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02060ba:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02060be:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02060c2:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02060c6:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02060ca:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02060ce:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02060d2:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02060d4:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02060d6:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02060da:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02060de:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02060e2:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02060e6:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02060ea:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02060ee:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02060f2:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02060f6:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02060fa:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02060fe:	8082                	ret

ffffffffc0206100 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0206100:	4118                	lw	a4,0(a0)
wakeup_proc(struct proc_struct *proc) {
ffffffffc0206102:	1101                	addi	sp,sp,-32
ffffffffc0206104:	ec06                	sd	ra,24(sp)
ffffffffc0206106:	e822                	sd	s0,16(sp)
ffffffffc0206108:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc020610a:	478d                	li	a5,3
ffffffffc020610c:	04f70b63          	beq	a4,a5,ffffffffc0206162 <wakeup_proc+0x62>
ffffffffc0206110:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0206112:	100027f3          	csrr	a5,sstatus
ffffffffc0206116:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0206118:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020611a:	ef9d                	bnez	a5,ffffffffc0206158 <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc020611c:	4789                	li	a5,2
ffffffffc020611e:	02f70163          	beq	a4,a5,ffffffffc0206140 <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0206122:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0206124:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0206128:	e491                	bnez	s1,ffffffffc0206134 <wakeup_proc+0x34>
        else {
...
ffffffffc020612a:	60e2                	ld	ra,24(sp)
ffffffffc020612c:	6442                	ld	s0,16(sp)
ffffffffc020612e:	64a2                	ld	s1,8(sp)
ffffffffc0206130:	6105                	addi	sp,sp,32
ffffffffc0206132:	8082                	ret
ffffffffc0206134:	6442                	ld	s0,16(sp)
ffffffffc0206136:	60e2                	ld	ra,24(sp)
ffffffffc0206138:	64a2                	ld	s1,8(sp)
ffffffffc020613a:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc020613c:	d04fa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0206140:	00003617          	auipc	a2,0x3
ffffffffc0206144:	8b060613          	addi	a2,a2,-1872 # ffffffffc02089f0 <default_pmm_manager+0x1508>
ffffffffc0206148:	45c9                	li	a1,18
ffffffffc020614a:	00003517          	auipc	a0,0x3
ffffffffc020614e:	88e50513          	addi	a0,a0,-1906 # ffffffffc02089d8 <default_pmm_manager+0x14f0>
ffffffffc0206152:	b90fa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0206156:	bfc9                	j	ffffffffc0206128 <wakeup_proc+0x28>
        intr_disable();
ffffffffc0206158:	ceefa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc020615c:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc020615e:	4485                	li	s1,1
ffffffffc0206160:	bf75                	j	ffffffffc020611c <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0206162:	00003697          	auipc	a3,0x3
ffffffffc0206166:	85668693          	addi	a3,a3,-1962 # ffffffffc02089b8 <default_pmm_manager+0x14d0>
ffffffffc020616a:	00001617          	auipc	a2,0x1
ffffffffc020616e:	ce660613          	addi	a2,a2,-794 # ffffffffc0206e50 <commands+0x450>
ffffffffc0206172:	45a5                	li	a1,9
ffffffffc0206174:	00003517          	auipc	a0,0x3
ffffffffc0206178:	86450513          	addi	a0,a0,-1948 # ffffffffc02089d8 <default_pmm_manager+0x14f0>
ffffffffc020617c:	afefa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0206180 <schedule>:

void
schedule(void) {
ffffffffc0206180:	1141                	addi	sp,sp,-16
ffffffffc0206182:	e406                	sd	ra,8(sp)
ffffffffc0206184:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0206186:	100027f3          	csrr	a5,sstatus
ffffffffc020618a:	8b89                	andi	a5,a5,2
ffffffffc020618c:	4401                	li	s0,0
ffffffffc020618e:	efbd                	bnez	a5,ffffffffc020620c <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0206190:	000ad897          	auipc	a7,0xad
ffffffffc0206194:	9e08b883          	ld	a7,-1568(a7) # ffffffffc02b2b70 <current>
ffffffffc0206198:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020619c:	000ad517          	auipc	a0,0xad
ffffffffc02061a0:	9dc53503          	ld	a0,-1572(a0) # ffffffffc02b2b78 <idleproc>
ffffffffc02061a4:	04a88e63          	beq	a7,a0,ffffffffc0206200 <schedule+0x80>
ffffffffc02061a8:	0c888693          	addi	a3,a7,200
ffffffffc02061ac:	000ad617          	auipc	a2,0xad
ffffffffc02061b0:	93c60613          	addi	a2,a2,-1732 # ffffffffc02b2ae8 <proc_list>
        le = last;
ffffffffc02061b4:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc02061b6:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc02061b8:	4809                	li	a6,2
ffffffffc02061ba:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02061bc:	00c78863          	beq	a5,a2,ffffffffc02061cc <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02061c0:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02061c4:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02061c8:	03070163          	beq	a4,a6,ffffffffc02061ea <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02061cc:	fef697e3          	bne	a3,a5,ffffffffc02061ba <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02061d0:	ed89                	bnez	a1,ffffffffc02061ea <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02061d2:	451c                	lw	a5,8(a0)
ffffffffc02061d4:	2785                	addiw	a5,a5,1
ffffffffc02061d6:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02061d8:	00a88463          	beq	a7,a0,ffffffffc02061e0 <schedule+0x60>
            proc_run(next);
ffffffffc02061dc:	e95fe0ef          	jal	ra,ffffffffc0205070 <proc_run>
    if (flag) {
ffffffffc02061e0:	e819                	bnez	s0,ffffffffc02061f6 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc02061e2:	60a2                	ld	ra,8(sp)
ffffffffc02061e4:	6402                	ld	s0,0(sp)
ffffffffc02061e6:	0141                	addi	sp,sp,16
ffffffffc02061e8:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02061ea:	4198                	lw	a4,0(a1)
ffffffffc02061ec:	4789                	li	a5,2
ffffffffc02061ee:	fef712e3          	bne	a4,a5,ffffffffc02061d2 <schedule+0x52>
ffffffffc02061f2:	852e                	mv	a0,a1
ffffffffc02061f4:	bff9                	j	ffffffffc02061d2 <schedule+0x52>
}
ffffffffc02061f6:	6402                	ld	s0,0(sp)
ffffffffc02061f8:	60a2                	ld	ra,8(sp)
ffffffffc02061fa:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02061fc:	c44fa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206200:	000ad617          	auipc	a2,0xad
ffffffffc0206204:	8e860613          	addi	a2,a2,-1816 # ffffffffc02b2ae8 <proc_list>
ffffffffc0206208:	86b2                	mv	a3,a2
ffffffffc020620a:	b76d                	j	ffffffffc02061b4 <schedule+0x34>
        intr_disable();
ffffffffc020620c:	c3afa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0206210:	4405                	li	s0,1
ffffffffc0206212:	bfbd                	j	ffffffffc0206190 <schedule+0x10>

ffffffffc0206214 <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0206214:	000ad797          	auipc	a5,0xad
ffffffffc0206218:	95c7b783          	ld	a5,-1700(a5) # ffffffffc02b2b70 <current>
}
ffffffffc020621c:	43c8                	lw	a0,4(a5)
ffffffffc020621e:	8082                	ret

ffffffffc0206220 <sys_pgdir>:
...
ffffffffc0206220:	4501                	li	a0,0
ffffffffc0206222:	8082                	ret

ffffffffc0206224 <sys_putc>:
    cputchar(c);
ffffffffc0206224:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc0206226:	1141                	addi	sp,sp,-16
ffffffffc0206228:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020622a:	f8df90ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
ffffffffc020622e:	60a2                	ld	ra,8(sp)
ffffffffc0206230:	4501                	li	a0,0
ffffffffc0206232:	0141                	addi	sp,sp,16
ffffffffc0206234:	8082                	ret

ffffffffc0206236 <sys_kill>:
    return do_kill(pid);
ffffffffc0206236:	4108                	lw	a0,0(a0)
ffffffffc0206238:	c31ff06f          	j	ffffffffc0205e68 <do_kill>

ffffffffc020623c <sys_yield>:
    return do_yield();
ffffffffc020623c:	bdfff06f          	j	ffffffffc0205e1a <do_yield>

ffffffffc0206240 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0206240:	6d14                	ld	a3,24(a0)
ffffffffc0206242:	6910                	ld	a2,16(a0)
ffffffffc0206244:	650c                	ld	a1,8(a0)
ffffffffc0206246:	6108                	ld	a0,0(a0)
ffffffffc0206248:	ebeff06f          	j	ffffffffc0205906 <do_execve>

ffffffffc020624c <sys_wait>:
    return do_wait(pid, store);
ffffffffc020624c:	650c                	ld	a1,8(a0)
ffffffffc020624e:	4108                	lw	a0,0(a0)
ffffffffc0206250:	bdbff06f          	j	ffffffffc0205e2a <do_wait>

ffffffffc0206254 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc0206254:	000ad797          	auipc	a5,0xad
ffffffffc0206258:	91c7b783          	ld	a5,-1764(a5) # ffffffffc02b2b70 <current>
ffffffffc020625c:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc020625e:	4501                	li	a0,0
ffffffffc0206260:	6a0c                	ld	a1,16(a2)
ffffffffc0206262:	e7bfe06f          	j	ffffffffc02050dc <do_fork>

ffffffffc0206266 <sys_exit>:
    return do_exit(error_code);
ffffffffc0206266:	4108                	lw	a0,0(a0)
ffffffffc0206268:	a5eff06f          	j	ffffffffc02054c6 <do_exit>

ffffffffc020626c <syscall>:
};
...
void
syscall(void) {
ffffffffc020626c:	715d                	addi	sp,sp,-80
ffffffffc020626e:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206270:	000ad497          	auipc	s1,0xad
ffffffffc0206274:	90048493          	addi	s1,s1,-1792 # ffffffffc02b2b70 <current>
ffffffffc0206278:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc020627a:	e0a2                	sd	s0,64(sp)
ffffffffc020627c:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc020627e:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc0206280:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc0206282:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc0206284:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc0206288:	0327ee63          	bltu	a5,s2,ffffffffc02062c4 <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc020628c:	00391713          	slli	a4,s2,0x3
ffffffffc0206290:	00002797          	auipc	a5,0x2
ffffffffc0206294:	7c878793          	addi	a5,a5,1992 # ffffffffc0208a58 <syscalls>
ffffffffc0206298:	97ba                	add	a5,a5,a4
ffffffffc020629a:	639c                	ld	a5,0(a5)
ffffffffc020629c:	c785                	beqz	a5,ffffffffc02062c4 <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc020629e:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02062a0:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02062a2:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc02062a4:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc02062a6:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02062a8:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc02062aa:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02062ac:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02062ae:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02062b0:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02062b2:	0028                	addi	a0,sp,8
ffffffffc02062b4:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc02062b6:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02062b8:	e828                	sd	a0,80(s0)
}
ffffffffc02062ba:	6406                	ld	s0,64(sp)
ffffffffc02062bc:	74e2                	ld	s1,56(sp)
ffffffffc02062be:	7942                	ld	s2,48(sp)
ffffffffc02062c0:	6161                	addi	sp,sp,80
ffffffffc02062c2:	8082                	ret
    print_trapframe(tf);
ffffffffc02062c4:	8522                	mv	a0,s0
ffffffffc02062c6:	d6efa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02062ca:	609c                	ld	a5,0(s1)
ffffffffc02062cc:	86ca                	mv	a3,s2
ffffffffc02062ce:	00002617          	auipc	a2,0x2
ffffffffc02062d2:	74260613          	addi	a2,a2,1858 # ffffffffc0208a10 <default_pmm_manager+0x1528>
ffffffffc02062d6:	43d8                	lw	a4,4(a5)
ffffffffc02062d8:	06200593          	li	a1,98
ffffffffc02062dc:	0b478793          	addi	a5,a5,180
ffffffffc02062e0:	00002517          	auipc	a0,0x2
ffffffffc02062e4:	76050513          	addi	a0,a0,1888 # ffffffffc0208a40 <default_pmm_manager+0x1558>
ffffffffc02062e8:	992fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02062ec <hash32>:
 *
...
ffffffffc02062ec:	9e3707b7          	lui	a5,0x9e370
ffffffffc02062f0:	2785                	addiw	a5,a5,1
ffffffffc02062f2:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02062f6:	02000793          	li	a5,32
ffffffffc02062fa:	9f8d                	subw	a5,a5,a1
}
ffffffffc02062fc:	00f5553b          	srlw	a0,a0,a5
ffffffffc0206300:	8082                	ret

ffffffffc0206302 <printnum>:
 * */
static void
...
ffffffffc0206302:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206306:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0206308:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020630c:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020630e:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206312:	f022                	sd	s0,32(sp)
ffffffffc0206314:	ec26                	sd	s1,24(sp)
ffffffffc0206316:	e84a                	sd	s2,16(sp)
ffffffffc0206318:	f406                	sd	ra,40(sp)
ffffffffc020631a:	e44e                	sd	s3,8(sp)
ffffffffc020631c:	84aa                	mv	s1,a0
ffffffffc020631e:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0206320:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0206324:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0206326:	03067e63          	bgeu	a2,a6,ffffffffc0206362 <printnum+0x60>
ffffffffc020632a:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc020632c:	00805763          	blez	s0,ffffffffc020633a <printnum+0x38>
ffffffffc0206330:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0206332:	85ca                	mv	a1,s2
ffffffffc0206334:	854e                	mv	a0,s3
ffffffffc0206336:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0206338:	fc65                	bnez	s0,ffffffffc0206330 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020633a:	1a02                	slli	s4,s4,0x20
ffffffffc020633c:	00003797          	auipc	a5,0x3
ffffffffc0206340:	81c78793          	addi	a5,a5,-2020 # ffffffffc0208b58 <syscalls+0x100>
ffffffffc0206344:	020a5a13          	srli	s4,s4,0x20
ffffffffc0206348:	9a3e                	add	s4,s4,a5
...
ffffffffc020634a:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020634c:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0206350:	70a2                	ld	ra,40(sp)
ffffffffc0206352:	69a2                	ld	s3,8(sp)
ffffffffc0206354:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206356:	85ca                	mv	a1,s2
ffffffffc0206358:	87a6                	mv	a5,s1
}
ffffffffc020635a:	6942                	ld	s2,16(sp)
ffffffffc020635c:	64e2                	ld	s1,24(sp)
ffffffffc020635e:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206360:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0206362:	03065633          	divu	a2,a2,a6
ffffffffc0206366:	8722                	mv	a4,s0
ffffffffc0206368:	f9bff0ef          	jal	ra,ffffffffc0206302 <printnum>
ffffffffc020636c:	b7f9                	j	ffffffffc020633a <printnum+0x38>

ffffffffc020636e <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc020636e:	7119                	addi	sp,sp,-128
ffffffffc0206370:	f4a6                	sd	s1,104(sp)
ffffffffc0206372:	f0ca                	sd	s2,96(sp)
ffffffffc0206374:	ecce                	sd	s3,88(sp)
ffffffffc0206376:	e8d2                	sd	s4,80(sp)
ffffffffc0206378:	e4d6                	sd	s5,72(sp)
ffffffffc020637a:	e0da                	sd	s6,64(sp)
ffffffffc020637c:	fc5e                	sd	s7,56(sp)
ffffffffc020637e:	f06a                	sd	s10,32(sp)
ffffffffc0206380:	fc86                	sd	ra,120(sp)
ffffffffc0206382:	f8a2                	sd	s0,112(sp)
ffffffffc0206384:	f862                	sd	s8,48(sp)
ffffffffc0206386:	f466                	sd	s9,40(sp)
ffffffffc0206388:	ec6e                	sd	s11,24(sp)
ffffffffc020638a:	892a                	mv	s2,a0
ffffffffc020638c:	84ae                	mv	s1,a1
ffffffffc020638e:	8d32                	mv	s10,a2
ffffffffc0206390:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0206392:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0206396:	5b7d                	li	s6,-1
ffffffffc0206398:	00002a97          	auipc	s5,0x2
ffffffffc020639c:	7eca8a93          	addi	s5,s5,2028 # ffffffffc0208b84 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02063a0:	00003b97          	auipc	s7,0x3
ffffffffc02063a4:	a00b8b93          	addi	s7,s7,-1536 # ffffffffc0208da0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02063a8:	000d4503          	lbu	a0,0(s10)
ffffffffc02063ac:	001d0413          	addi	s0,s10,1
ffffffffc02063b0:	01350a63          	beq	a0,s3,ffffffffc02063c4 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02063b4:	c121                	beqz	a0,ffffffffc02063f4 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02063b6:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02063b8:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02063ba:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02063bc:	fff44503          	lbu	a0,-1(s0)
ffffffffc02063c0:	ff351ae3          	bne	a0,s3,ffffffffc02063b4 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02063c4:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02063c8:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02063cc:	4c81                	li	s9,0
ffffffffc02063ce:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02063d0:	5c7d                	li	s8,-1
ffffffffc02063d2:	5dfd                	li	s11,-1
ffffffffc02063d4:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02063d8:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02063da:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02063de:	0ff5f593          	zext.b	a1,a1
ffffffffc02063e2:	00140d13          	addi	s10,s0,1
ffffffffc02063e6:	04b56263          	bltu	a0,a1,ffffffffc020642a <vprintfmt+0xbc>
ffffffffc02063ea:	058a                	slli	a1,a1,0x2
ffffffffc02063ec:	95d6                	add	a1,a1,s5
ffffffffc02063ee:	4194                	lw	a3,0(a1)
ffffffffc02063f0:	96d6                	add	a3,a3,s5
ffffffffc02063f2:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc02063f4:	70e6                	ld	ra,120(sp)
ffffffffc02063f6:	7446                	ld	s0,112(sp)
ffffffffc02063f8:	74a6                	ld	s1,104(sp)
ffffffffc02063fa:	7906                	ld	s2,96(sp)
ffffffffc02063fc:	69e6                	ld	s3,88(sp)
ffffffffc02063fe:	6a46                	ld	s4,80(sp)
ffffffffc0206400:	6aa6                	ld	s5,72(sp)
ffffffffc0206402:	6b06                	ld	s6,64(sp)
ffffffffc0206404:	7be2                	ld	s7,56(sp)
ffffffffc0206406:	7c42                	ld	s8,48(sp)
ffffffffc0206408:	7ca2                	ld	s9,40(sp)
ffffffffc020640a:	7d02                	ld	s10,32(sp)
ffffffffc020640c:	6de2                	ld	s11,24(sp)
ffffffffc020640e:	6109                	addi	sp,sp,128
ffffffffc0206410:	8082                	ret
            padc = '0';
ffffffffc0206412:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0206414:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206418:	846a                	mv	s0,s10
ffffffffc020641a:	00140d13          	addi	s10,s0,1
ffffffffc020641e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206422:	0ff5f593          	zext.b	a1,a1
ffffffffc0206426:	fcb572e3          	bgeu	a0,a1,ffffffffc02063ea <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020642a:	85a6                	mv	a1,s1
ffffffffc020642c:	02500513          	li	a0,37
ffffffffc0206430:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206432:	fff44783          	lbu	a5,-1(s0)
ffffffffc0206436:	8d22                	mv	s10,s0
ffffffffc0206438:	f73788e3          	beq	a5,s3,ffffffffc02063a8 <vprintfmt+0x3a>
ffffffffc020643c:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206440:	1d7d                	addi	s10,s10,-1
ffffffffc0206442:	ff379de3          	bne	a5,s3,ffffffffc020643c <vprintfmt+0xce>
ffffffffc0206446:	b78d                	j	ffffffffc02063a8 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0206448:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc020644c:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206450:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0206452:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0206456:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020645a:	02d86463          	bltu	a6,a3,ffffffffc0206482 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc020645e:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0206462:	002c169b          	slliw	a3,s8,0x2
ffffffffc0206466:	0186873b          	addw	a4,a3,s8
ffffffffc020646a:	0017171b          	slliw	a4,a4,0x1
ffffffffc020646e:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0206470:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0206474:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0206476:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020647a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020647e:	fed870e3          	bgeu	a6,a3,ffffffffc020645e <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0206482:	f40ddce3          	bgez	s11,ffffffffc02063da <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0206486:	8de2                	mv	s11,s8
ffffffffc0206488:	5c7d                	li	s8,-1
ffffffffc020648a:	bf81                	j	ffffffffc02063da <vprintfmt+0x6c>
            if (width < 0)
ffffffffc020648c:	fffdc693          	not	a3,s11
ffffffffc0206490:	96fd                	srai	a3,a3,0x3f
ffffffffc0206492:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206496:	00144603          	lbu	a2,1(s0)
ffffffffc020649a:	2d81                	sext.w	s11,s11
ffffffffc020649c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020649e:	bf35                	j	ffffffffc02063da <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02064a0:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02064a4:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02064a8:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02064aa:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02064ac:	bfd9                	j	ffffffffc0206482 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02064ae:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02064b0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02064b4:	01174463          	blt	a4,a7,ffffffffc02064bc <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02064b8:	1a088e63          	beqz	a7,ffffffffc0206674 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02064bc:	000a3603          	ld	a2,0(s4)
ffffffffc02064c0:	46c1                	li	a3,16
ffffffffc02064c2:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02064c4:	2781                	sext.w	a5,a5
ffffffffc02064c6:	876e                	mv	a4,s11
ffffffffc02064c8:	85a6                	mv	a1,s1
ffffffffc02064ca:	854a                	mv	a0,s2
ffffffffc02064cc:	e37ff0ef          	jal	ra,ffffffffc0206302 <printnum>
            break;
ffffffffc02064d0:	bde1                	j	ffffffffc02063a8 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02064d2:	000a2503          	lw	a0,0(s4)
ffffffffc02064d6:	85a6                	mv	a1,s1
ffffffffc02064d8:	0a21                	addi	s4,s4,8
ffffffffc02064da:	9902                	jalr	s2
            break;
ffffffffc02064dc:	b5f1                	j	ffffffffc02063a8 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02064de:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02064e0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02064e4:	01174463          	blt	a4,a7,ffffffffc02064ec <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02064e8:	18088163          	beqz	a7,ffffffffc020666a <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02064ec:	000a3603          	ld	a2,0(s4)
ffffffffc02064f0:	46a9                	li	a3,10
ffffffffc02064f2:	8a2e                	mv	s4,a1
ffffffffc02064f4:	bfc1                	j	ffffffffc02064c4 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02064f6:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02064fa:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02064fc:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02064fe:	bdf1                	j	ffffffffc02063da <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0206500:	85a6                	mv	a1,s1
ffffffffc0206502:	02500513          	li	a0,37
ffffffffc0206506:	9902                	jalr	s2
            break;
ffffffffc0206508:	b545                	j	ffffffffc02063a8 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020650a:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020650e:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206510:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206512:	b5e1                	j	ffffffffc02063da <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0206514:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206516:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020651a:	01174463          	blt	a4,a7,ffffffffc0206522 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020651e:	14088163          	beqz	a7,ffffffffc0206660 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0206522:	000a3603          	ld	a2,0(s4)
ffffffffc0206526:	46a1                	li	a3,8
ffffffffc0206528:	8a2e                	mv	s4,a1
ffffffffc020652a:	bf69                	j	ffffffffc02064c4 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020652c:	03000513          	li	a0,48
ffffffffc0206530:	85a6                	mv	a1,s1
ffffffffc0206532:	e03e                	sd	a5,0(sp)
ffffffffc0206534:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0206536:	85a6                	mv	a1,s1
ffffffffc0206538:	07800513          	li	a0,120
ffffffffc020653c:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020653e:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206540:	6782                	ld	a5,0(sp)
ffffffffc0206542:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206544:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0206548:	bfb5                	j	ffffffffc02064c4 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020654a:	000a3403          	ld	s0,0(s4)
ffffffffc020654e:	008a0713          	addi	a4,s4,8
ffffffffc0206552:	e03a                	sd	a4,0(sp)
ffffffffc0206554:	14040263          	beqz	s0,ffffffffc0206698 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0206558:	0fb05763          	blez	s11,ffffffffc0206646 <vprintfmt+0x2d8>
ffffffffc020655c:	02d00693          	li	a3,45
ffffffffc0206560:	0cd79163          	bne	a5,a3,ffffffffc0206622 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206564:	00044783          	lbu	a5,0(s0)
ffffffffc0206568:	0007851b          	sext.w	a0,a5
ffffffffc020656c:	cf85                	beqz	a5,ffffffffc02065a4 <vprintfmt+0x236>
ffffffffc020656e:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206572:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206576:	000c4563          	bltz	s8,ffffffffc0206580 <vprintfmt+0x212>
ffffffffc020657a:	3c7d                	addiw	s8,s8,-1
ffffffffc020657c:	036c0263          	beq	s8,s6,ffffffffc02065a0 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0206580:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206582:	0e0c8e63          	beqz	s9,ffffffffc020667e <vprintfmt+0x310>
ffffffffc0206586:	3781                	addiw	a5,a5,-32
ffffffffc0206588:	0ef47b63          	bgeu	s0,a5,ffffffffc020667e <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc020658c:	03f00513          	li	a0,63
ffffffffc0206590:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206592:	000a4783          	lbu	a5,0(s4)
ffffffffc0206596:	3dfd                	addiw	s11,s11,-1
ffffffffc0206598:	0a05                	addi	s4,s4,1
ffffffffc020659a:	0007851b          	sext.w	a0,a5
ffffffffc020659e:	ffe1                	bnez	a5,ffffffffc0206576 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02065a0:	01b05963          	blez	s11,ffffffffc02065b2 <vprintfmt+0x244>
ffffffffc02065a4:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02065a6:	85a6                	mv	a1,s1
ffffffffc02065a8:	02000513          	li	a0,32
ffffffffc02065ac:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02065ae:	fe0d9be3          	bnez	s11,ffffffffc02065a4 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02065b2:	6a02                	ld	s4,0(sp)
ffffffffc02065b4:	bbd5                	j	ffffffffc02063a8 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02065b6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02065b8:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02065bc:	01174463          	blt	a4,a7,ffffffffc02065c4 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02065c0:	08088d63          	beqz	a7,ffffffffc020665a <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02065c4:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02065c8:	0a044d63          	bltz	s0,ffffffffc0206682 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02065cc:	8622                	mv	a2,s0
ffffffffc02065ce:	8a66                	mv	s4,s9
ffffffffc02065d0:	46a9                	li	a3,10
ffffffffc02065d2:	bdcd                	j	ffffffffc02064c4 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02065d4:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02065d8:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02065da:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02065dc:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02065e0:	8fb5                	xor	a5,a5,a3
ffffffffc02065e2:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02065e6:	02d74163          	blt	a4,a3,ffffffffc0206608 <vprintfmt+0x29a>
ffffffffc02065ea:	00369793          	slli	a5,a3,0x3
ffffffffc02065ee:	97de                	add	a5,a5,s7
ffffffffc02065f0:	639c                	ld	a5,0(a5)
ffffffffc02065f2:	cb99                	beqz	a5,ffffffffc0206608 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc02065f4:	86be                	mv	a3,a5
ffffffffc02065f6:	00000617          	auipc	a2,0x0
ffffffffc02065fa:	1ca60613          	addi	a2,a2,458 # ffffffffc02067c0 <etext+0x2a>
ffffffffc02065fe:	85a6                	mv	a1,s1
ffffffffc0206600:	854a                	mv	a0,s2
ffffffffc0206602:	0ce000ef          	jal	ra,ffffffffc02066d0 <printfmt>
ffffffffc0206606:	b34d                	j	ffffffffc02063a8 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206608:	00002617          	auipc	a2,0x2
ffffffffc020660c:	57060613          	addi	a2,a2,1392 # ffffffffc0208b78 <syscalls+0x120>
ffffffffc0206610:	85a6                	mv	a1,s1
ffffffffc0206612:	854a                	mv	a0,s2
ffffffffc0206614:	0bc000ef          	jal	ra,ffffffffc02066d0 <printfmt>
ffffffffc0206618:	bb41                	j	ffffffffc02063a8 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020661a:	00002417          	auipc	s0,0x2
ffffffffc020661e:	55640413          	addi	s0,s0,1366 # ffffffffc0208b70 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206622:	85e2                	mv	a1,s8
ffffffffc0206624:	8522                	mv	a0,s0
ffffffffc0206626:	e43e                	sd	a5,8(sp)
ffffffffc0206628:	0e2000ef          	jal	ra,ffffffffc020670a <strnlen>
ffffffffc020662c:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206630:	01b05b63          	blez	s11,ffffffffc0206646 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0206634:	67a2                	ld	a5,8(sp)
ffffffffc0206636:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020663a:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020663c:	85a6                	mv	a1,s1
ffffffffc020663e:	8552                	mv	a0,s4
ffffffffc0206640:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206642:	fe0d9ce3          	bnez	s11,ffffffffc020663a <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206646:	00044783          	lbu	a5,0(s0)
ffffffffc020664a:	00140a13          	addi	s4,s0,1
ffffffffc020664e:	0007851b          	sext.w	a0,a5
ffffffffc0206652:	d3a5                	beqz	a5,ffffffffc02065b2 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206654:	05e00413          	li	s0,94
ffffffffc0206658:	bf39                	j	ffffffffc0206576 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020665a:	000a2403          	lw	s0,0(s4)
ffffffffc020665e:	b7ad                	j	ffffffffc02065c8 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0206660:	000a6603          	lwu	a2,0(s4)
ffffffffc0206664:	46a1                	li	a3,8
ffffffffc0206666:	8a2e                	mv	s4,a1
ffffffffc0206668:	bdb1                	j	ffffffffc02064c4 <vprintfmt+0x156>
ffffffffc020666a:	000a6603          	lwu	a2,0(s4)
ffffffffc020666e:	46a9                	li	a3,10
ffffffffc0206670:	8a2e                	mv	s4,a1
ffffffffc0206672:	bd89                	j	ffffffffc02064c4 <vprintfmt+0x156>
ffffffffc0206674:	000a6603          	lwu	a2,0(s4)
ffffffffc0206678:	46c1                	li	a3,16
ffffffffc020667a:	8a2e                	mv	s4,a1
ffffffffc020667c:	b5a1                	j	ffffffffc02064c4 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020667e:	9902                	jalr	s2
ffffffffc0206680:	bf09                	j	ffffffffc0206592 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0206682:	85a6                	mv	a1,s1
ffffffffc0206684:	02d00513          	li	a0,45
ffffffffc0206688:	e03e                	sd	a5,0(sp)
ffffffffc020668a:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc020668c:	6782                	ld	a5,0(sp)
ffffffffc020668e:	8a66                	mv	s4,s9
ffffffffc0206690:	40800633          	neg	a2,s0
ffffffffc0206694:	46a9                	li	a3,10
ffffffffc0206696:	b53d                	j	ffffffffc02064c4 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0206698:	03b05163          	blez	s11,ffffffffc02066ba <vprintfmt+0x34c>
ffffffffc020669c:	02d00693          	li	a3,45
ffffffffc02066a0:	f6d79de3          	bne	a5,a3,ffffffffc020661a <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02066a4:	00002417          	auipc	s0,0x2
ffffffffc02066a8:	4cc40413          	addi	s0,s0,1228 # ffffffffc0208b70 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02066ac:	02800793          	li	a5,40
ffffffffc02066b0:	02800513          	li	a0,40
ffffffffc02066b4:	00140a13          	addi	s4,s0,1
ffffffffc02066b8:	bd6d                	j	ffffffffc0206572 <vprintfmt+0x204>
ffffffffc02066ba:	00002a17          	auipc	s4,0x2
ffffffffc02066be:	4b7a0a13          	addi	s4,s4,1207 # ffffffffc0208b71 <syscalls+0x119>
ffffffffc02066c2:	02800513          	li	a0,40
ffffffffc02066c6:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02066ca:	05e00413          	li	s0,94
ffffffffc02066ce:	b565                	j	ffffffffc0206576 <vprintfmt+0x208>

ffffffffc02066d0 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02066d0:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02066d2:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02066d6:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02066d8:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02066da:	ec06                	sd	ra,24(sp)
ffffffffc02066dc:	f83a                	sd	a4,48(sp)
ffffffffc02066de:	fc3e                	sd	a5,56(sp)
ffffffffc02066e0:	e0c2                	sd	a6,64(sp)
ffffffffc02066e2:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02066e4:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02066e6:	c89ff0ef          	jal	ra,ffffffffc020636e <vprintfmt>
}
ffffffffc02066ea:	60e2                	ld	ra,24(sp)
ffffffffc02066ec:	6161                	addi	sp,sp,80
ffffffffc02066ee:	8082                	ret

ffffffffc02066f0 <strlen>:
...
strlen(const char *s) {
ffffffffc02066f4:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02066f6:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02066f8:	cb81                	beqz	a5,ffffffffc0206708 <strlen+0x18>
        cnt ++;
ffffffffc02066fa:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02066fc:	00a707b3          	add	a5,a4,a0
ffffffffc0206700:	0007c783          	lbu	a5,0(a5)
ffffffffc0206704:	fbfd                	bnez	a5,ffffffffc02066fa <strlen+0xa>
...
ffffffffc020670a:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc020670c:	e589                	bnez	a1,ffffffffc0206716 <strnlen+0xc>
ffffffffc020670e:	a811                	j	ffffffffc0206722 <strnlen+0x18>
        cnt ++;
ffffffffc0206710:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206712:	00f58863          	beq	a1,a5,ffffffffc0206722 <strnlen+0x18>
ffffffffc0206716:	00f50733          	add	a4,a0,a5
ffffffffc020671a:	00074703          	lbu	a4,0(a4)
ffffffffc020671e:	fb6d                	bnez	a4,ffffffffc0206710 <strnlen+0x6>
ffffffffc0206720:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0206722:	852e                	mv	a0,a1
ffffffffc0206724:	8082                	ret

ffffffffc0206726 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0206726:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0206728:	0005c703          	lbu	a4,0(a1)
ffffffffc020672c:	0785                	addi	a5,a5,1
ffffffffc020672e:	0585                	addi	a1,a1,1
ffffffffc0206730:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0206734:	fb75                	bnez	a4,ffffffffc0206728 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206738:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020673c:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206740:	cb89                	beqz	a5,ffffffffc0206752 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0206742:	0505                	addi	a0,a0,1
ffffffffc0206744:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206746:	fee789e3          	beq	a5,a4,ffffffffc0206738 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020674a:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc020674e:	9d19                	subw	a0,a0,a4
ffffffffc0206750:	8082                	ret
ffffffffc0206752:	4501                	li	a0,0
ffffffffc0206754:	bfed                	j	ffffffffc020674e <strcmp+0x16>

ffffffffc0206756 <strchr>:
...
ffffffffc020675a:	c799                	beqz	a5,ffffffffc0206768 <strchr+0x12>
        if (*s == c) {
ffffffffc020675c:	00f58763          	beq	a1,a5,ffffffffc020676a <strchr+0x14>
    while (*s != '\0') {
ffffffffc0206760:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0206764:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0206766:	fbfd                	bnez	a5,ffffffffc020675c <strchr+0x6>
    }
    return NULL;
ffffffffc0206768:	4501                	li	a0,0
}
ffffffffc020676a:	8082                	ret

ffffffffc020676c <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc020676c:	ca01                	beqz	a2,ffffffffc020677c <memset+0x10>
ffffffffc020676e:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0206770:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0206772:	0785                	addi	a5,a5,1
ffffffffc0206774:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0206778:	fec79de3          	bne	a5,a2,ffffffffc0206772 <memset+0x6>
    }
    return s;
...
ffffffffc020677e <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc020677e:	ca19                	beqz	a2,ffffffffc0206794 <memcpy+0x16>
ffffffffc0206780:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0206782:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0206784:	0005c703          	lbu	a4,0(a1)
ffffffffc0206788:	0585                	addi	a1,a1,1
ffffffffc020678a:	0785                	addi	a5,a5,1
ffffffffc020678c:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0206790:	fec59ae3          	bne	a1,a2,ffffffffc0206784 <memcpy+0x6>
    }
    return dst;
