...
ffffffffc0204252:	02053423          	sd	zero,40(a0)
        proc->tf = NULL;
ffffffffc0204256:	0a053023          	sd	zero,160(a0)
        proc->flags = 0;
ffffffffc020425a:	0a052823          	sw	zero,176(a0)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc020425e:	03050513          	addi	a0,a0,48
ffffffffc0204262:	481000ef          	jal	ra,ffffffffc0204ee2 <memset>
